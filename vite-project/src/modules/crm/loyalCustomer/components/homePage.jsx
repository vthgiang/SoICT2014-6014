...
function LoyalCustomerHomePage(props) {
  ...
  let pageTotal
  if (loyalCustomers) pageTotal = loyalCustomers.totalDocs / limit
  ...
  return (
    <div className='box'>
      <div className='box-body qlcv'>
        ...
        {customerGetPromotion && (
          <CustomerPromotionInfoForm customerId={customerGetPromotion} getLoyalCustomersData={() => getLoyalCustomersData()} />
        )}
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            <label></label>
            <button type='button' className='btn btn-success' onClick={search} title={'Tìm kiếm'}>
              {'Tìm kiếm'}
            </button>
          </div>
        </div>
        ...
        <table className='table table-hover table-striped table-bordered' id='table-manage-crm-group' style={{ marginTop: '10px' }}>
          <thead>
            <tr>
              ...
              <th style={{ width: '120px' }}>
                ...
                <DataTableSetting
                  columnArr={['Số thứ tự', 'Mã khách hàng', 'Tên khách hàng', 'Tổng số đơn hàng', 'Tổng giá trị đơn hàng']}
                  limit={limit}
          ...
          <tbody>
            {loyalCustomers &&
              loyalCustomers.list.map((o, index) => (
                <tr key={o.customer._id}>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    <a
                      ...
                      title='Tạo hoạt động chăm sóc khách hàng'
                      onClick={() => handleCreateCareAcrion(o.customer._id)}
                    >
                      <i className='material-icons'>add_comment</i>
                    </a>
                    <a className='text-orange' title='Khuyến mãi của khách hàng' onClick={() => handleGetPromotion(o.customer._id)}>
