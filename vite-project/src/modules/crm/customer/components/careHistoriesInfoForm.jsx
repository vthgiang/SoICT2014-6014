        ...
        <div className='box-body qlcv'>
          ...
          <div className='form-inline' style={{ marginBottom: '2px' }}>
            <div className='form-group'>
              ...
              {listCareType && (
                <SelectMulti
                  id='multiSelectUnit-care-history'
                  items={listCareType}
            ...
            <div className='form-group'>
              ...
              {
                <SelectMulti
                  id='multiSelectUnit-care-status-customer-info'
                  items={listStatus}
                ...
                ? cares.list.map((o) => (
                    <tr key={o._id}>
                      ...
                      <td style={{ textAlign: 'center' }}>
                        <a title='Xem thông tin hoạt động' className='text-green' onClick={() => handleInfo(o._id)}>
