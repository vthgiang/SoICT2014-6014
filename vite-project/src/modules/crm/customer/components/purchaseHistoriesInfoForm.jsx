            ...
            <thead>
              <tr>
                ...
                <th style={{ width: '120px' }}>
                  ...
                  <DataTableSetting columnArr={['Mã đơn hàng', 'Ngày đặt đơn', 'Giá trị đơn hàng', 'Trạng thái']} />
                </th>
              </tr>
            </thead>
            <tbody>
              {listSalesOrders &&
                listSalesOrders.map((item) => (
                  <tr>
                    <td>{item.code}</td>
                    ...
                    <td style={{ textAlign: 'center' }}>
                      <a className='text-green' title='Xem thông tin đơn hàng' onClick={() => handleShowDetailInfo(item)}>
