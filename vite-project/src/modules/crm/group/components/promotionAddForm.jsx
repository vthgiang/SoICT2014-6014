      ...
      >
        <form id='form-crm-group-promotion-add' className='qlcv'>
          ...
          <div className={`form-group`}>
            <label>
              {'Giá trị khuyến mại (%)'}
              <span className='test-red'>*</span>
            </label>
            <input type='number' className='form-control' onChange={handleChangeValue} />
          </div>
          ...
          <div className={`form-group`}>
            ...
            <input type='number' className='form-control' onChange={handleChangeMinimumOrderValue} />
          </div>
          ...
          <div className={`form-group}`}>
            ...
            <input type='number' className='form-control' onChange={handleChangePromotionalValueMax} />
          </div>
          ...
          <div className='form-group'>
            ...
            <DatePicker id='start-date-form-promotion-add' onChange={handleChangeExpirationDate} disabled={false} />
          </div>
          ...
          <div className={`form-group}`}>
            ...
            <textarea type='text' className='form-control' onChange={handleChangeDescription} />
          </div>
