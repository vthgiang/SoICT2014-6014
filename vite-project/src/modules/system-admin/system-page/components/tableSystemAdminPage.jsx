...
function TableSystemAdminPage(props) {
  ...
  return (
    <React.Fragment>
      <PageCreateForm page={page} perPage={perPage} />
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('system_admin.system_page.URL')}
              autoComplete='off'
            />
          </div>
          <div className='form-group'>
            <button
              ...
              title={translate('system_admin.system_page.search')}
              onClick={() => handleSubmitSearch()}
            >
              {translate('system_admin.system_page.search')}
            </button>
          </div>
        </div>
          ...
          tableHeaderData={{
            index: (
              <th className='col-fixed' style={{ width: 60 }}>
                {translate('system_admin.system_page.index')}
              </th>
            ),
