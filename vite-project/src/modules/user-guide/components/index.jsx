...
function UserGuide(props) {
  ...
  const currentRoleInfo = rolesUser
  ...
  let DocumentGuide = { user: [], manager: [], Administrator: [] }
  let HrGuide = { user: [], manager: [] }
  let kpiGuide = { user: [], manager: [] }
  let AssetGuide = { user: [], manager: [] }
  let SystemGuide = []
  const roleAdmin = roles.find((x) => x.name === 'Admin')
  const roleSuperAdmin = roles.find((x) => x.name === 'Super Admin')
  const roleManager = roles.find((x) => x.name === 'Manager')
