...
class EducationProgramEditForm extends Component {
  ...
  isFormValidated = () => {
    ...
    let result =
      ...
      this.validatePosition(position, false) &&
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <DialogModal
          modalID={`modal-edit-education${_id}`}
        ...
        >
          <form className='form-group' id={`form-edit-education${_id}`}>
            ...
            <div className={`form-group ${errorOnOrganizationalUnit && 'has-error'}`}>
              ...
              <SelectMulti
                id={`edit-multiSelectUnit${_id}`}
                multiple='multiple'
                display='inline-block'
                value={organizationalUnit}
                disabled={Number(totalList) > 0 ? true : false}
                options={{
            ...
            <div className={`form-group ${errorOnPosition && 'has-error'}`}>
              ...
              <SelectMulti
                id={`edit-multiSelectPosition${_id}`}
                multiple='multiple'
                display='inline-block'
                value={position}
                disabled={Number(totalList) > 0 ? true : false}
            ...
            <div className='form-group'>
              <label>
                {translate('training.education_program.education_program_code')}
                <span className='text-red'>*</span>
              </label>
            ...
            <div className={`form-group ${errorOnProgramName && 'has-error'}`}>
              <label>
                {translate('training.education_program.education_program_name')}
                <span className='text-red'>*</span>
              </label>
