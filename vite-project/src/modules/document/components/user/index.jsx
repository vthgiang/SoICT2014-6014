  ...
  return (
    <div className='nav-tabs-custom'>
      <ul className='nav nav-tabs'>
        <li className='active'>
          <a href='#user-documents' data-toggle='tab'>
            {translate('document.data')}
          </a>
        </li>
        <li>
          <a href='#user-document-history-document-downloaded' data-toggle='tab'>
            {translate('document.downloaded')}
          </a>
        </li>
        <li>
          <a href='#user-document-history-document-common' data-toggle='tab'>
            {translate('document.popular')}
          </a>
        </li>
        <li>
          <a href='#user-document-history-document-new' data-toggle='tab'>
            {translate('document.new')}
          </a>
        </li>
      </ul>
