...
function DocumentInformation(props) {
  ...
  const userList = user.list.map((role) => {
    return { value: role._id, text: role.name }
  })
              ...
              <div className='description-box'>
                ...
                <div className='row'>
                  ...
                  <div className='form-group col-lg-6 col-md-6 col-ms-6 col-xs-6'>
                    ...
                    {documentDomains ? documentDomains.map((y) => <div>{y}</div>) : translate('general.no_data')}
                  </div>
                  ...
                  <div className='form-group col-lg-6 col-md-6 col-ms-6 col-xs-6'>
                    ...
                    {documentArchives ? documentArchives.map((y) => <div>{y}</div>) : translate('general.no_data')}
                  </div>
                </div>
              </div>
              ...
              <div className='description-box'>
                ...
                <div className='row'>
                  ...
                  <div className='form-group col-lg-6 col-md-6 col-ms-6 col-xs-6'>
                    ...
                    {documentRelationshipDocuments && documentRelationshipDocuments.length
                      ? documentRelationshipDocuments.map((y) => <div>{y}</div>)
                ...
                <div className='row'>
                  <div className='form-group col-lg-6 col-md-6 col-ms-6 col-xs-6'>
                    ...
                    {roles && roles.length ? roles.map((y) => <div>{y[0]}</div>) : translate('general.no_data')}
                  </div>

                  <div className='form-group col-lg-6 col-md-6 col-ms-6 col-xs-6'>
                    <strong>{translate('document.store.organizational_unit_manage')}&emsp; </strong>
                    {documentArchivedRecordPlaceOrganizationalUnit
                      ? documentArchivedRecordPlaceOrganizationalUnit.name
                      : translate('general.no_data')}
                  </div>
                </div>
                <div className='row'>
                  <div className='form-group col-lg-12 col-md-12 col-ms-12 col-xs-12'>
                    ...
                    {documentUserCanView && documentUserCanView.length
                      ? documentUserCanView.map((y) => <div key={y._id}>{y.name}</div>)
                      : translate('general.no_data')}
                  </div>
                </div>
              </div>
