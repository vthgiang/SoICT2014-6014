    ...
    >
      <React.Fragment>
        ...
        <div className='form-group'>
          ...
          <DatePicker id={`document-edit-version-issuing-date-${versionId}`} value={formatDate(issuingDate)} onChange={handleIssuingDate} />
        </div>
        <div className='form-group'>
        ...
        <div className='form-group'>
          ...
          <DatePicker id={`document-edit-version-expired-date-${versionId}`} value={formatDate(expiredDate)} onChange={handleExpiredDate} />
        </div>
      </React.Fragment>
    </DialogModal>
  )
