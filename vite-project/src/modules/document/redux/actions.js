        ...
        switch (option) {
            ...
            case 'DELETE_VERSION':
                DocumentServices.editDocument(id, data, option)
                    ...
                    .catch((err) => {
                        dispatch({
                            type: DocumentConstants.DELETE_VERSION_DOCUMENT_FAILE,
                        });
                    });
                break;
    ...
    if (data !== undefined) {
        return (dispatch) => {
            ...
            DocumentServices.getDocumentCategories(data)
                ...
                .catch((err) => {
                    dispatch({
                        type: DocumentConstants.PAGINATE_DOCUMENT_CATEGORIES_FAILE,
                    });
                });
        };
    }
...
function getDocumentsUserCanView(roleId, data = undefined) {
    if (data !== undefined) {
        return (dispatch) => {
            dispatch({
                type: DocumentConstants.PAGINATE_DOCUMENTS_USER_CAN_VIEW_REQUEST,
            });
            DocumentServices.getDocumentsUserCanView(roleId, data)
                ...
                .catch((err) => {
                    dispatch({
                        type: DocumentConstants.PAGINATE_DOCUMENTS_USER_CAN_VIEW_FAILE,
                    });
                });
        };
    }
...
function getUserDocumentStatistics(roleId, option, data) {
    switch (option) {
        case 'downloaded':
            return (dispatch) => {
                dispatch({
                    type: DocumentConstants.GET_DOCUMENT_STATISTICS_DOWNLOADED_REQUEST,
                });
                DocumentServices.getUserDocumentStatistics({ roleId, option }, data)
                    ...
                    .catch((err) => {
                        dispatch({
                            type: DocumentConstants.GET_DOCUMENT_STATISTICS_DOWNLOADED_FAILE,
                        });
                    });
            };
        case 'common':
            return (dispatch) => {
                dispatch({
                    type: DocumentConstants.GET_DOCUMENT_STATISTICS_COMMON_REQUEST,
                });
                DocumentServices.getUserDocumentStatistics({ roleId, option }, data)
                    .then((res) => {
                        dispatch({
                    ...
                    .catch((err) => {
                        dispatch({
                            type: DocumentConstants.GET_DOCUMENT_STATISTICS_COMMON_FAILE,
                        });
                    });
            };
        case 'latest':
            return (dispatch) => {
                dispatch({
                    type: DocumentConstants.GET_DOCUMENT_STATISTICS_LATEST_REQUEST,
                });
                DocumentServices.getUserDocumentStatistics({ roleId, option }, data)
                    .then((res) => {
                        dispatch({
                    ...
                    .catch((err) => {
                        dispatch({
                            type: DocumentConstants.GET_DOCUMENT_STATISTICS_LATEST_FAILE,
                        });
                    });
            };
    }
