    ...
    if (checkFileImport) {
      ...
      value = value.map((x, index) => {
        ...
        if (
          ...
          x.description === null ||
          x.managers === null ||
          x.deputyManagers === null ||
          x.employees === null ||
          (x.name && checkOrgUnitNameDuplicateInFileExcell?.length > 1) ||
          (x.name && checkOrgUnitNameDuplicateInSystem)
        ) {
        ...
        <div className='form-group' id={`form_import_file`}>
          ...
          <div className='row'>
            ...
            <div className='form-group col-md-4 col-xs-12'>
              <label></label>
              <ExportExcel
                id='download_template_organizationalUnit'
                type='link'
                exportData={templateImportDepartment2}
