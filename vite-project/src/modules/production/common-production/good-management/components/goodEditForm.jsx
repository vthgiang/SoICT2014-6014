...
function GoodEditForm(props) {
  ...
  const isFormValidated = () => {
    let result =
      ...
      state.type &&
      state.type === 'product' &&
      state.isSeflProduced === true
        ? state.materials.length > 0
        : true && validateNumberExpirationDate(state.numberExpirationDate, false)
    return result
  }
          ...
          <div className='row'>
            ...
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              ...
              <div className={`form-group ${!errorOnCategory ? '' : 'has-error'}`}>
                ...
                <TreeSelect
                  data={dataSelectBox ? dataSelectBox : ''}
                  value={category}
            ...
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              ...
              <div className={`form-group ${!errorOnNumberExpirationDate ? '' : 'has-error'}`}>
                ...
                <input
                  ...
                  value={numberExpirationDate ? numberExpirationDate : ''}
                  onChange={handleNumberExpirationDateChange}
                />
            ...
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              ...
              <React.Fragment>
                ...
                {isSeflProduced === true ? (
                  <InfoMillCreateForm id={goodId} onDataChange={handleListMillsChange} initialData={listManfaucturingMills} />
                ) : (
                  ''
                )}
              </React.Fragment>
