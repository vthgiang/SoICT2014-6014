          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              ...
              <div className='form-group'>
                ...
                {numberExpirationDate ? numberExpirationDate : ''}
                {' ' + translate('manage_warehouse.good_management.day')}
              </div>
              <div className='form-group'>
                <strong>{translate('manage_warehouse.good_management.excluding_good')}:&emsp;</strong>
                {excludingGoods && excludingGoods.length > 0
                  ? excludingGoods.map((item, index) => {
