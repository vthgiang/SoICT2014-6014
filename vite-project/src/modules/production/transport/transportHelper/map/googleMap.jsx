...
const Map = withScriptjs(
  withGoogleMap((props) => (
    <GoogleMap defaultCenter={props.defaultCenter} defaultZoom={props.defaultZoom} onClick={props.getLatLng}>
...
function MapContainer(props) {
  ...
  const { loadingElement, containerElement, mapElement, defaultCenter, defaultZoom, callBackLatLng } = props
  const getLatLng = (e) => {
    const { latLng } = e
    callBackLatLng({
      lat: latLng.lat(),
