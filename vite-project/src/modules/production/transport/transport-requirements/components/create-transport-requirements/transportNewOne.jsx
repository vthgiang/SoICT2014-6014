...
function TransportNewOne(props) {
  ...
  useEffect(() => {
    if (formInfo1.customer1AddressTransport && formInfo1.isReload1) {
      getGeocode(formInfo1.customer1AddressTransport).then((value) => {
  ...
  useEffect(() => {
    if (formInfo2.customer2AddressTransport && formInfo2.isReload2) {
      getGeocode(formInfo2.customer2AddressTransport).then((value) => {
        // if (value.lat !== -1 && value.lng !== -1){
        setFormInfo2({
          ...formInfo2,
          toLat: value.lat,
        ...
        <fieldset className='scheduler-border' style={{ height: '100%' }}>
          ...
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className={`form-group`}>
              ...
              <textarea type='text' className='form-control' value={formInfo1.newOneDetail1} onChange={handlecustomer1DetailChange} />
            </div>
          </div>
      ...
      <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6' style={{ paddingRight: 0 }}>
        <fieldset className='scheduler-border' style={{ height: '100%' }}>
          ...
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className={`form-group`}>
              <label>Chi tiết</label>
              <textarea type='text' className='form-control' value={formInfo2.newOneDetail2} onChange={handlecustomer2DetailChange} />
            </div>
          </div>
