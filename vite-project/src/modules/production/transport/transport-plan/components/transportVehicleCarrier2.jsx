    ...
    <React.Fragment>
      ...
      <div className='form-inline'>
        <div className='form-group'>
          ...
          <DatePicker id={`start_date_232`} value={formatDate(date.startDate)} onChange={handleStartDateChange} disabled={false} />
        </div>
        <div className='form-group'>
          <label className='form-control-static'>Đến ngày: </label>
          <DatePicker id={`end_date_232`} value={formatDate(date.endDate)} onChange={handleEndDateChange} disabled={false} />
        </div>
      </div>
      ...
      {/* <div className="box-body qlcv"> */}
      <TransportPlanDetailInfo currentTransportPlan={planChosenSeen} />
