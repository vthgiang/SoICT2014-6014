        ...
        <form id='form-arrange-good-vehicle-ordinal-transport'>
          <div className='nav-tabs-custom'>
            <ul className='nav nav-tabs'>
              <li className='active'>
                <a
                  href='#arrange-vehicles-and-goods'
                  data-toggle='tab'
                  onClick={() => {
                ...
                >
                  {'Sắp xếp xe và hàng hóa'}
                </a>
              </li>
              <li>
                <a
                  href='#arrange-ordinal-transport'
                  data-toggle='tab'
                  onClick={() => {
                    forceCheckOrVisible(true, false)
                    changeState()
            ...
            <div className='tab-content'>
              ...
              <div className='tab-pane' id='arrange-ordinal-transport'>
                {/* <LazyLoadComponent
                        > */}
                <ArrangeOrdinalTransport currentTransportSchedule={currentTransportSchedule} callBackStateData={callBackRouteArrange} />
                {/* </LazyLoadComponent> */}
              </div>
            </div>
          </div>
