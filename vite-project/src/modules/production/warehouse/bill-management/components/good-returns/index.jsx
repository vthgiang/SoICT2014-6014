  ...
  return (
    <div id='bill-good-returns'>
      <div className='box-body qlcv'>
        ...
        {billInfor && <GoodReceiptWorkFlowModal billId={billInfor._id} billInfor={billInfor} />}
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              items={[
                {
                  value: '1',
                  text: translate('manage_warehouse.bill_management.goodReturnBillType.1')
                },
                {
                  value: '2',
                  text: translate('manage_warehouse.bill_management.goodReturnBillType.2')
                }
              ]}
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <DatePicker id='book-stock-end-date-return' dateFormat='month-year' value={endDate} onChange={props.handleChangeEndDate} />
          </div>
        </div>
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              multiple='multiple'
              options={{
                nonSelectedText: 'Chọn khách hàng',
                allSelectedText: 'Chọn tất cả'
              }}
              className='form-control select2'
              style={{ width: '100%' }}
            ...
            {typeof listPaginate !== undefined &&
              ...
              listPaginate.map((x, index) => (
                <tr key={index}>
                  ...
                  <td>{x.code}</td>
                  <td>
                    <a href='#' onClick={() => props.handleShowDetailInfo(x.bill ? x.bill._id : '')}>
                      {x.bill ? x.bill.code : ''}
                    </a>
                  </td>
                  ...
                  <td>
                    {x.manufacturingMill
                      ? x.manufacturingMill.name
                      : x.type === '12'
                        ? translate(`manage_warehouse.bill_management.goods_returned_to_the_supplier`)
                        : translate(`manage_warehouse.bill_management.goods_returned_to_the_stock`)}
                  </td>
