      ...
      <div className='box-body qlcv'>
        ...
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <DatePicker id='book-stock-start-date' dateFormat='month-year' value={startDate} onChange={props.handleChangeStartDate} />
          </div>
          <div className='form-group'>
            <label className='form-control-static'>{translate('manage_warehouse.bill_management.to_date')}</label>
            <DatePicker id='book-stock-end-date' dateFormat='month-year' value={endDate} onChange={props.handleChangeEndDate} />
          </div>
        </div>
        <div className='form-inline'>
          <div className='form-group'>
            ...
            {typeof listPaginate !== undefined &&
              ...
              listPaginate.map((x, index) => (
                <tr key={index}>
                  ...
                  {x.group === '1' && x.type === '2' && (
                    <td>{x.manufacturingMill ? x.manufacturingMill.name : 'manufacturingMillId is deleted'}</td>
                  )}
