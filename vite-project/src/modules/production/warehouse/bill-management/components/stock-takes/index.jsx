          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              items={[
                {
                  value: '1',
                  text: translate('manage_warehouse.bill_management.goodTakeBillType.1')
                },
                {
                  value: '2',
                  text: translate('manage_warehouse.bill_management.goodTakeBillType.2')
                },
                {
                  value: '3',
                  text: translate('manage_warehouse.bill_management.goodTakeBillType.3')
                },
                {
                  value: '4',
                  text: translate('manage_warehouse.bill_management.goodTakeBillType.4')
                },
                {
                  value: '5',
                  text: translate('manage_warehouse.bill_management.goodTakeBillType.5')
                },
                {
                  value: '6',
                  text: translate('manage_warehouse.bill_management.goodTakeBillType.6')
                }
              ]}
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              items={[
                ...
                {
                  value: '7',
                  text: translate('manage_warehouse.bill_management.bill_status.7')
                }
              ]}
