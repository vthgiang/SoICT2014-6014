...
function CustomnerNumberDashboard(props) {
  ...
  const barAndChart = () => {
    ...
    c3.generate({
      ...
      data: {
        x: 'x',
        columns: [dataForChart.title, dataForChart.quantity],
    ...
    <React.Fragment>
      <div className='box'>
        <div className='box-header with-border'>
          ...
          <h3 className='box-title'>{'Theo dõi số lượng phiếu xuất kho cho mỗi khách hàng'}</h3>
          <div className='form-inline' style={{ marginTop: '10px' }}>
            <div className='form-group'>
              <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6' style={{ display: 'flex' }}>
                <label>{'Kho'}</label>
                <SelectMulti
                  id={`select-multi-stock-customer-number-dashboard`}
                  multiple='multiple'
              ...
              <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6' style={{ display: 'flex' }}>
                <label style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '200px' }}>
                  {'Nhà cung cấp'}
                </label>
                {/* sử dụng dữ liệu của khách hàng */}
                <SelectBox
                  id={`select-customer-customer-number-dashboard`}
                  className='form-control select2'
                  style={{ width: '100%' }}
                  value={customer}
                  items={dataCustomer}
          ...
          <div className='form-inline'>
            <div className='form-group'>
              ...
              <DatePicker
                id='start-month-customer-number-dashboard'
            ...
            <div className='form-group'>
              ...
              <DatePicker
                id='end-month-customer-number-dashboard'
                dateFormat='month-year'
          ...
          <div className='dashboard_box_body'>
            <p className='pull-left' style={{ marginBottom: 0 }}>
              <b>{'ĐV tính: Số phiếu'}</b>
            </p>
            <div className='box-tools pull-right'>
              <div className='btn-group pull-rigth'>
                <button
                  type='button'
                  className={`btn btn-xs ${barAndLineChart ? 'active' : 'btn-danger'}`}
                ...
                <button
                  type='button'
                  className={`btn btn-xs ${barAndLineChart ? 'btn-danger' : 'active'}`}
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(CustomnerNumberDashboard))
