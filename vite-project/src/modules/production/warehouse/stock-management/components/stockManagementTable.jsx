        ...
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('manage_warehouse.stock_management.code')}
              autoComplete='off'
            />
          </div>
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('manage_warehouse.stock_management.name')}
              autoComplete='off'
            />
          </div>
        </div>
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              multiple='multiple'
              options={{
                nonSelectedText: translate('manage_warehouse.stock_management.choose_status'),
                allSelectedText: translate('manage_warehouse.stock_management.all_type')
              }}
          ...
          <div className='form-group'>
            ...
            <button
              ...
              title={translate('manage_warehouse.stock_management.search')}
            ...
            {typeof listPaginate !== undefined &&
              ...
              listPaginate.map((x, index) => (
                <tr key={index}>
                  ...
                  <td>{x.code}</td>
                  <td>{x.name}</td>
                  <td style={{ color: translate(`manage_warehouse.stock_management.${x.status}.color`) }}>
                    {translate(`manage_warehouse.stock_management.${x.status}.status`)}
                  </td>
                  <td>{x.address}</td>
                  <td>{x.description}</td>
