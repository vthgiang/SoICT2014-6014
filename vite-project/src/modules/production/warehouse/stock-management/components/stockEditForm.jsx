                    ...
                    {typeof managementLocation === 'undefined' || managementLocation.length === 0 ? (
                      ...
                      managementLocation.map((x, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            <a className='edit' title={translate('general.edit')} onClick={() => handleEditRole(x, index)}>
                              <i className='material-icons'></i>
                            </a>
                            <a className='delete' title={translate('general.delete')} onClick={() => handleDeleteRole(index)}>
                              <i className='material-icons'></i>
                            </a>
                          </td>
                        </tr>
                    ...
                    {typeof goods === 'undefined' || goods.length === 0 ? (
                      ...
                      goods.map((x, index) => (
                        <tr key={index}>
                          ...
                          <td>{x.maxQuantity}</td>
                          <td>
                            <a className='edit' title={translate('general.edit')} onClick={() => handleEditGood(x, index)}>
                              <i className='material-icons'></i>
                            </a>
                            <a className='delete' title={translate('general.delete')} onClick={() => handleDeleteGood(index)}>
                              <i className='material-icons'></i>
                            </a>
                          </td>
                        </tr>
