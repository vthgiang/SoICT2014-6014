    ...
    <React.Fragment>
      ...
      >
        <form id={`form-detail-request`}>
          {currentRequest.status && (
            <div className='timeline-create'>
              <div
                ...
                style={{ width: parseInt(currentRequest.status) > 5 ? '100%' : (parseInt(currentRequest.status - 1) / number) * 100 + '%' }}
              ></div>
          ...
          {currentRequest.status && currentRequest.type == '1' && currentRequest.requestType == '1' && (
            <div className='timeline-create'>
