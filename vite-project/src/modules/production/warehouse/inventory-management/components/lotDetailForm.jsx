            ...
            <div className='row'>
              ...
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                ...
                <fieldset className='scheduler-border'>
                  ...
                  {lotDetail.stocks.map((x, index) => (
                    <p key={index}>
                      <b>
                        Kho {x.stock.name} có {x.quantity} {lotDetail.good.baseUnit}:{' '}
                      </b>
                      {x.binLocations.map((item, index) => {
                  ...
                  <fieldset className='scheduler-border'>
                    ...
                    <table className='table table-bordered'>
                      ...
                      <tbody id={`good-edit-manage-by-archive`}>
                        {typeof lotDetail.lotLogs === 'undefined' || lotDetail.lotLogs.length === 0 ? (
                          <tr>
                            <td colSpan={3}>
