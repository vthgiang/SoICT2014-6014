...
function BinEditForm(props) {
  ...
  return (
    <div id='edit-bin-location'>
      <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
        ...
        <div className={`form-group`}>
          ...
          <SelectBox
            ...
            style={{ width: '100%' }}
            value={
              binDepartment ? binDepartment : { value: '', text: translate('manage_warehouse.bin_location_management.choose_department') }
            }
      ...
      <div className='form-group'>
        <button className='btn btn-success pull-right' style={{ marginLeft: '5px' }} onClick={save}>
          {translate('form.save')}
        </button>
        <button
