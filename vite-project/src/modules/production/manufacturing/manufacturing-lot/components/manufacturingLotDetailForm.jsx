...
function ManufacturingLotDetailForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID={`modal-detail-info-manufacturing-lot`}
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              ...
              <div className='form-group'>
                ...
                {currentLot.bills &&
                  currentLot.bills.map((bill, index) => {
                    if (index === currentLot.bills.length - 1) {
                      return (
                        <a href='#' onClick={() => showDetailBill(bill._id)}>
                          {bill.code}
                        </a>
                      )
                    }
              ...
              <div className='form-group'>
                ...
                {currentLot.manufacturingCommand &&
                  currentLot.manufacturingCommand.manufacturingMill.code + ' - ' + currentLot.manufacturingCommand.manufacturingMill.name}
              </div>
            </div>
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              <div className='form-group'>
                ...
                <div className={`form-group`}>
                  <table className='table table-bordered'>
                    ...
                    <tbody>
                      {currentLot.manufacturingCommand &&
                      currentLot.manufacturingCommand &&
                      currentLot.manufacturingCommand.good &&
                      currentLot.manufacturingCommand.good.materials &&
                      currentLot.manufacturingCommand.good.materials.length ? (
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <fieldset className='scheduler-border'>
                ...
                {currentLot.manufacturingCommand &&
                  currentLot.manufacturingCommand.responsibles &&
                  currentLot.manufacturingCommand.responsibles.length &&
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <fieldset className='scheduler-border'>
                ...
                {currentLot.manufacturingCommand &&
                  currentLot.manufacturingCommand.accountables &&
                  currentLot.manufacturingCommand.accountables.length &&
            ...
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <fieldset className='scheduler-border'>
                ...
                <table className='table'>
                  ...
                  <tbody>
                    {currentLot.manufacturingCommand &&
                      currentLot.manufacturingCommand.qualityControlStaffs &&
                      currentLot.manufacturingCommand.qualityControlStaffs.length &&
                ...
                <div className={`form-group`}>
                  <table className='table table-bordered'>
                    ...
                    <tbody id={`good-edit-manage-by-archive`}>
                      {typeof currentLot.lotLogs === 'undefined' || currentLot.lotLogs.length === 0 ? (
                        <tr>
                          <td colSpan={8}>
