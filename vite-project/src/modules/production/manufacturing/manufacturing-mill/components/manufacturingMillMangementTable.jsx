      ...
      <React.Fragment>
        ...
        <div className='box-body qlcv'>
          ...
          <div className='form-inline'>
            ...
            <div className='form-group'>
              <button
                ...
                title={translate('manufacturing.manufacturing_mill.search')}
                onClick={this.handleSubmitSearch}
              >
                {translate('manufacturing.manufacturing_mill.search')}
              </button>
            </div>
          </div>
                  ...
                  <tr key={index}>
                    ...
                    <td style={{ textAlign: 'center' }}>
                      <a
                        ...
                        onClick={() => {
                          this.handleShowDetailMill(mill)
                        }}
                      >
          ...
          {manufacturingMill.isLoading ? (
            ...
            (typeof listMills === 'undefined' || listMills.length === 0) && (
