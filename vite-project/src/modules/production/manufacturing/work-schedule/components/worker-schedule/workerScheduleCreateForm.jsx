  ...
  return (
    <React.Fragment>
      <ButtonModal
        ...
        modalID='modal-create-worker-work-schedule'
      ...
      >
        <form id='form-create-worker-work-schedule'>
          ...
          <div className='form-group'>
            <label>
              {translate('manufacturing.work_schedule.number_turns')}
          ...
          <SlimScroll
            outerComponentId='create-croll-table-worker'
            innerComponentId='create-work-schedule-table-worker'
