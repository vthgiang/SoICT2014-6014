  ...
  return (
    <div className='nav-tabs-custom'>
      <ul className='nav nav-tabs'>
        <li className='active'>
          <a href='#purchasing-request' data-toggle='tab' onClick={() => handlePurchasingRequest()}>
            {translate('production.request_management.purchase_request')}
          </a>
        </li>
        <li>
          <a href='#receipt-request' data-toggle='tab' onClick={() => handleReceiptRequest()}>
            {translate('production.request_management.receipt_request')}
          </a>
        </li>
        <li>
          <a href='#issue-request' data-toggle='tab' onClick={() => handleIssueRequest()}>
