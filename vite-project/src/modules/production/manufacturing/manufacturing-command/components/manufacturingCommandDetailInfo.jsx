...
function ManufacturingCommandDetailInfo(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID={`modal-detail-info-manufacturing-command-${idModal}`}
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              ...
              <div className='form-group'>
                ...
                {currentCommand.lot && currentCommand.lot[0] && (
                  <a href='#' onClick={() => showDetailManufacturingLot(currentCommand.lot[0])}>
                    {currentCommand.lot[0].code}
                  </a>
                )}
                {currentCommand.lot && currentCommand.lot[1] && (
                  <a href='#' onClick={() => showDetailManufacturingLot(currentCommand.lot[1])}>
                    {', ' + currentCommand.lot[1].code}
                  </a>
                )}
              </div>
              <div className='form-group'>
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <fieldset className='scheduler-border'>
                ...
                <div className={`form-group`}>
                  <table className='table table-bordered'>
                    ...
                    <tbody>
                      {currentCommand &&
                        currentCommand.good &&
                        currentCommand.good.materials &&
                        currentCommand.good.materials.length &&
                        currentCommand.good.materials.map((x, index) => (
                          <tr key={index}>
                            ...
                            <td
                              style={{
                                color: translate(`manufacturing.command.materials_info.${checkInventoryMaterials(x, currentCommand)}.color`)
                              }}
                            >
                ...
                {currentCommand && checkApprovers(currentCommand) && currentCommand.status === 1 && (
                  <div className='pull-right' style={{ marginBottom: '10px' }}>
                    <a
                      className={currentCommand.purchasingRequest ? 'disabled' : ''}
                      style={{ width: '5px' }}
                      title={translate('manufacturing.command.create_purchasing_request')}
                      onClick={() => {
                        handleAddPurchasingRequest(currentCommand)
                      }}
                    >
                    ...
                    <button
                      ...
                      onClick={(e) => handleApproverCommand(e, currentCommand)}
                    >
                      {translate('manufacturing.command.approver_command')}
                    </button>
                  </div>
                )}
              </fieldset>
              ...
              <fieldset className='scheduler-border'>
                ...
                <div className={`form-group`}>
                  <table className='table table-bordered'>
                    ...
                    <tbody>
                      {listBillByCommand && listBillByCommand.length === 0 ? (
                        <tr>
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <fieldset className='scheduler-border'>
                ...
                {currentCommand.accountables &&
                  currentCommand.accountables.length &&
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <fieldset className='scheduler-border'>
                ...
                {currentCommand.finishedProductQuantity && currentCommand.finishedTime ? (
                  <React.Fragment>
                    <p>
                    ...
                    <p>
                      ...
                      {currentCommand.substandardProductQuantity
                        ? currentCommand.substandardProductQuantity + ' (' + currentCommand.good.baseUnit + ')'
                        : 0 + ' (' + currentCommand.good.baseUnit + ')'}
                      &emsp;&emsp;&emsp;
