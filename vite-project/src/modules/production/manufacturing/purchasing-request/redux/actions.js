...
function getAllPurchasingRequests(query = {}) {
  return (dispatch) => {
    ...
    purchasingRequestServices
      .getAllPurchasingRequests(query)
      .then((res) => {
        dispatch({
...
function getNumberPurchasingStatus(query) {
  return (dispatch) => {
    ...
    purchasingRequestServices
      .getNumberPurchasingStatus(query)
      .then((res) => {
        dispatch({
