          ...
          <thead>
            <tr>
              ...
              >
                ...
                <DataTableSetting
                  tableId={tableId}
                  columnArr={['STT', 'Số tài khoản', 'Ký hiệu ngân hàng', 'Tên ngân hàng', 'Chủ tài khoản', 'Trạng thái', 'Người tạo']}
                  setLimit={setLimit}
                />
              </th>
            </tr>
            ...
            {listBankAccounts &&
              ...
              listBankAccounts.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>{item.owner}</td>
                  <td>
                    {item.status ? <span className='text-success'>Đang sử dụng</span> : <span className='text-red'>Đang vô hiệu hóa</span>}
                  </td>
