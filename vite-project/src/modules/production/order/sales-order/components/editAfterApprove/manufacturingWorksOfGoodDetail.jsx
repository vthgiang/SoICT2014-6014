...
function ManufacturingWorksOfGoodDetail(props) {
  ...
  return (
    <DialogModal
      modalID='modal-sales-order-edit-after-aprrove-manufacturing-works-of-good-detail'
      isLoading={false}
      formID='form-sales-order-edit-after-aprrove-manufacturing-works-of-good-detail'
      title={'Yêu cầu sản xuất'}
      size='50'
      hasSaveButton={false}
      hasNote={false}
    >
      <form id='form-sales-order-edit-after-aprrove-manufacturing-works-of-good-detail'>
        ...
        {currentManufacturingWorksOfGood && currentManufacturingPlanOfGood && (
          <React.Fragment>
            <div className={`form-group`}>
              ...
              <span className={currentManufacturingPlanOfGood.status ? statusConvert[currentManufacturingPlanOfGood.status].className : ''}>
