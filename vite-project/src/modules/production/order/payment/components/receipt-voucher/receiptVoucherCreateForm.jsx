        ...
        <form id={`form-create-receipt-voucher`}>
          ...
          <fieldset className='scheduler-border'>
            ...
            <div className={'pull-right'} style={{ padding: 10 }}>
              {editSalesOrder ? (
                <React.Fragment>
                  <button className='btn btn-success' onClick={handleCancelEditPaymentForSalesOrder} style={{ marginLeft: '10px' }}>
                    Hủy chỉnh sửa
                  </button>
                  <button
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          <a href='#abc' className='edit' title='Sửa' onClick={() => handlePaymentForSalesOrderEdit(item, index)}>
