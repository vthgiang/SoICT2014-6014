  ...
  return (
    <React.Fragment>
      {/* <ProjectDetailForm
            ...
            /> */}
      <DetailProjectTemplate projectId={currentRow && currentRow._id} projectDetail={currentRow} />
      ...
      />
      <CreateProjectTemplateForm handleAfterCreateProject={handleAfterCreateProject} />
            ...
            <thead>
              <tr>
                ...
                <th style={{ width: '150px', textAlign: 'center' }}>
                  ...
                  <DataTableSetting
                    tableId={tableId}
                    columnArr={['Tên mẫu', 'Số lần sử dụng', 'Người tạo', 'Người quản lý', 'Thành viên']}
                    setLimit={setLimit}
                  />
                </th>
              </tr>
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td style={{ textAlign: 'center' }}>
                        <a className='edit text-blue' style={{ width: '5px' }} onClick={() => handleDetail(item)}>
                          <i className='material-icons'>view_list</i>
                        </a>
                        {
                          <a className='edit text-yellow' style={{ width: '5px' }} onClick={() => handleEdit(item)}>
