...
const ContractManagement = (props) => {
  ...
  let pageTotal =
    biddingContract.totalList % limit === 0 ? parseInt(biddingContract.totalList / limit) : parseInt(biddingContract.totalList / limit + 1)
    ...
    <div className='box'>
      <div className='box-body qlcv'>
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            <label title='Ngày có hiệu lực' className='form-control-static'>
              Ngày có hiệu lực
            </label>
            <DatePicker id='month-startDate-biddingContract' value={startDateSearch} onChange={handlestartDateSearchChange} />
          </div>
          {/* Thời gian hết hạn hợp đồng */}
          <div className='form-group'>
            <label title='Thời gian hết hạn' className='form-control-static'>
              Ngày hết hạn
            </label>
            <DatePicker id='month-endDate-biddingContract' value={endDateSearch} onChange={handleendDateSearchChange} />
          </div>
        </div>
      ...
      {<EditBiddingContract id={currentRow ? currentRow._id : null} data={currentRow ? currentRow : null} />}

      {/* From tạo dự án theo hợp đồng */}
      {<CreateProjectByContractModal id={currentRow ? currentRow._id : null} data={currentRow ? currentRow : null} />}
      ...
      {<ViewBiddingContract id={currentRowView ? currentRowView._id : null} data={currentRowView ? currentRowView : null} />}
    </div>
  )
}
