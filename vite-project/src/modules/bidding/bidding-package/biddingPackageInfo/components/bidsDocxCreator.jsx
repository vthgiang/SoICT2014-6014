    ...
    sections: [
      {
        children: [
          ...
          createText(
            `theo đúng yêu cầu nêu trong E-HSMT với tổng số tiền là cùng với các bảng tổng hợp giá dự thầu kèm theo. Ngoài ra, chúng tôi tự nguyện giảm giá dự thầu với tỷ lệ phần trăm giảm giá là %.`
          ),
          createText(
            `Giá dự thầu sau khi trừ đi giá trị giảm giá là: (Giảm đều cho tất cả các hạng mục chính theo tỷ lệ giảm giá đã chào (bao gồm chi phí dự phòng và các khoản tạm tính, nếu có)).`
          ),
          ...
          createBulletNumber(
            `Chỉ tham gia trong một E-HSDT này với tư cách là nhà thầu chính hoặc đại diện liên danh trong trường hợp nhà thầu có liên danh.`
          ),
          createBulletNumber(
          ...
          createBulletNumber(
            `Những thông tin kê khai trong E-HSDT là trung thực. Nếu E-HSDT của chúng tôi được chấp nhận, chúng tôi sẽ thực hiện biện pháp bảo đảm thực hiện hợp đồng theo quy định tại Mục 37 E-CDNT của E-HSMT`
          ),
