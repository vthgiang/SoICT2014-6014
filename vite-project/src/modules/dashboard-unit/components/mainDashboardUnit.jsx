      ...
      <React.Fragment>
        <div className='qlcv'>
          <div className='form-inline' style={{ marginBottom: 10 }}>
            ...
            <button type='button' className='btn btn-success' onClick={this.handleUpdateData}>
          ...
          <div className='nav-tabs-custom'>
            <ul className='nav nav-tabs'>
              <li className='active'>
                <a href='#kpi' data-toggle='tab' onClick={() => this.handleNavTabs()}>
                  KPI
                </a>
              </li>
              <li>
                <a href='#task' data-toggle='tab' onClick={() => this.handleNavTabs()}>
                  Công việc
                </a>
              </li>
              <li>
                <a href='#employee-capacity' data-toggle='tab' onClick={() => this.handleNavTabs(true)}>
                  Năng lực nhân viên
                </a>
              </li>
              <li>
                <a href='#human-resourse' data-toggle='tab' onClick={() => this.handleNavTabs(true)}>
                  Tổng quan nhân sự
                </a>
              </li>
              <li>
                <a href='#annualLeave' data-toggle='tab' onClick={() => this.handleNavTabs(true)}>
                  Nghỉ phép-Tăng ca
                </a>
              </li>
              <li>
                <a href='#salary' data-toggle='tab' onClick={() => this.handleNavTabs(true)}>
                  Lương thưởng nhân viên
                </a>
              </li>
              <li>
                <a href='#integrated-statistics' data-toggle='tab' onClick={() => this.handleNavTabs(true)}>
                  Thống kê tổng hợp
                </a>
              </li>
            </ul>
              ...
              <div className='tab-pane active' id='kpi'>
                <CEOKpiDashboard
                  childOrganizationalUnit={
                    childOrganizationalUnit?.length && childOrganizationalUnit.filter((item) => organizationalUnits.includes(item?.id))
                  }
                  organizationalUnits={organizationalUnits}
                    ...
                    <div className='col-md-3 col-sm-6 col-xs-6'>
                      <div className='info-box with-border'>
                        ...
                        <div className='info-box-content'>
                          ...
                          <span className='info-box-number'>{listAllEmployees.length}</span>
                        </div>
                      </div>
                    </div>
