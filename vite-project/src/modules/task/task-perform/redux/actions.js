...
function getTimesheetLogs(taskId) {
  return (dispatch) => {
    ...
    performTaskService.getTimesheetLogs(taskId).then(
...
function getTimerStatusTask(taskId) {
  ...
  return (dispatch) => {
    ...
    performTaskService.getTimerStatusTask(taskId).then(
...
function getCurrentTaskTimesheetLogOfEmployeeInOrganizationalUnit(data) {
  return (dispatch) => {
    ...
    performTaskService
      .getCurrentTaskTimesheetLogOfEmployeeInOrganizationalUnit(data)
      .then((res) => {
        dispatch({
...
function editTimeSheetLog(taskId, timesheetlogId, data) {
  return (dispatch) => {
    ...
    return new Promise((resolve, reject) => {
      performTaskService
        .editTimeSheetLog(taskId, timesheetlogId, data)
        .then((res) => {
          dispatch({
...
function stopTimeAllDevices(data) {
  return (dispatch) => dispatch({ type: performTaskConstants.STOP_TIMER_ALL_DEVICES_SUCCESS, payload: data })
}
...
function stopTimerTask(taskId, newTimer) {
  return (dispatch) => {
    ...
    performTaskService.stopTimerTask(taskId, newTimer).then(
      (payload) => {
        dispatch({
...
function createActionComment(taskId, actionId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.createActionComment(taskId, actionId, newComment).then(
      (payload) => {
...
function createTaskAction(taskId, newAction) {
  return (dispatch) => {
    ...
    performTaskService.createTaskAction(taskId, newAction).then(
...
function editActionComment(taskId, actionId, commentId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.editActionComment(taskId, actionId, commentId, newComment).then(
      (payload) => {
...
function editTaskAction(id, newAction, taskId) {
  return (dispatch) => {
    ...
    performTaskService.editTaskAction(id, newAction, taskId).then(
      (payload) => {
...
function deleteActionComment(taskId, actionId, commentId) {
  return (dispatch) => {
    ...
    performTaskService.deleteActionComment(taskId, actionId, commentId).then(
...
function deleteTaskAction(id, taskId) {
  return (dispatch) => {
    ...
    performTaskService.deleteTaskAction(id, taskId).then(
...
function createTaskComment(taskId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.createTaskComment(taskId, newComment).then(
...
function editTaskComment(taskId, commentId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.editTaskComment(taskId, commentId, newComment).then(
      (payload) => {
...
function deleteTaskComment(commentId, taskId) {
  return (dispatch) => {
    ...
    performTaskService.deleteTaskComment(commentId, taskId).then(
...
function createCommentOfTaskComment(commentId, taskId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.createCommentOfTaskComment(commentId, taskId, newComment).then(
...
function editCommentOfTaskComment(commentId, taskId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.editCommentOfTaskComment(commentId, taskId, newComment).then(
...
function deleteCommentOfTaskComment(task, id) {
  return (dispatch) => {
    ...
    performTaskService.deleteCommentOfTaskComment(task, id).then(
...
function evaluationAction(actionId, taskId, evaluation) {
  return (dispatch) => {
    ...
    performTaskService.evaluationAction(actionId, taskId, evaluation).then(
...
function deleteActionEvaluation(actionId, taskId, evaluationId) {
  return (dispatch) => {
    ...
    performTaskService.deleteActionEvaluation(actionId, taskId, evaluationId).then(
...
function confirmAction(userId, actionId, taskId) {
  return (dispatch) => {
    ...
    performTaskService.confirmAction(userId, actionId, taskId).then(
...
function uploadFile(taskId, data) {
  return (dispatch) => {
    ...
    performTaskService.uploadFile(taskId, data).then(
...
function deleteFileAction(fileId, actionId, taskId, type) {
  return (dispatch) => {
    ...
    performTaskService.deleteFileAction(fileId, actionId, taskId, type).then(
...
function deleteFileCommentOfAction(fileId, actionId, taskId, type) {
  return (dispatch) => {
    ...
    performTaskService.deleteFileCommentOfAction(fileId, actionId, taskId, type).then(
...
function deleteFileTaskComment(fileId, actionId, taskId, type) {
  return (dispatch) => {
    ...
    performTaskService.deleteFileTaskComment(fileId, actionId, taskId, type).then(
...
function deleteFileChildTaskComment(fileId, actionId, taskId, type) {
  return (dispatch) => {
    ...
    performTaskService.deleteFileChildTaskComment(fileId, actionId, taskId, type).then(
...
function getTaskLog(taskId) {
  return (dispatch) => {
    ...
    performTaskService.getTaskLog(taskId).then(
      (res) =>
        dispatch({
...
function editTaskByAccountableEmployees(data, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .editTaskByAccountableEmployees(data, taskId)
      .then((res) => {
        dispatch({
...
function editTaskByResponsibleEmployees(data, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .editTaskByResponsibleEmployees(data, taskId)
      .then((res) => {
        dispatch({
...
function evaluateTaskByAccountableEmployees(data, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .evaluateTaskByAccountableEmployees(data, taskId)
      .then((res) => {
        dispatch({
...
function evaluateTaskByConsultedEmployees(data, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .evaluateTaskByConsultedEmployees(data, taskId)
      .then((res) => {
        dispatch({
...
function evaluateTaskByResponsibleEmployees(data, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .evaluateTaskByResponsibleEmployees(data, taskId)
      .then((res) => {
        dispatch({
...
function editHoursSpentInEvaluate(data, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .editHoursSpentInEvaluate(data, taskId)
      .then((res) => {
        dispatch({
...
function deleteEvaluation(taskId, evaluateId) {
  return (dispatch) => {
    ...
    performTaskService
      .deleteEvaluation(taskId, evaluateId)
      .then((res) => {
        dispatch({
...
function editActivateOfTask(id, typeOfTask, listSelected = []) {
  return (dispatch) => {
    ...
    performTaskService
      .editActivateOfTask(id, typeOfTask, listSelected)
      .then((res) => {
        dispatch({
...
function editDocument(documentId, taskId, data) {
  return (dispatch) => {
    ...
    performTaskService
      .editDocument(documentId, taskId, data)
      .then((res) => {
        dispatch({
...
function deleteFileTask(fileId, documentId, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .deleteFileTask(fileId, documentId, taskId)
      .then((res) => {
        dispatch({
...
function deleteDocument(fileId, documentId, taskId) {
  return (dispatch) => {
    ...
    performTaskService
      .deleteDocument(fileId, documentId, taskId)
      .then((res) => {
        dispatch({
...
function editInformationTask(taskId, informations) {
  return (dispatch) => {
    ...
    performTaskService
      .editInformationTask(taskId, informations)
      .then((res) => {
        dispatch({
...
function requestAndApprovalCloseTask(taskId, data) {
  return (dispatch) => {
    ...
    performTaskService
      .requestAndApprovalCloseTask(taskId, data)
      .then((res) => {
        dispatch({
...
function editEmployeeCollaboratedWithOrganizationalUnits(taskId, employeeCollaboratedWithUnit) {
  return (dispatch) => {
    ...
    performTaskService
      .editEmployeeCollaboratedWithOrganizationalUnits(taskId, employeeCollaboratedWithUnit)
      .then((res) => {
        dispatch({
...
function editComment(taskId, commentId, data, type) {
  if (type === 'incoming') {
    return (dispatch) => {
      ...
      performTaskService
        .editComment(taskId, commentId, data)
        .then((res) => {
          dispatch({
...
function createChildComment(taskId, commentId, data, type) {
  if (type === 'incoming') {
    return (dispatch) => {
      ...
      performTaskService
        .createChildComment(taskId, commentId, data)
        .then((res) => {
          dispatch({
...
function editChildComment(taskId, commentId, childCommentId, data, type) {
  if (type === 'incoming') {
    return (dispatch) => {
      ...
      performTaskService
        .editChildComment(taskId, commentId, childCommentId, data)
        .then((res) => {
          dispatch({
...
function deleteChildComment(taskId, commentId, childCommentId, type) {
  if (type === 'incoming') {
    return (dispatch) => {
      ...
      performTaskService
        .deleteChildComment(taskId, commentId, childCommentId)
        .then((res) => {
          dispatch({
...
function deleteFileComment(fileId, commentId, taskId, type) {
  if (type === 'incoming') {
    return (dispatch) => {
      ...
      performTaskService
        .deleteFileComment(fileId, commentId, taskId)
        .then((res) => {
          dispatch({
...
function deleteFileChildComment(fileId, childCommentId, commentId, taskId, type) {
  if (type === 'incoming') {
    return (dispatch) => {
      ...
      performTaskService
        .deleteFileChildComment(fileId, childCommentId, commentId, taskId)
        .then((res) => {
          dispatch({
...
function refreshData(data) {
  return (dispatch) => dispatch({ type: performTaskConstants.REFRESH_DATA_TASK, payload: data })
}

function evaluationAllAction(taskId, evaluation) {
  return (dispatch) => {
    dispatch({ type: performTaskConstants.EVALUATION_ALL_ACTION_REQUEST })
    performTaskService.evaluationAllAction(taskId, evaluation).then(
...
function evaluateTaskByResponsibleEmployeesProject(data, taskId) {
  return (dispatch) => {
    dispatch({ type: performTaskConstants.EVALUATE_TASK_BY_RESPONSIBLE_REQUEST, taskId })
    performTaskService
      .evaluateTaskByResponsibleEmployeesProject(data, taskId)
      .then((res) => {
        dispatch({
          type: performTaskConstants.EVALUATE_TASK_BY_RESPONSIBLE_SUCCESS,
          // payload: res.data.content.task
...
function evaluateTaskByAccountableEmployeesProject(data, taskId) {
  return (dispatch) => {
    dispatch({ type: performTaskConstants.EVALUATE_TASK_BY_ACCOUNTABLE_REQUEST, taskId })
    performTaskService
      .evaluateTaskByAccountableEmployeesProject(data, taskId)
      .then((res) => {
        dispatch({
          type: performTaskConstants.EVALUATE_TASK_BY_ACCOUNTABLE_SUCCESS,
          payload: res.data.content
...
function createTaskOutputs(taskId, taskOutputId, newAction) {
  return (dispatch) => {
    ...
    performTaskService.createTaskOutputs(taskId, taskOutputId, newAction).then(
...
function editTaskOutputs(taskId, data) {
  return (dispatch) => {
    ...
    performTaskService.editTaskOutputs(taskId, data).then(
...
function getTaskOutputs(taskId) {
  return (dispatch) => {
    ...
    performTaskService.getTaskOutputs(taskId).then(
...
function approveTaskOutputs(taskId, taskOutputId, data) {
  return (dispatch) => {
    ...
    performTaskService.approveTaskOutputs(taskId, taskOutputId, data).then(
...
function editSubmissionResults(taskId, taskOutputId, data) {
  return (dispatch) => {
    ...
    performTaskService.editSubmissionResults(taskId, taskOutputId, data).then(
...
function deleteSubmissionResults(taskId, taskOutputId) {
  return (dispatch) => {
    ...
    performTaskService.deleteSubmissionResults(taskId, taskOutputId).then(
...
function deleteFileOfTaskOutput(taskId, taskOutputId, fileId) {
  return (dispatch) => {
    ...
    performTaskService.deleteFileOfTaskOutput(taskId, taskOutputId, fileId).then(
...
function createCommentOfTaskOutput(taskId, taskOutputId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.createCommentOfTaskOutput(taskId, taskOutputId, newComment).then(
...
function editCommentOfTaskOutput(taskId, taskOutputId, commentId, newComment) {
  return (dispatch) => {
    ...
    performTaskService.editCommentOfTaskOutput(taskId, taskOutputId, commentId, newComment).then(
