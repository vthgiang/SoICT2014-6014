...
function ModalEditInfo(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal size='75' modalID={`modelEditInfo`} formID='form-edit-info' title={'Chỉnh sửa thông tin'} hasSaveButton={false}>
        <div>
          <InformationForm isEdit={true} initialData={taskInformation} onDataChange={handleTaskInformationChange} type={type} />
        </div>
      </DialogModal>
    </React.Fragment>
  )
