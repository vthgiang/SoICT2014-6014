          ...
          <div>
            ...
            <div className='description-box'>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                {currentDiagram?.manager?.length > 0 &&
                  currentDiagram.manager.map((item, index) => {
                    return (
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                {currentDiagram?.viewer?.length > 0 &&
                  currentDiagram.viewer.map((item, index) => {
                    return (
                      <span key={index} className='raci-style'>
                        <img
                          src={`${process.env.REACT_APP_SERVER}/upload/avatars/user.png`}
            ...
            <a
              className='viewbpmnprocesschild'
              href={`/process-template?processId=${currentDiagram ? currentDiagram._id : ''}`}
              target='_blank'
            >
