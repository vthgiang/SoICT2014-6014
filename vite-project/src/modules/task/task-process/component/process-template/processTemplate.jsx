      ...
      <div className='box-body qlcv'>
        ...
        {checkHasComponent('create-task-process-button') && (
          <React.Fragment>
            ...
            {showmodalCreateProcess && (
              <ModalCreateTaskProcess listOrganizationalUnit={listOrganizationalUnit} title={translate('task.task_process.add_modal')} />
            )}
            {showModalImportProcess && (
              <FormImportProcessTemplate listOrganizationalUnit={listOrganizationalUnit} title={translate('task.task_process.add_modal')} />
            )}
          </React.Fragment>
        )}
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <input
              ...
              type='text'
              onChange={handleChangeNameSerach}
              placeholder={translate('task_template.search_by_name')}
              // ref={input => name = input}
            />
            <button type='button' className='btn btn-success' title={translate('task_template.search')} onClick={handleUpdateData}>
        ...
        <table className='table table-bordered table-striped table-hover' id={tableId}>
          ...
          <tbody className='task-table'>
            {listDiagram && listDiagram.length !== 0
              ? listDiagram.map((item, key) => {
                  return (
                    <tr key={key}>
                      ...
                      <td>
                        <a
                          ...
                          title={translate('task.task_template.view_task_process_template')}
                        >
                        ...
                        <a
                          ...
                          style={{ color: '#28A745' }}
                          onClick={() => {
                            showModalCreateTask(item)
                          }}
                          title={translate('task_template.create_task_by_process')}
                        >
