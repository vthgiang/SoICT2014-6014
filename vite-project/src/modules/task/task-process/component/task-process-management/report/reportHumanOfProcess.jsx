...
function ReportHumanOfProcess(props) {
    ...
    for (let memberItem of newArr) {
      ...
      for (let tasksWithMemberItem of tasksWithMemberArr) {
        ...
        tasksWithMemberItem.evaluations.forEach((value) => {
          ...
          if (point1 !== 0 && value.results.length !== 0)
            currentMemberCurrentTaskPoint = currentMemberCurrentTaskPoint + point1 / value.results.length
        })
        if (currentMemberCurrentTaskPoint !== 0 && tasksWithMemberItem.evaluations.length !== 0)
          currentMemberCurrentTaskPoint = currentMemberCurrentTaskPoint / tasksWithMemberItem.evaluations.length
  ...
  return (
    <React.Fragment>
      ...
      <div className='box-body qlcv'>
        <h4>
          <strong>Tổng quan thành viên quy trình</strong>
        </h4>
