    ...
    <React.Fragment>
      ...
      >
        <DelegationDetailInfoTask
          ...
          delegationName={
            curentRowDetail ? curentRowDetail.delegationName : curentRowDetailReceive ? curentRowDetailReceive.delegationName : null
          }
          ...
          delegatePrivileges={
            curentRowDetail ? curentRowDetail.delegatePrivileges : curentRowDetailReceive ? curentRowDetailReceive.delegatePrivileges : null
          }
          delegateType={
            curentRowDetail ? curentRowDetail.delegateType : curentRowDetailReceive ? curentRowDetailReceive.delegateType : null
          }
          delegateRole={
            curentRowDetail ? curentRowDetail.delegateRole : curentRowDetailReceive ? curentRowDetailReceive.delegateRole : null
          }
          delegateTask={
            curentRowDetail ? curentRowDetail.delegateTask : curentRowDetailReceive ? curentRowDetailReceive.delegateTask : null
          }
          delegateTaskRoles={
            curentRowDetail ? curentRowDetail.delegateTaskRoles : curentRowDetailReceive ? curentRowDetailReceive.delegateTaskRoles : null
          }
          status={curentRowDetail ? curentRowDetail.status : curentRowDetailReceive ? curentRowDetailReceive.status : null}
          allPrivileges={
            curentRowDetail ? curentRowDetail.allPrivileges : curentRowDetailReceive ? curentRowDetailReceive.allPrivileges : null
          }
          ...
          revokeReason={
            curentRowDetail ? curentRowDetail.revokeReason : curentRowDetailReceive ? curentRowDetailReceive.revokeReason : null
          }
          replyStatus={curentRowDetail ? curentRowDetail.replyStatus : curentRowDetailReceive ? curentRowDetailReceive.replyStatus : null}
          declineReason={
            curentRowDetail ? curentRowDetail.declineReason : curentRowDetailReceive ? curentRowDetailReceive.declineReason : null
          }
          delegatePolicy={
            curentRowDetail ? curentRowDetail.delegatePolicy : curentRowDetailReceive ? curentRowDetailReceive.delegatePolicy : null
          }
        ...
        <div className='nav-tabs-custom'>
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a title={translate('menu.delegation_list')} data-toggle='tab' href={`#task_delegation_delegate`}>
                {translate('menu.delegation_list')}
              </a>
            </li>
            <li>
              <a title={translate('menu.delegation_receive')} data-toggle='tab' href={`#task_delegation_receive`}>
                {translate('menu.delegation_receive')}
              </a>
            </li>
          </ul>
          <div className='tab-content'>
            <div className='tab-pane active' id='task_delegation_delegate'>
              <TaskDelegationForm id={props.id} taskId={taskId} taskName={delegateTaskName} />
              ...
              <div className='form-inline'>
                <div className='form-group'>
                  <label style={{ width: 'auto', textAlign: 'left' }} className='form-control-static'>
                  ...
                  {taskDelegations &&
                    ...
                    taskDelegations.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          {item.delegateTaskRoles
                            ? item.delegateTaskRoles.map((r) => translate('task.task_management.' + r)).join(', ')
                            : ''}
                        </td>
            ...
            <div className='tab-pane' id='task_delegation_receive'>
              ...
              <table className='table table-striped table-bordered table-hover' style={{ marginTop: '15px' }}>
                ...
                <tbody>
                  {taskDelegationsReceive &&
                    taskDelegationsReceive.length !== 0 &&
