          ...
          <section className='gird'>
            {stateNew && stateNew[0].length !== 0
              ? stateNew[0].map((obj, index) => {
                  ...
                  if (obj?.responsibleEmployees?.length > 0) totalEmployeesInTask = [...totalEmployeesInTask, ...obj.responsibleEmployees]
                  if (obj?.accountableEmployees?.length > 0) totalEmployeesInTask = [...totalEmployeesInTask, ...obj.accountableEmployees]
                  if (obj?.consultedEmployees?.length > 0) totalEmployeesInTask = [...totalEmployeesInTask, ...obj.consultedEmployees]
                  if (obj?.informedEmployees?.length > 0) totalEmployeesInTask = [...totalEmployeesInTask, ...obj.informedEmployees]

                  return (
                    <div className='item' key={index}>
                      <span className='task-name'>{obj.name}</span>
                      <div className='time-todo-range'>
                        <span style={{ marginRight: '10px', display: 'block' }}>Thời gian thực hiện công việc: </span>{' '}
                      ...
                      <div className='progress-task-wraper'>
                        ...
                        <div className='progress-task'>
                          <div
                            ...
                            style={{
                              width: `${obj.progress}%`,
                              backgroundColor: obj.progress < 50 ? '#dc0000' : '#28a745'
                            }}
                          />
                      ...
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          totalEmployeesInTask.map((o, index) => {
                            if (index < 4)
                              return (
                                <img
                                  key={index}
                                  src={process.env.REACT_APP_SERVER + o.avatar}
                        ...
                        {totalEmployeesInTask.length > 4 && <span style={{ fontWeight: 'bold' }}>+ {totalEmployeesInTask.length - 4}</span>}
                      </div>
                      ...
                      <div className='action'>
                        ...
                        <a
                          ...
                          onClick={() => props.funcEdit(obj._id)}
                          className='edit'
                          data-toggle='modal'
                          title='Thực hiện công viêc'
                        >
                          <i className='material-icons' style={{ color: '#FFC107', marginRight: '5px' }}>
                            
                          </i>
                        </a>
                        ...
                        {obj.accountableEmployees && obj.accountableEmployees.filter((o) => o._id === userId).length > 0 && (
                          <a
                            style={{ cursor: 'pointer' }}
                            onClick={() => props.funcDelete(obj._id)}
                            className='delete'
                            title='Xóa công việc'
                          >
                            <i className='material-icons' style={{ color: '#E34724', marginRight: '5px' }}>
                              
                            </i>
                          </a>
                        )}
                        ...
                        {obj.isArchived === true ? (
                          ...
                          <a style={{ cursor: 'pointer' }} onClick={() => props.funcStore(obj._id)} className='all_inbox' title='Lưu kho'>
                            <i className='material-icons' style={{ color: 'darkred', marginRight: '5px' }}>
                              all_inbox
                            </i>
                          </a>
                        )}
