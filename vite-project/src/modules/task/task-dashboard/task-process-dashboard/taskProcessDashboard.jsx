        ...
        <div className='row statistical-wrapper' style={{ marginTop: '5px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#fff', padding: '10px', borderRadius: '10px' }}>
              ...
              <Link to='/task-process-management' target='_blank' rel='noopener noreferrer'>
                <span style={{ fontSize: '21px' }} className='info-box-number'>
                  {taskProcess?.listTaskProcess?.length}
                </span>
              </Link>
            </div>
          </div>
          ...
          <div className='col-md-2 col-sm-4 col-xs-4 statistical-item'>
            <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#fff', padding: '10px', borderRadius: '10px' }}>
              ...
              <Link to='/task-process-management' target='_blank' rel='noopener noreferrer'>
                <span style={{ fontSize: '21px' }} className='info-box-number'>
                  {getTaskProcessManagement(listTaskProcess, userId)}
                </span>
              </Link>
            </div>
          </div>
            ...
            <div className='box box-primary'>
              <div className='box-header with-border'>
                <div className='box-title'>
                  ...
                  {endMonthTitle} {`(${taskProcess.listTaskProcess?.length ?? 0} quy trình)`}
                </div>
                <a onClick={() => {}}>
        ...
        <div className='row'>
          <div className='col-xs-12 col-sm-12 col-md-6'>
            <div className='box box-primary'>
              <div className='box-header with-border'>
                <div className='box-title'>
                  Tổng quan công việc trong quy trình {startMonthTitle}
                  <i className='fa fa-fw fa-caret-right'></i>
                  {endMonthTitle}
                </div>
              </div>
              <div className='box-body qlcv'>
                <LazyLoadComponent once={true}>
                  <TaskHasTaskOutputs startMonth={state.startMonth} endMonth={state.endMonth} />
                </LazyLoadComponent>
              </div>
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-6'>
            <div className='box box-primary'>
              <div className='box-header with-border'>
                <div className='box-title'>
                  Quy trình công việc {startMonthTitle}
                  <i className='fa fa-fw fa-caret-right'></i>
                  {endMonthTitle}
                </div>
              </div>
              <div className='box-body qlcv'>
                <LazyLoadComponent once={true}>
                  <TaskHasDepartments startMonth={state.startMonth} endMonth={state.endMonth} />
                </LazyLoadComponent>
              </div>
            </div>
          </div>
