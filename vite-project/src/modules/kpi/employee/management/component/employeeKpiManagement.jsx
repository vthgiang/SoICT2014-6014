...
import { DataTableSetting, ExportExcel, PaginateBar, DatePicker, SelectBox, ToolTip } from '../../../../../common-components'
    ...
    <div className='box'>
      <div className='box-body qlcv'>
        ...
        <table id={tableId} className='table table-hover table-bordered'>
          <thead>
            <tr>
              <th title={translate('kpi.evaluation.employee_evaluation.index')} style={{ width: '40px' }} className='col-fixed not-sort'>
                {translate('kpi.evaluation.employee_evaluation.index')}
              </th>
              ...
              <th title={translate('kpi.evaluation.employee_evaluation.number_of_targets')}>
                {translate('kpi.evaluation.employee_evaluation.number_of_targets')}
              </th>
              ...
              <th title={translate('kpi.evaluation.employee_evaluation.action')}>
                {translate('kpi.evaluation.employee_evaluation.action')}
              </th>
            </tr>
          </thead>
              ...
              kpipersonal.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <a
                      href='#modal-detail-KPI-personal'
                      onClick={() => showDetailKpiPersonal(item)}
                      data-toggle='modal'
                      title={translate('kpi.evaluation.employee_evaluation.view_detail')}
                    >
                    ...
                    <a
                      ...
                      data-toggle='modal'
                      className='copy'
                      title={translate('kpi.evaluation.employee_evaluation.clone_to_new_kpi')}
                    >
                      <i className='material-icons'>content_copy</i>
                    </a>
                    {state.showModalCopy === item._id && (
                      <ModalCopyKPIPersonal id={item._id} idunit={item.organizationalUnit._id} kpipersonal={item} />
                    )}
                  </td>
                </tr>
              ))}
