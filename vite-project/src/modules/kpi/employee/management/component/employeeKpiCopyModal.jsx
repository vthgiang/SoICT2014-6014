  ...
  return (
    ...
    >
      <div className='form-group text-red'>
        <label style={{ margin: '0px 10px' }}>Lưu ý</label>
        <span>{translate('kpi.organizational_unit.management.copy_modal.alert.change_link')}</span>
      </div>
      ...
      <div className={`form-group ${errorOnNewDate === undefined ? '' : 'has-error'}`} style={{ marginLeft: '10px' }}>
        ...
        <label>
          {translate('kpi.organizational_unit.management.copy_modal.month')}
          <span className='text-red'>*</span>
        </label>
        <DatePicker id='new_date' value={''} onChange={handleNewDateChange} dateFormat='month-year' />
