...
function DistributionOfEmployeeKpiChart(props) {
  ...
  const setDataMultiChart = (organizationalUnitKPI) => {
    let dataChartAnalysis = [translate('kpi.organizational_unit.statistics.weight_analysis_employee')],
    ...
    return {
      xs: xs,
      dataChart: [dataChartDefault, dataChartAnalysis]
    }
  }
