...
function OrganizationalUnitKpiCreate(props) {
  ...
  let listOrganizationalUnitCopy,
    listUnitOfUser,
    listIdOfExistUnit = []
                      ...
                      <span>
                        {currentKPI.status === 1 ? (
                          <a className='btn btn-app' onClick={() => swalOfUnitKpi('edit_employee_importance')}>
                            <i className='fa fa-child' style={{ fontSize: '16px' }}></i>
                          ...
                          <span>
                            {currentKPI.status === 1 ? (
                              <a className='btn btn-app' onClick={() => swalOfUnitKpi('edit_organizational_unit_importance')}>
                                <i className='fa fa-university' style={{ fontSize: '16px' }}></i>
                              ...
                              <span>
                                ...
                                <OrganizationalUnitImportancesModal
                                  organizationalUnit={
                                    selectBoxUnit?.filter((item) => item?.id === currentKPI?.organizationalUnit?._id)?.[0]
                                  }
                                  organizationalUnitId={currentKPI.organizationalUnit && currentKPI.organizationalUnit._id}
                                  month={month}
                                />
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style={{ width: '100px' }}>
                            {translate('kpi.organizational_unit.create_organizational_unit_kpi_set.action')}
                          </th>
                        </tr>
                      </thead>
                      <tbody>
