      ...
      >
        ...
        <div className='nav-tabs-custom' style={{ marginTop: '-15px' }}>
          <ul className='nav nav-tabs' id='nav-tabs'>
            <li className='active'>
              <a title={translate('asset.general_information.general_information')} data-toggle='tab' href={`#edit_general${_id}`}>
                {translate('asset.general_information.general_information')}
              </a>
            </li>
            <li>
              <a
                title={translate('asset.general_information.depreciation_information')}
                data-toggle='tab'
                href={`#edit_depreciation${_id}`}
              >
            ...
            <li>
              <a title={translate('asset.general_information.incident_information')} data-toggle='tab' href={`#edit_incident${_id}`}>
            ...
            <li>
              <a
                ...
                data-toggle='tab'
                href={`#edit_maintainance${_id}`}
              >
                {translate('asset.general_information.maintainance_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.disposal_information')} data-toggle='tab' href={`#edit_disposal${_id}`}>
                {translate('asset.general_information.disposal_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.attach_infomation')} data-toggle='tab' href={`#edit_attachments${_id}`}>
