      ...
      <form className='form-group' id='form-view-asset'>
        <div className='nav-tabs-custom'>
          ...
          <ul className='nav nav-tabs'>
            ...
            <li>
              <a title={translate('asset.general_information.incident_information')} data-toggle='tab' href={`#view_incident${_id}`}>
            ...
            <li>
              <a
                ...
                data-toggle='tab'
                href={`#view_maintainance${_id}`}
              >
                {translate('asset.general_information.maintainance_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.disposal_information')} data-toggle='tab' href={`#view_disposal${_id}`}>
          ...
          <div className='tab-content'>
            ...
            {/* Thông tin bảo trì */}
            <MaintainanceLogTab id={`view_maintainance${_id}`} maintainanceLogs={maintainanceLogs} />
            ...
            {/* Thông tin sự cố */}
            <IncidentLogTab id={`view_incident${_id}`} incidentLogs={incidentLogs} status={status} />
