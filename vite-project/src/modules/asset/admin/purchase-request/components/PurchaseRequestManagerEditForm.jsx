...
function PurchaseRequestEditForm(props) {
  ...
  const isFormValidated = () => {
    ...
    let result = validateEquipment(equipmentName, false) && validateTotal(total, false) && validateUnit(unit, false)
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID='modal-edit-recommendprocuremanage'
        isLoading={recommendProcure.isLoading}
          ...
          <div className='col-md-12'>
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${!errorOnEquipment ? '' : 'has-error'}`}>
                ...
                <input
                  ...
                  autoComplete='off'
                  placeholder='Thiết bị đề nghị mua'
                />
              ...
              <div className={`form-group ${errorOnEquipmentDescription === undefined ? '' : 'has-error'}`}>
                ...
                <textarea
                  ...
                  value={equipmentDescription ? equipmentDescription : ''}
            ...
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${errorOnTotal === undefined ? '' : 'has-error'}`}>
                <label>
                  {translate('asset.general_information.number')}
                  <span className='text-red'>*</span>
                </label>
              ...
              <div className={`form-group ${!errorOnUnit ? '' : 'has-error'}`}>
                <label>
                  {translate('asset.manage_recommend_procure.unit')}
                  <span className='text-red'>*</span>
                </label>
                <input
                  type='text'
