...
class AssetMaintenanceChart extends Component {
  ...
  handleSearchData = async () => {
    ...
    if (maintenanceDateAfter.getTime() > maintenanceDateBefore.getTime()) {
      ...
      this.props.getAllAssetGroup([
        { name: 'maintenance-date-data', endTimeMaintenance: maintenanceDateBefore, startTimeMaintenance: maintenanceDateAfter }
      ])
    }
  }
  ...
  render() {
    ...
    let startValue =
      year === 'true' ? maintenanceDateAfter.slice(0, 4) : maintenanceDateAfter.slice(5, 7) + ' - ' + maintenanceDateAfter.slice(0, 4)
    let endValue =
      year === 'true' ? maintenanceDateBefore.slice(0, 4) : maintenanceDateBefore.slice(5, 7) + ' - ' + maintenanceDateBefore.slice(0, 4)
