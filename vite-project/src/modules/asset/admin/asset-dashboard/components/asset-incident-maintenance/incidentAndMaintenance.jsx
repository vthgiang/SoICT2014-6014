          ...
          <div className='row'>
            ...
            <div className='col-xs-12'>
              <div className='box box-solid'>
                ...
                <div className='box-body qlcv'>
                  <AssetIncidentChart listAssets={listAssets} assetType={assetType} getIncidentData={this.getIncidentData} />
                </div>
              </div>
            </div>
            ...
            <div className='col-xs-12'>
              <div className='box box-solid'>
                ...
                <div className='box-body qlcv'>
                  <AssetMaintenanceChart listAssets={listAssets} assetType={assetType} getMaintenanceData={this.getMaintenanceData} />
                </div>
              </div>
            </div>
          </div>
