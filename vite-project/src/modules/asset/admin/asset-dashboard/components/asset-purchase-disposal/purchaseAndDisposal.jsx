            ...
            <div className='col-xs-12'>
              <div className='box box-solid'>
                ...
                <div className='box-body qlcv'>
                  <AssetPurchaseChart assetType={assetType} listAssets={listAssets} getPurchaseData={this.getPurchaseData} />
                </div>
              </div>
            </div>
              ...
              <div className='box box-solid'>
                <div className='box-header'>
                  <div style={{ marginRight: '5px' }} className='box-title'>
                    {translate('asset.dashboard.disposal_asset')}
                  </div>
                ...
                <div className='box-body qlcv'>
                  <AssetDisposalChart assetType={assetType} listAssets={listAssets} getDisposalData={this.getDisposalData} />
                </div>
              </div>
            </div>
          </div>
