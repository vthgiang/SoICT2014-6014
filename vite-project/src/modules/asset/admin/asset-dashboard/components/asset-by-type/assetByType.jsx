...
class AssetByType extends Component {
  ...
  static getDerivedStateFromProps = (props, state) => {
    if (props?.assetType?.administration?.types?.list && state?.listAssets) {
      ...
      for (let i in listAssetTypes) {
        ...
        listAssetTypeSort = [...listAssetTypeSort, count]
      }
  ...
  render() {
    ...
    let listAssetTypeConvert = listAssetTypes && listAssetTypes.length > 0 ? this.getAssetTypes(listAssetTypes) : []
    let assetTypes
    ...
    if (listAssetsAmount.listType) {
      pageTotal =
        listAssetsAmount.listType.length % limit === 0
          ...
          <div className='row'>
            <div className='col-md-12'>
              ...
              <div className='form-group' style={{ width: '100%' }}>
                ...
                <TreeSelect data={dataSelect} value={type ? type : []} handleChange={this.handleChangeTypeAsset} mode='hierarchical' />
              </div>
            </div>
            <div className='col-md-12'>
              <PaginateBar
              ...
              <div className='box box-solid'>
                ...
                <div className='box-body qlcv'>
                  {(amountOfAsset || depreciation || valueOfAsset) && (
                    <StatisticalAssetByType amountOfAsset={amountOfAsset} depreciationOfAsset={depreciation} valueOfAsset={valueOfAsset} />
                  )}
                </div>
              </div>
            </div>
          ...
          <div className='row'>
            <div className='col-xs-6'>
              <div className='box box-solid'>
                ...
                <div className='box-body qlcv'>
                  <AmountTree listAssetsAmount={listAssetsAmount} setAmountOfAsset={this.setAmountOfAsset} />
                </div>
              </div>
            </div>
