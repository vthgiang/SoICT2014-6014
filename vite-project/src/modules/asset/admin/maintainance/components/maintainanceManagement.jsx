...
function MaintainanceManagement(props) {
  ...
  var pageTotal =
    mintainanceManager.mintainanceLength % limit === 0
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              value={type}
              options={{
                nonSelectedText: translate('asset.general_information.select_reception_type'),
                allSelectedText: translate('asset.general_information.select_all_reception_type')
              }}
          ...
          <div className='form-group'>
            ...
            <DatePicker id='maintain-month' dateFormat='month-year' value={maintainCreateDate} onChange={handleMaintainCreateDateChange} />
          </div>
        </div>
          ...
          <tbody>
            {lists && lists.length !== 0
              ? lists.map((x, index) => (
                  <tr key={index}>
                    <td>
                      <span onClick={() => handleEditAsset(x.asset)} style={{ color: '#367FA9', cursor: 'pointer' }}>
                        {x.asset.code}
                      </span>
                    </td>
