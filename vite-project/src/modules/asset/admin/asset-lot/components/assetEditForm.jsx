...
function AssetEditForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='75'
        modalID={`modal-edit-asset-in-edit-lot`}
      ...
      >
        ...
        <div className='nav-tabs-custom' style={{ marginTop: '-15px' }}>
          <ul className='nav nav-tabs' id='nav-tabs'>
            <li className='active'>
              <a title={translate('asset.general_information.general_information')} data-toggle='tab' href={`#edit_general_in_lot${_id}`}>
            ...
            <li>
              <a title={translate('asset.general_information.incident_information')} data-toggle='tab' href={`#incident_edit_in_lot${_id}`}>
            ...
            <li>
              <a
                ...
                data-toggle='tab'
                href={`#maintainance_edit_in_lot${_id}`}
              >
                {translate('asset.general_information.maintainance_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.disposal_information')} data-toggle='tab' href={`#disposal_edit_in_lot${_id}`}>
                {translate('asset.general_information.disposal_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.attach_infomation')} data-toggle='tab' href={`#attachments_edit_in_lot${_id}`}>
