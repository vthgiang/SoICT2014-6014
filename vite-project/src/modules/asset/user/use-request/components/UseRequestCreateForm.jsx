...
function UseRequestCreateForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID={`modal-create-recommenddistribute-${_id}`}
          ...
          <div className='col-md-12'>
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${!errorOnDateCreate ? '' : 'has-error'}`}>
                ...
                <DatePicker id='create_start_date' value={dateCreate} onChange={handleDateCreateChange} />
            ...
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${errorOnDateStartUse === undefined ? '' : 'has-error'}`}>
                ...
                <DatePicker id='create_start_use' value={dateStartUse} onChange={handleDateStartUseChange} />
                {props.typeRegisterForUse == 2 && (
                  <TimePicker id={`time-picker-start`} onChange={handleStartTimeChange} value={startTime} />
                )}
              ...
              <div className={`form-group ${errorOnDateEndUse === undefined ? '' : 'has-error'}`}>
                ...
                <DatePicker id='create_end_use' value={dateEndUse} onChange={handleDateEndUseChange} />
                {props.typeRegisterForUse == 2 && <TimePicker id={`time-picker-end`} onChange={handleStopTimeChange} value={stopTime} />}
