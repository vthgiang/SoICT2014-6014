      ...
      <div className='box-body'>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.diploma')}</h4>
          </legend>
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => handleDeleteDegree(index)}>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.certificate')}</h4>
          </legend>
          <CertificateAddModal handleChange={handleAddCertificate} id={`addCertificateShort${id}`} />
          <table className='table table-striped table-bordered table-hover' style={{ marginBottom: 0 }}>
            <thead>
              <tr>
                ...
                certificates.map((x, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        <a
                          onClick={() => handleEditShort(x, index)}
                          className='edit text-yellow'
                          style={{ width: '5px' }}
                        ...
                        <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => handleDeleteCertificate(index)}>
                          <i className='material-icons'></i>
                        </a>
                      </td>
                    </tr>
