      ...
      <div className='box-body'>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.reward')}</h4>
          </legend>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <a
                          ...
                          style={{ width: '5px' }}
                          title={translate('human_resource.commendation_discipline.commendation.delete_commendation')}
                        >
                          <i className='material-icons'>edit</i>
                        </a>
                        <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => handleDeleteConmmendation(index)}>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.discipline')}</h4>
          </legend>
                ...
                disciplines.map((x, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        <a
                          onClick={() => handleViewDiscipline(x, index)}
                          className='edit text-yellow'
                          style={{ width: '5px' }}
                        ...
                        <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => handleDeleteDiscipline(index)}>
                          <i className='material-icons'></i>
                        </a>
                      </td>
                    </tr>
