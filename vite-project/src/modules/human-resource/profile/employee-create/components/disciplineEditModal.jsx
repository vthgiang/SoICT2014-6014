...
function DisciplineEditModal(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID={`modal-edit-discipline-${id}`}
        isLoading={false}
        ...
        <form className='form-group' id={`form-edit-discipline-${id}`}>
          ...
          <div className='row'>
            ...
            <div className={`col-sm-6 col-xs-12 form-group ${errorOnStartDate && 'has-error'}`}>
              ...
              <DatePicker id={`edit_discipline_start_date${id}`} deleteValue={false} value={startDate} onChange={handleStartDateChange} />
            ...
            <div className={`col-sm-6 col-xs-12 form-group ${errorOnEndDate && 'has-error'}`}>
              ...
              <DatePicker id={`edit_discipline_end_date${id}`} deleteValue={true} value={endDate} onChange={handleEndDateChange} />
