...
function ModalAddWorkProcess(props) {
  ...
  const { company, startDate, endDate, position, referenceInformation, errorOnStartDate, errorOnEndDate, errorOnUnit, errorOnPosition } =
    state
  ...
  return (
    <React.Fragment>
      <ButtonModal
        modalID={`modal-create-work-process-${id}`}
