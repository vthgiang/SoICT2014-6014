  ...
  const handleSubmit = async (e) => {
    ...
    if (informationEmployee === null && state.avatar === '') {
      ...
      if (check === false) {
        ...
        let formData =
          convertJsonObjectToFormData(informationEmployee) !== null ? convertJsonObjectToFormData(informationEmployee) : new FormData()
            ...
            <div className='box-body'>
              <fieldset className='scheduler-border'>
                <legend className='scheduler-border'>
                  <h4 className='box-title'>{translate('human_resource.profile.tab_name.menu_basic_infor')}</h4>
                </legend>
                {/* Ảnh đại diện */}
                <div className='col-lg-4 col-md-4 col-ms-12 col-xs-12' style={{ textAlign: 'center' }}>
                  <div>{avatar && <ApiImage className='attachment-img avarta' id={`avatar-update`} src={avatar} />}</div>
                        ...
                        <div className='radio-inline'>
                          <label>
                            <input
                              ...
                              defaultChecked={x.gender === 'male' ? true : false}
                            />
                        ...
                        <div className='radio-inline'>
                          <label>
                            <input
                              ...
                              defaultValue='female'
                              onChange={handleChange}
                              defaultChecked={x.gender === 'female' ? true : false}
                            />
                        ...
                        <div className='radio-inline'>
                          <label>
                            <input
                              ...
                              value='single'
                              onChange={handleChange}
                              defaultChecked={x.maritalStatus === 'single' ? true : false}
                            />
                        ...
                        <div className='radio-inline'>
                          <label>
                            <input
                              ...
                              value='married'
                              onChange={handleChange}
                              defaultChecked={x.maritalStatus === 'married' ? true : false}
                            />
              ...
              <fieldset className='scheduler-border'>
                <legend className='scheduler-border'>
                  <h4 className='box-title'>{translate('human_resource.profile.tab_name.menu_contact_infor')}</h4>
                </legend>
                  ...
                  <div className='row'>
                    ...
                    <div className='form-group col-md-4'>
                      ...
                      <input
                        ...
                        className='form-control '
                        name='phoneNumber'
                        defaultValue={x.phoneNumber ? x.phoneNumber : ''}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Di động 2 */}
                    <div className='form-group col-md-4'>
                      ...
                      <input
                        ...
                        className='form-control '
                        name='phoneNumber2'
                        defaultValue={x.phoneNumber2 ? x.phoneNumber2 : ''}
                        onChange={handleChange}
                      />
                    </div>
                  </div>
                  ...
                  <div className='row'>
                    ...
                    <div className='form-group col-md-4'>
                      ...
                      <input
                        ...
                        className='form-control '
                        name='homePhone'
                        defaultValue={x.homePhone ? x.homePhone : ''}
                        onChange={handleChange}
                      />
                    </div>
                  </div>
                    ...
                    <div className='col-md-6'>
                      ...
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          defaultValue={x.emergencyContactPerson}
                          onChange={handleChange}
                        />
                      </div>
                      {/* Di động */}
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          id='emergencyContactPersonPhoneNumber'
                          defaultValue={x.emergencyContactPersonPhoneNumber ? x.emergencyContactPersonPhoneNumber : ''}
                          onChange={handleChange}
                        />
                      </div>
                      {/* Emai cá nhân */}
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          id='emergencyContactPersonEmail'
                          defaultValue={x.emergencyContactPersonEmail}
                          onChange={handleChange}
                        />
                      </div>
                    </div>
                    <div className='col-md-6'>
                      ...
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          id='relationWithEmergencyContactPerson'
                          defaultValue={x.relationWithEmergencyContactPerson}
                          onChange={handleChange}
                        />
                      </div>
                      {/* Diện thoại có định */}
                      <div className='form-group'>
                        ...
                        <input
                          type='text'
                          className='form-control '
                          name='emergencyContactPersonHomePhone'
                          id='emergencyContactPersonHomePhone'
                          defaultValue={x.emergencyContactPersonHomePhone ? x.emergencyContactPersonHomePhone : ''}
                          onChange={handleChange}
                        />
                      </div>
                      {/* Địa chỉ */}
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          defaultValue={x.emergencyContactPersonAddress}
                          onChange={handleChange}
                        />
                      </div>
                    </div>
                  ...
                  <fieldset className='scheduler-border'>
                    ...
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        defaultValue={x.permanentResidence}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Quốc gia */}
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        defaultValue={x.permanentResidenceCountry}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Tỉnh/ Thành phố */}
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        defaultValue={x.permanentResidenceCity}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Quận/ huyện */}
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        id='permanentResidenceDistrict'
                        defaultValue={x.permanentResidenceDistrict}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Xã/ phường */}
                    <div className='form-group'>
                      ...
                      <input
                        type='text'
                        className='form-control '
                        name='permanentResidenceWard'
                        id='permanentResidenceWard'
                        defaultValue={x.permanentResidenceWard}
                        onChange={handleChange}
                      />
                    </div>
                  </fieldset>
                  ...
                  <fieldset className='scheduler-border'>
                    ...
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        defaultValue={x.temporaryResidence}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Quốc gia*/}
                    <div className='form-group'>
                      ...
                      <input
                        type='text'
                        className='form-control '
                        name='temporaryResidenceCountry'
                        id='temporaryResidenceCountry'
                        defaultValue={x.temporaryResidenceCountry}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Tỉnh/ Thành phố */}
                    <div className='form-group'>
                      ...
                      <input
                        type='text'
                        className='form-control '
                        name='temporaryResidenceCity'
                        id='temporaryResidenceCity'
                        defaultValue={x.temporaryResidenceCity}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Quận / huyện */}
                    <div className='form-group'>
                      ...
                      <input
                        type='text'
                        className='form-control '
                        name='temporaryResidenceDistrict'
                        id='temporaryResidenceDistrict'
                        defaultValue={x.temporaryResidenceDistrict}
                        onChange={handleChange}
                      />
                    </div>
                    {/* Xã/ Phường */}
                    <div className='form-group'>
                      ...
                      <input
                        type='text'
                        className='form-control '
                        name='temporaryResidenceWard'
                        id='temporaryResidenceWard'
                        defaultValue={x.temporaryResidenceWard}
                        onChange={handleChange}
                      />
                    </div>
                  </fieldset>
            ...
            <div className='box-footer'>
              <div className='form-group col-md-12'>
                <div className='checkbox' style={{ paddingLeft: '20%' }}>
                  ...
                  <label style={{ color: 'red' }}>{translate('human_resource.profile.employee_info.contact_other')}</label>
                </div>
              </div>
              <button
                type='submit'
                title={translate('human_resource.profile.employee_info.update_infor_personal')}
