  ...
  return (
    <div id={id} className='tab-pane'>
      <div className='box-body qlcv'>
        ...
        <PurchaseAddModal handleChange={handleAddPurchaseInvoice} id={`addPurchaseInvoice${id}`} />
              ...
              purchaseInvoice.map((x, index) => (
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => handleDeletePurchaseInvoice(index)}>
