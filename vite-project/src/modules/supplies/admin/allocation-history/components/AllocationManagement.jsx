...
function AllocationManagement(props) {
  ...
  var pageTotal =
    allocationHistoryReducer.totalList % limit === 0
    ...
    <div className='box'>
      <div className='box-body qlcv'>
        ...
        <div className='dropdown pull-right'>
          <button
            ...
            aria-expanded='true'
            title={translate('menu.add_allocation')}
          >
            {translate('menu.add_allocation')}
          </button>
          <ul className='dropdown-menu pull-right' style={{ marginTop: 0 }}>
            <li>
              <a style={{ cursor: 'pointer' }} onClick={() => window.$('#modal-create-allocation').modal('show')}>
                {translate('menu.add_allocation')}
              </a>
            </li>
          </ul>
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              multiple='multiple'
              options={{
                nonSelectedText: translate('supplies.general_information.select_supplies'),
                allSelectedText: translate('supplies.general_information.select_all_supplies')
              }}
          ...
          <div className='form-group'>
            ...
            <DatePicker id='disposal-month' dateFormat='month-year' value={date} onChange={handleDateChange} />
          </div>
        </div>
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              name='allocationToUser'
              onChange={handleAllocationToUserChange}
              placeholder={translate('supplies.allocation_management.allocationToUser')}
              autoComplete='off'
            />
          </div>
        </div>
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <button
              ...
              title={translate('supplies.general_information.search')}
              onClick={handleSubmitSearch}
            >
              {translate('supplies.general_information.search')}
            </button>
          </div>
        ...
        <SmartTable
          ...
          tableBodyData={
            allocationHistoryReducer.listAllocation?.length > 0 &&
            allocationHistoryReducer.listAllocation.map((item, index) => {
              return {
                id: item?._id,
                index: <td>{index + 1}</td>,
                ...
                allocationToOrganizationalUnit: (
                  <td>{getPropertyOfValue(item.allocationToOrganizationalUnit, 'name', false, departmentlist)}</td>
                ),
        ...
        {allocationHistoryReducer.isLoading ? (
          ...
          (!allocationHistoryReducer.listAllocation || allocationHistoryReducer.listAllocation.length === 0) && (
      ...
      {currentRowEdit && (
        <AllocationEditForm
          ...
          allocationToOrganizationalUnit={getPropertyOfValue(currentRowEdit.allocationToOrganizationalUnit, '_id', true, userlist)}
          allocationToUser={getPropertyOfValue(currentRowEdit.allocationToUser, '_id', true, departmentlist)}
        />
      )}
    </div>
  )
