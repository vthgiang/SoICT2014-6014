...
function SuppliesManagement(props) {
  ...
  var pageTotal =
    suppliesReducer.totalList % limit === 0 ? parseInt(suppliesReducer.totalList / limit) : parseInt(suppliesReducer.totalList / limit + 1)
      ...
      <div className='box-body qlcv'>
        ...
        <div className='dropdown pull-right'>
          ...
          <ul className='dropdown-menu pull-right' style={{ marginTop: 0 }}>
            <li>
              <a style={{ cursor: 'pointer' }} onClick={() => window.$('#modal-add-supplies').modal('show')}>
                {translate('menu.add_supplies')}
              </a>
            </li>
          </ul>
        ...
        <SmartTable
          ...
          tableBodyData={
            suppliesReducer.listSupplies?.length > 0 &&
            suppliesReducer.listSupplies.map((item, index) => {
              return {
                id: item?._id,
                index: <td>{index + 1}</td>,
        ...
        {suppliesReducer.isLoading ? (
          ...
          (!suppliesReducer.listSupplies || suppliesReducer.listSupplies.length === 0) && (
