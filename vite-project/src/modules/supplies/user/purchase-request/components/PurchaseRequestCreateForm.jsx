...
function PurchaseRequestCreateForm(props) {
  ...
  const isFormValidated = () => {
    ...
    let result =
      validateSupplies(suppliesName, false) && validateTotal(total, false) && validateUnit(unit, false) && validateApprover(approver, false)
    return result
  }
  ...
  return (
    <React.Fragment>
      <ButtonModal
        modalID='modal-create-purchaserequest'
        button_name={translate('supplies.general_information.add')}
