...
export const getRoleInTask = (userId, currentTask, translate) => {
  ...
  if (currentTask?.responsibleEmployees?.length > 0) {
    currentTask.responsibleEmployees.forEach((obj) => {
      ...
      if (typeof obj === 'object') {
        if (obj._id === userId) roleInTask = [...roleInTask, translate('task.task_management.responsible')]
      }
      if (typeof obj === 'string') {
        if (obj === userId) roleInTask = [...roleInTask, translate('task.task_management.responsible')]
      }
    })
  }
  ...
  if (currentTask?.accountableEmployees?.length > 0) {
    currentTask.accountableEmployees.forEach((obj) => {
      ...
      if (typeof obj === 'object') {
        if (obj._id === userId) roleInTask = [...roleInTask, translate('task.task_management.accountable')]
      }
      if (typeof obj === 'string') {
        if (obj === userId) roleInTask = [...roleInTask, translate('task.task_management.accountable')]
      }
    })
  }
  ...
  if (currentTask?.consultedEmployees?.length > 0) {
    currentTask.consultedEmployees.forEach((obj) => {
      ...
      if (typeof obj === 'object') {
        if (obj._id === userId) roleInTask = [...roleInTask, translate('task.task_management.consulted')]
      }
      if (typeof obj === 'string') {
        if (obj === userId) roleInTask = [...roleInTask, translate('task.task_management.consulted')]
      }
    })
  }
  if (currentTask?.informedEmployees?.length > 0) {
    currentTask.informedEmployees.forEach((obj) => {
      ...
      if (typeof obj === 'object') {
        if (obj._id === userId) roleInTask = [...roleInTask, translate('task.task_management.informed')]
      }
      if (typeof obj === 'string') {
        if (obj === userId) roleInTask = [...roleInTask, translate('task.task_management.informed')]
      }
    })
  }
...
export const getProjectName = (id, listProject) => {
  if (id && listProject && listProject.length > 0) {
    ...
    for (let i = 0; i < projectLength; i++) {
      if (listProject[i]._id === id) return listProject[i].name
    }
  }
}
/**
