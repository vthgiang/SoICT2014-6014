      ...
      <React.Fragment>
        ...
        <div className={controlCssClass}>
          <div className='' style={{ textAlign: 'right' }}>
            ...
            <a style={{ cursor: 'pointer' }} className='link-black text-sm' onClick={(e) => this.refs.fileComponent.openFileChooser()}>
              {translate('task.task_perform.attach_file')}&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
            <a
            ...
            <a style={{ cursor: 'pointer' }} className='link-black text-sm' onClick={handleEdit}>
              {cancelButtonText}
            </a>
          </div>
                  ...
                  <li className='files-list-item' key={file.id}>
                    <div className='files-list-item-preview row'>
                      {!file.preview ? (
                        ...
                        <React.Fragment>{this.showFileExtension(file)}</React.Fragment>
                      )}
                    </div>
                    <div className='files-list-item-content'>
                      <div className='files-list-item-content-right'>
                        ...
                        <div>
                          {this.formatDate(file.lastModifiedDate)}・{file.sizeReadable || file.size}
                        </div>
                      </div>
