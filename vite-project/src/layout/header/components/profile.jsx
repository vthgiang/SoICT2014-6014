            ...
            <div className='row'>
              ...
              <div style={{ marginTop: '10px' }} className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                <a style={{ width: '100%' }} href='#modal-profile' data-toggle='modal' className='btn btn-default btn-flat'>
                  <i className='fa fa-info-circle' /> {translate('auth.profile.title')}{' '}
                </a>
              </div>
