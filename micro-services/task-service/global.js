...
module.exports = async (server) => {
  ...
  // global.AUTO_SENDEMAIL_TASK = require('./modules' + '/scheduler/scheduler.service').sendEmailTaskAutomatic;
  ...
  // global.AUTO_CREATE_NOTIFICATION_END_CONTRACT = require('./modules' + '/scheduler/scheduler.service').createNotificationEndOfContract;
  // AUTO_CREATE_NOTIFICATION_END_CONTRACT.start();

  // global.AUTO_UPDATE_STATUS_PACKAGE_PERSONAL = require('./modules' + '/scheduler/scheduler.service').updateStatusPackagePersonStatus;
