...
const TaskSchema = new Schema(
  {
    ...
    requestToCloseTask: {
      ...
      taskStatus: {
        // Các trạng thái như trạng thái công việc, trừ inprocess
        type: String,
      },
      requestStatus: {
        // 0: chưa yêu cầu, 1: đang yêu cầu, 2: từ chối, 3: đồng ý
        type: Number,
        default: 0,
      },
    ...
    evaluations: [
      {
        ...
        date: {
          // về sau không dùng. thay bởi các thuộc tính (evaluatingMonth, startDate, endDate) bên dưới
    ...
    taskActions: [
      {
        ...
        timesheetLogs: [
          // Lưu thời gian bấm giờ của một hoạt động
          {
            creator: {
              // Người thực hiện nào tiến hành bấm giờ
              type: Schema.Types.ObjectId,
        ...
        comments: [
          {
            ...
            version: {
              // trường này cho biết comments tương ứng với từng version
              type: Number,
            },
            description: {
              type: String,
