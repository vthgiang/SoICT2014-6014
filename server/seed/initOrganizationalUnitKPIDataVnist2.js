...
const initSampleCompanyDB = async () => {
    ...
    const truongPhongChamSocKhachHang = await User(vnistDB).find({ name: 'Trần Hữu Hiến' });
    const truongphongNhanSu = await User(vnistDB).find({ name: 'Ngô Văn Thức' });
    const truongboPhanKinhDoanh = await User(vnistDB).find({ name: 'Lê Đàm Quân' });
    const truongphongKeHoach = await User(vnistDB).find({ name: 'Tô Duy Tường' });
    ...
    const nangluc = await OrganizationalUnitKpi(vnistDB).find({ name: 'Tỉ lệ nhân viên được đạt chuẩn năng lực chức danh/ đạt định mức công việc' });
    const khenthuong = await OrganizationalUnitKpi(vnistDB).find({ name: 'Tỉ lệ nhân viên đồng ý chính sách động viên khen thưởng và kỹ luật' });
    ...
    const taskTemplates = await TaskTemplate(vnistDB).insertMany([
        ...
        },
        {
            ...
            listMappingTask: [
                {
                    taskName: 'Xây dựng tiêu chuẩn năng lực',
                    organizationalUnitKpi: new ObjectId(nangluc[0]._id),
                    target: 0.59,
                    unit: 'Nhân viên',
                    ...
                    taskDescription: '<p>Mô tả công việc về Xây dựng tiêu chuẩn năng lực</p>',
                },
                {
                    taskName: 'Xây dựng tiêu chuẩn năng lực',
                    organizationalUnitKpi: new ObjectId(nangluc[0]._id),
        ...
        },
        {
            ...
            listMappingTask: [
                {
                    taskName: 'Đánh giá định kỳ năng lực nhân viên',
                    organizationalUnitKpi: new ObjectId(nangluc[0]._id),
                    target: 0.63,
                    unit: 'Nhân viên',
                    startDate: '2024-06-13',
                    ...
                    taskDescription: '<p>Mô tả công việc về Đánh giá định kỳ năng lực nhân viên</p>',
                },
            ],
        },
        {
            type: 'Thực hiện chương Group',
            collaboratedWithOrganizationalUnits: [],
            numberOfDaysTaken: 1,
            readByEmployees: [],
            responsibleEmployees: [],
            ...
            listMappingTask: [
                {
                    taskName: 'Thực hiện chương trình khen thưởng hàng quý',
                    organizationalUnitKpi: new ObjectId(khenthuong[0]._id),
                    target: 0.91,
                    unit: 'Nhân viên',
                    ...
                    taskDescription: '<p>Mô tả công việc về Thực hiện chương trình khen thưởng hàng quý</p>',
                },
            ],
        },
        {
            type: 'Tổ chức hội Group',
            collaboratedWithOrganizationalUnits: [],
            numberOfDaysTaken: 1,
            readByEmployees: [],
            responsibleEmployees: [],
            ...
            listMappingTask: [
                {
                    taskName: 'Tổ chức hội thảo về chính sách động viên',
                    organizationalUnitKpi: new ObjectId(khenthuong[0]._id),
                    target: 1.17,
                    unit: 'Nhân viên',
                    ...
                    taskDescription: '<p>Mô tả công việc về Tổ chức hội thảo về chính sách động viên</p>',
                },
                {
                    taskName: 'Tổ chức hội thảo về chính sách động viên',
                    organizationalUnitKpi: new ObjectId(khenthuong[0]._id),
        ...
        },
        {
            ...
            listMappingTask: [
                {
                    taskName: 'Tổ chức các khóa đào tạo nâng cao',
                    organizationalUnitKpi: new ObjectId(nangluc[0]._id),
                    target: 0.94,
                    unit: 'Nhân viên',
                    ...
                    taskDescription: '<p>Mô tả công việc về Tổ chức các khóa đào tạo nâng cao</p>',
                },
            ],
        },
        {
        ...
        },
        {
            ...
            listMappingTask: [
                {
                    taskName: 'Đánh giá hiệu quả chính sách động viên',
                    organizationalUnitKpi: new ObjectId(khenthuong[0]._id),
                    target: 0.6,
                    unit: 'Nhân viên',
                    startDate: '2024-06-18',
                    ...
                    taskDescription: '<p>Mô tả công việc về Đánh giá hiệu quả chính sách động viên</p>',
                },
            ],
        },
        {
            type: 'Khảo sát ý Group',
            collaboratedWithOrganizationalUnits: [],
            numberOfDaysTaken: 1,
            readByEmployees: [],
            responsibleEmployees: [],
            ...
            listMappingTask: [
                {
                    taskName: 'Khảo sát ý kiến nhân viên',
                    organizationalUnitKpi: new ObjectId(khenthuong[0]._id),
                    target: 0.67,
                    unit: 'Nhân viên',
                    startDate: '2024-06-13',
                    ...
                    taskDescription: '<p>Mô tả công việc về Khảo sát ý kiến nhân viên</p>',
                },
            ],
        },
        {
        ...
        },
        {
            ...
            listMappingTask: [
                {
                    taskName: 'Đo lường và báo cáo năng lực nhân viên',
                    organizationalUnitKpi: new ObjectId(nangluc[0]._id),
                    target: 0.63,
                    unit: 'Nhân viên',
                    startDate: '2024-06-27',
                    ...
                    taskDescription: '<p>Mô tả công việc về Đo lường và báo cáo năng lực nhân viên</p>',
                },
                {
                    taskName: 'Đo lường và báo cáo năng lực nhân viên',
                    organizationalUnitKpi: new ObjectId(nangluc[0]._id),
