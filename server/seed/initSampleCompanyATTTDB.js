...
const initSampleCompanyDB = async () => {
    ...
    const vcTruongPhong = await Role(vnistDB).create({
        ...
        name: 'Trưởng phòng giám sát, lắp đặt',
        type: roleChucDanh._id,
    });
    ...
    const nhamaythuocbot = await OrganizationalUnit(vnistDB).create({
        ...
        description: 'Phòng phát triển phần mềm của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam',
    ...
    const nhamaythuocnuoc = await OrganizationalUnit(vnistDB).create({
        ...
        description: 'Phòng an toàn thông tin của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam',
    ...
    const nhamaythucphamchucnang = await OrganizationalUnit(vnistDB).create({
        name: 'Phòng cài đặt vận hành',
        description: 'Phòng cài đặt vận hành của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam',
    ...
    const phongVanChuyen = await OrganizationalUnit(vnistDB).create({
        name: 'Phòng lắp đặt, vận chuyển',
        description: 'Phòng lắp đặt, vận chuyển của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam',
   ...
   ----------------------------------------------------------------------------------------------- */
    ...
    manufacturingWorks0.manufacturingMills = [manufacturingMills[0]._id, manufacturingMills[1]._id, manufacturingMills[2]._id];
