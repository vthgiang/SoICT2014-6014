...
const initSampleCompanyDB = async () => {
  ...
  const nhamaythuocbot = await OrganizationalUnit(vnistDB).create({
    ...
    description:
      "Phòng phát triển phần mềm của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam",
  ...
  const nhamaythuocnuoc = await OrganizationalUnit(vnistDB).create({
    ...
    description:
      "Phòng an toàn thông tin của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam",
  ...
  const nhamaythucphamchucnang = await OrganizationalUnit(vnistDB).create({
    ...
    description:
      "Phòng cài đặt vận hành của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam",
  ...
  const phongVanChuyen = await OrganizationalUnit(vnistDB).create({
    ...
    description:
      "Phòng lắp đặt, vận chuyển của Công ty Cổ phần Công nghệ An toàn thông tin và Truyền thông Việt Nam",
