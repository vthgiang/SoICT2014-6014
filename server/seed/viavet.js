...
const initSampleCompanyDB = async () => {
    ...
    const phoGiamDoc = await Role(viavetDB).create({
        parents: [roleViceDean._id, thanhVienBGĐ._id],
        name: "Phó giám đốc",
        type: roleChucDanh._id
    });
    const giamDoc = await Role(viavetDB).create({
        parents: [roleDean._id, thanhVienBGĐ._id, phoGiamDoc._id],
        name: "Giám đốc",
        type: roleChucDanh._id
    });
    const nvPhongHC = await Role(viavetDB).create({
        parents: [roleEmployee._id],
        name: "Nhân viên phòng kinh doanh",
        type: roleChucDanh._id
    });
    const phoPhongHC = await Role(viavetDB).create({
        parents: [roleViceDean._id, nvPhongHC._id],
        name: "Phó phòng kinh doanh",
        type: roleChucDanh._id
    });
    const truongPhongHC = await Role(viavetDB).create({
     ...
     */
    await UserRole(viavetDB).insertMany([{ // Gán tài khoản super.admin.viavet có role là Super Admin của công ty viavet
        userId: users[0]._id,
        roleId: roleSuperAdmin._id
    }, {
        userId: users[1]._id, // Gán tài khoản admin.viavet có role là admin
     ...
     */
    const Directorate = await OrganizationalUnit(viavetDB).create({ // Khởi tạo ban giám đốc công ty
        name: "Ban giám đốc",
    ...
    const departments = await OrganizationalUnit(viavetDB).insertMany([{
    ...
    -----------------------------------------------------------------------------------------------
    ----------------------------------------------------------------------------------------------- */
    await Employee(viavetDB).insertMany([{
        ...
        emailInCompany: "vtc.viavet@gmail.com",
        ...
        identityCardDate: new Date("2015-10-20"),
        identityCardAddress: "Nam Định",
        emailInCompany: "tvb.viavet@gmail.com",
        nationality: "Việt Nam",
        atmNumber: "102298653",
        bankName: "ViettinBank",
        bankAddress: "Hai Bà Trưng",
    ...
    var employee = await Employee(viavetDB).create({
        avatar: "/upload/human-resource/avatars/avatar5.png",
        ...
        identityCardDate: new Date("2015-10-20"),
        identityCardAddress: "Nam Định",
        emailInCompany: "nva.viavet@gmail.com",
        nationality: "Việt Nam",
        atmNumber: "102298653",
        bankName: "ViettinBank",
        bankAddress: "Hai Bà Trưng",
    ...
    await AnnualLeave(viavetDB).insertMany([{
        company: viavet._id,
    ...
    await Salary(viavetDB).insertMany([{
        company: viavet._id,
        employee: employee._id,
        month: "2020-02",
        organizationalUnit: Directorate._id,
    ...
    await Commendation(viavetDB).insertMany([{
        company: viavet._id,
        employee: employee._id,
        decisionNumber: "123",
    ...
    await Discipline(viavetDB).insertMany([{
        company: viavet._id,
        employee: employee._id,
        decisionNumber: "1456",
        organizationalUnit: departments[0]._id,
    ...
    var educationProgram = await EducationProgram(viavetDB).insertMany([{
    ...
    await Course(viavetDB).insertMany([{
        company: viavet._id,
    ...
    await ModuleConfiguration(viavetDB).create({
        humanResource: {
     ...
     */
    const domains = await DocumentDomain(viavetDB).insertMany([{
        company: viavet._id,
    ...
    const domanins2 = await DocumentDomain(viavetDB).insertMany([
        //tài liệu bắt buộc
        {
            company: viavet._id,
    ...
    const archives = await DocumentArchive(viavetDB).insertMany([{
        company: viavet._id,
        name: "Văn phòng B1",
    ...
    const archives2 = await DocumentArchive(viavetDB).insertMany([{
        company: viavet._id,
        name: "Phòng 201",
    ...
    const archives3 = await DocumentArchive(viavetDB).insertMany([{
        company: viavet._id,
        name: "Tủ 1",
    ...
    const archives4 = await DocumentArchive(viavetDB).insertMany([{
        company: viavet._id,
        name: "Ngăn đầu",
    ...
    const categories = await DocumentCategory(viavetDB).insertMany([{
        company: viavet._id,
        name: "Văn bản",
        description: 'Văn bản'
    }, {
    ...
    const documents = await Document(viavetDB).insertMany([{
        company: viavet._id,
        name: 'Đi chơi',
    ...
    var listAssetType = await AssetType(viavetDB).insertMany([{ //0
        company: viavet._id,
        typeNumber: "BA",
        typeName: "Bàn",
        parent: null,
    ...
    var listRecommendProcure = await RecommendProcure(viavetDB).insertMany([{
    ...
    var listAsset = await Asset(viavetDB).insertMany([{
        company: viavet._id,
    ...
    var asset = await Asset(viavetDB).create({
        company: viavet._id,
        avatar: "/upload/asset/pictures/picture5.png",
        assetName: "HUST",
        group: "building",
    ...
    var assetManagedByEmployee2 = await Asset(viavetDB).create({
        company: viavet._id,
        avatar: "/upload/asset/pictures/picture5.png",
    ...
    var assetManagedByEmployee1 = await Asset(viavetDB).create({
        company: viavet._id,
        avatar: "/upload/asset/pictures/picture5.png",
    ...
    var listAsset1 = await Asset(viavetDB).insertMany([
    ...
    var listAsset2 = await Asset(viavetDB).insertMany([{ //3 B1 101
        company: viavet._id,
        avatar: "/upload/asset/pictures/picture5.png",
        assetName: "B1-101",
        group: "building",
    ...
    var recommmenddistribute = await RecommendDistribute(viavetDB).insertMany([{
        company: viavet._id,
        asset: asset._id,
    ...
    var listCategory = await Category(viavetDB).insertMany([{
        name: "Dạng bột",
        code: "CT001",
        type: "product",
    ...
    var listGood = await Good(viavetDB).insertMany([{
        company: viavet._id,
    ...
    var listProduct = await Good(viavetDB).insertMany([
    ...
    var listStock = await Stock(viavetDB).insertMany([{
        company: viavet._id,
        name: "D5",
        code: "ST001",
    ...
    await Group(viavetDB).insertMany(customerGroupData);
    ...
    await Status(viavetDB).insertMany(customerStatusData);
