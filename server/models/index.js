module.exports = {
    ...
    Entity: require('./security/entity.model'),
    Object: require('./security/object.model'),
    Attribute: require('./security/attribute.model'),
    Policy: require('./security/policy.model'),
    Rule: require('./security/rule.model'),
    AuthorizationLog: require('./security/authorization.log.model'),
    ...
    Transport3rd: require('./transport3/transport3rd.model'),
