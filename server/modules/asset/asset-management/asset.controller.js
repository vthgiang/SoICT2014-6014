...
exports.getAssetGroupChart = async (req, res) => {
    ...
    try {
        ...
        // Disposalchart
        let listMonthDisposal = [], valueDisposal = [], countAssetDisposal = [], categoryDisposal = [], arrDisposal = [];
        if (req.query.time) {
            let item1 = JSON.parse(req.query.time)
        ...
        if (assetChart) {
            for (let i = 0; i < listMonthDisposal.length - 1; i++) {
                ...
                countTypeDisposal.push({ xTypeDipsosal: categoryDisposal[i], countAssetcount: countAssetcount, valueAsset: valueAsset, idAssetTypeTestDisposal: idAssetTypeTestDisposal, idAssetTypeDisposal: idAssetTypeDisposal })
        ...
        if (assetChart) {
            for (let i = 0; i < categoryYearDisposal.length; i++) {
                ...
                countTypeYearDisposal.push({ xType: categoryYearDisposal[i], countAssetcountYear: countAssetcountYear, valueAssetYear: valueAssetYear, idAssetTypeTestDisposalYear: idAssetTypeTestDisposalYear, idAssetTypeDisposalYear: idAssetTypeDisposalYear })
        ...
        if (assetChart) {
            for (let i = 0; i < listMonthIncident.length - 1; i++) {
                ...
                countTypeIncident.push({ xType: categoryIncident[i], countAssetcount: countAssetcount, idAssetTypeTestIncident: idAssetTypeTestIncident, idAssetTypeIncident: idAssetTypeIncident })
        ...
        if (assetChart) {
            for (let i = 0; i < categoryYearIncident.length; i++) {
                ...
                countTypeYearIncident.push({ xType: categoryYearIncident[i], countAssetcountYear: countAssetcountYear, idAssetTypeTestIncidentYear: idAssetTypeTestIncidentYear, idAssetTypeIncidentYear: idAssetTypeIncidentYear })
        ...
        if (assetChart) {
            for (let i = 0; i < listMonthMaintenance.length - 1; i++) {
                ...
                countTypeMaintenance.push({ xType: categoryMaintenance[i], countAssetcount: countAssetcount, valueAsset: valueAsset, idAssetTypeTestMaintenance: idAssetTypeTestMaintenance, idAssetTypeMaintenance: idAssetTypeMaintenance })
        ...
        let valueYearMaintenance = [], countAssetYearMaintenance = [], categoryYearMaintenance = [], arrYearMaintenance = [];
        ...
        if (assetChart) {
            for (let i = 0; i < categoryYearMaintenance.length; i++) {
                ...
                countTypeYearMaintenance.push({ xType: categoryYearMaintenance[i], countAssetcountYear: countAssetcountYear, valueAssetYear: valueAssetYear, idAssetTypeTestMaintenanceYear: idAssetTypeTestMaintenanceYear, idAssetTypeMaintenanceYear: idAssetTypeMaintenanceYear })
