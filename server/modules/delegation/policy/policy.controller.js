...
exports.createPolicy = async (req, res) => {
    try {
        ...
        await Log.info(req.user.email, 'created_new_delegation_policy', req.portal);
        ...
        console.log(error)
        await Log.error(req.user.email, 'created_new_delegation_policy', req.portal);
...
exports.getPolicies = async (req, res) => {
    try {
        ...
        const response = await rabbitMq.gRPC('delegation-policy.getPolicies',
...
exports.getPolicyById = async (req, res) => {
    try {
        ...
        const response = await rabbitMq.gRPC('delegation-policy.getPolicyById',
...
exports.getDetailedPolicyById = async (req, res) => {
    try {
        ...
        const response = await rabbitMq.gRPC('delegation-policy.getDetailedPolicyById',
            JSON.stringify({portal: req.portal, id: id}),
            listRpcQueue.SECURITY_SERVICE);
