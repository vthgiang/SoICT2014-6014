...
exports.getAllEmployeeKpiInOrganizationalUnit = async (req, res) => {
    try {
        var employeeKpis = await DashboardOrganizationalUnitService.getAllEmployeeKpiInOrganizationalUnit(req.query);
...
exports.getAllOrganizationalUnitKpiSetByTime = async (req, res) => {
    try {
        var organizationalUnitKpiSets = await DashboardOrganizationalUnitService.getAllOrganizationalUnitKpiSetByTime(req.query);
...
exports.getAllEmployeeKpiInChildrenOrganizationalUnit = async (req, res) => {
    try {
        var employeeKpisInChildrenOrganizationalUnit = await DashboardOrganizationalUnitService.getAllEmployeeKpiInChildrenOrganizationalUnit(req.user.company._id, req.query.roleId);
        LogInfo(req.user.email, ' get all employee kpi set in organizational unit ', req.user.company);
        res.status(200).json({
            success: true,
            messages: ['get_all_employee_kpi_set_in_organizational_unit_success'],
