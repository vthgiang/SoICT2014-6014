...
exports.searchAnnualLeaves = async (req, res) => {
    try {
        var listSabbatical = await SabbaticalService.searchAnnualLeaves(req.body, req.user.company._id);
...
exports.createAnnualLeave = async (req, res) => {
    try {
        if(req.body.employeeNumber.trim()===""){
            ...
            var newSabbatical = await SabbaticalService.createAnnualLeave(req.body, req.user.company._id);
...
exports.deleteAnnualLeave = async (req, res) => {
    try {
        var sabbaticalDelete = await SabbaticalService.deleteAnnualLeave(req.params.id);
...
exports.updateAnnualLeave = async (req, res) => {
    try {
        if(req.body.employeeNumber.trim()===""){
            ...
            var sabbaticalUpdate = await SabbaticalService.updateAnnualLeave(req.params.id, req.body);
