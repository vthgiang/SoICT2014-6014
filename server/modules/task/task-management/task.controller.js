...
getAllTaskOfChildrenOrganizationalUnit = async (req, res) => {
    try {
        let tasksOfChildrenOrganizationalUnit = await TaskManagementService.getAllTaskOfChildrenOrganizationalUnit(req.user.company._id, req.query.roleId, req.query.month);
