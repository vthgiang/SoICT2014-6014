...
exports.get = async (req, res) => {
    try {
        ...
        await LogInfo(req.user.email, 'GET_EDUCATIONPROGRAM', req.user.company._id );
        res.status(200).json({
            message: "success",
...
exports.create = async (req, res) => {
    try {
        ...
        await LogInfo(req.user.email, 'CREATE_EDUCATIONPROGRAM', req.user.company._id );
        res.status(200).json({
            message: "success",
            content: education
        });
...
exports.delete = async (req, res) => {
    try {
        ...
        await LogInfo(req.user.email, 'DELETE_EDUCATIONPROGRAM', req.user.company._id );
        if (educationDelete !== null) {
            ...
            await LogError(req.user.email, 'DELETE_EDUCATIONPROGRAM', req.user.company._id );
            res.status(400).json({
                message: "Not find",
            });
        }
...
exports.update = async (req, res) => {
    try {
        ...
        await LogInfo(req.user.email, 'EDIT_EDUCATIONPROGRAM', req.user.company._id );
        res.status(200).json({
            message: "success",
        ...
        await LogError(req.user.email, 'EDIT_EDUCATIONPROGRAM', req.user.company._id );
        res.status(400).json({
            message: error
        });
    }
