                    ...
                    <section className="sidebar">
                        ...
                        <ul className="sidebar-menu" data-widget="tree" ref="sideBarMenu">
                            ...
                            <GroupItem groupItem={{
                                ...
                                icon: 'fa fa-safari',
                                list: [
                                    {name: 'menu.dashboard_inventory', icon: 'fa fa-dashboard', path: '/dashboard-inventory'},
                                    { name: 'menu.dashboard_bill', icon: 'fa fa-dashboard', path: '/dashboard-bill' },
                            ...
                            <GroupItem groupItem={{
                                ...
                                icon: 'fa fa-gears',
                                list: [
                                    { name: 'menu.manufacturing_dashboard', icon: 'fa fa-dashboard', path: '/manufacturing-dashboard' },
