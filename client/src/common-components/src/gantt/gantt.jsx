...
function Gantt(props) {
  ...
  useEffect(() => {
    ...
    if (gantt) {
      ...
      gantt.config.columns = [
        {
          name: 'role',
          label: unit ? translate('task.task_management.responsible') : translate('task.task_management.role'),
          align: 'center',
          resize: true,
          width: 120
        }
  ...
  return (
    <React.Fragment>
      ...
      <div className='gantt-container' id={`gantt-${ganttId}`} style={{ width: '100%', height: heightCalc }} />
    </React.Fragment>
  )
}
