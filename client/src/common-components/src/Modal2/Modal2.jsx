            ...
            <React.Fragment>
                {
                    ...
                    <a className="btn btn-success pull-right" href='#modal' title={this.props.title} onClick={() => this.toggleModal(this.props.id)}>{this.props.button_name}</a> :
...
const ModalExport2 = connect(mapState, null)(withTranslate(Modal2));

export { ModalExport2 as Modal2 }