            ...
            <React.Fragment>
                {
                    ...
                    <a style={{marginBottom: '10px', marginTop: '5px', marginRight: '5px'}} className={className} title={this.props.title} data-toggle="modal" data-backdrop="static" href={`#${this.props.modalID}`}>{this.props.button_name}</a> :
