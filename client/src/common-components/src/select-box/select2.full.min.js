/**
 * Nguồn: https://github.com/select2/select2/tree/master
 * Các sửa đổi:
 * 1. Thay cặp dấu ` ` trong script bằng ' '
 * 2. Xử lý dấu \
