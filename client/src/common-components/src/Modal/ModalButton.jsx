            ...
            <React.Fragment>
                {
                    ...
                    <a style={{marginBottom: '10px', marginTop: '2px'}} className="btn btn-success pull-right" title={this.props.title} data-toggle="modal" href={`#${this.props.modalID}`}>{this.props.button_name}</a> :
