...
const CreateBiddingContract = (props) => {
  ...
  }, [JSON.stringify(biddingPackagesManager?.listBiddingPackages), JSON.stringify(biddingPackagesManager?.listAllBiddingPackages)])
      ...
      <div id='general' className='active tab-pane'>
        <div className='row'>
          <div className={`form-group col-md-6 ${!state.contractNameError ? '' : 'has-error'}`}>
            <label>
              Tên hợp đồng<span className='text-red'>*</span>
            </label>
          ...
          <div className={`form-group col-md-6 ${!state.contractCodeError ? '' : 'has-error'}`}>
            <label>
              Mã hợp đồng<span className='text-red'>*</span>
            </label>
        ...
        <div className='row'>
          <div className={`form-group col-md-6`}>
            <label>
              Giá trị hợp đồng<span className='text-red'>*</span>
            </label>
          ...
          <div className={`form-group col-md-6`}>
            <label>
              Đơn vị chi phí<span className='text-red'>*</span>
            </label>
            <SelectBox
        ...
        <div className='row'>
          <div className='form-group col-md-6'>
            <label>
              Ngày có hiệu lực<span className='text-red'>*</span>
            </label>
            <DatePicker
        ...
        <div className='row'>
          ...
          <div className='form-group col-md-6'>
            <label>
              Chọn gói thầu<span className='text-red'>*</span>
            </label>
            <SelectBox
              id={`package-${id}`}
              className='form-control select2'
            ...
            <div className='row'>
              <div className={`form-group col-md-6`}>
                ...
                <input
                  ...
                  value={state.companyA}
                  onChange={(e) => handleChangeForm(e, 'companyA')}
                ></input>
              </div>
              ...
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  ...
                  onChange={(e) => handleChangeForm(e, 'addressA')}
                ></input>
              </div>
            </div>
            <div className='row'>
            ...
            <div className='row'>
              <div className={`form-group col-md-6`}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.representativeNameA}
                  onChange={(e) => handleChangeForm(e, 'representativeNameA')}
                ></input>
              </div>
              ...
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.representativeRoleA}
                  onChange={(e) => handleChangeForm(e, 'representativeRoleA')}
                ></input>
              </div>
            </div>
            <div className='row'>
              <div className={`form-group col-md-6`}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.bankAccountNumberA}
                  onChange={(e) => handleChangeForm(e, 'bankAccountNumberA')}
                ></input>
              </div>
              ...
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.bankNameA}
                  onChange={(e) => handleChangeForm(e, 'bankNameA')}
                ></input>
              </div>
            </div>
            <div className='row'>
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.taxCodeA}
                  onChange={(e) => handleChangeForm(e, 'taxCodeA')}
                ></input>
              </div>
            </div>
          </fieldset>
            ...
            <div className='row'>
              <div className={`form-group col-md-6`}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.companyB}
                  onChange={(e) => handleChangeForm(e, 'companyB')}
                ></input>
              </div>
              ...
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  ...
                  onChange={(e) => handleChangeForm(e, 'addressB')}
                ></input>
              </div>
            </div>
            <div className='row'>
            ...
            <div className='row'>
              <div className={`form-group col-md-6`}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.representativeNameB}
                  onChange={(e) => handleChangeForm(e, 'representativeNameB')}
                ></input>
              </div>
              ...
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.representativeRoleB}
                  onChange={(e) => handleChangeForm(e, 'representativeRoleB')}
                ></input>
              </div>
            </div>
            <div className='row'>
              <div className={`form-group col-md-6`}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.bankAccountNumberB}
                  onChange={(e) => handleChangeForm(e, 'bankAccountNumberB')}
                ></input>
              </div>
              ...
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.bankNameB}
                  onChange={(e) => handleChangeForm(e, 'bankNameB')}
                ></input>
              </div>
            </div>
            <div className='row'>
              <div className={`form-group col-md-6 `}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={state.taxCodeB}
                  onChange={(e) => handleChangeForm(e, 'taxCodeB')}
                ></input>
              </div>
            </div>
          </fieldset>
        ...
        <form id='form-create-biddingContract'>
          <div className='nav-tabs-custom' style={{ boxShadow: 'none', MozBoxShadow: 'none', WebkitBoxShadow: 'none', marginBottom: 0 }}>
            ...
            <ul className='nav nav-tabs'>
              ...
              <li className='active'>
                <a title='Thông tin chung' data-toggle='tab' href='#general'>
                  Thông tin chung
                </a>
              </li>
              {/* Nút tab các bên tgia */}
              <li>
                <a title='Các bên tham gia' data-toggle='tab' href='#party'>
                  Các bên tham gia
                </a>
              </li>
              {/* Nút tab quyết định giao triển khai hợp đồng */}
              <li>
                <a title='Quyết định giao triển khai hợp đồng' data-toggle='tab' href={`#decision-${id}`}>
                  Quyết định giao triển khai hợp đồng
                </a>
              </li>
            </ul>
            <div className='tab-content'>
              {generalInfo()}
              {partyForm()}
              <DecisionForImplement type={'create'} id={`decision-${id}`} biddingContract={state} handleChange={handleChange} />
            </div>
          </div>
        </form>
      </DialogModal>
