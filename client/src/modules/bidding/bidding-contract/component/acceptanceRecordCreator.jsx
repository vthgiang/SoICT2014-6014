        ...
        sections: [
            {
                children: [
                    ...
                    createBulletHeader(`Căn cứ Hợp đồng số ${contract?.code} về việc ${contract?.biddingPackage?.name}) giữa ${contract?.companyA} và ${contract?.companyB};`),
                    ...
                    createBulletList(`Đã huy động đầy đủ các chuyên gia để thực hiện công việc theo hợp đồng đã đề xuất và trong thời gian thực hiện hợp đồng có: ${contract?.decideToImplement?.projectManager?.length || "01"} quản lý dự án chịu trách nhiệm về các hoạt động của dịch vụ và liên lạc giữa Bên B và Bên A`, 1),
                    ...
                    createBulletList(`Bên B đã hoàn thành công việc đợt ___ của hợp đồng và bàn giao cho Bên A đầy đủ các sản phẩm theo hợp đồng với các hạng mục sau đây:`, 0),
                    ...
                    createBulletList(`Trong đợt ___ của hợp đồng: Bên B đã thực hiện đầy đủ các nội dung công việc, nghĩa vụ và trách nhiệm đảm bảo khối lượng chất lượng và tiến độ theo yêu cầu trong hợp đồng số: ${contract?.code} ngày ${contract?.effectiveDate}, đủ điều kiện nghiệm thu.`, 0),
                    createBulletList(`Chất lượng thực hiện triển khai hợp đồng "${contract?.name}" đáp ứng các yêu cầu kỹ thuật nêu tại nội dung công việc hợp đồng.`, 0),
                    createBulletList(`Biên bản này dùng làm cơ sở để thanh toán đợt ___ của hợp đồng ${contract?.code} giữa hai Bên `, 0),
                    createBulletList(`Biên bản đã được hai bên nhất trí thông qua và lập thành 04 bản có giá trị như nhau, mỗi bên giữ 02 bản để thực hiện`, 0),
