...
const CreateProjectTemplateForm = (props) => {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID='modal-create-project-template'
        isLoading={false}
        ...
        <form id='form-create-project-template'>
          <div className='nav-tabs-custom' style={{ boxShadow: 'none', MozBoxShadow: 'none', WebkitBoxShadow: 'none', marginBottom: 0 }}>
            ...
            <ul className='nav nav-tabs'>
              ...
              <li className='active'>
                <a href='#general' onClick={() => handleChangeContent('general')} data-toggle='tab'>
                  Thông số và nhân sự mẫu dự án
                </a>
              </li>
              {/* Nút tab các bên tgia */}
              <li>
                <a href='#tasks' onClick={() => handleChangeContent('tasks')} data-toggle='tab'>
