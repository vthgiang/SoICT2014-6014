...
class PlanManagementTable extends Component {
  ...
  componentDidUpdate() {
    ...
    if (!this.state.flagDelete && this.state.page !== 0 && plan.lists.length == 0) {
      this.setState(
        {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        {<PlanDetailInfo planID={this.state.currentDetailPlanID} />}
          ...
          <div className='form-inline'>
            <div className='form-group'>
              ...
              <input
                ...
                placeholder={translate('manage_plan.code')}
                autoComplete='off'
              />
            </div>
          </div>
          <div className='form-inline'>
            <div className='form-group'>
              ...
              <input
                ...
                name='planName'
                onChange={this.handleChangeData}
                placeholder={translate('manage_plan.planName')}
                autoComplete='off'
              />
            </div>
            <div className='form-group'>
              <button type='button' className='btn btn-success' title={translate('manage_plan.search')} onClick={this.handleSubmitSearch}>
                {translate('manage_plan.search')}
              </button>
            </div>
          </div>
                  ...
                  <tr key={index}>
                    ...
                    <td style={{ textAlign: 'center' }}>
                      <a
                        ...
                        style={{ width: '5px' }}
                        title={translate('manage_plan.edit')}
                        onClick={() => this.handleShowDetailInfo(plan._id)}
                      >
