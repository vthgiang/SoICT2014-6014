...
function CompanyTable(props) {
  ...
  return (
    <React.Fragment>
        ...
        <thead>
          <tr>
            ...
            <th style={{ width: '120px', textAlign: 'center' }}>
              ...
              <DataTableSetting tableId='company-table' columnName={translate('table.action')} hideColumn={false} setLimit={setLimit} />
            </th>
          </tr>
        </thead>
        <tbody>
          {company.listPaginate.length > 0 && (
            <React.Fragment>
              {company.listPaginate.map((com) => (
                <tr key={com._id} className={com.active ? 'bg bg-white' : 'bg bg-gray'}>
                  <td>{com.name}</td>
                  <td>{com.shortName}</td>
                  ...
                  <td>
                    {com.log ? (
                      ...
                      <p>
                        <i className='fa fa-circle text-danger' /> {translate('system_admin.company.off')}{' '}
                      </p>
                    )}
                  </td>
                  <td>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    ...
                    <a
                      onClick={() => handleService(com)}
                      className='text-green'
                      style={{ width: '5px' }}
                      title={translate('system_admin.company.service')}
                    >
      ...
      {/* Paginate Bar */}
      <PaginateBar
        display={company.listPaginate.length}
        total={company.totalPages}
        pageTotal={company.totalPages}
