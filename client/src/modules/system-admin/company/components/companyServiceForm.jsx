                ...
                <div role="tabpanel">
                    ...
                    <ul className="nav nav-tabs" role="tablist">
                        <li
                            role="presentation"
                            className="active"
                            onClick={() => setTabPanel('company_manage_link')}
                        >
                            <a
                                href="#company_manage_link"
                                aria-controls="home"
                                role="tab"
                                data-toggle="tab"
                            >
                                <b>Links</b>{`(${company.item.links.list.filter(link => link.deleteSoft === false).length}/${systemLinks.list.length})`}
                            </a>
                        </li>
                        <li
                            role="presentation"
                            onClick={() => setTabPanel('company_manage_component')}
                        >
                            <a
                                href="#company_manage_component"
                                aria-controls="tab"
                                role="tab"
                                data-toggle="tab"
                            >
                                <b>Component</b>{`(${company.item.components.list.length}/${systemComponents.list.length})`}
                            </a>
                        </li>
                        <li
                            role="presentation"
                            onClick={() => setTabPanel('company_manage_api')}
                        >
                            <a
                                href="#company_manage_api"
                                aria-controls="tab"
                                role="tab"
                                data-toggle="tab"
                            >
                    ...
                    <div className="tab-content">
                        ...
                        <div role="tabpanel" className="tab-pane" id="company_manage_api">
                            {tabPanel === 'company_manage_api' &&
                                <CompanyManageApi companyId={companyId} companyShortName={companyShortName} />
                            }
                        </div>
                    </div>
                </div>
