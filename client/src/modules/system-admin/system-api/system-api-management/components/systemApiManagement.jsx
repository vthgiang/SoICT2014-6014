...
const SystemApiManagement = (props) => {
          ...
          listPaginateApi.map((api, index) => (
            <tr key={api?._id}>
              ...
              <td style={{ textAlign: 'center' }}>
                <a onClick={() => handleEdit(api)} className='edit' title={translate('system_admin.system_api.modal.edit_title')}>
  ...
  return (
    <React.Fragment>
      ...
      {updateApiLog && <SystemApiUpdateModal updateApiLog={updateApiLog} systemApiManageGetSystemApis={systemApiManageGetSystemApis} />}
      <SystemApiEditModal _id={systemApiEdit?._id} systemApi={systemApiEdit} />
      <div className='box'>
