...
const ModalProjectEvaluation = (props) => {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID={`modal-show-project-eval-${projectDetailId || projectDetail?._id}`}
        isLoading={false}
        ...
        {getCurrentProjectDetails(project, projectDetail?._id)?.projectType === 2 ? (
          <div className='nav-tabs-custom'>
            <ul className='nav nav-tabs'>
              <li className='active'>
                <a href='#eval-project' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  Thống kê đánh giá dự án
                </a>
              </li>
              <li>
                <a href='#eval-project-tasks' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  Thống kê đánh giá công việc
                </a>
              </li>
              {checkIfAbleToCRUDProject({ project, user, currentProjectId, isInsideProject: true }) && (
                <li>
                  <a href='#eval-project-members' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
