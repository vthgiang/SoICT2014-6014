...
const DetailPhase = (props) => {
    ...
    const allowModified = checkIfAbleToCRUDProject({ project, user, currentProjectId: projectDetailId || projectDetail?._id, isInsideProject: true });
    ...
    return (
        <React.Fragment>
            <DialogModal
                modalID={`modal-show-detail-phase-${phaseId}`} isLoading={false}
            ...
            >
                <div className="nav-tabs-custom">
                    <ul className="nav nav-tabs">
                        <li className="active"><a href="#phase-general-detail" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Thông tin chung</a></li>
                        <li><a href="#phase-report-time" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Công việc giai đoạn</a></li>
                        {
                            projectType === 2 &&
                            <li><a href="#phase-report-cost" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Chi phí giai đoạn</a></li>
                        }
                        {
                            allowModified &&
                            <li><a href="#phase-report-member" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Thành viên giai đoạn</a></li>
                        }
                        {
                            projectType === 2 &&
                            <li><a href="#eval-phase" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Thống kê đánh giá giai đoạn</a></li>
                        }
                        {
                            projectType === 2 &&
                            <li><a href="#eval-phase-tasks" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Thống kê đánh giá công việc</a></li>
                        }
                        {
                            allowModified && projectType === 2 &&
                            <li><a href="#eval-phase-members" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>Thống kê đánh giá thành viên</a></li>
                        }
                        {
                            projectType === 2 &&
