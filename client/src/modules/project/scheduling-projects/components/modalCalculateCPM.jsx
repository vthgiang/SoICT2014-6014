        ...
        <React.Fragment>
            <div style={{ lineHeight: 1.5 }}>
                ...
                <ul className="nav nav-tabs">
                    <li className="active"><a href="#calc-cpm-table" data-toggle="tab" >Bảng dữ liệu CPM của các công việc</a></li>
                    <li><a href="#calc-phase-table" data-toggle="tab" >Bảng dữ liệu các giai đoạn</a></li>
                    <li><a href="#calc-cpm-graph" data-toggle="tab" >Đồ thị CPM</a></li>
                </ul>
                            ...
                            <div className="description-box without-border">
                                ...
                                <h5>Ngày kết thúc dự án tính theo CPM:
                                    ...
                                    {moment(findLatestDate(processedData)).isAfter(moment(projectDetail?.endDate)) &&
                                        <span style={{ color: 'red' }}> - Hãy sử dụng tính năng "Đề xuất thoả hiệp thời gian - chi phí" ở góc bên phải màn hình!</span>}
                                </h5>
                            </div>
