      ...
      <React.Fragment>
        ...
        <div id='tab-notification-un-read' style={{ display: 'block' }}>
            ...
            <ul className='notify-tabs nav nav-tabs'>
              <li className='active'>
                <a
                  ...
                  href='#allNotificationUnread'
                  data-toggle='tab'
                >{`Tất cả (${notifications.receivered.paginate.length})`}</a>
              </li>
              <li>
                <a className='notify-action' href='#allNotificationUnreadDefault' data-toggle='tab'>{`Chung (${notifyDefault.length})`}</a>
              </li>
              <li>
                <a
                  className='notify-action'
                  href='#allNotificationUnreadOfTask'
                  data-toggle='tab'
              ...
              <li>
                <a
                  className='notify-action'
                  href='#allNotificationUnreadOfAsset'
                  data-toggle='tab'
                >{`Tài sản (${notifyAssetUnRead.length})`}</a>
              </li>
              <li>
                <a className='notify-action' href='#allNotificationUnreadOfKPI' data-toggle='tab'>{`KPI (${notifyKPIUnRead.length})`}</a>
              </li>
            </ul>
          ...
          <div style={{ marginTop: 10 }}>
            <span style={{ cursor: 'pointer', color: '#385898' }} onClick={() => this.handleClick()}>
              {translate('notification.mark_all_readed')}
            </span>
          </div>
          <PaginateBar
            id='un-read'
