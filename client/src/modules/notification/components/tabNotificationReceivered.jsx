...
class TabNotificationReceivered extends Component {
    ...
    render() {
        ...
        let content = [];
        let notifyTaskReceivered = [], notifyAssetReceivered = [], notifyKPIReceivered = [], notifyDefault = [];
                ...
                <div id="tab-notification-receivered" style={{ display: 'none' }}>
                    <div className="nav-tabs-custom">
                        <ul className="notify-tabs nav nav-tabs">
                            <li className="active"><a className="notify-action" href="#allNotificationReceivered" data-toggle="tab" >{`Tất cả (${notifications.receivered.paginate.length})`}</a></li>
                            <li><a className="notify-action" href="#allNotificationReceiveredDefault" data-toggle="tab" >{`Chung (${notifyDefault.length})`}</a></li>
                            <li><a className="notify-action" href="#allNotificationReceiveredOfTask" data-toggle="tab" >{`Công việc (${notifyTaskReceivered.length})`}</a></li>
                            <li><a className="notify-action" href="#allNotificationReceiveredOfAsset" data-toggle="tab" >{`Tài sản (${notifyAssetReceivered.length})`}</a></li>
                            <li><a className="notify-action" href="#allNotificationReceiveredOfKPI" data-toggle="tab" >{`KPI (${notifyKPIReceivered.length})`}</a></li>
                        </ul>
