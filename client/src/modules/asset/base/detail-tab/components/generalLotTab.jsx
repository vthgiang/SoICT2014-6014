...
function GeneralLotTab(props) {
  ...
  const { avatar, code, assetLotName, assetTypes, group, total, price, supplier, currentRowView, tableId } = state
          ...
          <div className='col-md-12'>
            ...
            <div className='form-group'>
              <SmartTable
                ...
                tableBodyData={
                  assetLotManager.listAssets?.length > 0 &&
                  assetLotManager.listAssets.map((x, index) => {
