...
function GeneralLotEditTab(props) {
    ...
    const {
        img, defaultAvatar, code, assetLotName, assetTypeEdit, group,
        status, total, price, supplier,
        errorOnCode, errorOnAssetLotName, errorOnAssetType, errorOnTotal, errorOnPrice,
        usageLogs, tableId, currentRow, currentIndex, page,
    } = state;
                    ...
                    <div>
                        <div id="form-create-asset-type" className="col-md-6">
                            ...
                            <div className={`form-group ${!errorOnAssetLotName ? "" : "has-error"} `}>
                                ...
                                <input type="text" className="form-control" name="assetName" value={assetLotName} onChange={handleAssetLotNameChange} placeholder={translate('asset.asset_lot.asset_lot_name')}
                                    autoComplete="off" />
