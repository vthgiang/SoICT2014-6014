      ...
      <div className='box-body'>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('asset.general_information.disposal_information')}</h4>
          </legend>

          {/* Ngày thanh lý */}
          <div className={`form-group`}>
            <label htmlFor='disposalDate'>{translate('asset.general_information.disposal_date')}</label>
            <DatePicker id={`disposalDate${id}`} value={disposalDate ? formatDate(disposalDate) : ''} onChange={handleDisposalDateChange} />
          </div>
          ...
          {/* Giá trị thanh lý */}
          <div className={`form-group`}>
            <label htmlFor='disposalCost'>{translate('asset.general_information.disposal_price')} (VNĐ)</label>
            <br />
            <input
              type='number'
              className='form-control'
              name='disposalCost'
              value={disposalCost ? disposalCost : ''}
              onChange={handleDisposalCostChange}
              placeholder={translate('asset.general_information.disposal_price')}
              autoComplete='off'
            />
          </div>
          ...
          {/* Nội dung thanh */}
          <div className={`form-group`}>
            <label htmlFor='disposalDesc'>{translate('asset.general_information.disposal_content')}</label>
            <br />
            <input
              type='text'
              className='form-control'
              name='disposalDesc'
              value={disposalDesc ? disposalDesc : ''}
              onChange={handleDisposalDescriptionChange}
              placeholder={translate('asset.general_information.disposal_content')}
              autoComplete='off'
            />
          </div>
        </fieldset>
