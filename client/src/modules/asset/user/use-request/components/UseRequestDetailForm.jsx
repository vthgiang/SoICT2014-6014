...
function UseRequestDetailForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID={`modal-recommenddistribute-detail-${id}`}
          ...
          <div className='col-md-12'>
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${!errorOnDateCreate ? '' : 'has-error'}`}>
                ...
                <DatePicker id={`edit_start_date${_id}`} value={formatDate(dateCreate)} disabled />
            ...
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${!errorOnDateStartUse ? '' : 'has-error'}`}>
                ...
                <DatePicker id={`edit_start_use${_id}`} value={formatDate(dateStartUse)} disabled />
                <TimePicker id={`time-picker-start${_id}`} value={startTime} disabled />
              ...
              <div className={`form-group ${!errorOnDateEndUse ? '' : 'has-error'}`}>
                ...
                <DatePicker id={`edit_end_use${_id}`} value={formatDate(dateEndUse)} disabled />
                <TimePicker id={`time-picker-end${_id}`} value={stopTime} disabled />
