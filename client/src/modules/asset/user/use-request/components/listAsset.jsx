                            ...
                            lists.filter(item => item.typeRegisterForUse !== 1).map((x, index) => (
                                <tr key={index}>
                                    ...
                                    <td style={{ textAlign: "center" }}>
                                        ...
                                        <a onClick={() => handleCreateRecommend(x)} className="post_add" style={{ width: '5px' }} title={translate('menu.recommend_distribute_asset')}><i className="material-icons">post_add</i></a>
                                    </td>
                                </tr>
                            )) : null
                        }
