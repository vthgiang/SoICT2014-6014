    ...
    return (
        <div className="nav-tabs-custom" >
            ...
            <ul className="nav nav-tabs">
                <li className="active"><a title={translate('menu.manage_info_asset')} data-toggle="tab" onClick={openGeneralTab} >{translate('menu.manage_info_asset')}</a></li>
                <li><a title={translate('menu.manage_recommend_distribute_asset')} data-toggle="tab" onClick={openUseRequestTab} >{translate('menu.manage_recommend_distribute_asset')}</a></li>
                <li><a title={translate('menu.manage_incident_asset')} data-toggle="tab" onClick={openIncidentTab} >{translate('menu.manage_incident_asset')}</a></li>
            </ul>
