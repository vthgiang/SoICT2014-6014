...
class EmployeePurchaseRequestManager extends Component {
    constructor(props) {
        super(props);
        this.state = {
            recommendNumber: "",
...
const connectedListRecommendDistributeManager = connect(mapState, actionCreators)(withTranslate(EmployeePurchaseRequestManager));
export { connectedListRecommendDistributeManager as EmployeePurchaseRequestManagement };
