...
class AssetEditForm extends Component {
    ...
    save = async () => {
        let { maintainanceLogs, usageLogs, incidentLogs, files, assignedToUser, assignedToOrganizationalUnit, handoverFromDate, handoverToDate,managedBy } = this.state;
        ...
        this.props.updateInformationAsset(this.state._id, formData, managedBy );
