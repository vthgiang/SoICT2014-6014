...
class AssetIsExpired extends Component {
  ...
  render() {
    ...
    var ExpiryDateAssets = [],
      willExpiryDateAssets = []
    ...
    if (assetType && assetType.listAssetTypes) var assettypelist = assetType.listAssetTypes
                  ...
                  willExpiryDateAssets.map((x, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        {!x.asset
                          ? ''
                          : x.asset.assetType && x.asset.assetType.length
                            ? x.asset.assetType.map((item, index) => {
                                let suffix = index < x.asset.assetType.length - 1 ? ', ' : ''
                      ...
                      <td>
                        {x.day} {translate('asset.dashboard.day')}
                      </td>
                    </tr>
                  ))}
                {ExpiryDateAssets &&
                  ExpiryDateAssets.length !== 0 &&
