...
function UseRequestManagerEditForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID='modal-edit-recommenddistributemanage'
          ...
          <div className='col-md-12'>
            ...
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${!errorOnDateStartUse ? '' : 'has-error'}`}>
                ...
                <DatePicker id={`edit_start_use`} value={dateStartUse} onChange={handleDateStartUseChange} />
                {asset && asset.typeRegisterForUse == 2 && (
                  <TimePicker id={`edit_start_time_use${_id}`} value={startTime} onChange={handleStartTimeChange} />
                )}
              ...
              <div className={`form-group ${!errorOnDateEndUse ? '' : 'has-error'}`}>
                ...
                <DatePicker id={`edit_end_use`} value={dateEndUse} onChange={handleDateEndUseChange} />
                {asset && asset.typeRegisterForUse == 2 && (
                  <TimePicker id={`edit_stop_time_use${_id}`} value={stopTime} onChange={handleStopTimeChange} />
                )}
