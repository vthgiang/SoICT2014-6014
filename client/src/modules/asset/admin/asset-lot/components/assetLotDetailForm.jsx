...
function AssetLotDetailForm(props) {
    ...
    const { _id, avatar, code, assetLotName, supplier, price, total, group, assetType,
        archivedRecordNumber, files} = state;
    ...
    return (
        <React.Fragment>
            <DialogModal
            size='75' modalID='modal-view-asset-lot' isLoading={assetLotManager}
