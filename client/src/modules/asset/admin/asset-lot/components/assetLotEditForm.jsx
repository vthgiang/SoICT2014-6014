...
function AssetLotEditForm(props) {
  ...
  const { _id, img, avatar, code, assetLotName, assetType, group, total, price, supplier, archivedRecordNumber, files, deleteAssetInLot } =
    state
  ...
  const isFormValidated = () => {
    ...
    if (state !== {}) {
      let result = validatorInput(code) && validatorInput(assetLotName) && validatorInput(assetType)
      return result
    }
