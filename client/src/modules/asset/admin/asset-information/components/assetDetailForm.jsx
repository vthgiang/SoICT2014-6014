                    ...
                    <form className="form-group" id="form-view-asset" style={{ marginTop: "-15px" }}>
                        <div className="nav-tabs-custom">
                            ...
                            <ul className="nav nav-tabs">
                                ...
                                <li><a title={translate('asset.general_information.usage_information')} data-toggle="tab" href={`#view_usage${_id}`} onClick={() => { window.$("#asset-calendar-usage").trigger('onActive')}}>{translate('asset.general_information.usage_information')}</a></li>
