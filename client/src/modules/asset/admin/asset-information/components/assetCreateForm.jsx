...
function AssetCreateForm(props) {
  ...
  return (
    <React.Fragment>
      ...
      <DialogModal
        size='75'
        modalID='modal-add-asset'
        isLoading={assetsManager.isLoading}
      ...
      >
        <div className='nav-tabs-custom' style={{ marginTop: '-15px' }}>
          ...
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a title={translate('asset.general_information.general_information')} data-toggle='tab' href={`#create_general`}>
                {translate('asset.general_information.general_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.depreciation_information')} data-toggle='tab' href={`#depreciation`}>
                {translate('asset.general_information.depreciation_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.usage_information')} data-toggle='tab' href={`#usage`}>
                {translate('asset.general_information.usage_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.incident_information')} data-toggle='tab' href={`#incident`}>
                {translate('asset.general_information.incident_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.maintainance_information')} data-toggle='tab' href={`#maintainance`}>
                {translate('asset.general_information.maintainance_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.disposal_information')} data-toggle='tab' href={`#disposal`}>
                {translate('asset.general_information.disposal_information')}
              </a>
            </li>
            <li>
              <a title={translate('asset.general_information.attach_infomation')} data-toggle='tab' href={`#attachments`}>
          ...
          <div className='tab-content'>
            ...
            {/* Thông tin khấu hao */}
            <DepreciationTab id='depreciation' asset={asset} handleChange={handleChange} />
            ...
            {/* Thông tin thanh lý */}
            <DisposalTab id='disposal' asset={asset} handleChange={handleChange} />
