...
class ReceiptDetailForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <DialogModal
                    modalID={`modal-detail-receipt`}
                    formID={`form-detail-receipt`}
...
export default connect(null, null)(withTranslate(ReceiptDetailForm));