...
class ModalDetailKPI extends Component {
    ...
    componentDidMount() {
        this.props.getChildTarget(this.props.id, this.props.date);
    }
    ...
    render() {
        ...
        return (
            <div className="modal modal-full fade" id={"dataResultTask" + this.props.idkpiunit} tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-header" style={{ textAlign: "center", background: "#605ca8", color: "white" }}>
                            <button type="button" className="close" data-dismiss="modal">
                                <span className="modal-full" style={{ color: "#ffffff" }}>X</span>
                                {/* <span className="sr-only">Close</span> */}
                            </button>
                            <h3 className="modal-title" style={{ textAlign: "unset" }} id="myModalLabel">Thông tin chi tiết kpi đơn vị tháng {this.formatMonth(this.props.date)} </h3>
                        </div>
                        {/* Modal Body */}
