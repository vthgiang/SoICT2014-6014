        ...
        <fieldset className='scheduler-border'>
          ...
          <div className='row'>
            ...
            <div className={` col-sm-6 form-inline`}>
              ...
              <span style={{ marginLeft: 10 }}>{kpiTemplate?.name}</span>
            </div>
            ...
            <div className={`col-sm-6 form-group`} style={{ marginLeft: 0, marginRight: 0 }}>
              ...
              <span style={{ marginLeft: 10 }}>{kpiTemplate?.organizationalUnit?.name}</span>
            </div>
          </div>
          ...
          <div className='row'>
            ...
            <div className={`col-sm-6 form-group`} style={{ marginLeft: 0, marginRight: 0 }}>
              ...
              <span style={{ marginLeft: 10, display: 'inline-block' }}>{parse(kpiTemplate?.description ?? '')}</span>
            </div>
          </div>
