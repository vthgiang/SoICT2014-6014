      ...
      >
        ...
        <form id='form-edit-target' onSubmit={() => handleEditTarget(translate('kpi.organizational_unit.edit_target_kpi_modal.success'))}>
          <div className={`form-group ${!errorOnName ? '' : 'has-error'}`}>
            <label>
              {translate('kpi.organizational_unit.edit_target_kpi_modal.name')}
          ...
          {/* Mục tiêu cha */}
          {organizationalUnit &&
            organizationalUnit.parent && ( //unit.parent === null này!!! kiểm tra xem đây là đơn vị gốc hay không!
          ...
          <div className={`form-group ${!errorOnCriteria ? '' : 'has-error'}`}>
            <label>
              {translate('kpi.organizational_unit.edit_target_kpi_modal.evaluation_criteria')}
              <span className='text-red'>*</span>
            </label>
            <QuillEditor
          ...
          <div className={`form-group ${!errorOnWeight ? '' : 'has-error'}`}>
            <label>
              {translate('kpi.organizational_unit.edit_target_kpi_modal.weight')}
              <span className='text-red'>*</span>
            </label>
