        ...
        <div className='modal-content'>
          ...
          <div className='modal-header'>
            ...
            <h3 className='modal-title' id='myModalLabel'>
              Thông tin chi tiết mục tiêu đảm bảo quy trình nội bộ <small>KPI đơn vị</small>
            </h3>
          </div>
          {/* Modal Body */}
              ...
              <table className='table table-bordered table-striped'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>100</td>
                    <td>
                      <a href='#myModalHorizontal1' data-toggle='modal' className='view' title='View' data-target='#myModalHorizontal1'>
                  ...
                  <tr>
                    ...
                    <td>100</td>
                    <td>
                      <a href='#myModalHorizontal2' data-toggle='modal' data-target='#myModalHorizontal2' className='view' title='View'>
                        <i className='material-icons'>visibility</i>
                      </a>
                      <a href='#abc' className='delete' title='Delete' data-toggle='tooltip'>
                        <i className='material-icons'></i>
                  ...
                  <tr>
                    ...
                    <td>100</td>
                    <td>
                      <a href='#myModalHorizontal3' data-toggle='modal' data-target='#myModalHorizontal3' className='view' title='View'>
                        <i className='material-icons'>visibility</i>
                      </a>
                      <a href='#abc' className='delete' title='Delete' data-toggle='tooltip'>
                        <i className='material-icons'></i>
                  ...
                  <tr>
                    ...
                    <td>100</td>
                    <td>
                      <a href='#myModalHorizontal4' data-toggle='modal' data-target='#myModalHorizontal4' className='view' title='View'>
                        <i className='material-icons'>visibility</i>
                      </a>
                      <a href='#abc' className='delete' title='Delete' data-toggle='tooltip'>
                        <i className='material-icons'></i>
