...
function ModalDetailEmployeeKpiSet(props) {
        ...
        <div className='modal-content'>
          ...
          <div className='modal-header' style={{ textAlign: 'center', background: '#fff', color: 'white' }}>
            ...
            <h3 className='modal-title' id='myModalLabel'>
              Thông tin chi tiết kpi cá nhân tháng {formatDate(employeeKpiSet.time)}
            </h3>
          </div>
          {/* Modal Body */}
            ...
            <div className='left-modal'>
              ...
              <div className='content-left-modal' id='style-1' style={{ width: '24.5%' }}>
                <div className='scroll-content' style={{ borderRight: '3px solid #ddd' }}>
                  {list &&
                    list.map((item, index) => (
                      <a href='#abc' onClick={() => handleChangeContent(item._id)} className='list-group-item' key={index}>
                        {item.name}
                      ...
                      <React.Fragment key={item._id}>
                        <div className='header-content-right'>
                          ...
                          <div className='col-sm-12'>
                            <label className='col-sm-2' style={{ fontWeight: '400' }}>
                              Tiêu chí đính giá:
                            </label>
                            <label className='col-sm-10' style={{ fontWeight: '400' }}>
                              {item.name}
                            </label>
                          </div>
                          <div className='col-sm-12'>
                          ...
                          <div className='col-sm-12'>
                            ...
                            <label className='col-sm-10' style={{ fontWeight: '400' }}>
                              {item.systempoint == null ? 'Chưa đánh giá' : item.systempoint}
                            </label>
                          </div>
                          <div className='col-sm-12'>
                            <label className='col-sm-2' style={{ fontWeight: '400' }}>
                            ...
                            <label className='col-sm-10' style={{ fontWeight: '400' }}>
                              {item.approverpoint === null ? 'Chưa đánh giá' : item.approverpoint}
                            </label>
                          </div>
                          <div className='col-sm-12'>
                            <label className='col-sm-2' style={{ fontWeight: '400' }}>
