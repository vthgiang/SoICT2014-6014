                                            ...
                                            {(typeof currentKPI !== 'undefined' && currentKPI !== null) ?
                                                <div className="col-xs-12 col-sm-12">
                                                    <div style={{ marginLeft: "-10px", marginBottom: "10px" }}>
                                                        ...
                                                        <ModalCreateEmployeeKpi kpipersonal={currentKPI._id} unit={currentUnit && currentUnit[0]} />
                                                   ...
                                                   <div className="" style={{ marginBottom: "10px" }}>
                                                        <h4 style={{ display: "inline", fontWeight: "600" }}>{translate('kpi_personal.kpi_personal_create.general_information.general_information')} {this.formatDate(currentKPI.time)} ({currentKPI.organizationalUnit.name})</h4>
                                                        <span style={{ float: "right" }} title={translate('kpi_personal.kpi_personal_create.kpi_status.status')}>{this.handleCheckEmployeeKpiSetStatus(currentKPI.status)}</span>
                                                    </div>
                                                    ...
                                                    <div>
                                                        {(typeof currentKPI !== 'undefined' && currentKPI !== null) &&
                                                            <h4 style={{ display: "inline-block", fontWeight: "600", marginTop: "20px" }}>{translate('kpi_personal.kpi_personal_create.target_list')} ({currentKPI.kpis.reduce(sum => sum + 1, 0)})</h4>
                                                        }
                                                                        ...
                                                                        (typeof currentKPI === 'undefined' || currentKPI === null) ? 
                                                                            ...
                                                                            : (currentKPI.kpis.map((item, index) =>
                                                                                <tr key={index + 1}>
                                                                                    ...
                                                                                    <td>
                                                                                        <a data-target={`#editEmployeeKpi${item._id}`} style={{ color: "#FFC107", fontSize: "16px" }} title={translate('kpi_personal.kpi_personal_create.action_title.edit')} data-toggle="modal" onClick={() => this.handleEditEmployeeKpi(currentKPI.status, item)}><i className="fa fa-edit"></i></a>
                                                                                        {this.state.editingTarget === item._id ? <ModalEditEmployeeKpi target={item}/> : null}
                                                                                        {item.default === 0 ? <a href="#abc" style={{ color: "#E34724", fontSize: "16px" }} title={translate('kpi_personal.kpi_personal_create.action_title.delete')} onClick={() => this.handleDeleteEmployeeKpi(item.status, currentKPI.status, item._id, currentKPI._id)}><i className="fa fa-trash"></i></a> :
                                                    ...
                                                    {(typeof currentKPI !== 'undefined' && currentKPI !== null) &&
                                                        <div>
                                                            {commenting ? 
                                                                <div>
                                                                    <button className="btn btn-danger" style={{ marginRight: "15px", float: "right" }} onClick={() => this.handleCommentEmployeeKpiSet()}>{translate('kpi_personal.kpi_personal_create.submit.cancel_feedback')}</button>
                                                                    <button className="btn btn-primary" style={{ marginRight: "15px", float: "right" }} onClick={() => this.handleCommentEmployeeKpiSet()}>{translate('kpi_personal.kpi_personal_create.submit.send_feedback')}</button>
                                                                </div>
                                                                : <button className="btn btn-primary" style={{ marginRight: "15px", float: "right" }} onClick={() => this.handleCommentEmployeeKpiSet()}>{translate('kpi_personal.kpi_personal_create.submit.feedback')}</button>
                                                            }
                                                        </div>
                                                    }
                                                ...
                                                : <div className="col-xs-12">
                                                    <div style={{marginLeft: "-10px"}}>
                                                        ...
                                                        <div>
                                                                    ...
                                                                    <ModalCreateEmployeeKpiSet unit={currentUnit && currentUnit[0]} />
                                                                </div>
                                                    </div>
