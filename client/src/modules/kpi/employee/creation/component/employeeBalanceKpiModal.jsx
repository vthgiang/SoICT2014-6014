...
function EmployeeBalanceKpiModal(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID='employee-balance-kpi-auto'
        isLoading={false}
      ...
      >
        ...
        <form
          id='form-employee-balance-kpi-auto'
        ...
        >
            ...
            <table className='table table-hover table-bordered'>
              ...
              <tbody>
                {state?.balanceData?.data &&
                  Object.values(state.balanceData.data).map((item, index) => (
          ...
          <br />
          <label className='control-label' style={{ margin: '10px 0px', padding: '0px 15px' }}>
            KPI nhân viên sau cân bằng{' '}
          </label>
          <br />
            ...
            {state?.balanceData?.kpiData.map((item) => {
              return (
                <div className='col-md-4'>
                  <PreviewKpiEmployee data={item} disableNotice={true} />
                </div>
              )
            })}
          </div>
