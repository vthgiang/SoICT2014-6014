...
function getAllEmployeeKpiSetByMonth(organizationalUnitIds, userId, startDate, endDate) {
  return (dispatch) => {
    ...
    createKpiSetService
      .getAllEmployeeKpiSetByMonth(organizationalUnitIds, userId, startDate, endDate)
      .then((res) => {
        dispatch({
...
function getAllEmployeeKpiSetInOrganizationalUnitsByMonth(organizationalUnitIds, startDate, endDate) {
  return (dispatch) => {
    ...
    createKpiSetService
      .getAllEmployeeKpiSetInOrganizationalUnitsByMonth(organizationalUnitIds, startDate, endDate)
      .then((res) => {
        dispatch({
...
function editEmployeeKpiSet(id, kpipersonal) {
  return (dispatch) => {
    ...
    createKpiSetService
      .editEmployeeKpiSet(id, kpipersonal)
      .then((res) => {
        dispatch({
...
function updateEmployeeKpiSetStatus(id, status) {
  return (dispatch) => {
    ...
    createKpiSetService
      .updateEmployeeKpiSetStatus(id, status)
      .then((res) => {
        dispatch({
...
function deleteEmployeeKpi(id, kpipersonal) {
  return (dispatch) => {
    ...
    createKpiSetService
      .deleteEmployeeKpi(id, kpipersonal)
      .then((res) => {
        dispatch({
...
function editComment(setKpiId, commentId, data) {
  return (dispatch) => {
    ...
    createKpiSetService
      .editComment(setKpiId, commentId, data)
      .then((res) => {
        dispatch({
...
function deleteComment(setKpiId, commentId) {
  return (dispatch) => {
    ...
    createKpiSetService
      .deleteComment(setKpiId, commentId)
      .then((res) => {
        dispatch({
...
function createChildComment(setKpiId, commentId, data) {
  return (dispatch) => {
    ...
    createKpiSetService
      .createChildComment(setKpiId, commentId, data)
      .then((res) => {
        dispatch({
...
function editChildComment(setKpiId, commentId, childCommentId, data) {
  return (dispatch) => {
    ...
    createKpiSetService
      .editChildComment(setKpiId, commentId, childCommentId, data)
      .then((res) => {
        dispatch({
...
function deleteChildComment(setKpiId, commentId, childCommentId) {
  return (dispatch) => {
    ...
    createKpiSetService
      .deleteChildComment(setKpiId, commentId, childCommentId)
      .then((res) => {
        dispatch({
...
function deleteFileComment(fileId, commentId, setKpiId) {
  return (dispatch) => {
    ...
    createKpiSetService
      .deleteFileComment(fileId, commentId, setKpiId)
      .then((res) => {
        dispatch({
...
function deleteFileChildComment(fileId, childCommentId, commentId, setKpiId) {
  return (dispatch) => {
    ...
    createKpiSetService
      .deleteFileChildComment(fileId, childCommentId, commentId, setKpiId)
      .then((res) => {
        dispatch({
