    ...
    render() {
        ...
        return (
            <div className="tab-pane active" id={id}>
                <strong><h4 style={{ marginTop: '15px', marginBottom: '15px' }}>Thông tin chính</h4></strong>
                <div className="row"  >
                ...
                {/* button showMore */}
                <span class="showMoreInfo" data-toggle="collapse" data-target="#showinfo1" aria-expanded="false" onClick={this.handleShowMore}>{!showMore ? 'Thông tin thêm' : 'Thu gọn'}</span>

                <div className="row" style={{ marginTop: '10px' }}>
                    <div className="col-md-12">
                        <strong><h4>{translate('crm.customer.status')}</h4></strong>
