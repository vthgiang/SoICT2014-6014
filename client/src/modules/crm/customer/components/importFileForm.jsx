...
class CrmCustomerImportFile extends Component {
    ...
    handleImportExcel = (value, checkFileImport) => {
        ...
        let valueImport = [], showValueImport = [], rowError = [], checkImportData = value, k = -1;
        ...
        value.forEach(o => {
            if (o.code) {
                ...
                let companyEstablishmentDate = (!o.companyEstablishmentDate || typeof o.companyEstablishmentDate === "string") ? o.companyEstablishmentDate : formatFunction.convertExcelDateToJSDate(o.companyEstablishmentDate);
                        ...
                        <div className="form-group">
                            <div style={{
                                ...
                                <ul>
                                    ...
                                    <li>Tải xuống file mẫu:
                                        {<ExportExcel type="link" id="downloadTemplateImport-customer" buttonName={translate('human_resource.download_file')} exportData={exportData} style={{ position: 'absolute', marginLeft: '10px' }} />}
                                    </li>
                                </ul>
                            </div>
                        </div>
