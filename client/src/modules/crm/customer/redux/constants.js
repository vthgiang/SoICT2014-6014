export const CrmCustomerConstants = {
    ...
    PAGINATE_CRM_CUSTOMERS_REQUEST: 'PAGINATE_CRM_CUSTOMERS_REQUEST',
    PAGINATE_CRM_CUSTOMERS_SUCCESS: 'PAGINATE_CRM_CUSTOMERS_SUCCESS',
    PAGINATE_CRM_CUSTOMERS_FAILE: 'PAGINATE_CRM_CUSTOMERS_FAILE',
