...
function getCustomerRankPoints(data) {
    return dispatch => {
        ...
        CrmCustomerRankPointServices.getCustomerRankPoints(data)
            ...
            .catch(err => { dispatch({ type: CrmCustomerRankPointConstants.GET_CRM_CUSTOMERRANKPOINTS_FAILE }) })
    }
}
...
function createCustomerRankPoint(data) {
    return dispatch => {
        ...
        CrmCustomerRankPointServices.createCustomerRankPoint(data)
            ...
            .catch(err => { dispatch({ type: CrmCustomerRankPointConstants.CREATE_CRM_CUSTOMERRANKPOINT_FAILE }) })
    }
}
...
function getCustomerRankPoint(id) {
    return dispatch => {
        ...
        CrmCustomerRankPointServices.getCustomerRankPoint(id)
            ...
            .catch(err => { dispatch({ type: CrmCustomerRankPointConstants.GET_CRM_CUSTOMERRANKPOINT_FAILE }) })
    }
}
...
function editCustomerRankPoint(id, data) {
    return dispatch => {
        ...
        CrmCustomerRankPointServices.editCustomerRankPoint(id, data)
            ...
            .catch(err => { dispatch({ type: CrmCustomerRankPointConstants.EDIT_CRM_CUSTOMERRANKPOINT_FAILE }) })
    }
}
...
function deleteCustomerRankPoint(id) {
    return dispatch => {
        ...
        CrmCustomerRankPointServices.deleteCustomerRankPoint(id)
            ...
            .catch(err => { dispatch({ type: CrmCustomerRankPointConstants.DELETE_CRM_CUSTOMERRANKPOINT_FAILE }) })
    }
}