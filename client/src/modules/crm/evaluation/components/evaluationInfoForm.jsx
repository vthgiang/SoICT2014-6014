            ...
            >
                ...
                <div className="nav-tabs-custom" >
                            <ul className="nav nav-tabs">
                                <li className="active"><a href={`#evaluation-tab`} data-toggle="tab">Thông tin đánh giá nhân viên</a></li>
                                <li ><a href={`#histories-action`} data-toggle="tab">Lịch sử làm việc</a></li>
                            </ul>
