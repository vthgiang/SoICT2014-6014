...
function getCrmUnits(data) {
  return (dispatch) => {
    ...
    CrmUnitServices.getCrmUnits(data)
      ...
      .catch((err) => {
        dispatch({ type: CrmUnitConstants.GET_CRM_UNIT_FAILE })
      })
  }
}
...
function createCrmUnit(data) {
  return (dispatch) => {
    ...
    CrmUnitServices.createCrmUnit(data)
      ...
      .catch((err) => {
        dispatch({ type: CrmUnitConstants.CREATE_CRM_UNIT_FAILE })
      })
  }
}
...
function deleteCrmUnit(id) {
  return (dispatch) => {
    ...
    CrmUnitServices.deleteCrmUnit(id)
      ...
      .catch((err) => {
        dispatch({ type: CrmUnitConstants.DELETE_CRM_UNIT_FAILE })
      })
  }
}
