                                    ...
                                    <div className="col-md-6">
                                        <div className="form-horizontal">
                                            <div className="form-group">
                                                ...
                                                <div className="col-sm-8">
                                                    <span>{careInfomation.customerCareStaffs ? careInfomation.customerCareStaffs.map(o => o.name).join(', ') : ''}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-horizontal">
                                            <div className="form-group">
                                                ...
                                                <div className="col-sm-8">
                                                    <span>{careInfomation.customerCareTypes ? careInfomation.customerCareTypes.map(o => o.name).join(', ') : ''}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="form-horizontal">
                                            <div className="form-group">
                                                ...
                                                <div className="col-sm-8">
                                                    ...
                                                    <div dangerouslySetInnerHTML={{ __html: careInfomation.evaluation && careInfomation.evaluation.comment ? careInfomation.evaluation.comment : '' }}></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
