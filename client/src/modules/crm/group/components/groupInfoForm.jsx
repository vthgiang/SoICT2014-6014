...
function GroupInfoForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal modalID={`modal-info-group`} formID={`form-info-group`} isLoading={groups.isLoading} size={75} disableSubmit={true}>
        {groupById && (
          <fieldset className='scheduler-border'>
            <legend className='scheduler-border'>{'Thông tin nhóm khách hàng'}</legend>
