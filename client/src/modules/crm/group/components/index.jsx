...
function CrmGroup(props) {
  ...
  let pageTotal = crm.groups.totalDocs % limit === 0 ? parseInt(crm.groups.totalDocs / limit) : parseInt(crm.groups.totalDocs / limit + 1)
              ...
              list.map((gr) => (
                <tr key={gr._id}>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    <a className='text-green' onClick={() => handleInfoGroup(gr._id)}>
                      <i className='material-icons'>visibility</i>
                    </a>
                    <a className='text-yellow' onClick={() => handleEditGroup(gr._id)}>
                      <i className='material-icons'>edit</i>
                    </a>
                    <a
                      className='text-orange'
                      title='Khuyến mãi của nhóm khách hàng'
                      onClick={() => {
                        handleGetPromotion(gr._id)
                      }}
                    >
