            ...
            >
                ...
                <form id="form-crm-customer-rankPoint-edit">
                    ...
                    <div className={`form-group`}>
                        ...
                        <input type="text" className="form-control" value={customerRankPointEdit.name ? customerRankPointEdit.name : ''} onChange={handleChangeName} />
                        {/* <ErrorLabel content={groupCodeEditFormError} /> */}
                    </div>
                      {/* Số điểm tối thiểu  */}
                      <div className={`form-group`}>
                        <label>{'Số điểm tối thiểu'}<span className="attention"> * </span></label>
                        <input type="number" className="form-control" value={customerRankPointEdit.point ? customerRankPointEdit.point : ''} onChange={handleChangePoint} />
                        {/* <ErrorLabel content={groupCodeEditFormError} /> */}
                    </div>

                    {/* Mô tả */}
                    <div className={`form-group`}>
                        <label>{'Mô tả phân nhóm khách hàng'}<span className="attention"> * </span></label>
                        <input type="text" className="form-control" value={customerRankPointEdit.description ? customerRankPointEdit.description : ''} onChange={handleChangeDescription} />
