...
function SuppliesTab(props) {
    ...
    const {
        code, suppliesName, totalPurchase, totalAllocation, price,
        errorOnCode, errorOnSuppliesName, errorOnTotalPurchase, errorOnTotalAllocation, errorOnPrice,
    } = state;
            ...
            <div className='row'>
                <div className='col-md-6'>
                    ...
                    <div className={`form-group ${!errorOnCode ? "" : "has-error"} `}>
                        <label htmlFor="code">{translate('supplies.supplies_management.code')}<span className="text-red">*</span></label>
                        ...
                        <input type="text" className="form-control" name="code" value={code} onChange={handleCodeChange} placeholder={translate('supplies.supplies_management.code')}
                            autoComplete="off" />
                    ...
                    <div className={`form-group ${!errorOnSuppliesName ? "" : "has-error"} `}>
                        <label htmlFor="suppliesName">{translate('supplies.supplies_management.suppliesName')}<span className="text-red">*</span></label>
                        <input type="text" className="form-control" name="suppliesName" value={suppliesName} onChange={handleSuppliesNameChange} placeholder={translate('supplies.supplies_management.suppliesName')}
                            autoComplete="off" />
                    ...
                    <div className={`form-group ${!errorOnPrice ? "" : "has-error"} `}>
                        ...
                        <input type="number" className="form-control" name="price" value={price} onChange={handlePriceChange} placeholder={translate('supplies.supplies_management.price')}
                            autoComplete="off" />
                ...
                <div className='col-md-6'>
                    ...
                    <div className={`form-group ${!errorOnTotalPurchase ? "" : "has-error"} `}>
                        <label htmlFor="totalPurchase">{translate('supplies.supplies_management.totalPurchase')} <span className="text-red">*</span></label>
                        <input type="number" className="form-control" name="total" value={totalPurchase} onChange={handleTotalPurchaseChange} placeholder={translate('supplies.supplies_management.totalPurchase')}
                            autoComplete="off" />
                    ...
                    <div className={`form-group ${!errorOnTotalAllocation ? "" : "has-error"} `}>
                        <label htmlFor="total">{translate('supplies.supplies_management.totalAllocation')} <span className="text-red">*</span></label>
                        <input type="number" className="form-control" name="totalAllocation" value={totalAllocation} onChange={handleTotalAllocationChange} placeholder={translate('supplies.supplies_management.totalPurchase')}
                            autoComplete="off" />
