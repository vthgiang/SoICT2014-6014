    ...
    return (
        <div id={id} className="tab-pane">
            <div className="box-body qlcv">
                        ...
                        {(suppliesReducer.listAllocation && suppliesReducer.listAllocation.length !== 0) &&
                            suppliesReducer.listAllocation.map((x, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        <a className="edit text-green" style={{ width: '5px' }} title={translate('manage_example.detail_info_example')}
                                            onClick={() => handleView(x)}><i className="material-icons">visibility</i></a>
                ...
                {
                    (!suppliesReducer.listAllocation || suppliesReducer.listAllocation.length === 0) && <div className="table-info-panel">{translate('confirm.no_data')}</div>
                }
                {/* </fieldset> */}
