      ...
      >
        <div className='nav-tabs-custom' style={{ marginTop: '-15px' }}>
          ...
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a title={translate('supplies.general_information.supplies_information')} data-toggle='tab' href={`#create_supplies`}>
                {translate('supplies.general_information.supplies_information')}
              </a>
            </li>
            <li>
              <a title={translate('supplies.general_information.invoice_information')} data-toggle='tab' href={`#invoice`}>
                {translate('supplies.general_information.invoice_information')}
              </a>
            </li>
            <li>
              <a title={translate('supplies.general_information.allocation_information')} data-toggle='tab' href={`#allocation`}>
