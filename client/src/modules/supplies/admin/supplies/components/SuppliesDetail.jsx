...
function SuppliesDetail(props) {
    ...
    return (
        <React.Fragment>
            <DialogModal
                size='75' modalID="modal-view-supplies" isLoading={suppliesReducer.isLoading}
            ...
            >
                <div className="nav-tabs-custom">
                    ...
                    <ul className="nav nav-tabs">
                        <li className="active"><a title={translate('supplies.general_information.supplies_information')} data-toggle="tab" href={`#view_supplies_general${_id}`}>{translate('supplies.general_information.supplies_information')}</a></li>
                        <li><a title={translate('supplies.general_information.invoice_information')} data-toggle="tab" href={`#view_purchase_infor${_id}`}>{translate('supplies.general_information.invoice_information')}</a></li>
                        <li><a title={translate('supplies.general_information.allocation_information')} data-toggle="tab" href={`#view_allocation_infor${_id}`}>{translate('supplies.general_information.allocation_information')}</a></li>
                    </ul>
                    <div className="tab-content">
                        ...
                        <PurchaseInvoiceTab
                            id={`view_purchase_infor${_id}`}
                        />

                        <AllocationTab
                            id={`view_allocation_infor${_id}`}
                        />
                    </div>
                </div>
            </DialogModal>
