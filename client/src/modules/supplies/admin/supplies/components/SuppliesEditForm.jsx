...
function SuppliesEditForm(props) {
    ...
    const { _id, code, suppliesName, totalPurchase, totalAllocation, price,
        listPurchaseInvoice, listAllocation
    } = state;
    ...
    const save = async () => {
        let { _id, code, suppliesName, totalAllocation, totalPurchase, price,
            deleteAllocations, updateAllocations, deleteInvoices, updateInvoices } = state;
    ...
    return (
        <React.Fragment>
            <DialogModal
                size='75' modalID="modal-edit-supplies" isLoading={suppliesReducer.isLoading}
            ...
            >
                <div className="nav-tabs-custom" style={{ marginTop: '-15px' }}>
                    ...
                    <ul className="nav nav-tabs">
                        <li className="active"><a title={translate('supplies.general_information.supplies_information')} data-toggle="tab" href={`#edit_supplies${_id}`}>{translate('supplies.general_information.supplies_information')}</a></li>
                        <li><a title={translate('supplies.general_information.invoice_information')} data-toggle="tab" href={`#edit_invoice${_id}`}>{translate('supplies.general_information.invoice_information')}</a></li>
                        <li><a title={translate('supplies.general_information.allocation_information')} data-toggle="tab" href={`#edit_allocation${_id}`}>{translate('supplies.general_information.allocation_information')}</a></li>
