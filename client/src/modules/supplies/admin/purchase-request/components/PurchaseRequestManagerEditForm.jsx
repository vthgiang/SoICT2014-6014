...
function PurchaseRequestEditForm(props) {
    ...
    const {
        recommendNumber, dateCreate, proponent, suppliesName, suppliesDescription, supplier, total, unit, estimatePrice, approver, status, note, recommendUnits, files,
        errorOnSupplies, errorOnSuppliesDescription, errorOnTotal, errorOnUnit, errorOnRecommendNumber
    } = state;
    ...
    return (
        <React.Fragment>
            <DialogModal
                size='50' modalID="modal-edit-purchaserequestmanage" isLoading={purchaseRequest.isLoading}
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="col-sm-6">
                            ...
                            <div className={`form-group ${!errorOnSupplies ? "" : "has-error"}`}>
                                ...
                                <input type="text" className="form-control" name="suppliesName" value={suppliesName ? suppliesName : ''} onChange={handleSuppliesChange} autoComplete="off" placeholder="Vật tư đề nghị mua" />
                            ...
                            <div className={`form-group ${errorOnSuppliesDescription === undefined ? "" : "has-error"}`}>
                                ...
                                <textarea className="form-control" rows="3" name="suppliesDescription" value={suppliesDescription ? suppliesDescription : ''} onChange={handleSuppliesDescriptionChange} autoComplete="off"
