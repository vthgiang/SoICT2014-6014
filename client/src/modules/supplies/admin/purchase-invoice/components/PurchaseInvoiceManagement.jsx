...
function PurchaseInvoiceManagement(props) {
  ...
  var pageTotal =
    purchaseInvoiceReducer.totalList % limit === 0
      ...
      <div className='box-body qlcv'>
        ...
        <div className='dropdown pull-right'>
          <button
            ...
            aria-expanded='true'
            title={translate('menu.add_purchase_invoice')}
          >
            {translate('menu.add_purchase_invoice')}
          </button>
          <ul className='dropdown-menu pull-right' style={{ marginTop: 0 }}>
            <li>
              <a style={{ cursor: 'pointer' }} onClick={() => window.$('#modal-create-purchase-invoice').modal('show')}>
                {translate('menu.add_purchase_invoice')}
              </a>
            </li>
          </ul>
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('supplies.invoice_management.codeInvoice')}
              autoComplete='off'
            />
          </div>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('supplies.invoice_management.supplier')}
              autoComplete='off'
            />
          </div>
        </div>
        ...
        <SmartTable
          ...
          tableBodyData={
            purchaseInvoiceReducer.listPurchaseInvoice?.length > 0 &&
            purchaseInvoiceReducer.listPurchaseInvoice.map((item, index) => {
              return {
                id: item?._id,
                index: <td>{index + 1}</td>,
        ...
        {purchaseInvoiceReducer.isLoading ? (
          ...
          (!purchaseInvoiceReducer.listPurchaseInvoice || purchaseInvoiceReducer.listPurchaseInvoice.length === 0) && (
