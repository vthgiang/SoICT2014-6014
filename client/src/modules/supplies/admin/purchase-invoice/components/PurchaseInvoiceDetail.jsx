...
function PurchaseInvoiceDetail(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID='modal-view-purchase-invoice'
      ...
      >
        <div className='nav-tabs-custom'>
          ...
          <ul className='nav nav-tabs'>
            ...
            <li>
              <a
                title={translate('supplies.general_information.invoice_history_information')}
                data-toggle='tab'
                href={`#view_history_update${_id}`}
              >
                {translate('supplies.general_information.invoice_history_information')}
              </a>
            </li>
          </ul>
          <div className='tab-content'>
            ...
            {/* Tài liệu đính kèm */}
            <InvoiceLogTab id={`view_history_update${_id}`} logs={logs} />
          </div>
        </div>
      </DialogModal>
    </React.Fragment>
