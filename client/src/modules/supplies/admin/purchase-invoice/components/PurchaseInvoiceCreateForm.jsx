...
function PurchaseInvoiceCreateForm(props) {
    ...
    const {
        codeInvoice, date, supplies, supplier, quantity, price,
        errorOnCoceInvoice, errorOnSupplies, errorOnSupplier, errorOnQuantity, errorOnDate, errorOnPrice,
    } = state;
    ...
    return (
        <React.Fragment>
            <DialogModal
                size='50' modalID="modal-create-purchase-invoice" isLoading={purchaseInvoiceReducer.isLoading}
