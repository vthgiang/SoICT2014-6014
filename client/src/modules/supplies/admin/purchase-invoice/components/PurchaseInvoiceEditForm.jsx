...
function PurchaseInvoiceEditForm(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID={`modal-edit-purchase-invoice`}
          ...
          <div className='col-md-12'>
            <div className='col-sm-6'>
              ...
              <div className={`form-group ${errorOnDate === undefined ? '' : 'has-error'}`}>
                ...
                <DatePicker id={`edit_date${id}`} value={date ? formatDate(date) : ''} onChange={handleDateChange} />
                ...
                <div>
                  <div id={`suppliesBox-${id}`}>
                    <SelectBox
                      ...
                      style={{ width: '100%' }}
                      items={suppliesReducer.listSupplies.map((x) => {
