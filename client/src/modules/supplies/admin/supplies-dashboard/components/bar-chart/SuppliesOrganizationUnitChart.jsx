...
function SupplyOrganizationUnitChart(props) {
  ...
  const getDataChart = () => {
    ...
    let lineBarChart = [[translate('asset.dashboard.amount')], [translate('asset.dashboard.value')]]
  ...
  return (
    <>
      <DataTableSetting tableId={'supply-organization-chart'} setLimit={setLimitDistributionOfEmployeeChart} />
