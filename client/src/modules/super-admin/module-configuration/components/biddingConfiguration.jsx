            ...
            <fieldset className="scheduler-border">
                ...
                <div className="row">
                    <div className={`form-group col-md-6`}>
                        ...
                        <input type="text" className="form-control" value={state.representativeName} onChange={(e) => handleChangeForm(e, 'representativeName')}></input>
                    </div>

                    <div className={`form-group col-md-6 `}>
                        <label>Chức vụ<span className="text-red">*</span></label>
                        <input type="text" className="form-control" value={state.representativeRole} onChange={(e) => handleChangeForm(e, 'representativeRole')}></input>
                    </div>
                </div>
                <div className="row">
                    <div className={`form-group col-md-6`}>
                        <label>Số tài khoản<span className="text-red">*</span></label>
                        <input type="text" className="form-control" value={state.bankAccountNumber} onChange={(e) => handleChangeForm(e, 'bankAccountNumber')}></input>
                    </div>
