...
class SystemManagement extends Component {
    ...
    downloadBackupVersion = (path) => {
        this.props.downloadBackupVersion(path);
    }
        ...
        return (
            <React.Fragment>
                <div className="row">
                                            ...
                                            system.backup.list.map((data, i) =>
                                                <tr key={`backup-version-${i}`}>
                                                    ...
                                                    <td>
                                                        ...
                                                        />
                                                        <a className="text-orange" title={translate('super_admin.system.edit_backup_info')} style={{ cursor: 'pointer' }} onClick={() => this.editBackupInfo(data)}><i className="material-icons">edit</i></a>
                                                        <a className="text-blue" title={translate('super_admin.system.download_backup_version')} style={{ cursor: 'pointer' }} onClick={() => this.downloadBackupVersion(data.path)}><i className="material-icons">save_alt</i></a>
                                                        <ConfirmNotification
                                                            icon="warning"
                    ...
                    <BackupInfo backupInfo={this.state.backupInfo} />
