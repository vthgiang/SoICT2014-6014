...
const BackupInfo = ({ backupInfo = {}, editBackupInfo, translate }) => {
  ...
  return (
    <DialogModal modalID='modal-edit-backup-info' title={translate('super_admin.system.edit_backup_info')} func={_save}>
      <form id='form-edit-backup-info'>
        <div className='form-group'>
          ...
          <textarea
            ...
            type='text'
            style={{ height: '200px' }}
            onChange={_handleBackupDescription}
          ></textarea>
        </div>
      </form>
    </DialogModal>
...
const mapDispatchToProps = {
  editBackupInfo: SystemActions.editBackupInfo
}
