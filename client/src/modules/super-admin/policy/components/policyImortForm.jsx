...
function PolicyImportForm(props) {
    ...
    return (
        <React.Fragment>
            <DialogModal
                modalID={`modal-import-file-policy-hooks`} isLoading={false}
                ...
                <form className="form-group" id={`form-import-file-policy-hooks`}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-xs-12">
                            <label></label>
                            <ExportExcel id="download_template_policy" type='link' exportData={importPolicyTemplate}
