      ...
      >
        <div className='nav-tabs-custom' style={{ marginTop: '-15px' }}>
          ...
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a title={translate('manage_policy.general_information')} data-toggle='tab' href={`#edit_general`}>
                {translate('manage_policy.general_information')}
              </a>
            </li>
            <li>
              <a title={translate('manage_policy.subject_information')} data-toggle='tab' href={`#edit_subject`}>
                {translate('manage_policy.subject_information')}
              </a>
            </li>
            <li>
              <a title={translate('manage_policy.resource_information')} data-toggle='tab' href={`#edit_resource`}>
