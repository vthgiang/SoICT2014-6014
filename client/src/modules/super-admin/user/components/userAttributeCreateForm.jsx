...
function UserAttributeCreateForm(props) {
    ...
    return (
        <React.Fragment>
            ...
            <div style={{ display: 'flex', marginBottom: 6, float: 'right' }}>
                {
                    <div className="dropdown">
                        <button style={{ marginRight: 10 }} type="button" className="btn btn-primary dropdown-toggler" data-toggle="dropdown" aria-expanded="true">{translate('manage_user.add_attribute')}</button>
                        <ul className="dropdown-menu pull-right">
                            <li><a href="#" onClick={handleOpenModalCreateUserAttribute}>{translate('manage_user.add_user_attribute')}</a></li>
            ...
            <DialogModal
                modalID="modal-create-user-attribute" isLoading={user.isLoading}
            ...
            >
                ...
                <form id="form-create-user-attribute">
                    ...
                    <div className="form-group">
                        <label>{translate('manage_user.users_add_attribute')}<span className="text-red">*</span></label>
                        <SelectBox
