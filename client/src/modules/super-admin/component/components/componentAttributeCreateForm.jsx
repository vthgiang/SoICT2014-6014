...
function ComponentAttributeCreateForm(props) {
    ...
    return (
        <React.Fragment>
            ...
            <div style={{ display: 'flex', marginBottom: 6, float: 'right' }}>
                {
                    <div className="dropdown">
                        <button style={{ marginRight: 10 }} type="button" className="btn btn-primary dropdown-toggler" data-toggle="dropdown" aria-expanded="true">{translate('manage_component.add_attribute')}</button>
                        <ul className="dropdown-menu pull-right">
                            <li><a href="#" onClick={handleOpenModalCreateComponentAttribute}>{translate('manage_component.add_component_attribute')}</a></li>
            ...
            <DialogModal
                modalID="modal-create-component-attribute" isLoading={component.isLoading}
            ...
            >
                ...
                <form id="form-create-component-attribute">
                    ...
                    <div className="form-group">
                        <label>{translate('manage_component.components_add_attribute')}<span className="text-red">*</span></label>
                        <SelectBox
                            id="select-component-attribute-create"
                            className="form-control select2"
                            style={{ width: "100%" }}
                            items={component.list
                                .map(component => { return { value: component ? component._id : null, text: component ? component.name : "" } })}
