            ...
            <div className="box-body qlcv">
                <div className="form-inline">
                    ...
                    <div className="dropdown pull-right" style={{ marginTop: "5px" }}>
                        <button type="button" className="btn btn-success pull-right" onClick={() => window.$('#modal-create-attribute-hooks').modal('show')} title={translate('manage_attribute.add_title')} >{translate('manage_attribute.add')}</button>
