...
function createComment(newsFeedId, data) {
    return dispatch => {
        ...
        homeServices.createComment(newsFeedId, data)
            .then(res => {
                dispatch({
...
function editComment(newsFeedId, commentId, data) {
    return dispatch => {
        ...
        homeServices.editComment(newsFeedId, commentId, data)
            .then(res => {
                dispatch({
...
function deleteComment(newsFeedId, commentId) {
    return dispatch => {
        ...
        homeServices.deleteComment(newsFeedId, commentId)
            .then(res => {
                dispatch({
...
function deleteFileComment(fileId, commentId, newsFeedId) {
    return dispatch => {
        ...
        homeServices.deleteFileComment(fileId, commentId, newsFeedId)
            .then(res => {
                dispatch({
