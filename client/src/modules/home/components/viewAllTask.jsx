                ...
                <div className="qlcv">
                    <div className="nav-tabs-custom" >
                        <ul className="alarm-tabs nav nav-tabs">
                            ...
                            <li><a className="alarm-tabs-type" href="#allGeneralTaskHasActionsAccountable" data-toggle="tab" onClick={() => handleNavTabs()}>Cần đánh giá công việc<span>{`(${taskHasActionsAccountable ? taskHasActionsAccountable.length : 0})`}</span></a></li>
                            <li><a className="alarm-tabs-type" href="#allGeneralTaskHasEvaluationInMonth" data-toggle="tab" onClick={() => handleNavTabs()}>Chưa có kết quả đánh giá tháng hiện tại<span>{`(${taskHasNotEvaluationResultIncurrentMonth ? taskHasNotEvaluationResultIncurrentMonth.length : 0})`}</span></a></li>
                            <li><a className="alarm-tabs-type" href="#allGeneralTaskHasNotApproveRequestToClose" data-toggle="tab" onClick={() => handleNavTabs()}>Chưa phê duyệt kết thúc<span>{`(${taskHasNotApproveResquestToClose ? taskHasNotApproveResquestToClose.length : 0})`}</span></a></li>
                        </ul>
