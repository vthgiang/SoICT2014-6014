                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <div className="row">
                                ...
                                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <button className="btn btn-default" data-dismiss="modal" onClick={refreshPage}>Tải lại trang</button>
                                    <button style={{ marginLeft: '10px' }} className="btn btn-danger pull-right" data-dismiss="modal" onClick={reset}>{translate('auth.logout')}</button>
                                </div>
                            </div>
                        </div>
                    </div>
