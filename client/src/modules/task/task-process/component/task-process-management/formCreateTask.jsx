                ...
                <div className="row">
                    <div className={`${isProcess ? "col-lg-12" : "col-sm-6"}`}>
                        ...
                        <div className={`form-group ${this.state.taskItem.errorOnName === undefined ? "" : "has-error"}`} >
                            <label className="control-label">{translate('task.task_management.name')} <span style={{ color: "red" }}>*</span></label>
                            <input type="Name" className="form-control" placeholder={translate('task.task_management.name')} value={taskItem.name} onChange={this.handleTaskTemplateName} />
