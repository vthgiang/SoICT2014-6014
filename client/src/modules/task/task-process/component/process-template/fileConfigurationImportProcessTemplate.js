          ...
          data: [
            {
              ...
              viewer: 'Thành viên ban giám đốc, Nhân viên phòng kinh doanh 247',
              xmlDiagram:
              ...
              tasks: [
                {
                  ...
                  organizationalUnit: 'Bộ phận kinh doanh',
                  collaboratedWithOrganizationalUnits: 'Bộ phận kinh doanh, Nhà máy sản xuất thuốc bột',
                  priority: 2,
                  ...
                  numberOfDaysTaken: 6,
                  formula:
                    'progress / (daysUsed / totalDays) - (numberOfFailedAction / (numberOfFailedAction + numberOfPassedAction)) * 100',
                  taskActions: [
                    {
