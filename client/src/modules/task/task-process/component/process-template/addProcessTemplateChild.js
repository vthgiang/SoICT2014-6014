        ...
        <div className='col-lg-12'>
          <div className='form-group'>
            ...
            <SelectBox
              ...
              style={{ width: '100%' }}
              items={
                taskProcess.xmlDiagram &&
                taskProcess.xmlDiagram
                  .filter((x) => x._id !== props.idParent)
                  .map((x) => {
                    return { value: x._id, text: x.processName }
                  })
              }
            ...
            <div>
              ...
              <div className='description-box'>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                  {newProcessTemplate?.manager?.length > 0 &&
                    newProcessTemplate.manager.map((item, index) => {
                      return (
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                  {newProcessTemplate?.viewer?.length > 0 &&
                    newProcessTemplate.viewer.map((item, index) => {
                      return (
                        <span key={index} className='raci-style'>
                          <img
                            src={process.env.REACT_APP_SERVER + '/upload/avatars/user.png'}
