    ...
    <React.Fragment>
      ...
      <div className=' row '>
        ...
        <div className={`col-lg-6 col-md-6 col-ms-12 col-xs-12 ${state.taskItem.errorOnEndDate === undefined ? '' : 'has-error'}`}>
          ...
          <DatePicker id={`datepicker2-${id}`} value={taskItem.endDate} onChange={handleChangeTaskEndDate} />
      ...
      <div className='form-group'>
        <small>
          <i>(Thời gian hoàn thành nhanh nhất: </i>
        </small>
        {taskItem.fastest ? (
          <small>
            <i>{taskItem.fastest.time + ' giờ )'}</i>
          </small>
        ) : (
          <small>
            <i>Không có dữ liệu. )</i>
      ...
      <div className='row'>
        <div className={`${isProcess ? 'col-lg-12' : 'col-sm-6'}`}>
          ...
          <div className='form-group'>
            <small>
              <i>(Người hoàn thành nhanh nhất: </i>
            </small>
            {taskItem.fastest ? (
              <small>
                <i>{showResponsibleEmployees(taskItem.fastest.task.responsibleEmployees) + ' )'}</i>
              </small>
            ) : (
              <small>
                <i>Không có dữ liệu. )</i>
