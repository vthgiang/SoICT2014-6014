...
function getAllXmlDiagram(pageNumber, noResultsPerPage, name = '') {
  return (dispatch) => {
    ...
    TaskProcessService.getAllXmlDiagram(pageNumber, noResultsPerPage, name).then(
...
function getAllTaskProcess(pageNumber, noResultsPerPage, name = '', startDate, endDate) {
  return (dispatch) => {
    ...
    TaskProcessService.getAllTaskProcess(pageNumber, noResultsPerPage, name, startDate, endDate).then(
...
function getXmlDiagramById(diagramId) {
  return (dispatch) => {
    ...
    TaskProcessService.getXmlDiagramById(diagramId).then(
...
function getProcessById(processId) {
  return (dispatch) => {
    ...
    TaskProcessService.getProcessById(processId).then(
...
function createXmlDiagram(data) {
  return (dispatch) => {
    ...
    TaskProcessService.createXmlDiagram(data).then(
...
function importProcessTemplate(data) {
  return (dispatch) => {
    ...
    TaskProcessService.importProcessTemplate(data).then(
...
function editXmlDiagram(diagramId, data) {
  return (dispatch) => {
    ...
    TaskProcessService.editXmlDiagram(diagramId, data).then(
...
function deleteXmlDiagram(diagramId, pageNumber, noResultsPerPage, name = '') {
  return (dispatch) => {
    ...
    TaskProcessService.deleteXmlDiagram(diagramId, pageNumber, noResultsPerPage, name).then(
...
function deleteTaskProcess(taslProcessId, pageNumber, noResultsPerPage, name = '') {
  return (dispatch) => {
    ...
    TaskProcessService.deleteTaskProcess(taslProcessId, pageNumber, noResultsPerPage, name).then(
      (res) => {
...
function createTaskByProcess(data, diagramId, template) {
  if (template) {
    return (dispatch) => {
      ...
      TaskProcessService.createTaskByProcess(data, diagramId).then(
...
function updateDiagram(processId, diagram) {
  return (dispatch) => {
    ...
    TaskProcessService.updateDiagram(processId, diagram).then(
...
function editProcessInfo(processId, data) {
  return (dispatch) => {
    ...
    TaskProcessService.editProcessInfo(processId, data).then(
      (res) => {
