...
class CalendarTestEmployee extends Component {
    constructor(props) {
        super(props);
...
const connectedTestEmployee = connect(mapState, actions)(withTranslate(CalendarTestEmployee))
export { connectedTestEmployee as CalendarTestEmployee }