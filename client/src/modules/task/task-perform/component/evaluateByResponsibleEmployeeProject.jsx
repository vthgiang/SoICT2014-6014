...
var currentTask;
// var indexReRender = 0;
class EvaluateByResponsibleEmployeeProject extends Component {
    constructor(props) {
        ...
        if (dateParam) {
            ...
            if (evaluation) {
                ...
                if (evaluation.resultsForProject && JSON.stringify(evaluation.resultsForProject) !== '{}') {
                    ...
                    point = evaluation.resultsForProject.employeePoint ? evaluation.resultsForProject.employeePoint : undefined;
                }
    ...
    handleMonthOfEvaluationChange = (value) => {
        ...
        let { task, idUser, evaluatingMonth } = this.state;
    ...
    save = async () => {
        ...
        await this.props.evaluateTaskByResponsibleEmployeesProject(data, taskId);
        this.setState(state => {
            return {
                ...state,
                        ...
                        <form id={`form-evaluate-task-by-${role}`}>
                            <fieldset className="scheduler-border">
                                ...
                                <div className={`form-group ${errorOnPoint === undefined ? "" : "has-error"}`}>
                                    <label>Điểm người thực hiện đánh giá (0 - 100) <span style={{ color: "red" }}>*</span></label>
                                    <input
