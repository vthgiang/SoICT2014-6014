        ...
        if (deadlineForEvaluation > 0) {
          ...
          if (deadlineForEvaluation < 1) {
            if (deadlineForEvaluation * 24 < 1) {
              deadlineForEvaluation =
                Math.floor(deadlineForEvaluation * 24 * 60) + ` ${props.translate('task.task_management.warning_minutes')}`
            } else {
        ...
        <div style={{ marginLeft: '-10px' }}>
          ...
          {(currentRole === 'responsible' || currentRole === 'accountable') && checkInactive && (
            <React.Fragment>
              ...
              >
                <i className='fa fa-clone' style={{ fontSize: '16px' }}></i>
          ...
          {(currentRole === 'accountable' || currentRole === 'responsible') &&
            ...
            checkCurrentRoleIsManager.length > 0 && (
              <React.Fragment>
                ...
                >
                  <i className='fa fa-floppy-o' style={{ fontSize: '16px' }}></i>
          ...
          {task && (
            <div className='description-box'>
              ...
              <div>
                ...
                <i className='fa fa-fw fa-caret-right'></i> {formatTime(task && task.endDate)}{' '}
              </div>
              <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <span className='material-icons' style={{ fontSize: '17px', color: taskPriorityColor(task?.priority) }}>
                    priority_high
                  </span>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div className='progress-task' style={{ width: '30%' }}>
                  <div
                    ...
                    style={{ width: `${task && task.progress}%`, backgroundColor: task && task.progress < 50 ? '#dc0000' : '#28a745' }}
                  ></div>
                ...
                evalList.map((eva, keyEva) => {
                  return (
                    <div key={keyEva} className='description-box'>
                      <h4>
                        {translate('task.task_management.detail_eval')}&nbsp;{formatDate(eva.startDate)}{' '}
                        <i className='fa fa-fw fa-caret-right'></i> {formatDate(eva.endDate)}
                      </h4>
