                    ...
                    <div className="tab-content">
                        <div className={selected === "taskAction" ? "active tab-pane" : "tab-pane"} id="taskAction">
                                ...
                                taskActions.map(item => {
                                    ...
                                    return <div className="post clearfix"  key={item._id}>
                                        <div class="user-block" style={{marginBottom:"10px"}}>
                                            <img class="img-circle img-bordered-sm" src={(LOCAL_SERVER_API+item.creator.avatar)} alt="User Image" />
                                                <span class="username">
                                            ...
                                            <React.Fragment>
                                                <div style={{ marginTop: "3%", marginLeft: "10%", width: "82%" }}>
                                                    ...
                                                    <ul className="pull-right list-inline">
                                                        <li><button style={{ width: "auto", marginRight: "2%" }} className=" btn btn-success btn-sm" onClick={(e) => this.handleSaveEditAction(e, item._id)}>Gửi chỉnh sửa</button></li>
                                                        <li><button style={{ width: "auto" }} className=" btn btn-default btn-sm" onClick={(e) => this.handleEditAction(e)}>Hủy bỏ</button></li>
                                                    </ul>
                                                    {/* <div className="action-post pull-right">
                                                        <button style={{ width: "auto", marginRight: "2%" }} className=" btn btn-success btn-sm" onClick={(e) => this.handleSaveEditAction(e, item._id)}>Gửi chỉnh sửa</button>
                                                        <button style={{ width: "auto" }} className=" btn btn-default btn-sm" onClick={(e) => this.handleEditAction(e)}>Hủy bỏ</button>
                                                    </div> */}
                                                </div>
                                            </React.Fragment>}
                                            ...
                                            <div>
                                                {item.comments.map(child => {
                                                    return <div className="col-sm-12 form-group margin-bottom-none" key={child._id} style={{ marginTop: "10px", marginLeft: "10px" }}>
                                                        <div class="user-block" style={{marginBottom:"10px"}}>
                                                            <img class="img-circle img-bordered-sm" src={(LOCAL_SERVER_API+child.creator.avatar)} style={{ height: "40px", width: "40px" }} alt="User Image" />
                                                                <span class="username">
                                                ...
                                                <div class="user-block" style={{marginLeft:"25px",marginTop:"20px"}}>
                                                    <img class="img-circle img-bordered-sm" src={(LOCAL_SERVER_API+auth.user.avatar)} alt="User Image" />
                                                    <span class="username">
                                                        <textarea placeholder="Hãy nhập nội dung bình luận" id="textarea-action-comment"
                                                                style={{ width: '92.5%', height: 50, fontSize: 13, border: '1px solid #dddddd', borderRadius: "18px", marginLeft: "1%", padding:"5px 0px 0px 5px" }} ref={input => this.contentCommentOfAction[item._id] = input} />
                                                    </span>
                                                </div>
                                                <button type="submit" style={{ width: "auto",marginTop:"-15px",marginRight:"40px"  }} className="btn btn-success btn-sm pull-right" onClick={(e) => this.submitComment(e, item._id, item._id, task._id)}>Gửi bình luận  </button> 
                                            </div>
                                        }
                                    </div>;
                                    return true;
                            ...
                            <React.Fragment>
                                ...
                                <img className="img-circle img-bordered-sm" src={(LOCAL_SERVER_API+auth.user.avatar)} alt="user avatar" />
                                    <span class="username">
                                    {/* <TextareaAutosize
                        ...
                        <div className={selected === "actionComment" ? "active tab-pane" : "tab-pane"} id="actionComment">
                                        ...
                                        {showChildTaskComment === item._id &&
                                            <div className="comment-content-child">
                                                        ...
                                                        {editCommentOfTaskComment === child._id &&
                                                            <React.Fragment>
                                                                <div style={{ width: "83%", marginLeft: "8.2%" }}>
                                                                    ...
                                                                    />
                                                                    <div className="row action-post" style={{ marginRight: "-4px", marginBottom: "10px", marginLeft: "5px" }}>
                                                                        <button style={{ width: "auto", marginRight: "2%" }} className="col-xs-3 btn btn-success btn-sm" onClick={(e) => this.handleSaveEditCommentOfTaskComment(e, child._id)}>Gửi chỉnh sửa</button>
                                                                        <button style={{ width: "auto" }} className="col-xs-2 btn btn-default btn-sm" onClick={(e) => this.handleEditCommentOfTaskComment(e)}>Hủy bỏ</button>
                                                                    </div>
                                                                </div>
                                                            </React.Fragment>   
                                                            // <React.Fragment>
                                                ...
                                                <div class="user-block" style={{marginLeft:"25px",marginTop:"20px"}}>
                                                    ...
                                                    <span class="username">
                                                        <textarea placeholder="Hãy nhập nội dung bình luận" id="textarea-action-comment"
                                                                style={{ width: '92.5%', height: 50, fontSize: 13, border: '1px solid #dddddd', borderRadius: "18px", marginLeft: "1%", padding:"5px 0px 0px 5px" }} ref={input => this.contentCommentOfTaskComment[item._id] = input} />
                                                    </span>
                                                </div>
                                                <button type="submit" style={{ width: "auto",marginTop:"-15px",marginRight:"40px"  }} className="btn btn-success btn-sm pull-right" onClick={(e) => this.submitCommentOfTaskComment(e, item._id, item._id, task._id)}>Gửi bình luận  </button> 
                            ...
                            <button type="submit" style={{ width: "auto"}} className="btn btn-success btn-sm pull-right" onClick={(e) => this.submitTaskComment(e, null, 0, task._id)}>Thêm hoạt động</button>
                        </div>
