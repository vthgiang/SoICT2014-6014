      ...
      <div className='nav-tabs-custom' style={{ boxShadow: 'none', MozBoxShadow: 'none', WebkitBoxShadow: 'none' }}>
        ...
        <div className='tab-content'>
                              ...
                              <div className='btn-group pull-right'>
                                ...
                                {showSort === true && (role === 'responsible' || role === 'accountable') && (
                                  <div className='sort-action'>
                                    {index !== 0 && (
                                      <a
                                        style={{ marginTop: index === taskActions.length - 1 ? '10px' : '0px' }}
                                    ...
                                    {index !== taskActions.length - 1 && (
                                      <a style={{ marginTop: index === 0 ? '13px' : '0px' }} onClick={() => sort(index, 'down')}>
                                ...
                                {item.creator && (
                                  <React.Fragment>
                                    ...
                                    <li>
                                      ...
                                      >
                                        <i className='fa fa-comments-o margin-r-5'></i> {translate('task.task_perform.comment')} (
                                      ...
                                      <>
                                        <div className='form-group text-sm'>
                                          ...
                                          <span style={{ marginRight: '5px' }}>
                                            Điểm đánh giá:{' '}
                                            <strong>
                                              {evaluations?.[item?._id]?.rating ?? (item?.rating !== -1 ? item?.rating : '--')}/10
                                            </strong>
                                          </span>
                                          <Rating
                                            fractions={2}
                                        ...
                                        <div className='form-group text-sm'>
                                          ...
                                          <span style={{ marginRight: '5px' }}>
                                            Độ quan trọng:{' '}
                                            <strong>
                                              {evaluations?.[item?._id]?.actionImportanceLevel ?? item?.actionImportanceLevel}/10
                                            </strong>
                                          </span>
                                          <Rating
                                            fractions={2}
                                        ...
                                        item.evaluations.map((element, index) => {
                                          return (
                                            <div key={index}>
                                              ...
                                              <span>
                                                {' '}
                                                Điểm đánh giá:<span className='text-red'> {element?.rating}/10</span> - Độ quan trọng:
                                  ...
                                  {Array.isArray(item?.evaluations) &&
                                    item?.evaluations?.filter((element) => element.role === 'accountable').length > 0 && (
                                      <p>
                                        ...
                                        <span>
                                          {' '}
                                          Điểm đánh giá:<span className='text-red'> {item?.rating}/10</span> - Độ quan trọng:
                                      ...
                                      <div className='content-level2'>
                                        ...
                                        {child.creator?._id === currentUser && (
                                          <div className='btn-group pull-right'>
                                            ...
                                            <ul className='dropdown-menu'>
                                              <li>
                                                <a style={{ cursor: 'pointer' }} onClick={() => handleEditActionComment(child)}>
                          ...
                          <div>
                            <ContentMaker
                              ...
                              onTextChange={(value, imgs) => {
                                setState({
                                  ...state,
                                  newTaskCommentEdited: { ...state.newTaskCommentEdited, description: value }
                                })
                              }}
                              onSubmit={(e) => {
                                    ...
                                    <div>
                                      <ContentMaker
                                        ...
                                        onTextChange={(value, imgs) => {
                                          setState({
                                            ...state,
                                            newCommentOfTaskCommentEdited: { ...state.newCommentOfTaskCommentEdited, description: value }
                                          })
                                        }}
                                        onSubmit={(e) => {
          ...
          <div className={selected === 'documentTask' ? 'active tab-pane' : 'tab-pane'} id='documentTask'>
            <div>
              {documents && (
                <ShowMoreShowLess id={`documentTask${id}`} styleShowMoreLess={{ display: 'inline-block', marginBotton: 15, marginTop: 15 }}>
                          ...
                          <div key={item._id} className={`item-box ${index > 3 ? 'hide-component' : ''}`}>
                            ...
                            <div>
                              {showFile.some((obj) => obj === item._id) ? (
                                ...
                                >
                                  Hiển thị {item?.files?.length} tài liệu &nbsp; <i className='fa fa-angle-double-down'></i>{' '}
                                </a>
                              )}
                            </div>
                            {showFile.some((obj) => obj === item._id) && (
                            ...
                            <div style={{ marginTop: '15px' }}>
                              ...
                              <ContentMaker
                                ...
                                onTextChange={(value, imgs) => {
                                  setState({
                                    ...state,
                                    fileTaskEdited: { ...state.fileTaskEdited, description: value }
                                  })
                                }}
                                onSubmit={(e) => {
              ...
              <div style={{ marginTop: '15px' }}>
                ...
                <ContentMaker
                  ...
                  onTextChange={(value, imgs) => {
                    setState({
                      ...state,
                      taskFiles: { ...state.taskFiles, description: value, descriptionDefault: null }
                    })
                  }}
                  disableSubmit={true}
                  onSubmit={(e) => {
          ...
          <div className={selected === 'logTimer' ? 'active tab-pane' : 'tab-pane'} id='logTimer'>
            ...
            {logTimer && (
              <ShowMoreShowLess id={`logTimer${id}`} styleShowMoreLess={{ display: 'inline-block', marginBottom: 15, marginTop: 15 }}>
          ...
          <div className={selected === 'historyLog' ? 'active tab-pane' : 'tab-pane'} id='historyLog'>
            {logs && (
              <ShowMoreShowLess id={`historyLog${id}`} styleShowMoreLess={{ display: 'inline-block', marginBotton: 15 }}>
                {logs.map((item, index) => (
                  <div key={item._id} className={`item-box ${index > 3 ? 'hide-component' : ''}`}>
                    <a style={{ fontWeight: 700, cursor: 'pointer' }}>
                      {item.creator?.name}{' '}
          ...
          <div className={selected === 'incoming-data' ? 'active tab-pane' : 'tab-pane'} id='incoming-data'>
            {task && task.process && (
              <React.Fragment>
                <IncomingDataTab taskId={task._id} preceedingTasks={task.preceedingTasks} />
              </React.Fragment>
            )}
          </div>
