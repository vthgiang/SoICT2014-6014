                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex' }}>
                    {taskOutput.status === 'approved' && (
                      <i className='fa fa-check text-success' style={{ display: 'flex', marginRight: '2px', placeItems: 'center' }}></i>
                    )}
                    <h4 className='title' style={{ fontSize: '16px', marginLeft: taskOutput.status !== 'approved' ? '15px' : 0 }}>
                      {taskOutput.title}
                    </h4>
                  </div>
                  <div
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '7px' }}>
                      ...
                      <div style={{ display: 'flex' }}>
                          ...
                          (taskOutput.status === 'waiting_for_approval' ||
                            ...
                            <div style={{ display: 'flex' }}>
                              {getActionAccountable(idUser, taskOutput.accountableEmployees) !== 'approve' && (
                                ...
                                >
                                  <i className='fa fa-check' aria-hidden='true'></i> Phê duyệt
                                </a>
                              )}
                              {getActionAccountable(idUser, taskOutput.accountableEmployees) !== 'reject' && (
                                ...
                                >
                                  <i className='fa fa-times' aria-hidden='true'></i> Từ chối
                                </a>
                              )}
                            </div>
                          )}
                        {taskOutput.versions?.length > 0 && (
                          <a
                            style={{ cursor: 'pointer', marginRight: '3px', paddingLeft: '15px' }}
                            onClick={async () => {
                              await setTaskOutput(taskOutput)
                              showVersionsTaskOutput(taskOutput)
                            }}
                          >
                            <i className='fa fa-history' aria-hidden='true'></i> Lịch sử giao nộp
                          </a>
                        )}
                        {role === 'responsible' &&
                            ...
                            editAction !== taskOutput._id && (
                              <React.Fragment>
                                ...
                                <ul className='list-inline' style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                                  <li className='text-sm' style={{ paddingRight: '10px', paddingLeft: '5px' }}>
                                  ...
                                  <li>
                                    ...
                                    >
                                      <i className='fa fa-paperclip' aria-hidden='true'></i> Tập tin đính kèm (
                                  ...
                                  <li>
                                    <a style={{ cursor: 'pointer' }} className='text-sm' onClick={() => handleShowComment(taskOutput._id)}>
                                      <i className='fa fa-comments-o margin-r-2' aria-hidden='true'></i> Trao đổi (
                                  ...
                                  <div style={{ cursor: 'pointer', margintop: '-10px' }}>
                                    <ul className='list-inline tool-level1'>
                                      {taskOutput.submissionResults.files.map((elem, index) => {
                                        let listImage = taskOutput.submissionResults.files
                                            ...
                                            {isImage(elem.name) ? (
                                              ...
                                              <div>
                                                ...
                                                <a href='#' onClick={() => showFilePreview(elem && elem.url)}>
                                                  <u>{elem && checkTypeFile(elem.url) ? <i className='fa fa-eye fa-1'></i> : ''}</u>
                                                </a>
                                              </div>
                                            )}
                                          </li>
                                ...
                                <div key={child._id}>
                                  ...
                                  {editComment !== child._id && (
                                    <div>
                                      ...
                                      <ul className='list-inline tool-level1'>
                                        <li>
                                          <span className='text-sm'>{<DateTimeConverter dateTime={child.createdAt} />}</span>
                                        </li>
                                                    ...
                                                    <div key={index} className='show-files-task'>
                                                      {isImage(elem.name) ? (
                                                        ...
                                                        <div style={{ marginTop: '2px' }}>
                                                          ...
                                                          <a href='#' onClick={() => showFilePreview(elem && elem.url)}>
                                                            <u>{elem && checkTypeFile(elem.url) ? <i className='fa fa-eye'></i> : ''}</u>
                                                          </a>
                                                        </div>
                                                      )}
                                                    </div>
