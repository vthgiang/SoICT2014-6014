...
import { DetailProjectTaskTab } from './detailProjectTaskTab';
...
class TaskProjectComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            taskId: null
...
const taskComponent = connect(mapState, actionCreators)(withTranslate(TaskProjectComponent));
export { taskComponent as TaskProjectComponent }
