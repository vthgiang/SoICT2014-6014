            ...
            setState(state => {
                return {
                    ...
                    newTemplate: {
                        ...
                        collaboratedWithOrganizationalUnits: props.savedTaskItem.collaboratedWithOrganizationalUnits.map(e => e.organizationalUnit._id),
        ...
        <React.Fragment>
            ...
            {showMore &&
                <div className="row">
                    ...
                    <div className={`${isProcess ? "col-lg-12" : "col-sm-6"}`}>
                        <InformationForm initialData={taskInformations} onDataChange={handleTaskInformationsChange} savedTaskAsTemplate={savedTaskAsTemplate} />
                    </div>
                </div>
            }
