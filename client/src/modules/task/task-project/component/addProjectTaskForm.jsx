...
const AddProjectTaskForm = (props) => {
  ...
  useEffect(() => {
    ...
    // })
    let preceedingTasksEndDateArr =
      newTask.preceedingTasks.map((preceedingItem) => {
    ...
    let preceedingMilestonesEndDateArr =
      newTask?.preceedingMilestones?.map((preceedingItem) => {
    ...
    ;(newTask.preceedingTasks.length > 0 || newTask.preceedingMilestones.length > 0) &&
      setState({
        ...state,
        newTask: {
          ...state.newTask,
