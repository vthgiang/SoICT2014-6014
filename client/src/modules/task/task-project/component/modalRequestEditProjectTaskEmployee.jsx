...
const ModalRequestEditProjectTaskEmployee = (props) => {
    ...
    const [state, setState] = useState({
        editTask: {
            ...
            currentResWeightArr: task?.responsibleEmployees?.map((resItem, resIndex) => {
                return {
                    userId: resItem._id,
                    weight: Number(task?.totalResWeight || 80) / task?.responsibleEmployees?.length,
                }
            }) || [],
            currentAccWeightArr: task?.accountableEmployees?.map((accItem, accIndex) => {
                return {
                    userId: accItem._id,
                    weight: Number(task?.totalResWeight ? (100 - Number(task?.totalResWeight)) : 20) / task?.accountableEmployees?.length,
                }
            }) || [],
            currentLatestStartDate: getMaxMinDateInArr(task?.preceedingTasks?.map((preceedingItem) => {
    ...
    const validateTaskStartDate = (value, willUpdateState = true) => {
        ...
        const taskItem = curStartDateTime && editTask.estimateNormalTime && {
    ...
    const save = async () => {
        ...
        const currentTask = {
            ...
            estimateNormalTime: Number(editTaskFormatted.estimateNormalTime) * (projectDetail.unitTime === 'days' ? MILISECS_TO_DAYS : MILISECS_TO_HOURS),
            estimateOptimisticTime: Number(editTaskFormatted.estimateOptimisticTime) * (projectDetail.unitTime === 'days' ? MILISECS_TO_DAYS : MILISECS_TO_HOURS),
        }
                ...
                <div>
                    {
                        ...
                        <div className="box">
                            <div className={`col-sm-4 col-md-4 col-xs-12`}>
                                ...
                                <fieldset className="scheduler-border">
                                    ...
                                    <div className="row">
                                        ...
                                        {currentTasksToChoose.preceeding.length > 0 &&
                                            <div className={`form-group col-md-12 col-xs-12 ${editTask.errorOnPreceedFollowTasks === undefined ? "" : "has-error"}`}>
                                ...
                                {/* Chi phí */}
                                {editTask.startDate.trim().length > 0 && editTask.endDate.trim().length > 0
                                    && editTask.responsibleEmployees.length > 0 && editTask.accountableEmployees.length > 0
                                    &&
                                    <fieldset className="scheduler-border">
                                        <legend className="scheduler-border">Ước lượng chi phí</legend>
                                        <div className={'row'}>
                                            {/* Chi phí ước lượng tài sản */}
                                            <div className={`col-lg-6 col-md-6 col-ms-12 col-xs-12 form-group ${editTask.errorOnAssetCode === undefined ? "" : 'has-error'}`}>
                                                <label className="control-label">Chi phí ước lượng tài sản<span className="text-red">*</span> ({projectDetail?.unitCost})</label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className={'row'}>
                                            ...
                                            <div className={`col-lg-6 col-md-6 col-ms-12 col-xs-12 form-group ${editTask.errorOnBudget === undefined ? "" : "has-error"}`}>
                                                <label>Chi phí thoả hiệp<span className="text-red">*</span> ({projectDetail?.unitCost})</label>
                                                <input
                                                    type="text"
                                                    className="form-control"
                            ...
                            <div className={`col-sm-8 col-md-8 col-xs-12`} >
                                    ...
                                    <div className="row form-group">
                                        ...
                                        <div className="row form-group">
                                            <div className={`col-lg-3 col-md-3 col-ms-12 col-xs-12 ${editTask.errorOnEndDate === undefined ? "" : "has-error"}`}>
                                                ...
                                                <div>
                                                    {state.editTask.endDate && state.editTask.estimateNormalTime && `${state.editTask.endDate} ${endTime}`}
                                                </div>
                                ...
                                <fieldset className="scheduler-border">
                                    ...
                                    <div className="row form-group">
                                        ...
                                        <div className={`col-lg-6 col-md-6 col-ms-12 col-xs-12 ${editTask.errorOnResponsibleEmployees === undefined ? "" : "has-error"}`}>
                                        ...
                                        <div className={`col-lg-6 col-md-6 col-ms-12 col-xs-12 ${editTask.errorOnAccountableEmployees === undefined ? "" : "has-error"}`}>
                                ...
                                <fieldset className="scheduler-border" style={{ lineHeight: 1.5 }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <div className={`col-md-12 ${editTask.errorOnTotalWeight === undefined ? "" : "has-error"}`}
                                    ...
                                    <table id="res-emp-weight-table" className="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            {(accountableEmployees && accountableEmployees.length !== 0) && currentAccWeightArr && currentAccWeightArr.length !== 0 &&
