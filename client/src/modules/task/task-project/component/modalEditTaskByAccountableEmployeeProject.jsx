            ...
            <div>
                <React.Fragment>
                    <DialogModal
                        size={75}
                        maxWidth={750}
                        modalID={hasAccountable ? `modal-edit-project-task-by-${role}-${id}` : `modal-edit-project-task-by-${role}-${id}-has-not-accountable`}
...
const modalEditTaskByAccountableEmployee = connect(mapStateToProps, actionGetState)(withTranslate(ModalEditTaskByAccountableEmployeeProject));
