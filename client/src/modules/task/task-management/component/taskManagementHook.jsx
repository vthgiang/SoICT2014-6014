import React, { Component, useEffect, useState, usePrevious } from 'react';
...
function TaskManagement(props) {
    ...
    const nextPage = async (pageTotal) => {
        let { organizationalUnit, status, priority, special, name, startDate, endDate, responsibleEmployees, accountableEmployees, creatorEmployees, perPage, creatorTime, projectSearch, tags } = state;
                ...
                <div className="box-body qlcv">
                    <div style={{ height: "40px", display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <div style={{ display: 'flex', marginBottom: 6 }}>
                            ...
                            {/* <button type="button" onClick={handleOpenModalImport} className="btn btn-success pull-right" title={translate('task.task_management.add_title')}>Thêm excel</button> */}
