      ...
      >
        <div className={` form-group ${errorOnFormula === undefined ? '' : 'has-error'}`}>
          <label className='control-label' htmlFor='inputFormula'>
            Công thức tính điểm đề xuất<span className='text-red'>*</span>
          </label>
          <div style={{ display: 'flex' }}>
            <input
              ...
              id='inputFormula'
              placeholder='averagePoint - 10 * numberOfTaskInprocess'
              value={formula}
          ...
          <br />
          <div>
            <span style={{ fontWeight: 800 }}>Ví dụ 1: </span>averagePoint - 10 * numberOfTaskInprocess
          </div>
          <div>
            <span style={{ fontWeight: 800 }}>Ví dụ 2: </span>averagePoint/numberOfTaskNotEvaluated - 5 * numberOfTaskInprocess
          </div>
          <br />
          <div>
            <span style={{ fontWeight: 600 }}>averagePoint</span> - Điểm trung bình các công việc kết thúc đã được đánh giá
          </div>
          <div>
            <span style={{ fontWeight: 600 }}>avgPointOfRelatedTask</span> - Điểm trung bình các công việc liên quan
          </div>
          <div>
            <span style={{ fontWeight: 600 }}>numberOfTaskNotEvaluated</span> - Công việc kết thúc chưa được đánh giá
          </div>
          <div>
            <span style={{ fontWeight: 600 }}>numberOfTaskInprocess</span> - Số lượng công việc đang tham gia
          </div>
          <div>
            <span style={{ fontWeight: 600 }}>numberOfRelatedTask</span> - Số lượng công việc có liên quan đã tham gia
          </div>
        </div>
        <div>
          <table id='proposal-table' className='table table-striped table-bordered table-hover'>
            ...
            <tbody>
              {tasks &&
                tasks.proposalPersonnel?.length !== 0 &&
