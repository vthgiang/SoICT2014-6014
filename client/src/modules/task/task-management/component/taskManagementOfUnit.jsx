  ...
  if (currentTasks && currentTasks.length !== 0) {
    ...
    for (let n in dataTemp) {
      data[n] = {
        ...
        organization: dataTemp[n].organizationalUnit
          ? dataTemp[n].organizationalUnit.name
          : translate('task.task_management.err_organizational_unit'),
        priority: convertPriorityData(dataTemp[n].priority),
        responsibleEmployees: dataTemp[n].responsibleEmployees ? (
          <ToolTip dataTooltip={dataTemp[n].responsibleEmployees.map((o) => o.name)} />
        ) : null,
        accountableEmployees: dataTemp[n].accountableEmployees ? (
          <ToolTip dataTooltip={dataTemp[n].accountableEmployees.map((o) => o.name)} />
        ) : null,
    ...
    for (let i in data) {
      ...
      if (
        (dataTemp[i].responsibleEmployees && dataTemp[i].responsibleEmployees.find((e) => e._id === userId)) ||
        (dataTemp[i].consultedEmployees && dataTemp[i].consultedEmployees.indexOf(userId) !== -1)
      ) {
        ...
        <div className='box'>
          <div className='box-body qlcv'>
            <div style={{ height: '40px', marginBottom: '10px' }}>
              ...
              >
                <i className='fa fa-list'></i> Dạng bảng
              </button>
