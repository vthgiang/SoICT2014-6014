    ...
    const validateAttributes = () => {
        ...
        if (attributes.length !== 0) {
            ...
            for (let n in attributes) {
                if (!ValidationHelper.validateEmpty(props.translate, attributes[n].attributeId).status || !ValidationHelper.validateEmpty(props.translate, attributes[n].value).status) {
                    result = false;
                    break;
                }
            }
