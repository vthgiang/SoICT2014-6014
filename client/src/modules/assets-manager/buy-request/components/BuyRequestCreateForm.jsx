...
class BuyRequestCreateForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            employeeNumber: "",
    ...
    validateEmployeeNumber = (value, willUpdateState = true) => {
        let msg = BuyRequestFormValidator.validateEmployeeNumber(value, this.props.translate)
        if (willUpdateState) {
            this.setState(state => {
                return {
                    ...state,
    ...
    save = () => {
        if (this.isFormValidated()) {
            return this.props.createNewBuyRequest(this.state);
        }
    }
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <ModalButton modalID="modal-create-buyrequest" button_name="Thêm mới phiếu" title="Thêm mới phiếu đề nghị" />
                <ModalDialog
                    size='75' modalID="modal-create-buyrequest" isLoading={buyRequest.isLoading}
                    formID="form-create-buyrequest"
                ...
                >
                    <form className="form-group" id="form-create-buyrequest">
                        <div className="col-md-12">
                            <div className="col-sm-6">
                                <div className={`form-group ${errorOnEmployeeNumber === undefined ? "" : "has-error"}`}>
                                    ...
                                    <input type="text" className="form-control" name="employeeNumber" value={employeeNumber} onChange={this.handleMSNVChange} autoComplete="off" placeholder="Mã phiếu" />
...
const actionCreators = {
    // createNewBuyRequest: BuyRequestActions.createNewBuyRequest,
};

const createForm = connect(mapState, actionCreators)(withTranslate(BuyRequestCreateForm));
export { createForm as BuyRequestCreateForm };
