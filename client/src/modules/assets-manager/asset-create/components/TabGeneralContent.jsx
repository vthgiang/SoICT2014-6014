...
class TabGeneralContent extends Component {
    ...
    handlePersonChange = (e) => {
        ...
        console.log('string2literal', this.string2literal(value));
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            placeholder="Chức vụ" name="position" autoComplete="off" disabled/>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6">
                                    <div className={`form-group`}>
                                        ...
                                        <select id="drops1" className="form-control" name="person" value={(this.props.asset.person !== undefined && Object.keys(this.props.asset.person).length) ? this.props.asset.person._id : 'init'}
                                            ...
                                            <option value={"null"} data-key1=''>Null</option>
                                            {user.list.length ? user.list.map((item, index) => {
                                                return (
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            value={this.state.userIndexPerson !== '' && user.list[this.state.userIndexPerson].roles.length ? user.list[this.state.userIndexPerson].roles[0].roleId.name : (this.props.asset.person !== undefined && Object.keys(this.props.asset.person).length) ? this.props.asset.person.position.name : ''}
                                            type="text" className="form-control"
                                            placeholder="Chức vụ" name="position1" autoComplete="off" disabled/>
                                    </div>
