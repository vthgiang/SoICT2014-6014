...
class DepreciationTab extends Component {
    ...
    render() {
        ...
        console.log('addMonthToEndDepreciation', usefulLife);
        return (
                    ...
                    <fieldset className="scheduler-border">
                        ...
                        <div className={`form-group ${errorOnStartDepreciation === undefined ? "" : "has-error"} `}>
                            ...
                            <DatePicker
                                ...
                                value={this.formatDate(startDepreciation)}
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" className="form-control" name="annualDepreciationValue" value={annualDepreciationValue}
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" className="form-control" name="monthlyDepreciationValue" value={monthlyDepreciationValue}
