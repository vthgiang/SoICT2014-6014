...
export function assetCrash(state =initState, action) {
    switch (action.type) {
        ...
        //         ...state,
        //         isLoading: false,
        //         listAssetCrashs: state.listAssetCrashs.filter(distributeTransfer => (distributeTransfer._id !== action.payload._id)),
        //     };
        // case AssetCrashConstants.UPDATE_ASSET_CRASH_SUCCESS:
        //     return {
        //         ...state,
        //         isLoading: false,
        //         listAssetCrashs: state.listAssetCrashs.map(distributeTransfer =>distributeTransfer._id === action.payload._id ?action.payload : distributeTransfer),
        //     };
