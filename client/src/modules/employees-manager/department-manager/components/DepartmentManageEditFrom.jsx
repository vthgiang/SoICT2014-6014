...
class DepartmentManageEditFrom extends Component {
    constructor(props) {
        super(props);
        this.state = {};
...
const editFrom = connect(mapState, actionCreators)(withTranslate(DepartmentManageEditFrom));
export { editFrom as DepartmentManageEditFrom };