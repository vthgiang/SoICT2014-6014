...
class ModalAddDiscipline extends Component {
    ...
    render() {
        ...
        const { startDate, reason, number, unit, type, errorOnEndDate, errorOnStartDate,
            errorOnNumber, errorOnUnit, errorOnType, errorOnReason } = this.state;
        return (
            <React.Fragment>
                <ModalButton modalID={`modal-create-discipline${id}`} button_name={translate('modal.create')} title={translate('discipline.add_discipline_title')} />
                <ModalDialog
