...
class ModalEditDiscipline extends Component {
    ...
    handleSunmit = async () => {
        ...
        window.$(`#modal-editNewDiscipline-${this.props.index}`).modal("hide");
    }
    render() {
        return (
            <div style={{ display: "inline" }}>
                <a href={`#modal-editNewDiscipline-${this.props.index}`} className="edit" title="Chỉnh sửa thông tin kỷ luật" data-toggle="modal"><i className="material-icons"></i></a>
                <div className="modal fade" id={`modal-editNewDiscipline-${this.props.index}`} tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
