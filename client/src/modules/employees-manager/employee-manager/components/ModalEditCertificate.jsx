...
class ModalEditCertificate extends Component {
    ...
    handleSubmit() {
        ...
        window.$(`#modal-editNewCertificate-${this.props.index}`).modal("hide");
    }
    render() {
        return (
            <div style={{ display: "inline" }}>
                <a href={`#modal-editNewCertificate-${this.props.index}`} className="edit" title="Chỉnh sửa thông tin bằng cấp" data-toggle="modal"><i className="material-icons"></i></a>
                <div className="modal fade" id={`modal-editNewCertificate-${this.props.index}`} tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div className="modal-body">
                                    <div className="col-md-12">
                                        ...
                                        <div className="form-group col-md-6" style={{ paddingRight: 0 }}>
                                            ...
                                            <select className="form-control" style={{height:34}} defaultValue="Đã chấp nhận" name="typeCertificate" defaultValue={this.state.typeCertificate} onChange={this.handleChange}>
