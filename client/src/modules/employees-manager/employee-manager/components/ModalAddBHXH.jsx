...
class ModalAddBHXH extends Component {
    ...
    handleCloseModale = () => {
        ...
        window.$(`#modal-addNewBHXH-${this.props.index}`).modal("hide");
    }
    handleSubmit = async () => {
        await this.setState({
        ...
        if (this.state.unit === "") {
            ...
            document.getElementById(`formBHXH-${this.props.index}`).reset();
            window.$(`#modal-addNewBHXH-${this.props.index}`).modal("hide");
        }
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="modal fade" id={`modal-addNewBHXH-${this.props.index}`} tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <button type="button" className="close" onClick={() => this.handleCloseModale()}>
                                    <span aria-hidden="true">×</span></button>
                                <h4 className="modal-title">Thêm mới quá trình đóng BHXH:</h4>
                            </div>
                            <form id={`formBHXH-${this.props.index}`}>
                                <div className="modal-body">
                                    <div className="col-md-12">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" defaultValue={this.state.unit} name="unit" onChange={this.handleChange} autoComplete="off" />
                                        </div>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button style={{ marginRight: 15 }} type="button" className="btn btn-success" onClick={() => this.handleSubmit()} title="Thêm mới quá trình đóng BHXH" >Thêm mới</button>
                                </div>
                            </form>
                        </div>
                    </div >
