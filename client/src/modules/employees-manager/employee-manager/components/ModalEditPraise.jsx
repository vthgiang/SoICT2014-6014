...
class ModalEditPraise extends Component {
    ...
    handleSunmit = async () => {
        ...
        window.$(`#modal-editPraise-${this.props.index}`).modal("hide");
    }
    render() {
        return (
            <div style={{ display: "inline" }}>
                <a href={`#modal-editPraise-${this.props.index}`} className="edit" title="Chỉnh sửa thông tin khen thưởng" data-toggle="modal"><i className="material-icons"></i></a>
                <div className="modal fade" id={`modal-editPraise-${this.props.index}`} tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
