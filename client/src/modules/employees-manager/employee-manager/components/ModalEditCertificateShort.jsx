...
class ModalEditCertificateShort extends Component {
    ...
    handleSubmit = async () => {
        ...
        window.$(`#modal-editNewCertificateShort-${this.props.index}`).modal("hide");

    }
    render() {
        return (
            <div style={{ display: "inline" }}>
                <a href={`#modal-editNewCertificateShort-${this.props.index}`} className="edit" title="Chỉnh sửa thông tin chứng chỉ" data-toggle="modal"><i className="material-icons"></i></a>
                <div className="modal fade" id={`modal-editNewCertificateShort-${this.props.index}`} tabIndex={-1} role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
