    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                // disableSubmit={false}
                >
                    <form className="form-group" id="form-view-employee">
...
const detailEmployee = connect(null, null)(withTranslate(ModalDetailEmployee));
export { detailEmployee as ModalDetailEmployee };