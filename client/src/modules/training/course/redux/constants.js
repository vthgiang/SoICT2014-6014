export const CourseConstants = {
    GET_LISTCOURSE_REQUEST: 'GET_LIST_COURSE_REQUEST',
    GET_LISTCOURSE_SUCCESS: 'GET_LIST_COURSE_SUCCESS',
    GET_LISTCOURSE_FAILURE: 'GET_LIST_COURSE_FAILURE',

    GET_COURSE_BY_EDUCATION_REQUEST: 'GET_COURSE_BY_EDUCATION_REQUEST',
    GET_COURSE_BY_EDUCATION_SUCCESS: 'GET_COURSE_BY_EDUCATION_SUCCESS',
    GET_COURSE_BY_EDUCATION_FAILURE: 'GET_COURSE_BY_EDUCATION_FAILURE',
