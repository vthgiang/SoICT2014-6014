                            ...
                            listCourses.map((x, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        <a onClick={() => handleEdit(x)} className="edit text-yellow" style={{ width: '5px' }} title={translate('training.course.edit_course')}><i className="material-icons">edit</i></a>
                                        <DeleteNotification
