    ...
    <div className='box'>
      <div className='box-body qlcv'>
        ...
        <div className='form-inline' style={{ marginBottom: 10 }}>
          ...
          <div className='form-group'>
            <label></label>
            <button type='button' className='btn btn-success' onClick={handleSunmitSearch}>
        ...
        <table id='education-table' className='table table-striped table-bordered table-hover'>
          <thead>
            <tr>
              <th style={{ textAlign: 'center' }} title={translate('training.education_program.education_program_code')}>
                {translate('training.education_program.table.program_code')}
              </th>
              <th style={{ textAlign: 'center' }} title={translate('training.education_program.education_program_name')}>
