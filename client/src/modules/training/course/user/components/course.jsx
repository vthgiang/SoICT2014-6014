...
import { CourseCreateForm, CourseDetailForm } from './combinedContent';
                            ...
                            listCourses.map((x, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        <a onClick={""} className="edit text-yellow" style={{ width: '5px' }} title={translate('training.course.register')}><i className="material-icons">edit</i></a>
                                    </td>
                                </tr>
                            ))
                        }
