...
class GoodIssueCreateForm extends Component {
    ...
    save =async () => {
        const { fromStock, code, type, status, users, approvers, customer, 
    ...
    render() {
        ...
        const { lots, listGood, good, code, approver, accountables, responsibles, qualityControlStaffs, status, customer, fromStock, 
            type, name, phone, email, address, errorStock, errorType, errorApprover, errorCustomer, errorQualityControlStaffs, errorAccountables, errorResponsibles } = this.state;
