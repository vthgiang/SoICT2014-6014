        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              className='form-control select2'
              style={{ width: '100%' }}
              items={[{ value: '8', text: translate('manage_warehouse.bill_management.billType.8') }]}
                        ...
                        <div className='timeline-index'>
                          ...
                          <div className='timeline-items'>
                            <div className='tooltip-abc-completed'>
                              <div className={'timeline-item active'}></div>
                            ...
                            <div className={`tooltip-abc${x.status === '1' ? '' : '-completed'}`}>
                              <div className={`timeline-item ${x.status === '1' ? '' : 'active'}`}></div>
                            ...
                            <div className={`tooltip-abc${props.checkRoleQualityControlStaffs(x) ? '' : '-completed'}`}>
                              <div className={`timeline-item ${props.checkRoleQualityControlStaffs(x) ? '' : 'active'}`}></div>
                            ...
                            <div className={`tooltip-abc${x.status !== '5' ? '' : '-completed'}`}>
                              <div className={`timeline-item ${x.status !== '5' ? '' : 'active'}`}></div>
