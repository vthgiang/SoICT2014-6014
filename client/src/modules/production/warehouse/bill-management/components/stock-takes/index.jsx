    ...
    return (
        <div id="bill-stock-takes">
            <div className="box-body qlcv">
                <ButtonModal modalID={`modal-create-new-takes-bill`} button_name={translate('manage_warehouse.good_management.add')} title={translate('manage_warehouse.good_management.add_title')} />
