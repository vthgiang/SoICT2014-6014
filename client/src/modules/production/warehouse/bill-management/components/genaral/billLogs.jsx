            ...
            <table className='table table-bordered'>
              <thead>
                <tr>
                  ...
                  <th title={translate('manage_warehouse.bill_management.updateror')}>
                    {translate('manage_warehouse.bill_management.updateror')}
                  </th>
                  <th title='version'>Version</th>
                  <th title={translate('manage_warehouse.bill_management.createAt')}>
                    {translate('manage_warehouse.bill_management.createAt')}
                  </th>
