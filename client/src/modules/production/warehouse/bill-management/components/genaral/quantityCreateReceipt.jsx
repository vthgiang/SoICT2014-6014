...
class QuantityCreateReceipt extends Component {
    constructor(props) {
        super(props);
        this.EMPTY_LOT = {
            lot: '',
    ...
    render() {
        ...
        const { errorLot, lot, errorQuantity, lots, name } = this.state;
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(QuantityCreateReceipt));