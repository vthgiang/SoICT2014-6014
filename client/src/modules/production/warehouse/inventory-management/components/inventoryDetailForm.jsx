              ...
              <fieldset className='scheduler-border'>
                ...
                <div className='form-inline'>
                  <div className='form-group'>
                    ...
                    <DatePicker id='date-history-start' dateFormat='month-year' value={startDate} onChange={handleChangeStartDate} />
                  </div>
                  <div className='form-group'>
                    <label className='form-control-static'>{translate('manage_warehouse.bill_management.to_date')}</label>
                    <DatePicker id='date-history-end' dateFormat='month-year' value={endDate} onChange={handleChangeEndDate} />
                  </div>
                  <div className='form-group'>
                    <button
                      type='button'
                ...
                <table className='table table-bordered' id={tableId}>
                  <thead>
                    <tr>
                      ...
                      <th title={translate('manage_warehouse.inventory_management.receipt')}>
                        {translate('manage_warehouse.inventory_management.receipt')}
                      </th>
                      <th title={translate('manage_warehouse.inventory_management.issue')}>
                        {translate('manage_warehouse.inventory_management.issue')}
                      </th>
                      <th title={translate('manage_warehouse.inventory_management.stock')}>
                        {translate('manage_warehouse.inventory_management.stock')}
                        <DataTableSetting tableId={tableId} setLimit={setLimit} />
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {typeof listBillByGood !== undefined &&
                      listBillByGood.length !== 0 &&
