        ...
        <React.Fragment>
            <div className="box">
                <div className="box-header with-border">
                    ...
                    <h3 className="box-title">{"Xem số lượng phiếu xuất cho từng nhóm khách hàng"}</h3>
                    <div className="form-inline">
                        <div className="form-group" style={{ display: 'flex', width: '30%' }}>
                            <label>{"Kho"}</label>
                            <SelectMulti
                                id={`select-multi-stock-customer-dashboard`}
                                multiple="multiple"
                        ...
                        <div className="form-group">
                            ...
                            <DatePicker
                                id="start-month-customer-dashboard"
                        ...
                        <div className="form-group">
                            ...
                            <DatePicker
                                id="end-month-customer-dashboard"
                                dateFormat="month-year"
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(CustomerDashboard));
