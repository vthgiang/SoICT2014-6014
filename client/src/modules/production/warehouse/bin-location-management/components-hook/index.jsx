    ...
    return (
        <div className="nav-tabs-custom">
            <ul className="nav nav-tabs">
                <li className="active"><a href="#bin-locations" data-toggle="tab" onClick={() => updateStateArchive()}>{translate('manage_warehouse.bin_location_management.bin_location')}</a></li>
                <li><a href="#bin-location-archives" data-toggle="tab" onClick={() => updateStateBinLocation()}>{translate('manage_warehouse.bin_location_management.archive')}</a></li>
            </ul>
