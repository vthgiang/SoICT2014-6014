...
function GoodWillIssue(props) {
    ...
    return (
        <React.Fragment>
            <h3 className="box-title" style={{ padding: "0.7em 25%" }}>{"Xem số lượng sẽ xuất kho của từng mặt hàng"}</h3>
...
export default connect(null, null)(withTranslate(GoodWillIssue));
