...
class GoodWillIssue extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default withTranslate(GoodWillIssue);