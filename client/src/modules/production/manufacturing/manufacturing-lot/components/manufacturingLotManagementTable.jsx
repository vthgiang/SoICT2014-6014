...
function ManufacturingLotManagementTable(props) {
  ...
  return (
    <React.Fragment>
      ...
      {<GoodReceiptCreateForm lotId={state.lotId} lot={state.currentLot} billCode={state.billCode} />}
      {state.currentRow && (
      ...
      <div className='box-body qlcv'>
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <input
              ...
              placeholder='LOT202011111'
              autoComplete='off'
            />
          </div>
          <div className='form-group'>
            <label>{translate('manufacturing.lot.created_at')}</label>
            <DatePicker id={`createdAt-manufacturing-lot`} value={createdAt} onChange={handleCreatedAtChange} disabled={false} />
          </div>
        </div>
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <input
              type='text'
              className='form-control'
              value={manufacturingCommandCode}
              onChange={handleManufacturingCommandCodeChange}
              placeholder='LSX202000001'
              autoComplete='off'
            />
          </div>
          <div className='form-group'>
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              multiple='multiple'
              options={{
                nonSelectedText: translate('manufacturing.lot.choose_status'),
                allSelectedText: translate('manufacturing.lot.choose_all')
              }}
              className='form-control select2'
              style={{ width: '100%' }}
              items={[
        ...
        <table id={tableId} className='table table-striped table-bordered table-hover'>
          ...
          <tbody>
            {listManufacturingLots &&
              listManufacturingLots.length !== 0 &&
              listManufacturingLots.map((lot, index) => (
                <tr key={index}>
                  ...
                  <td style={{ color: translate(`manufacturing.lot.${lot.status}.color`) }}>
                    {translate(`manufacturing.lot.${lot.status}.content`)}
                  </td>
                  <td style={{ textAlign: 'center' }}>
                    ...
                    {lot.status === 1 && (
                      <a
                        ...
                        title={translate('manufacturing.lot.create_bill')}
                        onClick={() => {
                          handleCreateGoodReceipt(lot)
                        }}
                      >
        ...
        {lots.isLoading ? (
          ...
          (typeof listManufacturingLots === 'undefined' || listManufacturingLots.length === 0) && (
