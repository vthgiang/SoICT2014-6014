  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <DialogModal
          modalID='modal-create-manufacturing-lot'
          ...
          <form id='form-create-manufacturing-lot'>
            ...
            <fieldset className='scheduler-border'>
              <legend className='scheduler-border'>
                {translate('manufacturing.lot.finished_product')}
                <span className='text-red'>*</span>
              </legend>
              <div className='form-group'>
                <label>
                  {translate('manufacturing.lot.code1')}
                  <span className='text-red'>*</span>
                </label>
              ...
              <div className={`form-group ${!errorQuantity1 ? '' : 'has-error'}`}>
                <label>
                  {translate('manufacturing.lot.quantity')} ({good && good.baseUnit})<span className='text-red'>*</span>
                </label>
            ...
            <fieldset className='scheduler-border'>
              ...
              <div className={`form-group ${!errorQuantity2 ? '' : 'has-error'}`}>
                <label>
                  {translate('manufacturing.lot.quantity')} ({good && good.baseUnit})
                </label>
              ...
              <div className='form-group'>
                <label>
                  {translate('manufacturing.lot.expiration_date')}
                  {quantity2 && <span className='text-red'>*</span>}
                </label>
                <DatePicker
