      ...
      <React.Fragment>
        {!NotHaveCreateButton && (
          <ButtonModal
            ...
            button_name={translate('manufacturing.purchasing_request.add_purchasing_request_button')}
            title={translate('manufacturing.purchasing_request.add_purchasing_request')}
          />
        )}
        <DialogModal
          modalID='modal-create-purchasing-request'
          isLoading={purchasingRequest.isLoading}
        ...
        >
          <form id='form-create-purchasing-request'>
            ...
            <div className={`form-group ${!errorDescription ? '' : 'has-error'}`}>
              <label>
                {translate('manufacturing.purchasing_request.description')}
                <span className='text-red'>*</span>
              </label>
                            ...
                            currentCommand.good.materials.map((x, index) => (
                              <tr key={index}>
                                ...
                                <td
                                  style={{
                                    color: translate(
                                      `manufacturing.command.materials_info.${this.checkInventoryMaterials(x, currentCommand)}.color`
                                    )
                                  }}
                                >
                                  {translate(
                                    `manufacturing.command.materials_info.${this.checkInventoryMaterials(x, currentCommand)}.content`
                                  )}
                                </td>
                              </tr>
                            ))}
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <a
                            ...
                            onClick={() => this.handleEditGood(good, index)}
                          >
                          ...
                          <a
                            ...
                            onClick={() => this.handleDeleteGood(good, index)}
                          >
                            <i className='material-icons'></i>
                          </a>
                        </td>
