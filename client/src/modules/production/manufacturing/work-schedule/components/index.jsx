    ...
    return (
        <div className="nav-tabs-custom">
            <ul className="nav nav-tabs">
                <li className="active"><a href="#list-manufacturing-mill-schedule" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>{translate('manufacturing.work_schedule.manufacturing_mill_schedule_list')}</a></li>
                <li ><a href="#list-workder-schedule" data-toggle="tab" onClick={() => forceCheckOrVisible(true, false)}>{translate('manufacturing.work_schedule.worker_schedule_list')}</a></li>
            </ul>
