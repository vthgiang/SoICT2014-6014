            ...
            <div className="box-body qlcv">
                <div className="form-inline">
                    <div className="form-group">
                        ...
                        <input type="text" value={code} className="form-control" onChange={handleCodeChange} placeholder="KH2020122212" autoComplete="off" />
                    </div>
                </div>
                <div className="form-inline">
                    <div className="form-group">
                                                        ...
                                                        if (command !== null && command.status)
                                                            return (
                                                                <td key={index3} className="tooltip-checkbox">
                                                                    ...
                                                                    <span className="tooltiptext"><a style={{ color: "white" }} onClick={() => handleShowDetailManufacturingCommand(command)}>{command.code}</a></span>
                                                                </td>
                                                            )
