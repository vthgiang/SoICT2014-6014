...
function WorkerScheduleManagementTable(props) {
  ...
  return (
    <React.Fragment>
      ...
      <div className='box-body qlcv'>
          ...
          {checkHasComponent('select-manufacturing-works') && (
            <div className='form-group'>
              ...
              <SelectMulti
                ...
                multiple='multiple'
                options={{
                  nonSelectedText: translate('manufacturing.work_schedule.all_works'),
                  allSelectedText: translate('manufacturing.work_schedule.all_works')
                }}
        ...
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <DatePicker id={`month-worker`} dateFormat={'month-year'} value={month} onChange={handleChangeMonth} disabled={false} />
          </div>
          <div className='form-group'>
      ...
      <div id='croll-table-worker' className='form-inline'>
        <div className='col-lg-6 col-md-6 col-sm-7 col-xs-8' style={{ padding: 0 }}>
          <table id={tableId} className='table table-bordered not-sort'>
            ...
            <tbody>
              {listWorkSchedulesWorker.length !== 0 &&
                listWorkSchedulesWorker.map((schedule, index) => {
        ...
        <div className='col-lg-6 col-md-6 col-sm-5 col-xs-4' style={{ padding: 0 }}>
          <table id='work-schedule-table-worker' className='table table-striped table-bordered table-hover not-sort'>
            ...
            <tbody>
              {listWorkSchedulesWorker.length !== 0 &&
                listWorkSchedulesWorker.map((schedule, index1) =>
      ...
      <SlimScroll
        outerComponentId='croll-table-worker'
        innerComponentId='work-schedule-table-worker'
