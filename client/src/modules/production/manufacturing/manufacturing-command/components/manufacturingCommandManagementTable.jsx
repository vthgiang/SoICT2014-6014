...
function ManufacturingCommandManagementTable(props) {
    ...
    const { code, accountables, planCode, createdAt, manufacturingOrderCode, fromDate, salesOrderCode, toDate, lotCode, status, tableId } = state;
    getUserArray();
    return (
        <React.Fragment>
            {
                <ManufacturingCommandDetailInfo
                    idModal={1}
                    commandDetail={state.commandDetail}
                    onReloadCommandTable={reloadCommandTable}
                />
            }
            {
                state.command &&
            ...
            <div className="box-body qlcv">
                <div className="form-inline">
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" value={code} onChange={handleCodeChange} placeholder="LSX202012245" autoComplete="off" />
                    </div>
                    <div className="form-group">
                ...
                <div className="form-inline">
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" value={planCode} onChange={handlePlanCodeChange} placeholder="KH202011122" autoComplete="off" />
                    </div>
                ...
                <div className="form-inline">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" value={salesOrderCode} onChange={handleSalesOrderCodeChange} placeholder="DKD202032210" autoComplete="off" />
                    </div>
                    <div className="form-group">
                ...
                <div className="form-inline">
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" value={lotCode} onChange={handleLotCodeChange} placeholder="LOSX202031233" autoComplete="off" />
                    </div>
                    <div className="form-group">
                            ...
                            listCommands.map((command, index) => (
                                <tr key={index}>
                                    ...
                                    <td style={{ textAlign: "center" }}>
                                        <a style={{ width: '5px' }} title={translate('manufacturing.command.command_detail')} onClick={() => { handleShowDetailManufacturingCommand(command) }}><i className="material-icons">view_list</i></a>
                                        {
                                        ...
                                        }
                                        {
                                            ...
                                            <a style={{ width: '5px', color: "green" }} title={translate('manufacturing.command.quality_control_command')} onClick={() => { handleQualityControlCommand(command) }}><i className="material-icons">thumb_up</i></a>
                                        }
                                        {
