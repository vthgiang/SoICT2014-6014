...
class QualityControlForm extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <DialogModal
                    modalID="modal-quality-control" isLoading={manufacturingCommand.isLoading}
                ...
                >
                    <form id="form-quality-control">
                        <div className="form-group">
                            <label>{translate('manufacturing.command.code')}<span className="text-red">*</span></label>
                            <input type="text" value={code} className="form-control" disabled={true}></input>
                        </div>
                        <div className="form-group">
                            <label>{translate('manufacturing.command.quality_control_status')}<span className="text-red">*</span></label>
                            <SelectBox
