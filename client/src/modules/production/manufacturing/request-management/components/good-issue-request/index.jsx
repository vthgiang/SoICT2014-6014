                ...
                <div className="form-inline">
                    <div className="form-group">
                        ...
                        <SelectMulti
                            ...
                            style={{ width: "100%" }}
                            items={[
                                { value: 1, text: translate('production.request_management.issue_request_to_manufacturing.1.content') },
                                { value: 2, text: translate('production.request_management.issue_request_to_manufacturing.2.content') },
                                { value: 3, text: translate('production.request_management.issue_request_to_manufacturing.3.content') },
                                { value: 4, text: translate('production.request_management.issue_request_to_manufacturing.4.content') },
                                { value: 5, text: translate('production.request_management.issue_request_to_manufacturing.5.content') },
                            ]}
