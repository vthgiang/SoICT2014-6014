                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div className="form-group">
                                ...
                                {currentRequest.status && <span style={{ color: translate(`production.request_management.issue_request_to_manufacturing.${currentRequest.status}.color`) }}>{translate(`production.request_management.issue_request_to_manufacturing.${currentRequest.status}.content`)}</span>}
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <fieldset className="scheduler-border">
                                ...
                                <table id="production-works-table" className="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
