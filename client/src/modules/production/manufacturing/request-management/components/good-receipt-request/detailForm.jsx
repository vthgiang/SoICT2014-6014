                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div className="form-group">
                                ...
                                {currentRequest.status && <span style={{ color: translate(`production.request_management.receipt_request_from_manufacturing.${currentRequest.status}.color`) }}>{translate(`production.request_management.receipt_request_from_manufacturing.${currentRequest.status}.content`)}</span>}
                            </div>
                        </div>
                    </div>
                    <div className="row">
