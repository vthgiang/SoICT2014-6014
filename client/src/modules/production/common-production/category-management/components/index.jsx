  ...
  return (
    <div className='nav-tabs-custom'>
      <ul className='nav nav-tabs'>
        <li className='active'>
          <a href='#category-table' data-toggle='tab' onClick={() => updateCategoryTable()}>
            {translate('manage_warehouse.bin_location_management.category_table')}
          </a>
        </li>
        <li>
          <a href='#category-tree' data-toggle='tab' onClick={() => updateCategoryTree()}>
            {translate('manage_warehouse.bin_location_management.category_tree')}
          </a>
        </li>
      </ul>
