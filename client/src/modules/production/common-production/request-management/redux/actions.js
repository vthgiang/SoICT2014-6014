...
function getAllRequestByCondition(query = {}) {
    return dispatch => {
        ...
        requestServices.getAllRequestByCondition(query)
            .then((res) => {
                dispatch({
...
function getDetailRequest(id) {
    return dispatch => {
        ...
        requestServices.getDetailRequest(id)
            .then((res) => {
                dispatch({
...
function editRequest(id, data) {
    return dispatch => {
        ...
        requestServices.editRequest(id, data)
            .then((res) => {
                dispatch({
...
function getNumberStatus(query) {
    return dispatch => {
        ...
        requestServices.getNumberStatus(query)
            .then((res) => {
                dispatch({
