...
import { DialogModal, ButtonModal, SelectBox } from "../../../../../common-components";
...
handleAddGood = () => {
  let {returnRuleOfGood, serviceLevelAgreementOfGood, nameOfGood, 
    baseUnitOfGood, priceOfGood, quantityOfGood, goods, goodId} = this.state;
  let good = {};
...
handleGoodEdit = (data) => {
  ...
  render() {
    let {description, stock, responsible, goods, 
      returnRule, serviceLevelAgreement, partner,
      returnRuleOfGood, serviceLevelAgreementOfGood, 
      nameOfGood, baseUnitOfGood, priceOfGood, quantityOfGood } = this.state;
    return (
      <React.Fragment>
        <DialogModal
          modalID={`modal-edit-material-purchase-order`} isLoading={false}
                  ...
                  {this.state.isChangeGood ? ( <>
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div className={"pull-right"} style={{ padding: 10 }}>
                        <button className="btn btn-success" style={{ marginLeft: "10px" }} disabled={!this.isGoodsValidated()} onClick={this.handleAddGood} >Lưu</button>
                    ...
                    <tbody id={`good-edit-manage-by-stock`}>
                      {
                        ...
                        goods.map((item, index) =>
                          <tr key={index}>
                            ...
                            <td>
                              <a className="edit text-yellow" onClick={()=>this.handleGoodEdit(item)}>
