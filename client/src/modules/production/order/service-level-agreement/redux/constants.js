export const SLAConstants = {
    ...
    GET_SLA_BY_GOOD_ID_REQUEST: 'GET_SLA_BY_GOOD_ID_REQUEST',
    GET_SLA_BY_GOOD_ID_SUCCESS: 'GET_SLA_BY_GOOD_ID_SUCCESS',
    GET_SLA_BY_GOOD_ID_FAILURE: 'GET_SLA_BY_GOOD_ID_FAILURE',
}