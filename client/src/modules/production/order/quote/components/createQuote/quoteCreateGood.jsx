            ...
            <div style={{ padding: 10, backgroundColor: 'white' }}>
              ...
              <div className='form-group'>
                ...
                <span style={{ float: 'right' }} className='text-red'>
                  {amountAfterApplyDiscount ? formatCurrency(Math.round((amountAfterApplyDiscount - originAmount) * 100) / 100) : `0 `}
                </span>
              </div>
              <div className='form-group'>
                <strong>Tổng tiền trước thuế: </strong>
                <span style={{ float: 'right' }}>{amountAfterApplyDiscount ? formatCurrency(amountAfterApplyDiscount) : `0 `}</span>
              </div>
              <div className='form-group'>
                <strong>Thuế: </strong>
                <span style={{ float: 'right' }}>
                  {amountAfterApplyTax ? formatCurrency(Math.round((amountAfterApplyTax - amountAfterApplyDiscount) * 100) / 100) : `0 `}
                </span>
              </div>
