export const TaxConstants = {
    ...
    GET_TAX_BY_GOOD_ID_REQUEST: 'GET_TAX_BY_GOOD_ID_REQUEST',
    GET_TAX_BY_GOOD_ID_SUCCESS: 'GET_TAX_BY_GOOD_ID_SUCCESS',
    GET_TAX_BY_GOOD_ID_FAILURE: 'GET_TAX_BY_GOOD_ID_FAILURE',
}