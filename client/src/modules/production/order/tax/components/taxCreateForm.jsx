        ...
        <React.Fragment>
            ...
            >
                {currentRow && (
                    <CreateTaxDetail
                        data={currentRow}
                        handleSubmitGoodChange={(dataChagneSubmit) => handleSubmitGoodChange(dataChagneSubmit)}
                    />
                )}
                            ...
                            {editGoodsTaxCollection ? (
                                <React.Fragment>
                                    <button
                                        ...
                                        onClick={handleCancelEditGoodTaxCollection}
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td style={{ textAlign: "center" }}>
                                                    <a
                                                        ...
                                                        className="edit"
                                                        title="Sửa"
                                                        onClick={() => handleEditGoodsTaxCollection(item, index)}
                                                    >
