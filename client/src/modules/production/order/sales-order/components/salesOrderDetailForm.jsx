...
function SalesOrderDetailForm(props) {
  const [state, setState] = useState({
    print: false
  })

  const getAmountAfterApplyTax = () => {
    let { goods } = props.salesOrderDetail
  ...
  const getFreeShipCost = () => {
    let maxFreeShip = 0
    let { discounts, shippingFee } = props.salesOrderDetail
    if (discounts) {
  ...
  const getCoinOfAll = () => {
    let coinOfAll = 0
    let { goods, discounts } = props.salesOrderDetail
  ...
  const getDiscountsValueSalesOrder = (amount) => {
    let amountAfterApplyTax = amount
    let { discounts } = props.salesOrderDetail
  ...
  const setCurrentDiscountOfSalesOrder = async (discountsOfSalesOrderDetail) => {
  ...
  const setCurrentManufacturingWorksOfGoods = async (manufacturingWorks, manufacturingPlan) => {
    await setState((state) => {
      return {
        ...state,
  ...
  if (props.salesOrderDetail._id) {
    salesOrderDetail = props.salesOrderDetail
  }
  ...
  if (props.salesOrderDetail._id) {
    ...
    discountsOfSalesOrder = getDiscountsValueSalesOrder(amountAfterApplyTax) // Chưa tính miễn phí vận chuyển và sử dụng xu
  }
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID={`modal-detail-sales-order-${props.modalID}`}
        isLoading={false}
        formID={`form-detail-sales-order-${props.modalID}`}
              ...
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12 quote-address' style={{ marginTop: '35px' }}>
                ...
                <div className='shopping-address-info'>
                  <div style={{ fontWeight: 600 }}>
                    {`${salesOrderDetail.customer ? salesOrderDetail.customer.name : ''} (${salesOrderDetail.customerPhone})`} &ensp;
                  </div>
                            ...
                            {item.manufacturingWorks ? (
                              ...
                              >
                                <a
                                  ...
                                  onClick={() => setCurrentManufacturingWorksOfGoods(item.manufacturingWorks, item.manufacturingPlan)}
                                >
              ...
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12 shopping-shipping'>
                ...
                <div className='shoppe-shipping-content'>
                  ...
                  <div className='shopping-shipping-time'>
                    ...
                    <div style={{ fontWeight: 500 }}>
                      {salesOrderDetail.deliveryTime ? formatDate(salesOrderDetail.deliveryTime) : 'Chưa có thời gian giao hàng dự kiến'}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12 shopping-discount'>
                  ...
                  <div className='shopping-apply-discounts'>
                    ...
                    <a
                      ...
                      onClick={() => setCurrentDiscountOfSalesOrder(salesOrderDetail.discounts)}
                    >
                      Xem chi tiết
                    </a>
                  </div>
