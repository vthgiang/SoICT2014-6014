...
function SalesOrderCreatePayment(props) {
  ...
  let discountsOfSalesOrder = getDiscountsValueSalesOrder(amountAfterApplyTax) // Chưa tính miễn phí vận chuyển và sử dụng xu
      ...
      <fieldset className='scheduler-border' style={{ background: '#f5f5f5' }}>
        ...
        <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12 shopping-quote-info'>
          ...
          <div className='shopping-quote-info-element'>
            <div style={{ fontWeight: 600 }}>Mã đơn &ensp;</div>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <a
                        ...
                        href={'#modal-edit-sales-order-discounts-of-good-detail'}
                    ...
                    <td>
                      ...
                      >
                        <a
                          ...
                          data-toggle='modal'
                          data-backdrop='static'
                          href={'#modal-edit-sales-order-slas-of-good-detail'}
