...
class AddManufacturingWorkForGood extends Component {
    ...
    render() {
        const { currentGood, currentManufacturingWorks, handleChangeManufacturingWorksForGood } = this.props;
        return (
            <DialogModal
                modalID="modal-edit-sales-order-and-add-manufacturing-for-good"
                isLoading={false}
                formID="form-edit-sales-order-and-add-manufacturing-for-good"
                title={"Yêu cầu sản xuất"}
                size="75"
                hasSaveButton={false}
                hasNote={false}
            >
                <form id="form-edit-sales-order-and-add-manufacturing-for-good">
                    ...
                    <div className={`form-group`}>
                        ...
                        <SelectBox
                            id={`select-manufacturing-works-sales-order-edit-after-approve`}
