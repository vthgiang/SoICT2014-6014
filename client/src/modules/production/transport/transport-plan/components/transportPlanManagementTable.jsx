...
function TransportPlanManagementTable(props) {
  ...
  return (
    ...
    <div className='box-body qlcv'>
      {checkHasComponent('create-transport-plan') && <TransportPlanGenerate transportPlan={transportPlan} />}
      {checkHasComponent('create-transport-plan') && (
        <TransportPlanCreateForm transportPlan={transportPlan} currentDateClient={getCurrentDate()} />
      )}
      ...
      <TransportPlanDetailInfo currentTransportPlan={currentTransportPlan} />
      ...
      <div className='form-inline'>
        ...
        <div className='form-group'>
          ...
          <DatePicker id={`search-plan-endDate`} value={formatDate(searchData?.endDate)} onChange={handleEndDateChange} disabled={false} />
        </div>
      </div>
      ...
      <table id={tableId} className='table table-striped table-bordered table-hover'>
        ...
        <tbody>
          {transportPlan &&
            transportPlan.lists &&
            transportPlan.lists.length !== 0 &&
            transportPlan.lists.map(
              (x, index) =>
                x && (
                  <tr key={index}>
      ...
      {transportPlan && transportPlan.isLoading ? (
        ...
        (typeof transportPlan.lists === 'undefined' || transportPlan.lists.length === 0) && (
