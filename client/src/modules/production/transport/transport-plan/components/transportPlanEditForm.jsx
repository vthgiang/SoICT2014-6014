...
function TransportPlanEditForm(props) {
  ...
  let { transportRequirements, currentDateClient, currentTransportPlan, reloadRequirementTable, reloadOtherEditForm, transportDepartment } =
    props
        ...
        <form id='form-create-transport-requirements'>
          <div className='nav-tabs-custom'>
            <ul className='nav nav-tabs'>
              <li className='active'>
                <a href='#plan-list-transport-requirement-edit' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Kế hoạch vận chuyển'}
                </a>
              </li>
              <li>
                <a href='#plan-transport-vehicle-carrier-edit' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Xếp kế hoạch vận chuyển'}
                </a>
              </li>
            </ul>
