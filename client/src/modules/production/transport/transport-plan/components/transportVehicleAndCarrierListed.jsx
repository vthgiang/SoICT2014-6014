...
function TransportVehicleAndCarrierListed(props) {
  ...
  useEffect(() => {
    if (indexListVehiclesCarriers) console.log(listVehicles)
    ...
    <div className='box-body qlcv'>
      <div className='form-inline'>
        <div className='form-group'>
          ...
          <DatePicker id={`start_date_2`} value={formatDate(date.startDate)} onChange={handleStartDateChange} disabled={false} />
        </div>
        <div className='form-group'>
          <label className='form-control-static'>Đến ngày: </label>
          <DatePicker id={`end_date_2`} value={formatDate(date.endDate)} onChange={handleEndDateChange} disabled={false} />
        </div>
      </div>
      <TransportVehicleCarrierListedChart
        ...
        setIndexClick={function setIndexClick(value) {
          setIndexListVehiclesCarriers(value)
        }}
      />
        ...
        <div className='box-body qlcv'>
          ...
          {listVehicles && listVehicles[indexListVehiclesCarriers] && listVehicles[indexListVehiclesCarriers].length !== 0 && (
            <table id={'1'} className='table table-striped table-bordered table-hover'>
              ...
              <tbody>
                {listVehicles[indexListVehiclesCarriers] &&
                  listVehicles[indexListVehiclesCarriers].length !== 0 &&
                  listVehicles[indexListVehiclesCarriers].map(
                    (x, index) =>
                      x && (
                        <tr key={index}>
                          <td>{index + 1}</td>
        ...
        <div className='box-body qlcv'>
          ...
          {listCarriers && listCarriers[indexListVehiclesCarriers] && listCarriers[indexListVehiclesCarriers].length !== 0 && (
            <table id={'2'} className='table table-striped table-bordered table-hover'>
              ...
              <tbody>
                {listCarriers[indexListVehiclesCarriers] &&
                  listCarriers[indexListVehiclesCarriers].length !== 0 &&
                  listCarriers[indexListVehiclesCarriers].map(
                    (x, index) =>
                      x && (
