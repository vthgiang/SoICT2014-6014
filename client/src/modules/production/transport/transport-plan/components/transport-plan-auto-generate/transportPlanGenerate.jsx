...
function TransportPlanGenerate(props) {
  ...
  const handleSubmitGenerate = () => {
    // console.log(listAll);
    let generatePlan = generatePlanFastestMove(
      listAll?.allRequirements,
      listAll?.allPlans,
      listAll?.allVehicles,
      listAll?.allCarriers,
      formSchedule.inDay,
        ...
        <form id='form-generate-transport-plans'>
          <div className='nav-tabs-custom'>
            <ul className='nav nav-tabs'>
              <li className='active'>
                <a href='#schedule' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Thống kê phương tiện và nhân viên'}
                </a>
              </li>
              <li>
                <a href='#select-requirement' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Chọn yêu cầu vận chuyển'}
                </a>
              </li>
              <li>
                <a href='#generate-plan' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Tạo kế hoạch'}
                </a>
              </li>
            </ul>
            <div className='tab-content'>
              <div className='tab-pane active' id='schedule'>
                <TransportVehicleCarrier2 transportPlan={transportPlan} />
              </div>

              <div className='tab-pane' id='select-requirement'>
                <TransportPlanRequirement transportPlan={transportPlan} callBackListRequirements={callBackListRequirements} />
              </div>
              ...
              <div className='tab-pane' id='generate-plan'>
                ...
                <div className='box-body'>
                  <TransportPlanDetailInfo currentTransportPlan={currentPlan} idPlan={idPlan} />
                    ...
                    <div className='box-body qlcv'>
                      ...
                      <table id={'tableId'} className='table table-striped table-bordered table-hover'>
                        ...
                        <tbody>
                          ...
                          {listPlanGenerate &&
                            listPlanGenerate.length !== 0 &&
                            listPlanGenerate.map(
                              (x, index) =>
                                x && (
                                  <tr key={index}>
                                    <td>{index + 1}</td>
                                    ...
                                    <td style={{ textAlign: 'center' }}>
                                      ...
                                      <a
                                        className='edit text-light-blue'
                                        style={{ width: '5px' }}
                                        title={'Lưu kế hoạch'}
                    ...
                    <div className='box box-solid'>
                      ...
                      <div className='box-body qlcv'>
                        <table id={'unavailable-requirement'} className='table table-striped table-bordered table-hover'>
                          ...
                          <tbody>
                            {listUnavailableRequirement.map(
                              (x, index) =>
                                x && (
                                  <tr key={index}>
