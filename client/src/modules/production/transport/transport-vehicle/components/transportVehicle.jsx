...
function TransportVehicle(props) {
  ...
  const selectVehicle = (index) => {
    ...
    if (index === 0) {
      setstate1((state1) => [value, ...state1.slice(1)])
    } else setstate1((state1) => [...state1.slice(0, index), value, ...state1.slice(index + 1)])
  }
                    ...
                    vehicle && (
                      <tr key={index}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          ...
                          <a className='text-green' onClick={() => handleChooseVehicle(vehicle)}>
