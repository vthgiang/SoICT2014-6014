...
function TransportVehical(props) {
...
const connectedTransportVehical = connect(mapState, actions)(withTranslate(TransportVehical));
export { connectedTransportVehical as TransportVehical };