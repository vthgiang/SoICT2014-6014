...
function ArrangeVehiclesAndGoods(props) {
    ...
    <React.Fragment>
      <div className='box-body qlcv'>
        <div className='form-inline'>
          ...
          <div className='form-group'>
            <button type='button' className='btn btn-success' title='Lưu' onClick={handleSubmitDistribution}>
              Lưu
            </button>
          </div>
        </div>
        ...
        {currentTransportPlan && currentTransportPlan._id !== '0' && allTransportVehicle && allTransportVehicle.length !== 0 && (
            ...
            <table className={'tableTest table-bordered table-hover not-sort'}>
              <thead>
                ...
                <tr className='word-no-break'>
                  {allTransportVehicle &&
                    allTransportVehicle.length !== 0 &&
                    allTransportVehicle.map((item, index) => item && <td>{'Payload: ' + item.vehicle.payload}</td>)}
                </tr>
                <tr className='word-no-break'>
                  {allTransportVehicle &&
                    allTransportVehicle.length !== 0 &&
                    allTransportVehicle.map((item, index) => item && <td>{'Volume: ' + item.vehicle.volume}</td>)}
                </tr>
              </thead>
  ...
  return (
    <div className='box-body qlcv'>
      <DataTableSetting tableId={'999'} setLimit={10} />
