  ...
  return (
    <React.Fragment>
      <div className='box-body qlcv'>
        ...
        <div>
          {!(transportVehicles && transportVehicles.length !== 0) && <label>{'Cần phân phối hàng hóa lên xe trước'}</label>}
          {transportVehicles &&
            transportVehicles.length !== 0 &&
            transportVehicles.map(
              (item, index) =>
                item.transportRequirements &&
                item.transportRequirements.length !== 0 && (
