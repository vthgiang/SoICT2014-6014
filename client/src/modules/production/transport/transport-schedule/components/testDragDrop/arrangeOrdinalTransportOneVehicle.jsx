...
import {
  reverseConvertDistanceToKm,
  convertDistanceToKm,
  reverseConvertTimeToMinutes,
  convertTimeToMinutes
} from '../../../transportHelper/convertDistanceAndDuration'
        ...
        <div className='col-xs-12 col-sm-12 col-md-5 col-lg-5' style={{ padding: '0px' }}>
          ...
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              ...
              {item.transportVehicle.name}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              <strong>{'Trọng tải: '}</strong>
              {item.transportVehicle.payload}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              <strong>{'Thể tích thùng chứa: '}</strong>
              {item.transportVehicle.volume}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              <strong>{'Tổng quãng đường di chuyển: '}</strong>
              {getTotalDistance()}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              <strong>{'Tổng thời gian di chuyển: '}</strong>
              {getTotalTime()}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              <strong>{'Trọng lượng hàng hóa lớn nhất đạt: '}</strong>
              {payloadVolumeStatus.maxPayload + '- tại địa điểm ' + payloadVolumeStatus.posMaxPayload}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
              <strong>{'Thể tích hàng hóa lớn nhất đạt: '}</strong>
              {payloadVolumeStatus.maxVolume + '- tại địa điểm ' + payloadVolumeStatus.posMaxVolume}
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className='form-group'>
