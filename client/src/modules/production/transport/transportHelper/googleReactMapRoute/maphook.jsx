  ...
  withGoogleMap((props) => (
    <GoogleMap defaultCenter={props.defaultCenter} defaultZoom={props.defaultZoom}>
      ...
      {props.locations.map((item, index) => {
        return (
          index !== 0 && (
            <MapDirectionsRenderer places={[props.locations[index - 1], item]} travelMode={window.google.maps.TravelMode.DRIVING} />
          )
        )
      })}
...
const MapContainer = (props) => {
  ...
  console.log(locations, ' 123 day la locations')
  return (
    <Map
      googleMapURL={
      ...
      defaultCenter={defaultCenter || { lat: 21.0969807, lng: 105.7340742 }}
