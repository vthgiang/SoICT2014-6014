...
function TransportDetailNewOne(props) {
  ...
  return (
    <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12' style={{ padding: '0px' }}>
      <p>
        <strong>{'Địa điểm nhận hàng: '} &emsp; </strong> {state.fromAddress}
      </p>
      <p>
        <strong>{'Chi tiết: '} &emsp; </strong> {state.detail1}
      </p>
      <p>
        <strong>{'Địa điểm giao hàng: '} &emsp; </strong> {state.toAddress}
      </p>
      <p>
        <strong>{'Chi tiết: '} &emsp; </strong> {state.detail2}
      </p>
    </div>
  )
}
