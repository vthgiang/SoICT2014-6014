...
function TransportImportGoods(props) {
  let { currentBill, callBackGeneralInfo, manufacturingWorks } = props
    ...
    if (currentBill) {
      ...
      if (currentBill.manufacturingMill) {
        if (currentBill.manufacturingMill.manufacturingWorks) {
          let worksId = currentBill.manufacturingMill.manufacturingWorks.id
            ? currentBill.manufacturingMill.manufacturingWorks.id
            : currentBill.manufacturingMill.manufacturingWorks
              ...
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12' style={{ padding: 0 }}>
                <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                  <div className={`form-group`}>
                    ...
                    <input type='text' className='form-control' disabled={false} value={formValue.millCode} />
                  </div>
                </div>
                <div className='col-xs-12 col-sm-8 col-md-8 col-lg-8'>
                  <div className='form-group'>
                    ...
                    <input type='text' className='form-control' disabled={false} value={formValue.millName} />
                  </div>
                </div>
              </div>
              <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                <div className={`form-group`}>
                  ...
                  <input type='text' className='form-control' value={formValue.worksCode} />
                </div>
              </div>
              <div className='col-xs-12 col-sm-8 col-md-8 col-lg-8'>
                <div className='form-group'>
                  ...
                  <input type='text' className='form-control' disabled={false} value={formValue.worksName} />
                </div>
              </div>
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                <div className={`form-group`}>
                  ...
                  <textarea type='text' className='form-control' value={formValue.worksAddress} />
                </div>
              </div>
            </fieldset>
          </div>
              ...
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12' style={{ padding: 0 }}>
                ...
                <div className='col-xs-12 col-sm-8 col-md-8 col-lg-8'>
                  <div className='form-group'>
                    ...
                    <input type='text' className='form-control' disabled={false} value={formValue.stockName} />
                  </div>
                </div>
              </div>
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
