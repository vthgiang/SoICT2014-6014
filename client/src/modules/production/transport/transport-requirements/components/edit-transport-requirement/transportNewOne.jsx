  ...
  useEffect(() => {
    if (curentTransportRequirementDetail) {
      setFormInfo({
        ...
        newOneDetail1: curentTransportRequirementDetail.detail1,
        newOneDetail2: curentTransportRequirementDetail.detail2
      })
    }
        ...
        <fieldset className='scheduler-border' style={{ height: '100%' }}>
          ...
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className={`form-group`}>
              ...
              <textarea type='text' className='form-control' value={formInfo.newOneDetail1} onChange={handlecustomer1DetailChange} />
            </div>
          </div>
        </fieldset>
      </div>
      ...
      <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6' style={{ paddingRight: 0 }}>
        <fieldset className='scheduler-border' style={{ height: '100%' }}>
          ...
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
            <div className={`form-group`}>
              <label>Chi tiết</label>
              <textarea type='text' className='form-control' value={formInfo.newOneDetail2} onChange={handlecustomer2DetailChange} />
            </div>
          </div>
        </fieldset>
      </div>
