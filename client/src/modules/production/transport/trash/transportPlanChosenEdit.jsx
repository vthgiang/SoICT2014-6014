...
function TransportPlanChosenEdit(props) {
  let { allTransportPlans, currentRequirementId, currentTransportPlan, currentTransportRequirement } = props
        ...
        <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              ...
              <fieldset className='scheduler-border' style={{ height: '100%' }}>
                ...
                <form id={`form-edit-example-hooks`}>
                  <table id={'6666'} className='table table-striped table-bordered table-hover'>
                    ...
                    <tbody>
                      {allTransportPlans &&
                        allTransportPlans.length !== 0 &&
                        allTransportPlans.map(
                          (item, index) =>
                            item && (
                              <tr key={index}>
                                <td>{index + 1}</td>
                                ...
                                <td style={{ textAlign: 'center' }}>
                                  ...
                                  <a className='text-green' onClick={() => handleSelectPlan(item._id)}>
                          ...
                          (item, index) =>
                            item && (
                              <tr key={index}>
                                ...
                                <td>{formatDate(item.endTime)}</td>
                                <td>
                                  <a className='text-green' onClick={() => handleSelectPlan(item)}>
                                    <i className='material-icons'>add_comment</i>
                                  </a>
                                </td>
                              </tr>
          ...
          <div className='col-xs-12 col-sm-12 col-md-12 col-lg-6'>
            <fieldset className='scheduler-border' style={{ height: '100%' }}>
              ...
              <MapContainer locations={placeGeocode} />
            </fieldset>
          </div>
        </div>
