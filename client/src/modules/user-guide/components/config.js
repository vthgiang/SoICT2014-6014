...
export const UserGuideKpi = {
    ...
    manager: [
        ...
        },
        {
            ...
            fileName: 'thongkekpidonvi.pdf',
            url: '/upload/user-guide/kpi/thongkekpidonvi.pdf',
        },
    ]
}


export const UserGuideAsset = {
    user: [
        {
            pageName: "Tài sản quản lý",
            fileName: 'taisanquanly.pdf',
    ...
    manager: [
        {
            pageName: "Quản lý thông tin tài sản",
            fileName: 'quanlythongtintaisan.pdf',
            url: '/upload/user-guide/asset/quanlythongtintaisan.pdf',
        },
        {
            pageName: "Quản lý đăng ký sử dụng",
            fileName: 'quanlydangkysudungtb.pdf',
            url: '/upload/user-guide/asset/quanlydangkysudungtb.pdf',
        },
        {
            pageName: "Quản lý đề nghị mua sắm",
            fileName: 'quanlydenghimuasam.pdf',
            url: '/upload/user-guide/asset/quanlydenghimuasam.pdf',
        },
        {
            pageName: "Dashboard quản lý tài sản",
            fileName: 'dashboardqlts.pdf',
            url: '/upload/user-guide/asset/dashboardqlts.pdf',
        },
    ]
}
...
export const UserGuideSystem = [
    {
        ...
        fileName: 'cauhinhhethong.pdf',
        url: '/upload/user-guide/system/cauhinhhethong.pdf',
    },
    {
        pageName: "Sơ dồ cơ cấu tổ chức",
        fileName: 'sodococautochuc.pdf',
        url: '/upload/user-guide/system/sodococautochuc.pdf',
    },
    {
        pageName: "Quản lý trang",
        fileName: 'quanlytrang.pdf',
        url: '/upload/user-guide/system/quanlytrang.pdf',
    },
    {
        pageName: "Quản lý phân quyền",
        fileName: 'quanlyphanquyen.pdf',
        url: '/upload/user-guide/system/quanlyphanquyen.pdf',
    },
    {
        pageName: "Quản lý người dùng",
        fileName: 'quanlynguoidung.pdf',
        url: '/upload/user-guide/system/quanlynguoidung.pdf',
    },
    {
        pageName: "Quản lý component",
        fileName: 'quanlycomponent.pdf',
        url: '/upload/user-guide/system/quanlycomponent.pdf',

    },
    { 
        pageName: "Sao lưu, phục hồi",
        fileName: 'backup.pdf',
        url: '/upload/user-guide/system/backup.pdf',
    },
]
