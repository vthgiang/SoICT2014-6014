    ...
    case DocumentConstants.CREATE_DOCUMENT_SUCCESS:
      return {
        ...
        administration: {
          ...
          data: {
            ...state.administration.data,
            list: [action.payload, ...state.administration.data.list],
            paginate: [...state.administration.data.paginate, action.payload]
          }
        }
      }
    ...
    case DocumentConstants.CREATE_DOCUMENT_CATEGORY_SUCCESS:
      return {
        ...
        administration: {
          ...
          categories: {
            ...state.administration.categories,
            list: [action.payload, ...state.administration.categories.list],
            paginate: [action.payload, ...state.administration.categories.paginate]
          }
        }
      }
