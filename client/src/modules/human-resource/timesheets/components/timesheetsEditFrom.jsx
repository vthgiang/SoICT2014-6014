...
const TimesheetsEditForm = (props) => {
    ...
    const save = () => {
        ...
        props.updateTimesheets(_id, { ...state, month: monthNew, timekeepingByHours: timekeepingByHours, timekeepingByShift: { shift1s: shift1s, shift2s: shift2s, shift3s: shift3s } });
    }
    ...
    const { _id, errorOnEmployeeNumber, errorOnMonthSalary, month, employeeNumber, timekeepingType,
        allDayOfMonth, shift1s, shift2s, shift3s, timekeepingByHours, totalHoursOff, totalOvertime } = state;
