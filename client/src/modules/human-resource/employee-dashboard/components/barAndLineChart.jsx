                    ...
                    <div className="box-body dashboard_box_body">
                        ...
                        <div className="box-tools pull-right">
                            <div className="btn-group pull-rigth">
                                <button type="button" className={`btn btn-danger btn-xs ${lineBar === false ? 'btn-danger' : null}`} onClick={() => this.handleChangeViewChart(true)}>Bar and line chart</button>
                                <button type="button" className={`btn btn-danger btn-xs ${lineBar === true ? 'btn-danger' : null}`} onClick={() => this.handleChangeViewChart(false)}>Line chart</button>
                            </div>
                        </div>
                        <div ref="chart"></div>
                    </div>
