...
const MultipleBarChart = (props) => {
  ...
  useEffect(() => {
    setState({
      ...
      data2: ['data2', 13.5, 13.5, 13.5, 12.5, 11.5, 13.5, 10.5, 13.5, 13.5, 11.5, 13.5, 9.5],
      data3: ['data3', 11.5, 12.5, 19.5, 13.5, 13.5, 14.5, 13.5, 10.5, 13.5, 13.5, 12.5, 13.5]
    })
  }, [props, state])
        ...
        <div className='box-body dashboard_box_body'>
          ...
          <div className='box-tools pull-right'>
            <div className='btn-group pull-rigth'>
              <button
                type='button'
                className={`btn btn-xs ${lineBar === false ? 'btn-danger' : null}`}
              ...
              <button
                type='button'
                className={`btn btn-xs ${lineBar === true ? 'btn-danger' : null}`}
