...
const PraiseEditForm = (props) => {
    ...
    const isFormValidated = () => {
        ...
        let result = validateOrganizationalUnit(organizationalUnit, false) && validateType(type, false) &&
            validateReason(reason, false) && validateStartDate(startDate, false);
        return result;
    }
    ...
    const { employeeNumber, startDate, reason, decisionNumber, organizationalUnit, type, errorOnStartDate,
        errorOnOrganizationalUnit, errorOnType, errorOnReason } = state;
