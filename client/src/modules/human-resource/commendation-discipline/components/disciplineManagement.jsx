            ...
            <div className="box-body qlcv">
                ...
                <div className="form-inline" style={{ marginBottom: 10 }}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" name="type" onChange={handleChange} placeholder={translate('human_resource.commendation_discipline.discipline.table.discipline_forms')} autoComplete="off" />
                    </div>
                    {/* Nút tìm kiếm */}
                    <div className="form-group">
                        <label></label>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            <a onClick={() => handleEdit(x)} className="edit text-yellow" style={{ width: '5px' }} title={translate('human_resource.commendation_discipline.discipline.edit_discipline')}><i className="material-icons">edit</i></a>
                                            <DeleteNotification
