  ...
  const handleImportExcel = (value, checkFileImport) => {
    ...
    if (checkFileImport) {
      ...
      value = value.map((x, index) => {
        ...
        if (x.orgUnit === null) errorAlert = [...errorAlert, 'Đơn vị không được để trống']
        ...
        <form className='form-group' id={`form_import_file`}>
          ...
          <div className='row'>
            ...
            <div className='form-group col-md-4 col-sm-12 col-xs-12'>
              ...
              <DatePicker id='import-salary-month' dateFormat='month-year' deleteValue={false} value='' onChange={handleMonthChange} />
            </div>
          </div>
          <div className='row'>
            {/* File import */}
