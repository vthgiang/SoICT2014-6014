                ...
                <div className="form-inline">
                    ...
                    <div className="dropdown pull-right" style={{ marginBottom: 15 }}>
                        ...
                        <ul className="dropdown-menu pull-right" style={{ marginTop: 0 }}>
                            <li><a style={{ cursor: 'pointer' }} title={translate('human_resource.salary.add_by_hand_title')} onClick={createSalary}>
                                {translate('human_resource.salary.add_by_hand')}</a></li>
                            <li><a style={{ cursor: 'pointer' }} title={translate('human_resource.salary.add_import_title')} onClick={_importSalary}>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            <a onClick={() => handleEdit(x)} className="edit text-yellow" style={{ width: '5px' }} title={translate('human_resource.salary.edit_salary')}><i className="material-icons">edit</i></a>
                                            <DeleteNotification
