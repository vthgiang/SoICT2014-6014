...
export function employeesManager(state = initState, action) {
  switch (action.type) {
    ...
    case EmployeeConstants.GETALL_SUCCESS:
      if (action.exportData) {
      ...
      } else if (action.payload.totalList !== undefined) {
        // Phải để khác undefined
        return {
          ...state,
        ...
        return {
          ...
          totalEmployeeOfOrganizationalUnits:
            action.payload.totalEmployee !== undefined ? action.payload.totalEmployee : state.totalEmployeeOfOrganizationalUnits,

          listEmployeesOfOrganizationalUnits:
            action.payload.listEmployeesOfOrganizationalUnits !== undefined
              ? action.payload.listEmployeesOfOrganizationalUnits
              : state.listEmployeesOfOrganizationalUnits,

          totalAllEmployee: action.payload.totalAllEmployee !== undefined ? action.payload.totalAllEmployee : state.totalAllEmployee,

          listAllEmployees: action.payload.listAllEmployees !== undefined ? action.payload.listAllEmployees : state.listAllEmployees,
