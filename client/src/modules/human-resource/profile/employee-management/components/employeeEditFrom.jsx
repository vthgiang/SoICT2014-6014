...
class EmployeeEditFrom extends Component {
    ...
    save = async () => {
        let { _id, experiences, degrees, certificates, contracts, files, avatar,
            disciplines, commendations, salaries, annualLeaves, socialInsuranceDetails, courses, career, major } = this.state;
    ...
    render() {
        ...
        let { _id, img, employee, degrees, certificates, socialInsuranceDetails, contracts, courses,
            organizationalUnits, roles, commendations, disciplines, salaries, annualLeaves, files, major, career } = this.state;
        return (
            <React.Fragment>
                <DialogModal
