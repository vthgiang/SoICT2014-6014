...
class EmployeeExperienceImportForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            limit: 1,
                ...
                <div id={id} className="tab-pane">
                    <div className="box-body">
                        <div className=" row col-md-12">
                            ...
                            <ConFigImportFile
                                id="import_employees_experience_config"
...
const importExperience = connect(null, null)(withTranslate(EmployeeExperienceImportForm));
export { importExperience as EmployeeExperienceImportForm };