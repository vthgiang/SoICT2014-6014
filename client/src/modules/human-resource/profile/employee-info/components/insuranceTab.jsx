    ...
    <div id={id} className='tab-pane'>
      <div className='box-body'>
        <fieldset className='scheduler-border'>
          ...
          <ExportExcel
            id='detail-export-bhxh'
            buttonName={translate('human_resource.name_button_export')}
            exportData={exportData}
            style={{ marginBottom: 10 }}
          />
          <h4 className='col-md-6' style={{ paddingLeft: 0, fontSize: 16 }}>
            {translate('human_resource.profile.bhxh_process')}:
          </h4>
        ...
        <fieldset className='scheduler-border'>
          ...
          <div className='row'>
            ...
            <div className='form-group col-md-6'>
              ...
              {healthInsuranceAttachment &&
                healthInsuranceAttachment.map((obj, index) => (
                  <li key={index}>
