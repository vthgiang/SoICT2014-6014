...
function AnnualLeaveEditModal(props) {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='50'
        modalID={`modal-edit-sabbatical-${id}`}
        isLoading={false}
        ...
        <form className='form-group' id={`form-edit-sabbatical-${id}`}>
          ...
          <div className='row'>
            ...
            <div className={`form-group col-sm-6 col-xs-12 ${errorOnStartDate && 'has-error'}`}>
              ...
              <DatePicker id={`edit_start_date${id}`} deleteValue={false} value={startDate} onChange={handleStartDateChange} />
              {type && (
                <TimePicker
            ...
            <div className={`form-group col-sm-6 col-xs-12 ${errorOnEndDate && 'has-error'}`}>
              ...
              <DatePicker id={`edit_end_date${id}`} deleteValue={false} value={endDate} onChange={handleEndDateChange} />
              {type && (
                <TimePicker
                  id={`edit_end_time${id}`}
                  ref={editEndTime}
