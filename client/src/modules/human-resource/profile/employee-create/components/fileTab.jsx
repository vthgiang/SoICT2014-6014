        ...
        <div id={id} className="tab-pane">
            <div className=" row box-body">
                ...
                <div className="col-md-4">
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" name="archivedRecordNumber" value={archivedRecordNumber ? archivedRecordNumber : ''} onChange={handleChange} placeholder={translate('human_resource.profile.attachments_code')} autoComplete="off" />
                    </div>
                </div>
                ...
                <div className="col-md-12">
                    ...
                    <button style={{ marginTop: 2, marginBottom: 10, marginRight: 15 }} type="submit" className="btn btn-primary pull-right" onClick={defaulteClick} title={translate('human_resource.profile.add_default_title')}>{translate('human_resource.profile.add_default')}</button>
                            ...
                            {files && files.length !== 0 &&
                                files.map((x, index) => {
                                    return <tr key={index}>
                                        ...
                                        <td >
                                            <a onClick={() => handleEdit(x, index)} className="edit text-yellow" style={{ width: '5px', cursor: 'pointer' }} title={translate('human_resource.profile.edit_file')}><i className="material-icons">edit</i></a>
                                            <a className="delete" title="Delete" data-toggle="tooltip" onClick={() => handleDeleteFile(index)} style={{ cursor: 'pointer' }}><i className="material-icons"></i></a>
                                        </td>
                                    </tr>
                                }
            ...
            </div>
            {
                ...
                <div className=" box-footer">
                    <button type="reset" disabled={!isFormValidated()} className="btn btn-success col-md-2 pull-right btnuser" onClick={() => props.handleSubmit()}>{translate('human_resource.profile.add_staff')}</button>
                </div>
            }
