...
function GeneralTab(props) {
  ...
  useEffect(() => {
    if (
      ...
      !state.employeeTimesheetId &&
      props.employee &&
      props.employee.employeeNumber &&
      props.employee.employeeTimesheetId
    ) {
      setState((state) => {
        return {
          ...state,
    ...
    if (value) {
      ...
      if (leavingDate) {
        ...
        if (date.getTime() >= d.getTime()) {
          ...
          errorOnLeavingDate =
            errorOnLeavingDate === translate('human_resource.profile.leaving_date_after_starting_date') ? undefined : errorOnLeavingDate
        }
      }
    } else {
    ...
    <div id={id} className='tab-pane active'>
      <div className='row box-body'>
        ...
        <div className='col-lg-4 col-md-4 col-ms-12 col-xs-12' style={{ textAlign: 'center' }}>
          <div>{img && <ApiImage className='attachment-img avarta' src={img} />}</div>
        ...
        <div className='pull-right col-lg-8 col-md-8 col-ms-12  '>
          {id === 'page_general' && (
            <div className='row col-lg-12 col-md-12 col-ms-12 col-xs-12'>
              <p>
                (<span className='text-red'>*</span>): <span className='text-red'>{translate('modal.note')}</span>
              </p>
            </div>
          )}
          ...
          <div className='row'>
            ...
            <div className={`form-group col-lg-6 col-md-6 col-ms-12 col-xs-12 ${errorOnEmployeeNumber && 'has-error'}`}>
              <label>
                {translate('human_resource.profile.staff_number')}
            ...
            <div className={`form-group col-lg-6 col-md-6 col-ms-12 col-xs-12`}>
              ...
              <input
                type='text'
                className='form-control'
                placeholder={translate('human_resource.profile.attendance_code')}
                name='employeeTimesheetId'
                value={employeeTimesheetId}
                onChange={handleMSCCChange}
                autoComplete='off'
              />
            </div>
          </div>
          <div className='row'>
            ...
            <div className={`form-group col-lg-6 col-md-6 col-ms-12 col-xs-12 ${errorOnFullName && 'has-error'}`}>
              <label htmlFor='fullname'>
                {translate('human_resource.profile.full_name')}
                <span className='text-red'>*</span>
              </label>
              <input
                type='text'
          ...
          <div className='row'>
            ...
            <div className={`form-group col-lg-6 col-md-6 col-ms-12 col-xs-12 `}>
              ...
              <DatePicker id={`brithday${id}`} value={birthdate} onChange={handleBrithdayChange} />
            </div>
            {/* Nơi sinh */}
            <div className='form-group col-lg-6 col-md-6 col-ms-12 col-xs-12'>
          ...
          <div className='row'>
            ...
            <div className={`form-group col-lg-4 col-md-4 col-ms-12 col-xs-12`}>
              ...
              <input
                type='email'
                className='form-control'
                placeholder={translate('human_resource.profile.email_company')}
                name='emailInCompany'
                value={emailInCompany}
                onChange={handleEmailCompanyChange}
                autoComplete='off'
              />
            </div>
            ...
            <div className={`form-group col-lg-4 col-md-4 col-ms-12 col-xs-12 ${errorOnLeavingDate && 'has-error'}`}>
              ...
              <DatePicker id={`leavingDate${id}`} value={leavingDate} onChange={handleLeavingDateChange} />
          ...
          <div className='row'>
            ...
            <div className={`form-group col-lg-4 col-md-4 col-ms-12 col-xs-12`}>
              ...
              <input
                ...
                placeholder={translate('human_resource.profile.id_card')}
                autoComplete='off'
              />
            </div>
            {/* Ngày cấp */}
            ...
            <div className={`form-group col-lg-4 col-md-4 col-ms-12 col-xs-12`}>
              ...
              <input
                ...
                value={identityCardAddress}
                onChange={handleAddressCMNDChange}
                placeholder={translate('human_resource.profile.issued_by')}
                autoComplete='off'
              />
            </div>
          </div>
