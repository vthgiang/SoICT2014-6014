...
function DisciplineAddModal(props) {
  /**
  ...
  const isFormValidated = () => {
    const { decisionNumber, type, organizationalUnit, reason, startDate, endDate } = state
    let result =
  ...
  return (
    <React.Fragment>
      <ButtonModal
        modalID={`modal-create-discipline${id}`}
        ...
        <form className='form-group' id={`form-create-discipline${id}`}>
          ...
          <div className='row'>
            ...
            <div className={`col-sm-6 col-xs-12 form-group ${errorOnStartDate && 'has-error'}`}>
              ...
              <DatePicker id={`create_discipline_start_date${id}`} deleteValue={false} value={startDate} onChange={handleStartDateChange} />
            ...
            <div className={`col-sm-6 col-xs-12 form-group ${errorOnEndDate && 'has-error'}`}>
              ...
              <DatePicker id={`create_discipline_end_date${id}`} deleteValue={true} value={endDate} onChange={handleEndDateChange} />
