      ...
      <div className='box-body'>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.bank_account')}</h4>
          </legend>
          <div className='row'>
            {/* Số tài khoản */}
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                name='atmNumber'
                value={atmNumber ? atmNumber : ''}
                onChange={handleChange}
                placeholder={translate('human_resource.profile.account_number')}
                autoComplete='off'
              />
            </div>
            {/* Tên ngân hàng */}
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder={translate('human_resource.profile.bank_name')}
                autoComplete='off'
              />
            </div>
            {/* Chi nhánh */}
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                className='form-control'
                name='bankAddress'
                value={bankAddress ? bankAddress : ''}
                onChange={handleChange}
                placeholder={translate('human_resource.profile.bank_branch')}
                autoComplete='off'
              />
            </div>
          </div>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.personal_income_tax')}</h4>
          </legend>
          {/* Mã số thuế */}
          <div className='form-group'>
            ...
            <input
              ...
              onChange={handleNumberTaxChange}
              placeholder={translate('human_resource.profile.tax_number')}
              autoComplete='off'
            />
          </div>
          {/* Người đại diện */}
          <div className='form-group'>
            ...
            <input
              type='text'
              className='form-control'
              name='taxRepresentative'
              value={taxRepresentative ? taxRepresentative : ''}
              onChange={handleUserTaxChange}
              placeholder={translate('human_resource.profile.representative')}
              autoComplete='off'
            />
          </div>
          {/* Ngày hoạt động */}
          ...
          <div className='form-group'>
            ...
            <input
              ...
              className='form-control'
              name='taxAuthority'
              value={taxAuthority ? taxAuthority : ''}
              onChange={handleUnitTaxChange}
              placeholder={translate('human_resource.profile.managed_by')}
              autoComplete='off'
            />
          </div>
        </fieldset>
