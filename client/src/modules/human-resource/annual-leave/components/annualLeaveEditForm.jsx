...
function AnnualLeaveEditForm(props) {
    ...
    const { _id, employeeNumber, organizationalUnit, startDate, endDate, reason, status,
        errorOnReason, errorOnStartDate, errorOnEndDate, endTime, startTime, totalHours, errorOnTotalHours, type } = state;
    ...
    const save = () => {
        ...
        if (isFormValidated()) {
            return props.updateAnnualLeave(_id, { ...state, startTime: startTime, endTime: endTime, startDate: startDateNew, endDate: endDateNew, approvedApplication: true });
        }
    }
