...
class LineBarChartDetailForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            collapseChart: false,
    ...
    render() {
        const { dataForAxisXInChart, startDate, endDate, id, barLineChartData, collapseChart } = this.state;
