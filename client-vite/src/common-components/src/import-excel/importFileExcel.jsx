                    ...
                    for (let key in configData) {
                      ...
                      if (key !== 'sheets' && key !== 'rowHeader' && key !== 'file' && Array.isArray(config.value)) {
                        ...
                        if (
                          ...
                          x.toString().trim().toLowerCase() === config.value.toString().trim().toLowerCase()
                        ) {
                          if (config.colspan) {
                            let arr = []
    ...
    return (
      <React.Fragment>
        ...
        <UploadFile
          ...
          callFunctionDeleteFile={this.props.callFunctionDeleteFile}
          deleteValue={true}
          importFile={this.handleChangeFileImport}
          disabled={disabled}
