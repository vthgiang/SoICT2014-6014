            ...
            <div className='form-group'>
              ...
              <SelectBox
                ...
                items={
                  columns !== undefined
                    ? columns.map((column) => {
                        return { value: column.value, text: column.title }
                      })
                    : []
                }
            ...
            <div className='form-group'>
              ...
              {option === 'type' ? (
                ...
                <input
                  ...
                  type='text'
                  onKeyUp={this.handleEnterLimitSetting}
                  placeholder={translate('searchByValue')}
                  onChange={this.handleChangeInput}
                />
              )}
              <button type='button' className='btn btn-success' onClick={this.search} title={translate('form.search')}>
