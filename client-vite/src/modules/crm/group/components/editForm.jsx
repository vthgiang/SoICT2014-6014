...
function EditGroupForm(props) {
  ...
  const isFormValidated = () => {
    ...
    if (!ValidationHelper.validateName(translate, code).status || !ValidationHelper.validateDescription(translate, name).status)
      return false
    return true
  }
  ...
  if (
    ...
    groups.groupById.groupById._id &&
    editingGroup._id != groups.groupById.groupById._id
  )
    setEdittingGroup(groups.groupById.groupById)

  return (
    <React.Fragment>
      <DialogModal
        modalID='modal-edit-group'
        ...
        <form id='form-crm-group-edit'>
          ...
          <div className={`form-group ${!groupCodeEditFormError ? '' : 'has-error'}`}>
            ...
            <input
              ...
              value={editingGroup.code ? editingGroup.code : ''}
          ...
          <div className={`form-group ${!groupNameEditFormError ? '' : 'has-error'}`}>
            ...
            <input
              type='text'
              className='form-control'
              value={editingGroup.name ? editingGroup.name : ''}
          ...
          <div className='form-group'>
            ...
            <textarea
              type='text'
              value={editingGroup.description ? editingGroup.description : ''}
              className='form-control'
