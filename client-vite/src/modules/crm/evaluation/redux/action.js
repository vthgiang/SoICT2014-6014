...
function getEvaluations(data) {
  return (dispatch) => {
    ...
    CrmEvaluationServices.getEvaluations(data)
      ...
      .catch((err) => {
        dispatch({ type: CrmEvaluationConstants.GET_CRM_EVALUATIONS_FAILE })
      })
  }
}
function getCustomerCareInfoByEmployee() {
  return (dispatch) => {
    ...
    CrmEvaluationServices.getCustomerCareInfoByEmployee()
      ...
      .catch((err) => {
        dispatch({ type: CrmEvaluationConstants.GET_CRM_CARE_INFO_BY_EMPLOYEE_FAILE })
      })
  }
}
function getCustomerCareInfoByUnit() {
  return (dispatch) => {
    ...
    CrmEvaluationServices.getCustomerCareInfoByUnit()
      ...
      .catch((err) => {
        dispatch({ type: CrmEvaluationConstants.GET_CRM_CARE_INFO_BY_UNIT_FAILE })
      })
  }
}
