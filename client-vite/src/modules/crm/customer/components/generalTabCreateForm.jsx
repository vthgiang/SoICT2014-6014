                  ...
                  {listStatus &&
                    ...
                    listStatus.map((o, index) => (
                      <div
                        ...
                        onClick={() => handleChangeCustomerStatus(index)}
                      >
            ...
            <div className='col-md-6'>
              <div className={`form-group ${!customerNameError ? '' : 'has-error'}`}>
                ...
                <input
                  ...
                  placeholder={translate('crm.customer.name')}
                />
                ...
                <div className='col-md-6'>
                  <div className={`form-group`}>
                    ...
                    <input
                      ...
                      onChange={handleChangeRepresent}
              ...
              <div className='row'>
                ...
                <div className='col-md-6'>
                  <div className={`form-group`}>
                    ...
                    <DatePicker id='birth-form-create' value={birth ? birth : ''} onChange={handleChangeCustomerBirth} disabled={false} />
                  </div>
                </div>
              </div>
            </>
            ...
            <div className='col-md-6'>
              <div className={`form-group`}>
                ...
                <input
                  ...
                  placeholder={translate('crm.customer.mobilephoneNumber')}
                />
              </div>
            </div>
            ...
            <div className='col-md-6'>
              <div className={`form-group`}>
                ...
                <input
                  ...
                  placeholder={translate('crm.customer.email')}
                />
              </div>
            </div>
          </div>
            ...
            <div className='col-md-6'>
              <div className={`form-group`}>
                ...
                <input
                  ...
                  placeholder={translate('crm.customer.address')}
                />
              </div>
            </div>
            ...
            <div className='col-md-6'>
              <div className={`form-group`}>
                ...
                <input
                  ...
                  placeholder={translate('crm.customer.telephoneNumber')}
                />
              </div>
            </div>
          </div>
            ...
            <div className='col-md-6'>
              <div className={`form-group ${!customerTaxNumberError ? '' : 'has-error'}`}>
                ...
                <input
                  ...
                  placeholder={translate('crm.customer.taxNumber')}
                />
            ...
            <div className='col-md-6'>
              <div className='form-group'>
                ...
                <input
                  ...
                  onChange={handleChangeCustomerWebsite}
                  placeholder={translate('crm.customer.website')}
                />
              </div>
            </div>
          </div>
            ...
            <div className='col-md-6'>
              <div className={`form-group`}>
                ...
                <input
                  type='text'
                  className='form-control'
                  value={customerSource ? customerSource : ''}
                  onChange={handleChangeCustomerSource}
