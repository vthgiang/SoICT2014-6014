      ...
      <div className='form-inline'>
        <div className='dropdown pull-right'>
          ...
          <button
            ...
            disabled={categoryParent.length > 1 ? true : false}
            onClick={handleSave}
          >
          ...
          <ul className='dropdown-menu pull-right'>
            <li>
              <a
                href='#modal-create-category-good'
                title='Add category'
                onClick={(event) => {
            ...
            <li>
              <a
                ...
                onClick={() => {
                  window.$('#import_category').modal('show')
                }}
              >
      ...
      <div className='row'>
        <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
          <div className='category-tree' id='category-tree'>
            <Tree id='tree-qlcv-category-good' onChanged={onChanged} checkNode={checkNode} unCheckNode={unCheckNode} data={dataTree} />
          </div>
        </div>
        <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
          {currentCategory && (
