...
function CreateForm(props) {
  ...
  const {
    ...
    billSelected,
    dataLots,
    returnQuantityErrorPosition,
    returnQuantityErrorOnTable
  } = state
  let dataSource = [
    {
      value: '0',
          ...
          <fieldset className='scheduler-border'>
            ...
            <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
              ...
              <div className={`form-group ${!errorBill ? '' : 'has-error'}`}>
                <label>
                  {translate('manage_warehouse.bill_management.choose_bill')}
                  <span className='text-red'> * </span>
                </label>
                <div>
                  ...
                  <div className='col-md-4 col-lg-4'>
                    <p type='button' className='btn btn-info' style={{ marginLeft: '10px' }} onClick={() => selectBill()}>
                      {translate('manage_warehouse.bill_management.choose_bill')}
                    </p>
                  </div>
                </div>
                  ...
                  {typeof dataLots === 'undefined' || dataLots.length === 0 ? (
                    ...
                    dataLots.map((x, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <div
                            className={`form-group ${parseInt(returnQuantityErrorPosition) === index && returnQuantityErrorOnTable ? 'has-error' : ''} `}
                          >
                            <input
