                ...
                <table className='table table-bordered'>
                  <thead>
                    <tr>
                      ...
                      <th title={translate('manage_warehouse.bin_location_management.type')}>
                        {translate('manage_warehouse.bin_location_management.type')}
                      </th>
                  ...
                  <tbody id={`good-edit-manage-by-archive`}>
                    {typeof enableGoods === 'undefined' || enableGoods.length === 0 ? (
                      <tr>
                        <td colSpan={4}>
                      ...
                      enableGoods.map((x, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            {x.contained} {x.good ? x.good.baseUnit : ''}
                          </td>
                          <td>
                            {x.capacity} {x.good ? x.good.baseUnit : ''}
                          </td>
                        </tr>
                      ))
                    )}
