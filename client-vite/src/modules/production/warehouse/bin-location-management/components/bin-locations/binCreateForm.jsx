...
function BinCreateForm(props) {
  ...
  const isValidated = () => {
    let result = validateCode(state.binCode, false) && validateName(state.binName, false) && validateDepartment(state.binDepartment, false)
        ...
        <form id={`form-create-bin-location`}>
          <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
            ...
            <div className={`form-group ${!errorStock ? '' : 'has-error'}`}>
              <label>
                {translate('manage_warehouse.bin_location_management.stock')}
                <span className='text-red'> * </span>
              </label>
              <SelectBox
            ...
            <div className={`form-group ${!errorDepartment ? '' : 'has-error'}`}>
              <label>
                {translate('manage_warehouse.bin_location_management.department')}
                <span className='text-red'> * </span>
              </label>
              <SelectBox
            ...
            <div className={`form-group`}>
              <label>
                {translate('manage_warehouse.bin_location_management.unit')}
                <span className='text-red'> * </span>
              </label>
          ...
          <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
            <div className={`form-group ${!errorName ? '' : 'has-error'}`}>
              <label>
                {translate('manage_warehouse.bin_location_management.name')}
                <span className='text-red'> * </span>
              </label>
            ...
            <div className={`form-group`}>
              <label>
                {translate('manage_warehouse.bin_location_management.management_location')}
                <span className='text-red'> * </span>
              </label>
              <SelectBox
            ...
            <fieldset className='scheduler-border'>
              ...
              <div className='pull-right' style={{ marginBottom: '10px' }}>
                {state.editInfo ? (
                  ...
                  <button className='btn btn-success' style={{ marginLeft: '10px' }} disabled={!isGoodsValidated()} onClick={handleAddGood}>
