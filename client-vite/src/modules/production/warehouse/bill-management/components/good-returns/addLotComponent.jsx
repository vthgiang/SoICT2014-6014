                    ...
                    <tr key={index}>
                      ...
                      <td>
                        {parseInt(x.returnQuantity) - parseInt(x.passedQuantity) > 0
                          ? parseInt(x.returnQuantity) - parseInt(x.passedQuantity)
                          : 'Không có hàng hóa không đạt kiểm định, hàng sẽ được nhập vào lô cũ'}
                      </td>
                      {checkLots(x.lots, parseInt(x.returnQuantity) - parseInt(x.passedQuantity)) ? (
                        ...
                        <td>
                          {parseInt(x.returnQuantity) - parseInt(x.passedQuantity) == 0 ? 'Không có hàng hóa không đạt' : 'Chưa đánh lô'}
                        </td>
                      )}
                      <td>
                        {parseInt(x.returnQuantity) - parseInt(x.passedQuantity) > 0 && (
