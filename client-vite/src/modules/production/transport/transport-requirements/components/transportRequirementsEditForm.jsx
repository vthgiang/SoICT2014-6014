...
function TransportRequirementsEditForm(props) {
  ...
  const save = async () => {
    ...
    if (!(requirementsForm.geocode?.fromAddress?.lat && requirementsForm.geocode?.fromAddress?.lng)) {
      await getGeocode(requirementsForm.fromAddress).then((value) => {
    ...
    if (!(requirementsForm.geocode?.toAddress?.lat && requirementsForm.geocode?.toAddress?.lng)) {
      await getGeocode(requirementsForm.toAddress).then((value) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <form
          id='modal-edit-example-hooks'
          // onSubmit={() => save(translate('manage_example.add_success'))}
        >
          <div className='nav-tabs-custom'>
            <ul className='nav nav-tabs'>
              <li className='active'>
                <a href='#list-transport-plan' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Thông tin chung'}
                </a>
              </li>
              <li>
                <a href='#list-arrange-plan' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
                  {'Địa chỉ điểm giao và nhận hàng'}
                </a>
              </li>
            ...
            <div className='tab-content'>
              <div className='tab-pane active' id='list-transport-plan'>
                ...
                <div className='box-body qlcv'>
                  ...
                  <TransportGoods goods={curentTransportRequirementDetail?.goods} callBackState={callBackGoodsInfo} />
                  <TransportTime
