          ...
          <fieldset className='scheduler-border' style={{ height: '100%' }}>
            ...
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <div className={`form-group`}>
                ...
                <textarea type='text' className='form-control' value={location?.fromAddress} onChange={handleCustomer1AddressChange} />
              </div>
            </div>
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <div className={`form-group`}>
            ...
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                <div className={`form-group`}>
                  ...
                  <textarea type='text' className='form-control' value={location?.toAddress} onChange={handleCustomer2AddressChange} />
                </div>
              </div>
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                <div className={`form-group`}>
                  <label>Tọa độ</label>
                  <input type='text' className='form-control' disabled={true} value={location?.toLat + ', ' + location?.toLng} />
                </div>
              </div>
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                <MapContainer
