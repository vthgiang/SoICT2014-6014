...
function TransportDetailRoute(props) {
  ...
  useEffect(() => {
    if (transportPlan && currentVehicleRoute && transportPlan.currentTransportPlan) {
      let vehicle = transportPlan.currentTransportPlan.transportVehicles.filter(
        (r) => String(r.vehicle) === currentVehicleRoute?.transportVehicle?._id
      )
                  ...
                  (routeOrdinal, index) =>
                    routeOrdinal && (
                      <tr key={index}>
                        ...
                        <td>
                          {routeOrdinal.transportRequirement?.type ? getTypeRequirement(routeOrdinal.transportRequirement.type) : ' '}
                        </td>
                        <td>
                        ...
                        <td>{getTransportStatus(routeOrdinal)}</td>
