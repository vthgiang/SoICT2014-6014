...
const ActionCreateForm = (props) => {
  const { translate, user, onKpiChange } = props
  ...
  const isFormValidated = () => {
    if (!action.name || !action.description || !action.target || !action.responsibles || !action.startDate || !action.endDate) {
      return false
    }
        ...
        <div className='row'>
          <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
            <div className='form-group'>
              ...
              <input type='text' className='form-control' name='name' value={action.name} onChange={handleActionInputChange} />
            </div>
          </div>
          <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
            <div className='form-group'>
          ...
          <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
            <div className='form-group'>
              ...
              <input type='text' className='form-control' name='target' value={action.target} onChange={handleActionInputChange} />
            </div>
          </div>
            ...
            <thead>
              <tr>
                ...
                <th style={{ width: '40px' }} className='text-center'>
                  <a className='text-green' onClick={handleAddMileStone}>
