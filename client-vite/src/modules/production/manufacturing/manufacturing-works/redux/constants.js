export const worksConstants = {
  ...
  GET_ALL_EMPLOYEE_ROLES_REQUEST: 'GET_ALL_EMPLOYEE_ROLES_REQUEST',
  GET_ALL_EMPLOYEE_ROLES_SUCCESS: 'GET_ALL_EMPLOYEE_ROLES_SUCCESS',
  GET_ALL_EMPLOYEE_ROLES_FAILURE: 'GET_ALL_EMPLOYEE_ROLES_FAILURE'
}
