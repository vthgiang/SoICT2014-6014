                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <a
                            ...
                            onClick={() => {
                              this.handleShowDetailSalesOrder(x)
                            }}
                          >
                ...
                {listGoods && listGoods.length === 0 ? (
                  ...
                  listGoods.map((x, index) => (
                    <tr key={index}>
                      ...
                      <td>{x.quantity}</td>
                      <td>
                        <a href='#abc' className='edit' title={translate('general.edit')} onClick={() => this.handleEditGood(x, index)}>
                          <i className='material-icons'></i>
                        </a>
                        <a href='#abc' className='delete' title={translate('general.delete')} onClick={() => this.handleDeleteGood(index)}>
                          <i className='material-icons'></i>
                        </a>
                      </td>
                    </tr>
