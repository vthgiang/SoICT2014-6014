  ...
  getWorkerBusyInCurrentArrayWorkerSchedules = () => {
    ...
    for (let i = 0; i < arrayWorkerSchedules.length; i++) {
      for (let j = 0; j < arrayAllWorkerSchedules.length; j++) {
        if (
          arrayWorkerSchedules[i].index1 === arrayAllWorkerSchedules[j].index1 &&
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <a
                            ...
                            onClick={() => this.handleShowCommandHistory(command.good._id)}
                          >
                        ...
                        <td>
                          <a
                            ...
                            style={{ width: '5px' }}
                            title={translate('manufacturing.plan.schedule_booking')}
              ...
              <fieldset className='scheduler-border'>
                ...
                <div className='row'>
                  <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                    <div className={`form-group ${!manufacturingMillError ? '' : 'has-error'}`}>
                      <label>
                        {translate('manufacturing.plan.choose_mill')}
                  ...
                  <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                    <div className={`form-group`}>
                      ...
                      <input
                        type='text'
                        value={command.manufacturingMill ? this.getTurnNumberSuggest() : ''}
                        disabled={true}
                  ...
                  <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                    <div className={`form-group`}>
                      ...
                      <input
                        type='text'
                        disabled={true}
                        value={command.manufacturingMill ? this.getWorkerNumberSuggest() : ''}
                        className='form-control'
                      />
                    </div>
                  </div>
                ...
                <div className='row'>
                  <div className='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                    <div className={`form-group`}>
                      <label>
                        {translate('manufacturing.plan.start_date_command')}
                        <span className='attention'> * </span>
                      </label>
                      <DatePicker
                  ...
                  <div className='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                    <div className={`form-group`}>
                      <label>
                        {translate('manufacturing.plan.start_turn')}
                        <span className='attention'> * </span>
                      </label>
                      <input
                        type='text'
                        disabled={true}
                        value={command.startTurn ? translate('manufacturing.plan.turn') + command.startTurn : ''}
                        className='form-control'
                      />
                    </div>
                  </div>
                  <div className='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                    <div className={`form-group`}>
                      <label>
                        {translate('manufacturing.plan.end_date_command')}
                        <span className='attention'> * </span>
                      </label>
                      <DatePicker
                  ...
                  <div className='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                    <div className={`form-group`}>
                      <label>
                        {translate('manufacturing.plan.end_turn')}
                        <span className='attention'> * </span>
                      </label>
                      <input
                        type='text'
                        disabled={true}
                        value={command.endTurn ? translate('manufacturing.plan.turn') + command.endTurn : ''}
                        className='form-control'
                      />
                    </div>
                  </div>
                  ...
                  <div className='row'>
                    <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                      <div className={`form-group ${!responsiblesError ? '' : 'has-error'}`}>
                        <label>
                          {translate('manufacturing.plan.responsible')}
                          <span className='attention'> * </span>
                        </label>
                        <SelectBox
