        ...
        <>
            ...
            >
                <form id={`form-detail-manufacturing-routing`}>
                    ...
                    <RoutingFlowBuilder mode="view" {...currentRouting} />
                    < div className="row">
                                            ...
                                            {currentRouting?.operations.map(operation => (
                                                <tr key={operation.id}>
                                                    ...
                                                    <td style={{textAlign: "left"}}>
                                                        <ul>
                                                            {operation.machines.map((item) => (
                                                                <li key={item._id}>{item.machine.assetName}, SL: {item.number} </li>
                                                            ))}
                                                        </ul>
                                                        <ul>
                                                            {operation.workers.map((item) => (
                                                                <li key={item._id}>{item.workerRole.name}, SL: {item.number} </li>
                                                            ))}
                                                        </ul>
                                                    </td>
                                                </tr>
