            ...
            <div className='row'>
              <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
                ...
                <div className='form-group'>
                  ...
                  {currentPurchasingRequest.manufacturingCommand && (
                    <a href='#' onClick={() => this.handleShowDetailManufacturingCommand(currentPurchasingRequest.manufacturingCommand)}>
              ...
              <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6'>
                ...
                <div className='form-group'>
                  ...
                  {currentPurchasingRequest.status && (
                    <span style={{ color: translate(`manufacturing.purchasing_request.${currentPurchasingRequest.status}.color`) }}>
                      {translate(`manufacturing.purchasing_request.${currentPurchasingRequest.status}.content`)}
                    </span>
                  )}
                </div>
              </div>
              ...
              <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                <fieldset className='scheduler-border'>
                  ...
                  <table id='manufacturing-works-table' className='table table-striped table-bordered table-hover'>
                    ...
                    <tbody>
                      {currentPurchasingRequest.materials && currentPurchasingRequest.materials.length === 0 && (
                        <tr>
