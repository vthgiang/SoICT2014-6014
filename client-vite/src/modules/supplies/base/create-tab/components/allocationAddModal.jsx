...
function AllocationAddModal(props) {
  ...
  const { date, quantity, allocationToOrganizationalUnit, allocationToUser, errorOnQuantity, errorOnDate, errorOnUnit, errorOnUser } = state
  ...
  return (
    <React.Fragment>
      ...
      <DialogModal
        size='75'
        modalID={`modal-create-allocation-tab-${id}`}
        isLoading={false}
        ...
        <form className='form-group' id={`form-create-allocation-tab-${id}`}>
          <div className='col-md-12'>
            ...
            <div className='form-group'>
              ...
              <DatePicker id='create_date_add_allocation' value={date} onChange={handleDateChange} />
              ...
              <div>
                <div id={`userAddAllocationDivBox-${id}`}>
                  <SelectBox
                    ...
                    style={{ width: '100%' }}
                    items={[
                      { value: 'null', text: 'Chọn người được cấp phát' },
                      ...userlist.map((x) => {
