...
function InternalServiceIdentity(props) {
                    ...
                    && listInternalServiceIdentity?.map((identity, index) =>
                        <tr key={identity?._id}>
                            ...
                            <td style={{ textAlign: 'center' }}>
                                <a className="edit text-green" style={{ width: '5px' }} title={translate('system_admin.internal_service_identity.view')} onClick={() => handleView(identity)}><i className="material-icons">visibility</i></a>
                                <a onClick={() => handleEdit(identity)} className="edit" title={translate('system_admin.internal_service_identity.edit')}><i className="material-icons">edit</i></a>
                                <DeleteNotification
    ...
    return (
        <React.Fragment>
            ...
            <InternalServiceIdentityViewModal
                internalServiceIdentity={internalServiceIdentityView}
            />
            <InternalServiceIdentityEditModal
                id={internalServiceIdentityEdit?.id}
                internalServiceIdentity={internalServiceIdentityEdit}
            />
            <div className="box" >
                <div className="box-body qlcv">
                    <div className="form-inline">
                        ...
                        <button
                            type="button"
                            onClick={() => {window.$("#create-internal-service-identity-modal").modal("show");}}
