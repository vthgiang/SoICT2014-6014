...
function InternalServiceIdentityEditModal(props) {
  ...
  return (
    <DialogModal
      modalID='update-internal-service-identity-modal'
      isLoading={false}
        ...
        <div className='form-group'>
          ...
          <div>
            <SelectBox
              ...
              style={{ width: '100%' }}
              items={listInternalPolicies?.map((internalPolicy) => {
                return { value: internalPolicy ? internalPolicy.id : null, text: internalPolicy ? internalPolicy.name : '' }
              })}
        ...
        <div className='form-group'>
          ...
          <div>
            <SelectBox
              ...
              className='form-control select2'
              style={{ width: '100%' }}
              items={listExternalPolicies?.map((externalPolicy) => {
                return { value: externalPolicy ? externalPolicy.id : null, text: externalPolicy ? externalPolicy.name : '' }
              })}
