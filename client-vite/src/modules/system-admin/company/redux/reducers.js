    ...
    case CompanyConstants.ADD_NEW_LINK_FOR_COMPANY_SUCCESS:
      return {
        ...
        item: {
          ...
          links: {
            ...state.item.links,
            list: [action.payload, ...state.item.links.list],
            listPaginate: [action.payload, ...state.item.links.listPaginate],
            isLoading: false
          }
        }
      }
    ...
    case CompanyConstants.ADD_NEW_COMPONENT_FOR_COMPANY_SUCCESS:
      return {
        ...
        item: {
          ...
          components: {
            ...state.item.components,
            list: [action.payload, ...state.item.components.list],
            listPaginate: [action.payload, ...state.item.components.listPaginate],
            isLoading: false
          }
        }
      }
