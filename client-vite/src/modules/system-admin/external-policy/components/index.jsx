...
function ExternalPolicy(props) {
            ...
            <tr key={policy?.id}>
              ...
              <td style={{ textAlign: 'center' }}>
                <a
                  ...
                  style={{ width: '5px' }}
                  title={translate('system_admin.external_policy.view')}
                  onClick={() => handleView(policy)}
                >
                  <i className='material-icons'>visibility</i>
                </a>
                <a onClick={() => handleEdit(policy)} className='edit' title={translate('system_admin.external_policy.update')}>
  ...
  return (
    <>
      ...
      <ExternalPolicyViewModal externalPolicy={externalPolicyView} />
      <ExternalPolicyEditModal id={externalPolicyEdit?.id} externalPolicy={externalPolicyEdit} />
      <div className='box'>
        <div className='box-body qlcv'>
          <div className='form-inline'>
            ...
            <button
              type='button'
              onClick={() => {
                window.$('#create-external-policy-modal').modal('show')
              }}
