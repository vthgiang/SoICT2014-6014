export const ScheduleConstants = {
  ...
  GET_NEAREST_DEPOT_REQUEST: 'GET_NEAREST_DEPOT_REQUEST',
  GET_NEAREST_DEPOT_SUCCESS: 'GET_NEAREST_DEPOT_SUCCESS',
  GET_NEAREST_DEPOT_FAILURE: 'GET_NEAREST_DEPOT_FAILURE'
}
