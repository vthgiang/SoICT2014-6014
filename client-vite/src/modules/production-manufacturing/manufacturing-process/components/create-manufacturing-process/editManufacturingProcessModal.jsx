...
const EditManufacturingProcessModal = (props) => {

    const { translate, processManufacturingEdit } = props;
    ...
    useEffect(() => {
        setProcessInfo({
            manufacturingProcessCode: processManufacturingEdit.manfucturingProcessCode,
            organizationalUnit: processManufacturingEdit.organizationalUnit,
            productionLineTemplate: processManufacturingEdit.productionLineTemplate,
            processManufacturingName: processManufacturingEdit.manufacturingName,
            manager: processManufacturingEdit.managerEmployee,
            supporter: processManufacturingEdit.supporterEmployee,
            quantityOfDay: processManufacturingEdit.quantityOfDay ? processManufacturingEdit.quantityOfDay : 0,
            startTime: processManufacturingEdit.timeStartOfDay,
            endTime: processManufacturingEdit.timeEndOfDay,
        })
    }, [props.processManufacturingEdit])
    ...
    return (
        <React.Fragment>
            <DialogModal
                modalID="edit-modal-manufacturing-process"
                isLoading={false}
                formID="edit-modal-manufacturing-process"
                title="Chỉnh sửa thông tin dây chuyền sản xuất"
...
const connectEditManufacturingProcess = connect(mapStateToProps, mapDispatchToProps)(withTranslate(EditManufacturingProcessModal))
export { connectEditManufacturingProcess as EditManufacturingProcessModal }