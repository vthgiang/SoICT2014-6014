...
function CreateApiRegistrationModal(props) {
  ...
  const handleCheckboxCategory = (e) => {
    ...
    if (checked) {
      ...
      setState({
        ...
        registrationApisCategory: [...state.registrationApisCategory, value]
      })
    } else {
      if (apis?.listPaginateApi?.length > 0) {
        let lists = apis.listPaginateApi.filter((item) => item?._id === value)
  ...
  const handleCheckbox = (e) => {
    ...
    if (checked) {
      setState({
        ...state,
        registrationApis: [...state.registrationApis, value]
      })
    } else {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID='create-api-registration-modal'
        isLoading={false}
        size='75'
      ...
      >
        ...
        <form
          id='form-create-api-registration'
          className='qlcv'
          ...
          <div className='row'>
            ...
            <div className='form-group col-xs-12 col-sm-6'>
              ...
              <input
                className='form-control'
                type='text'
                placeholder={translate('auth.profile.input_name')}
                value={name}
