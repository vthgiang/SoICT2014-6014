...
export function ChooseResource(props) {
  ...
  return (
    <DialogModal
      ...
      isLoading={isLoading}
      formID={`form-${id}`}
      title={translate('manage_delegation_policy.wizard.delegateObject.title')}
    ...
    >
      ...
      <div className={`form-group delegation-wizard-row `}>
        <label>
          <div className='delegation-wizard-title'>
            {translate('manage_delegation_policy.wizard.delegateObject.choose')}
      ...
      <div className={`form-group delegation-wizard-row `}>
        <label>
          <div className='delegation-wizard-title'>{translate('manage_delegation_policy.wizard.delegateObject.authorized')}</div>
        </label>
        {/* Bảng dữ liệu */}
      ...
      <ProposedRequirement
        ...
        title={translate('manage_delegation_policy.wizard.delegateObject.proposed_requirement')}
