...
function PolicyTable(props) {
  ...
  return (
    <React.Fragment>
      ...
      <PolicyCreateForm page={page} perPage={perPage} handleChangeAddRowAttribute={handleChangeAddRowAttribute} i={state.i} />

      <PolicyImportForm page={page} perPage={perPage} />
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('manage_policy.policyName')}
              autoComplete='off'
            />
          </div>
          <div className='form-group'>
            <button
              ...
              title={translate('manage_policy.search')}
              onClick={() => handleSubmitSearch()}
            >
              {translate('manage_policy.search')}
            </button>
          </div>
        </div>
                ...
                action: (
                  <td style={{ textAlign: 'center' }}>
                    ...
                    <a
                      ...
                      style={{ width: '5px' }}
                      title={translate('manage_policy.edit')}
