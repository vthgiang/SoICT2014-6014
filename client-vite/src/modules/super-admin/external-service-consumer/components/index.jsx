...
function ExternalServiceConsumer(props) {
            ...
            <tr key={identity?._id}>
              ...
              <td style={{ textAlign: 'center' }}>
                <a
                  ...
                  style={{ width: '5px' }}
                  title={translate('system_admin.external_service_consumer.view')}
                  onClick={() => handleView(identity)}
                >
                  <i className='material-icons'>visibility</i>
                </a>
                <a onClick={() => handleEdit(identity)} className='edit' title={translate('system_admin.external_service_consumer.edit')}>
  ...
  return (
    <>
      ...
      <ExternalServiceConsumerViewModal externalServiceConsumer={externalServiceConsumerView} />
      <ExternalServiceConsumerEditModal id={externalServiceConsumerEdit?.id} externalServiceConsumer={externalServiceConsumerEdit} />
      <div className='box'>
        <div className='box-body qlcv'>
          <div className='form-inline'>
            ...
            <button
              type='button'
              onClick={() => {
                window.$('#create-external-service-consumer-modal').modal('show')
              }}
