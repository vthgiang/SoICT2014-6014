export const RoleConstants = {
  ...
  EDIT_ROLE_ATTRIBUTE_REQUEST: 'EDIT_ROLE_ATTRIBUTE_REQUEST',
  EDIT_ROLE_ATTRIBUTE_SUCCESS: 'EDIT_ROLE_ATTRIBUTE_SUCCESS',
  EDIT_ROLE_ATTRIBUTE_FAILE: 'EDIT_ROLE_ATTRIBUTE_FAILE'
}
