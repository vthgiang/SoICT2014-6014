      ...
      <div className=' row box-body qlcv'>
        ...
        <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
          <div className='description-box' style={{ paddingRight: 10 }}>
            ...
            <div>
              <strong>{translate('human_resource.annual_leave_personal.total_number_leave_of_year')}:</strong>
              &nbsp;&nbsp;
              <span>{`${maximumNumberOfLeaveDays} ${translate('human_resource.annual_leave_personal.day')}`}</span>
            </div>
            <div>
              <strong>{translate('human_resource.annual_leave_personal.leaved')}:</strong>
              &nbsp;&nbsp;
            ...
            <table className='table table-striped table-bordered table-hover' style={{ marginBottom: 0 }}>
              ...
              <tbody>
                {listAnnualLeavesOfOneYear &&
                  listAnnualLeavesOfOneYear.length !== 0 &&
          ...
          {state.requestToChangeId && <RequestToChangeAnnualLeave id={state.requestToChangeId} data={state.requestToChangeItem} />}
          <div className='description-box' style={{ paddingRight: 10, marginTop: 25 }}>
            ...
            <table className='table table-striped table-bordered table-hover' style={{ marginBottom: 0 }}>
              <thead>
                <tr>
                  <th className='not-sort' style={{ width: 50 }}>
