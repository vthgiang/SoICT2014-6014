...
function ExperienceTab(props) {
  ...
  useEffect(() => {
    setState((state) => {
      return {
        ...
        biddingPackagePersonalStatus: props.employee?.biddingPackagePersonalStatus
          ? Number(props.employee?.biddingPackagePersonalStatus)
          : 3,
  ...
  const handleChangleEditCareerPosition = async (data) => {
    ...
    let checkData = checkForDuplicate(
      data,
      careerPositionsNew.filter((x, index) => index !== data.index)
    )
    if (checkData) {
      ...
      <div className='box-body'>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.academic_level')}</h4>
          </legend>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              placeholder={translate('human_resource.profile.educational_level')}
              autoComplete='off'
            />
          </div>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              value={foreignLanguage ? foreignLanguage : ''}
              onChange={handleChange}
              placeholder={translate('human_resource.profile.language_level')}
              autoComplete='off'
            />
          </div>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.work_experience')}</h4>
          </legend>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('human_resource.profile.project_experience')}</h4>
          </legend>
          <div className='row'>
            ...
            {biddingPackagePersonalStatus === 3 && (
              <div className={`form-group col-lg-4 col-md-4 col-ms-12 col-xs-12`}>
                ...
                <DatePicker id={`endBiddingPackage${id}`} value={biddingPackageEndDate} onChange={handleBiddingPackageEndDate} />
              </div>
            )}
          </div>
                ...
                careerPositions.map((x, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        <a
                          onClick={() => handleEditCareerPosition(x, index)}
                          className='edit text-yellow'
                          style={{ width: '5px' }}
                        ...
                        {!x.biddingPackage && (
                          <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => _deleteCareerPosition(index)}>
                            <i className='material-icons'></i>
                          </a>
                        )}
                      </td>
