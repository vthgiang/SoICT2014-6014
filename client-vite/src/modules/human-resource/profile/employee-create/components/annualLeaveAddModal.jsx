...
function AnnualLeaveAddModal(props) {
  ...
  return (
    <React.Fragment>
      <ButtonModal
        modalID={`modal-create-sabbatical-${id}`}
        ...
        <form className='form-group' id={`form-create-sabbatical-${id}`}>
          ...
          <div className={`form-group ${errorOnOrganizationalUnit && 'has-error'}`}>
            ...
            <SelectBox
              ...
              items={organizationalUnits
                ...
                .concat([{ value: '', text: translate('human_resource.non_unit') }])}
          ...
          <div className='row'>
            ...
            <div className={`form-group col-sm-6 col-xs-12 ${errorOnStartDate && 'has-error'}`}>
              ...
              <DatePicker id={`create_start_date${id}`} deleteValue={false} value={startDate} onChange={handleStartDateChange} />
              {type && (
                <TimePicker
            ...
            <div className={`form-group col-sm-6 col-xs-12 ${errorOnEndDate && 'has-error'}`}>
              ...
              <DatePicker id={`create_end_date${id}`} deleteValue={false} value={endDate} onChange={handleEndDateChange} />
              {type && (
                <TimePicker
