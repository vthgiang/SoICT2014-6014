...
const BarAndLineChart = (props) => {
  ...
  useEffect(() => {
    setState({
      ...
      data2: ['data2', 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5, 13.5]
    })
  }, [props, state])
        ...
        <div className='box-body dashboard_box_body'>
          ...
          <div className='box-tools pull-right'>
            <div className='btn-group pull-rigth'>
              <button
                type='button'
                className={`btn btn-danger btn-xs ${lineBar === false ? 'btn-danger' : null}`}
              ...
              <button
                type='button'
                className={`btn btn-danger btn-xs ${lineBar === true ? 'btn-danger' : null}`}
