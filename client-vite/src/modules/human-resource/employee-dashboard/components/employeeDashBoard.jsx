...
const DashBoardEmployees = (props) => {
  const { translate, employeeDashboardData, childOrganizationalUnit, getEmployeeDashboardData } = props
  ...
  let listTimesheets = employeeDashboardData.dataOvertimeUnits?.listOvertimeOfUnitsByStartDateAndEndDate
    ? employeeDashboardData.dataOvertimeUnits.listOvertimeOfUnitsByStartDateAndEndDate
    : []
      ...
      <div className='qlcv'>
        <div className='form-inline' style={{ marginBottom: 10 }}>
          ...
          <div className='form-group'>
            ...
            <DatePicker id='monthInDashboardUnit' dateFormat='month-year' value={month} onChange={handleSelectMonth} deleteValue={false} />
          </div>
            ...
            <div className='info-box with-border'>
              ...
              <div className='info-box-content'>
                <span className='info-box-text'>
                  Số giờ nghỉ phép{' '}
                  <a title={'Giải thích'} onClick={showDetailAnnualLeave}>
        ...
        <div className='nav-tabs-custom'>
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a href='#human-resourse' data-toggle='tab' onClick={() => handleNavTabs(true)}>
                Tổng quan nhân sự
              </a>
            </li>
            <li>
              <a href='#annualLeave' data-toggle='tab' onClick={() => handleNavTabs()}>
                Nghỉ phép-Tăng ca
              </a>
            </li>
            <li>
              <a href='#salary' data-toggle='tab' onClick={() => handleNavTabs(true)}>
                Lương thưởng nhân viên
              </a>
            </li>
            <li>
              <a href='#integrated-statistics' data-toggle='tab'>
                Thống kê tổng hợp
              </a>
            </li>
          </ul>
            ...
            <div className='tab-pane' id='annualLeave'>
              <LazyLoadComponent>
                <TabAnualLeave
                  ...
                  childOrganizationalUnit={childOrganizationalUnit}
                  idUnits={
                    props?.childOrganizationalUnit?.length &&
                    props.childOrganizationalUnit.filter((item) => arrayUnitShow.includes(item?.id))
                  }
                  defaultUnit={true}
                  search_data_props={search_data_props}
                />
