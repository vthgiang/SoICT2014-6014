...
const PraiseCreateForm = (props) => {
  ...
  return (
    <React.Fragment>
      <ButtonModal
        modalID='modal-create-praise'
        button_name={translate('human_resource.commendation_discipline.commendation.add_commendation')}
        ...
        <form className='form-group' id='form-create-praise'>
          ...
          <div className='row'>
            ...
            <div className={`col-sm-6 col-xs-12 form-group ${errorOnStartDate && 'has-error'}`}>
              ...
              <DatePicker id='create_praise_start_date' value={startDate} onChange={handleStartDateChange} />
