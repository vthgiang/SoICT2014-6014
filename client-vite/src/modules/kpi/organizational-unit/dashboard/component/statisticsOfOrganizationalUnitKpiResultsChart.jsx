...
function StatisticsOfOrganizationalUnitKpiResultsChart(props) {
  ...
  const filterAndCountEmployeeWithTheSamePoint = (arrayPoint) => {
    ...
    employeeWithTheSamePoints = [point, countEmployeeWithTheSamePoint]
  ...
  const setDataColumnChart = () => {
    ...
    if (listEmployeeKpiSet && month && organizationalUnit) {
      let exportData = convertDataToExportData(
        listEmployeeKpiSet,
        organizationalUnit,
...
const connectedStatisticsOfOrganizationalUnitKpiResultsChart = connect(
  mapState,
  actions
)(withTranslate(StatisticsOfOrganizationalUnitKpiResultsChart))
