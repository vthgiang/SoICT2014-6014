  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <form
          id='form-add-target'
          onSubmit={() => onAddItem(translate('kpi.organizational_unit.create_organizational_unit_kpi_modal.success'))}
        >
          {/* Tên mục tiêu */}
          <div className={`form-group ${!errorOnName ? '' : 'has-error'}`}>
            <label>
              {translate('kpi.organizational_unit.create_organizational_unit_kpi_modal.name')}
          ...
          <div className={`form-group ${!errorOnCriteria ? '' : 'has-error'}`}>
            <label>
              {translate('kpi.organizational_unit.create_organizational_unit_kpi_modal.evaluation_criteria')}
              <span className='text-red'>*</span>
            </label>
            <QuillEditor id={'create-organizational-unit-kpi'} getTextData={handleCriteriaChange} toolbar={false} />
          ...
          <div className={`form-group ${!errorOnWeight ? '' : 'has-error'}`}>
            <label>
              {translate('kpi.organizational_unit.create_organizational_unit_kpi_modal.weight')}
              <span className='text-red'>*</span>
            </label>
