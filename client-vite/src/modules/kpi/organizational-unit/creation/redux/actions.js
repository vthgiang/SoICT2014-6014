...
function getCurrentKPIUnit(roleId, organizationalUnitId = undefined, month = undefined, type = 'default') {
  return (dispatch) => {
    ...
    createUnitKpiServices
      .getCurrentKPIUnit(roleId, organizationalUnitId, month)
      .then((res) => {
        dispatch({
...
function getAllOrganizationalUnitKpiSetByTime(roleId, organizationalUnitId, startDate, endDate) {
  return (dispatch) => {
    ...
    createUnitKpiServices
      .getAllOrganizationalUnitKpiSetByTime(roleId, organizationalUnitId, startDate, endDate)
      .then((res) => {
        dispatch({
...
function getAllOrganizationalUnitKpiSetByTimeOfChildUnit(roleId, startDate, endDate) {
  return (dispatch) => {
    ...
    createUnitKpiServices
      .getAllOrganizationalUnitKpiSetByTimeOfChildUnit(roleId, startDate, endDate)
      .then((res) => {
        dispatch({
...
function deleteTargetKPIUnit(id, organizationalUnitKpiSetId) {
  return (dispatch) => {
    ...
    createUnitKpiServices
      .deleteTargetKPIUnit(id, organizationalUnitKpiSetId)
      .then((res) => {
        dispatch({
...
function editTargetKPIUnit(id, newTarget) {
  return (dispatch) => {
    ...
    createUnitKpiServices
      .editTargetKPIUnit(id, newTarget)
      .then((res) => {
        dispatch({
