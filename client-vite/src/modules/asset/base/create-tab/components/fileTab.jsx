        ...
        <div className=' row box-body'>
          ...
          <div className='col-md-12'>
            ...
            <button
              ...
              onClick={this.defaulteClick}
              title={translate('manage_asset.add_default_title')}
            >
              {translate('manage_asset.add_default')}
            </button>
                  ...
                  files.map((x, index) => {
                    return (
                      <tr key={index}>
                                  ...
                                  <React.Fragment key={index}>
                                    <li>
                                      <a
                                        ...
                                        onClick={(e) => this.requestDownloadFile(e, child.url, child.fileName)}
                                      >
                                        {child.fileName}
                                      </a>
                                    </li>
                        ...
                        <td>
                          <a
                            onClick={() => this.handleEdit(x, index)}
                          ...
                          <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => this.handleDeleteFile(index)}>
