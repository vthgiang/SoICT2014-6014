export const delegationConstants = {
  ...
  DELETE_RESOURCE_DELEGATION_REQUEST: 'DELETE_DELETE_RESOURCE_DELEGATION_REQUEST',
  DELETE_RESOURCE_DELEGATION_SUCCESS: 'DELETE_RESOURCE_DELEGATION_SUCCESS',
  DELETE_RESOURCE_DELEGATION_FAILURE: 'DELETE_RESOURCE_DELEGATION_FAILURE',

  REVOKE_RESOURCE_DELEGATION_REQUEST: 'REVOKE_RESOURCE_DELEGATION_REQUEST',
  REVOKE_RESOURCE_DELEGATION_SUCCESS: 'REVOKE_RESOURCE_DELEGATION_SUCCESS',
  REVOKE_RESOURCE_DELEGATION_FAILURE: 'REVOKE_RESOURCE_DELEGATION_FAILURE',

  CREATE_RESOURCE_DELEGATION_REQUEST: 'CREATE_RESOURCE_DELEGATION_REQUEST',
  CREATE_RESOURCE_DELEGATION_SUCCESS: 'CREATE_RESOURCE_DELEGATION_SUCCESS',
  CREATE_RESOURCE_DELEGATION_FAILURE: 'CREATE_RESOURCE_DELEGATION_FAILURE',

  EDIT_RESOURCE_DELEGATION_REQUEST: 'EDIT_RESOURCE_DELEGATION_REQUEST',
  EDIT_RESOURCE_DELEGATION_SUCCESS: 'EDIT_RESOURCE_DELEGATION_SUCCESS',
  EDIT_RESOURCE_DELEGATION_FAILURE: 'EDIT_RESOURCE_DELEGATION_FAILURE'
}
