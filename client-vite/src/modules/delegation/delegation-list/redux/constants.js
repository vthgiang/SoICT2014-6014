export const delegationConstants = {
  ...
  GET_ALL_DELEGATIONS_SERVICE_REQUEST: 'GET_ALL_DELEGATIONS_SERVICE_REQUEST',
  GET_ALL_DELEGATIONS_SERVICE_SUCCESS: 'GET_ALL_DELEGATIONS_SERVICE_SUCCESS',
  GET_ALL_DELEGATIONS_SERVICE_FAILURE: 'GET_ALL_DELEGATIONS_SERVICE_FAILURE',

  DELETE_SERVICE_DELEGATION_REQUEST: 'DELETE_DELETE_SERVICE_DELEGATION_REQUEST',
  DELETE_SERVICE_DELEGATION_SUCCESS: 'DELETE_SERVICE_DELEGATION_SUCCESS',
  DELETE_SERVICE_DELEGATION_FAILURE: 'DELETE_SERVICE_DELEGATION_FAILURE',

  REVOKE_SERVICE_DELEGATION_REQUEST: 'REVOKE_REVOKE_SERVICE_DELEGATION_REQUEST',
  REVOKE_SERVICE_DELEGATION_SUCCESS: 'REVOKE_SERVICE_DELEGATION_SUCCESS',
  REVOKE_SERVICE_DELEGATION_FAILURE: 'REVOKE_SERVICE_DELEGATION_FAILURE',

  CREATE_SERVICE_DELEGATION_REQUEST: 'CREATE_SERVICE_DELEGATION_REQUEST',
  CREATE_SERVICE_DELEGATION_SUCCESS: 'CREATE_SERVICE_DELEGATION_SUCCESS',
  CREATE_SERVICE_DELEGATION_FAILURE: 'CREATE_SERVICE_DELEGATION_FAILURE',

  EDIT_SERVICE_DELEGATION_REQUEST: 'EDIT_SERVICE_DELEGATION_REQUEST',
  EDIT_SERVICE_DELEGATION_SUCCESS: 'EDIT_SERVICE_DELEGATION_SUCCESS',
  EDIT_SERVICE_DELEGATION_FAILURE: 'EDIT_SERVICE_DELEGATION_FAILURE'
}
