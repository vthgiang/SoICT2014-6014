    ...
    <div className='box'>
      <div className='nav-tabs-custom'>
        <ul className='nav nav-tabs'>
          <li className='active'>
            <a href='#hr-training-plan-employee' data-toggle='tab' onClick={() => handleNavTabs(true)}>
              Danh sách chương trình đào tạo
            </a>
          </li>
          <li>
            <a href='#list-upcoming-course' data-toggle='tab' onClick={() => handleNavTabs()}>
              Danh sách khóa học sắp mở
            </a>
          </li>
          <li>
            <a href='#list-attended-course' data-toggle='tab' onClick={() => handleNavTabs()}>
