...
const CourseEditForm = (props) => {
  ...
  const isFormValidated = () => {
    ...
    let result =
      ...
      validateEducationProgram(educationProgram.name || educationProgram, false) &&
            ...
            <div className={`form-group col-sm-6 col-xs-12 ${errorOnEducationProgram && 'has-error'}`}>
              ...
              <SelectBox
                ...
                items={[
                  ...
                  { value: '', text: 'Chọn chương trình đào tạo' }
                ]}
