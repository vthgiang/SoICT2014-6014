    ...
    <div className='qlcv box-body'>
      <div className='nav-tabs-custom'>
        <ul className='general-tabs nav nav-tabs'>
          <li className='active'>
            <a className='general-task-type' href='#allGeneralTaskUrgent' data-toggle='tab'>
              <img style={{ width: '18px', height: '18px', marginRight: '5px' }} src={urgentIcon} alt='urgent' />
              {`${translate('task.task_dashboard.urgent_task')}`}&nbsp;<span>{`(${state.urgentTask ? state.urgentTask.length : 0})`}</span>
            </a>
          </li>
          <li>
            <a className='general-task-type' href='#allGeneralTaskTodo' data-toggle='tab'>
              <img src={todoIcon} alt='todo' style={{ width: '20px', marginRight: '5px' }} />{' '}
              {`${translate('task.task_dashboard.to_do_task')}`}&nbsp;<span>{`(${state.todoTask ? state.todoTask.length : 0})`}</span>
            </a>
          </li>
          <li>
            <a className='general-task-type' href='#allGeneralTaskOverdue' data-toggle='tab'>
              {`${translate('task.task_dashboard.overdue_task')}`}&nbsp;
              <span>{`(${state.overdueTask ? state.overdueTask.length : 0})`}</span>
            </a>
          </li>
          <li>
            <a className='general-task-type' href='#allGeneralTaskDelay' data-toggle='tab'>
              {`${translate('task.task_dashboard.delay_task')}`}&nbsp;<span>{`(${state.delayTask ? state.delayTask.length : 0})`}</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a className='general-task-type' href='#allGeneralTaskDeedlineIncoming' data-toggle='tab'>
              {`${translate('task.task_dashboard.incoming_task')}`}&nbsp;
              <span>{`(${state.deadlineincoming ? state.deadlineincoming.length : 0})`}</span>
            </a>
          </li>
          <li>
            <a className='general-task-type' href='#allGeneralTaskIntime' data-toggle='tab'>
              {`${translate('task.task_dashboard.intime_task')}`}&nbsp;<span>{`(${state.intimeTask ? state.intimeTask.length : 0})`}</span>
            </a>
          </li>
        </ul>
                    ...
                    state.urgentTask.map((obj, index) => (
                      <div className='panel panel-default' key={index}>
                        <span
                          ...
                          data-parent='#accordion-urgent'
                          href={`#collapse-urgent${index}`}
                          aria-expanded='true'
                        ...
                        >
                          ...
                          <small className='label label-danger' style={{ fontSize: '9px', marginLeft: '5px', borderRadius: '.5em' }}>
                            {obj.createdToNow} {translate('task.task_dashboard.day')} trước
                          </small>
                        </span>
                    ...
                    state.todoTask.map((obj, index) => (
                      <div className='panel panel-default' key={index}>
                        <span
                          ...
                          href={`#collapse-todo${index}`}
                          aria-expanded='false'
                          aria-controls={`#collapse-todo${index}`}
                        >
                          <span className='index'>{index + 1}</span>
                          <span className='task-name'>{obj.name}</span>
                          {obj.taskProject ? (
                    ...
                    state.delayTask.map((obj, index) => (
                      <div className='panel panel-default' key={index}>
                        <span
                          ...
                          className='item-question collapsed'
                          data-toggle='collapse'
                          data-parent='#accordion-delay'
                          href={`#collapse-delay${index}`}
                          aria-expanded='true'
                          aria-controls='collapse1a'
                        >
                          <span className='index'>{index + 1}</span>
                          ...
                          <small
                            className='label'
                            style={{ fontSize: '9px', marginLeft: '5px', borderRadius: '.5em', backgroundColor: '#db8b0b' }}
                          >
                            {obj.progress}% - {translate('task.task_dashboard.rest')} {obj.nowToEnd} {translate('task.task_dashboard.day')}{' '}
                            tới hạn
                          </small>
                        </span>
                    ...
                    state.deadlineNow.map((obj, index) => (
                      <div className='panel panel-default' key={index}>
                        <span
                          ...
                          className='item-question collapsed'
                          data-toggle='collapse'
                          data-parent='#accordion-deadlinenow'
                          href={`#collapse-deadlinenow${index}`}
                          aria-expanded='true'
                          aria-controls='collapse1a'
                        >
                          <span className='index'>{index + 1}</span>
                          ...
                          <small
                            className='label'
                            style={{ fontSize: '9px', marginLeft: '5px', borderRadius: '.5em', backgroundColor: 'rgb(117 152 224)' }}
                          >
                            {obj?.diff?.hours >= 0
                              ? `còn ${obj.diff.hours}h:${obj.diff.minutes}p hết hạn`
                              : `hết hạn ${-obj.diff.hours}h:${obj.diff.minutes}p trước`}
                          </small>
                        </span>
                    ...
                    state.deadlineincoming.map((obj, index) => (
                      <div className='panel panel-default' key={index}>
                        <span
                          ...
                          className='item-question collapsed'
                          data-toggle='collapse'
                          data-parent='#accordion-deadlineincoming'
                          href={`#collapse-deadlineincoming${index}`}
                          aria-expanded='true'
                          aria-controls='collapse1a'
                        >
                          <span className='index'>{index + 1}</span>
                          ...
                          <small
                            ...
                            style={{ fontSize: '9px', marginLeft: '5px', borderRadius: '.5em', backgroundColor: '#db8b0b' }}
                          >
                            {obj?.progress}% - {translate('task.task_dashboard.rest')} {obj.totalDays}{' '}
                            {translate('task.task_dashboard.day')}
                          </small>
                        </span>
                    ...
                    state.intimeTask.map((obj, index) => (
                      <div className='panel panel-default' key={index}>
                        <span
                          ...
                          className='item-question collapsed'
                          data-toggle='collapse'
                          data-parent='#accordion-intime'
                          href={`#collapse-intime${index}`}
                          aria-expanded='true'
                          aria-controls='collapse1a'
                        >
                          <span className='index'>{index + 1}</span>
                          ...
                          <small className='label label-success' style={{ fontSize: '9px', marginLeft: '5px', borderRadius: '.5em' }}>
                            {obj.progress}% - {translate('task.task_dashboard.rest')} {obj.nowToEnd} {translate('task.task_dashboard.day')}
                          </small>
                        </span>
