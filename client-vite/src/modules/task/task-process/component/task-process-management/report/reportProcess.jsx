  ...
  return (
    <React.Fragment>
      <div>
        ...
        >
          <i className='fa fa-table'></i>Tất cả công việc
        </button>
        <button
          className='btn btn-primary'
          type='button'
        ...
        >
          <i className='fa fa-sitemap'></i>Công việc đang làm
        </button>
        <button
          className='btn btn-primary'
          type='button'
        ...
        >
          <i className='fa fa-list'></i>Công việc đã hoàn thành
        </button>
        <button
          className='btn btn-primary'
          type='button'
        ...
        >
          <i className='fa fa-list'></i>Công việc trễ hạn
        </button>
      </div>
      ...
      <table id='listTaskProcess1' className='table table-striped table-bordered table-hover'>
        ...
        <tbody>{showData(props.listTask, nameTask)}</tbody>
      </table>
      ...
      {props.processTemplate && (
        <ReportTask
          convertDayToHour={props.convertDayToHour}
          officeHours={props.officeHours}
          listTask={props.listTask}
          listTaskTemplate={props.processTemplate?.tasks}
        />
      )}
    </React.Fragment>
  )
