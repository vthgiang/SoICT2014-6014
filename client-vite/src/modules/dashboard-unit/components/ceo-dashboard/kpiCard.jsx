      ...
      >
        <div className='card-body'>
          ...
          <div className='' style={{ margin: '0px', display: 'flex', justifyContent: 'space-between' }}>
            <span className='col-sm-5' style={{ backgroundColor: '#EEE', borderRadius: 2, padding: '5px 10px', display: 'flex' }}>
            ...
            <span className='col-sm-5' style={{ backgroundColor: '#EEE', borderRadius: 2, padding: '5px 10px', display: 'flex' }}>
              <i className='fa fa-calendar-minus-o text-info' style={{ fontSize: 18, marginRight: 10 }} />
