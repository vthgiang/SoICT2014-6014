...
// import {getRiskColor} from '../../../TaskPertHelper'
...
import {
    ...
    getFillColor,
    getStrokeColor
} from './risk-diagram/BpmnRenderUtil';
...
export default function CustomRenderer(
    ...
    var handlers = this.handlers = {
        ...
        'bpmn:EndEvent': function (parentGfx, element) {
            console.log(element)//Event_11eqwr0
        ...
        'bpmn:Task': function (parentNode, element) {
            ...
            let slack = element.businessObject.$attrs.slack
            let color = element.businessObject.$attrs.color
            ...
            element.height = 130;
            element.width = 160;
            let rect = drawRect(parentNode, 160, 130, TASK_BORDER_RADIUS, {
                stroke: 'black',
                fill: color,
                strokeWidth: slack == 0 ? '4px' : '1px'
            });
            const line = drawLineNor(parentNode, 0, 40, 160, 40, 'black');
      ...
      /* outer circle path */ drawCircle(parentGfx, element.width, element.height, element.height * 0.20, {
        ...
        'bpmn:SequenceFlow': function (parentGfx, element, attrs) {
            ...
            // let lineColor = attributes.slack && attributes.slack == 0 ? 'red' : 'black'
            // let lineStroke = attributes.slack && attributes.slack == 0 ? 3 : 2
            // let lineDashed = attributes.slack && attributes.slack == 0 ? false : true
            // console.log(attributes.progress, attributes.accountableName, attributes.slack)
            ...
            // var fill = getFillColor(element, lineColor),
            //     stroke = getStrokeColor(element, lineColor),
            //     dashed = lineDashed ? '0.5,5' : '',
            ...
            return element.colorUpdate?drawLine(parentGfx, element.waypoints, attrs):null;
        },
