...
function SuccessTransportRequests(props) {
    const { translate, requestManagements } = props;
    const [state, setState] = useState({
        tableId: 'success-requests-table',
        page: 1,
        limit: 10,
        idModalDetail: "success-transport-page",
        currentRowDetail: ""
    })
    const { tableId, page, limit, idModalDetail, currentRowDetail } = state;
    ...
    const setPage = async (page) => {
        ...
        props.getAllRequestByCondition({ requestType: 4, status: 4 , page, limit});
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(SuccessTransportRequests))