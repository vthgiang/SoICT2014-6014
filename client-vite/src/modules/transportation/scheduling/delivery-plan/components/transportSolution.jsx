...
import TimelineJourney from "../../tracking-route/components/timelineJourney";
import { checkExistNode, getCustomersOfJourney, getDepotsOfJourney } from '../../../utilities'
import OrdersDeliveryStatusChart from "../../tracking-route/components/ordersDeliveryStatusChart";

function TransportSolution(props) {
    ...
    const { solution, solutions, directions, customers, depots, problemAssumption, showDepotMarker, defaultZoom, center} = state;
    ...
    useEffect(() => {
        ...
        setState({
            ...
            customers: setCustomersMarker(props.problemAssumption.orders),
            depots: setDepotsMarker(props.problemAssumption.depots),
    ...
    const setDirections = (solution) => {
        const color = ['#1b55b3', '#a86319', '#247d13', '#137d66', '#4f137d', '#ad1599', '#ad1527']
...
export default (withTranslate(TransportSolution))