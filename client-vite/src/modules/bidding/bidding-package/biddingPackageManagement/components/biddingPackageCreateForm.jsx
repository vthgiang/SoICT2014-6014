...
import { KeyPeopleRequire, GeneralTab, KeyPeople } from './combinedContent'
...
const BiddingPackageCreateForm = (props) => {
  ...
  const isFormValidated = () => {
    const { biddingPackage } = state
    let result = validatorInput(biddingPackage.name) && validatorInput(biddingPackage.name)
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='75'
        modalID='modal-create-bidding-package'
      ...
      >
        ...
        <div className='nav-tabs-custom row' style={{ marginTop: '-15px', overflowX: 'hidden', marginBottom: '-15px' }}>
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a title={translate('human_resource.profile.tab_name.menu_general_infor_title')} data-toggle='tab' href='#general-create'>
            ...
            <li>
              <a
                ...
                data-toggle='tab'
                href='#key-people-require-create'
              >
                Yêu cầu nhân sự chủ chốt
              </a>
            </li>
            <li>
              <a title='Danh sách nhân sự chủ chốt' data-toggle='tab' href={`#key_people_create`}>
                Nhân sự chủ chốt
              </a>
            </li>
            <li>
              <a title='Hồ sơ đề xuất' data-toggle='tab' href={`#proposals_create`}>
                Hồ sơ đề xuất
              </a>
            </li>
          </ul>
          <div className='tab-content'>
            {/* Tab thông tin chung */}
            <GeneralTab id='general-create' type='create' handleChange={handleChange} biddingPackage={biddingPackage} />
