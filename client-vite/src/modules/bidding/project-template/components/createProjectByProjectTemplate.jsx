...
const CreateProjectByProjectTemplateModal = (props) => {
  ...
  }, [endTime, startTime, JSON.stringify(form), JSON.stringify(responsibleEmployeesWithUnit), JSON.stringify(currentSalaryMembers)])
      ...
      <form id={`form-create-project-by-template--${id}`}>
        <div className='nav-tabs-custom' style={{ boxShadow: 'none', MozBoxShadow: 'none', WebkitBoxShadow: 'none', marginBottom: 0 }}>
          ...
          <ul className='nav nav-tabs'>
            ...
            <li className='active'>
              <a title='Thông tin chung' data-toggle='tab' href={`#project-general-${id}`}>
                Thông tin chung
              </a>
            </li>
            {/* Nút tab các bên tgia */}
            <li>
              <a title='Công việc dự án' data-toggle='tab' href={`#project-task-${id}`}>
                Công việc dự án
              </a>
            </li>
          </ul>
