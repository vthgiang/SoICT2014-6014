                ...
                {state.listTasks &&
                  ...
                  state.listTasks.map((taskItem, index) => (
                    <tr style={{ cursor: 'pointer' }} onClick={() => handleEditRow(index)} key={index}>
                      ...
                      <td>
                        {taskItem?.currentResponsibleEmployees?.map((resItem) => convertUserIdToUserName(listUsers, resItem)).join(', ')}
                      </td>
                      <td>
                        {taskItem?.currentAccountableEmployees?.map((accItem) => convertUserIdToUserName(listUsers, accItem)).join(', ')}
                      </td>
