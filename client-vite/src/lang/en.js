  ...
  messages: {
    ...
    general: {
      ...
      validate: {
        ...
        minimum_length_error: 'Error: Value should have minimum length of {min}',
        maximum_length_error: 'Error: Value should have maximum length of {max}',
    ...
    menu: {
      ...
      manage_requester: 'Manage Requesters',
      manage_resource: 'Manage Resources',
      ...
      delegation_receive: 'Delegation received',
      ...
      analysis_manufacturing_performance: 'Analysis manufacturing performance',
    ...
    manufacturing_managerment: {
      manufacturing_process: {
        ...
        process_name: 'Manufacture name',
        process_start_date: 'Start date',
        process_end_date: 'End date',

        assign_employee: 'Assign employee manager',
        assign_supervisor: 'Supervisor',
    ...
    intro: {
      ...
      service_signup: {
        ...
        content: ['Free 15-day trial', 'Maximum 10 users access', 'Experience free features'],
        form: {
          customer: 'Customer',
          email: 'Email',
          phone: 'Phone',
    ...
    auth: {
      validator: {
        confirm_password_invalid: 'Confirm password is invalid! Please input again',
        password_length_error: 'Password length is not less than 6 or more than 30 digit',
    ...
    super_admin: {
      ...
      organization_unit: {
        ...
        department_has_user: 'Cannot delete. Organizational unit had employee',
      ...
      policy: {
        ...
        attribute_selected_duplicate: 'Selected attribute names are duplicated',
        policy_delegation_exist: 'There exists delegation enforcing policy!'
      },
      component: {
        // Thông điệp trả về từ server
    ...
    document: {
      ...
      create_document_category_success: 'Create new category successfully',
      ...
      get_document_that_role_can_view_success: 'Get document that role can view successfully',
      get_document_that_role_can_view_faile: 'Get document that role can view faile',
      get_document_user_statistical_success: 'Get document statistical successfully',
      get_document_user_statistical_faile: 'Get document statistical faile',
    ...
    manage_service: {
      add: 'Add',
      add_title: 'Add new service/account',
      add_common: 'Add common',
      import: 'Import from file',
      import_title: 'Import services data from file',
      info: 'User/Account information',
      edit: 'Edit User/Account information',
      disable: 'Disable',
      enable: 'Enable',
      delete: 'Delete service',
      add_success: 'Add new service successfully',
      add_faile: 'Add new service failed',
      edit_success: 'Edit service successfully',
      edit_faile: 'Edit service failed',
      roles: 'Roles assigned',
      name: 'User name',
      email: 'Email',
      status: 'Status',
      add_attribute: 'Add attribute',
      add_service_attribute: 'Add service attribute',
      attributes: 'User attributes',
      attribute_name: 'Attribute name',
      attribute_value: 'Attribute value',
      attribute_description: 'Attribute description',
      ...
      attribute_value_example: 'VD: PM',
      attribute_description_example: 'VD: Manager of project A',
      add_attribute_title: 'Add service attribute',
      services_add_attribute: 'Attributes of services',
      attribute_select: 'Select attribute',
      attribute_not_selected: 'Attribute not selected'
    },
    ...
    manage_requester: {
      ...
      add_title: 'Add new requester',
      description: 'Description of requester',
      edit: 'Edit requester information',
      delete: 'Delele',
      add_success: 'Add successfully',
      add_faile: 'Add falied!',
      edit_success: 'Edit successfully!',
      ...
      category: 'Category',
      add_attribute: 'Add attribute',
      add_requester_attribute: 'Add requester attribute',
      ...
      attribute_value_example: 'VD: PageProjectA',
      attribute_description_example: 'VD: Page for project A',
      add_attribute_title: 'Add requester attribute',
      attribute_select: 'Select attribute',
      attribute_not_selected: 'Attribute not selected'
    },
    ...
    manage_resource: {
      ...
      attribute_value_example: 'VD: PageProjectA',
      attribute_description_example: 'VD: Page for project A',
      add_attribute_title: 'Add resource attribute',
      attribute_select: 'Select attribute',
      attribute_not_selected: 'Attribute not selected'
    },
    ...
    manage_attribute: {
      ...
      edit_attribute_success: 'Update attribute successfully!',
      edit_attribute_fail: 'Update attribute fail!',
      detail_info_attribute: 'Detail information of attribute',
      type_select: 'Choose attribute type',
      type: {
        Authorization: 'Authorization',
        Delegation: 'Delegation',
        Mixed: 'Mixed'
      },
      add_type: 'Attribute type',
      type_not_selected: 'Attribute type not selected'
    },
    ...
    manage_policy: {
      ...
      delete_fail: 'Delete policy fail!',
      add: 'Add policy',
      add_title: 'Add a new authorization policy',
      ...
      edit_policy_success: 'Update policy successfully!',
      edit_policy_fail: 'Update policy fail!',
      detail_info_policy: 'Detail information of policy',
      ...
      satisfied_information: 'Authorization by policy',
      satisfied_subject: 'Authorized subjects',
      satisfied_resource: 'Authorized resources',
      satisfied_subject_name: 'User name',
      satisfied_subject_email: 'Email',
      satisfied_subject_role: 'Role',
      satisfied_resource_name: 'Resource name',
      satisfied_resource_type: 'Resouce type',
      satisfied_resource_description: 'Description',
      attribute_owner_table: 'Attribute of',
      role_table: 'Role',
      user_table: 'User',
      resource_table: 'Resource',
      rule_table: 'Check rule',
      attribute_name: 'Attribute name',
      attribute_value: 'Attribute value',
      edit_user_attribute: 'Edit user attribute',
      edit_role_attribute: 'Edit role attribute',
      edit_resource_attribute: 'Edit resource attribute',
      add_user_attribute: 'Add user attribute',
      add_role_attribute: 'Add role attribute',
      add_resource_attribute: 'Add resource attribute',
      rule_select: 'Choose checking rule',
      rule_not_selected: 'Rule not selected',
      add_rule: 'Check rule',
      duplicate_attribute: 'Duplicated chosen attributes! Choose differently',
      rule: {
        EQUALS: 'Attribute set are totally the same as in policy',
        CONTAINS: 'Attribute set contains those in policy',
        BELONGS: 'Attribute set belongs to those in policy'
      },
      user: {
        add_attribute: 'Add attribute',
        add_user_attribute: 'Add user attribute',
    ...
    manage_delegation_policy: {
      ...
      delete_fail: 'Delete policy fail!',
      add: 'Add policy',
      add_title: 'Add a new delegation policy',
      add_multi_policy: 'Add many new policies',
      add_one_policy: 'Add 1 new policy',
      add_success: 'Add policy successfully!',
      add_fail: 'Add policy fail!',
      ...
      detail_info_policy: 'Detail information of policy',
      general_information: 'General information',
      delegation_information: 'Delegation attributes information',
      resource_information: 'Resource attributes information',
      attribute_owner_table: 'Attribute of',
      delegator_table: 'Delegator',
      delegatee_table: 'Delegatee',
      delegatedObject_table: 'Delegated Role',
      delegatedObject_tableTask: 'Delegated Task',
      resource_table: 'Delegatable Link',
      rule_table: 'Check rule',
      ...
      edit_delegatee_attribute: 'Edit delegatee attribute',
      edit_delegatedObject_attribute: 'Edit delegated role attribute',
      edit_delegatedObject_attributeTask: 'Edit delegated task attribute',
      edit_resource_attribute: 'Edit link attribute',
      add_delegator_attribute: 'Add delegator attribute',
      add_delegatedObject_attribute: 'Add delegated role attribute',
      add_delegatedObject_attributeTask: 'Add delegated task attribute',
      add_delegatee_attribute: 'Add link attribute',
      add_resource_attribute: 'Add resource attribute',
      rule_select: 'Choose checking rule',
      rule_not_selected: 'Rule not selected',
      add_rule: 'Check rule',
      ...
      delegator: {
        add_attribute: 'Add attribute',
        add_delegator_attribute: 'Add delegator attribute',
        attributes: 'Delegator attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        attribute_name_example: 'VD: Project A',
        attribute_value_example: 'VD: PM',
        attribute_description_example: 'VD: Manager of project A',
        add_attribute_title: 'Add delegator attribute',
        delegators_add_attribute: 'Attributes of delegators',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected'
      },
      delegatee: {
        attributes: 'Delegatee attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        attribute_name_example: 'VD: Group',
        attribute_value_example: 'VD: Leader',
        attribute_description_example: 'VD: delegatee position in group',
        add_attribute_title: 'Add delegatee attribute',
        delegatees_add_attribute: 'Attributes of delegatees',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected',
        add_attribute: 'Add attribute',
        add_delegatee_attribute: 'Add delegatee attribute'
      },
      delegatedObject: {
        attributes: 'Delegated role attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        attribute_name_example: 'VD: Group',
        attribute_value_example: 'VD: Leader',
        attribute_description_example: 'VD: Delegated role position in group',
        add_attribute_title: 'Add delegated role attribute',
        delegatedObjects_add_attribute: 'Attributes of delegated role',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected',
        add_attribute: 'Add attribute',
        add_delegatedObject_attribute: 'Add delegated role attribute'
      ...
      delegatedObjectTask: {
        attributes: 'Delegated task attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        attribute_name_example: 'VD: Group',
        attribute_value_example: 'VD: Leader',
        attribute_description_example: 'VD: Delegated task position in group',
        add_attribute_title: 'Add delegated task attribute',
        delegatedObjects_add_attribute: 'Attributes of delegated task',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected',
        add_attribute: 'Add attribute',
        add_delegatedObject_attribute: 'Add delegated task attribute'
      },
      resource: {
        add_attribute: 'Add attribute',
        add_resource_attribute: 'Add link attribute',
        attributes: 'Link attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        ...
        attribute_description_example: 'VD: Page for project A',
        add_attribute_title: 'Add link attribute',
        resources_add_attribute: 'Attributes of links',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected'
      }
    },
    ...
    manage_delegation: {
      ...
      delegateObjectTaskRole: 'Task roles',
      delegatee: 'Delegatee',
      delegator: 'Delegator',
      ...
      delete_fail: 'Delete role delegation fail!',
      add: 'Add delegation',
      ...
      add_success: 'Add role delegation successfully!',
      add_fail: 'Add role delegation fail!',
      delegation_description: 'Delegation Description',
      edit_role_delegation_title: 'Edit role delegation',
      edit_delegation_success: 'Edit role delegation successfully!',
      edit_delegation_fail: 'Edit role delegation fail!',
      detail_info_delegation: 'Detail information of role delegation',
      detail_info_delegation_task: 'Detail information of task delegation',
      no_blank_delegate_role: 'Delegate role must not be empty',
      no_blank_delegate_task_role: 'Delegate task role must not be empty',
      no_blank_delegatee: 'Delegatee must not be empty',
      delegation_name_exist: 'Delegation name exists',
      delegation_role_exist: 'Delegation of this role exists',
      ...
      revoke_reason_placeholder: 'Input reason',
      pending: 'Pending',
      declined: 'Declined',
      confirmed: 'Confirmed',
      revoked: 'Revoked',
      ...
      revoke_success: 'Revoke role delegation successfully!',
      revoke_fail: 'Revoke role delegation fail!',
      general_information: 'General information',
      log_activity: 'Delegation logs',
      log_activity_task: 'Task actions',
      log_timesheet_task: 'Task timesheet',
      log_history_task: 'Task history',
      ...
      start_date_past: 'Activation time is in the past',
      end_date_past: 'Revocation time is in the past',
      confirm_delegation: 'Confirm delegation',
      reject_delegation: 'Request to reject delegation',
      reject_reason: 'Rejection reason',
      reject_reason_placeholder: 'Input reason',
      reject_success: 'Request to reject role delegation sent successfully!',
      reject_fail: 'Request to reject role delegation sent failed!',
      confirm_success: 'Confirm role delegation successfully!',
      confirm_fail: 'Confirm role delegation failed!',
      delegate_policy: 'Delegation policy',
      choose_delegate_policy: 'Choose delegation policy',
      no_blank_delegate_policy: 'Delegation olicy not selected',
      ...
      delegateTaskName: 'Delegate task',
      ...
      revoke_task_delegation_faile: 'Revoke task delegation failed!',
      delegation_task_exist: 'There exists task delegation with chosen role to delegatee!',
      delegation_task_role_exist: 'There exists task delegation with chosen role!',
      delegatee_already_in_task_responsible: 'Delegatee is already in task as responsible employee!',
      delegatee_already_in_task_accountable: 'Delegatee is already in task as accountable employee!',
      delegatee_already_in_task_consulted: 'Delegatee is already in task as consulted employee!',
      delegatee_already_in_task_informed: 'Delegatee is already in task as informed employee!',
      delegator_is_delegatee: 'Delegatee can not delegate task to another person',
      informed_get_by_delegation: "Your 'Informed' role is granted when you delegate this task!\nTherefore, you can not delegate this role",
      reject_task_delegation_success: 'Request to reject task delegation sent successfully!',
      reject_task_delegation_faile: 'Request to reject task delegation sent failed!',
      confirm_task_delegation_success: 'Confirm task delegation successfully!',
      confirm_task_delegation_faile: 'Confirm task delegation failed!',
      edit_task_delegation_success: 'Edit task delegation successfully!',
      edit_task_delegation_faile: 'Edit task delegation failed!'
    },
    ...
    asset: {
      ...
      purchase_request: {
        ...
        delete_purchase_request_success: 'Delete purchase request successfully',
        delete_purchase_request_failure: 'Delete purchase request faile',
        edit_purchase_request_success: 'Edit purchase request successfully',
    ...
    task: {
      task_management: {
        ...
        edit_task_attributes_success: 'Edit task attributes successfully!',
        edit_task_attributes_faile: 'Edit task attributes failed!',
        ...
        delegatee_already_in_task_informed: 'Delegatee is already in task as informed employee!',
        delegator_is_delegatee: 'Delegatee can not delegate task to another person',
        informed_get_by_delegation:
          "Your 'Informed' role is granted when you delegate this task!\nTherefore, you can not delegate this role",
        reject_task_delegation_success: 'Request to reject task delegation sent successfully!',
        reject_task_delegation_faile: 'Request to reject task delegation sent failed!',
        confirm_task_delegation_success: 'Confirm task delegation successfully!',
        confirm_task_delegation_faile: 'Confirm task delegation failed!',
        ...
        col_actual_end_date: 'Actual end date',
        col_status: 'Status',
        ...
        edit_employee_collaborated_failure: 'Can not edit employees to join task',
      ...
      task_perform: {
        ...
        edit_task_information_failure: 'Can not edit information',
        edit_document_task_comment_failure: 'Can not edit document',
      ...
      task_template: {
        ...
        error_task_template_creator_null: 'Creator of this task template does not exist or has been deleted',
        ...
        employee_kpi_set: {
          create_employee_kpi_set: {
            ...
            edit_target: {
              ...
              evaluated: 'KPI is being evaluated, you can not edit!'
            },
            ...
            handle_populate_info_null: {
              error_kpi_approver_null: 'Error! The approver of this KPI set does not exist or was deleted',
              error_kpi_organizational_unit_null: 'Error! The organizational unit of this KPI set does not exist or was deleted',
              error_kpi_parent_target_null: 'Error! The parent target of this KPI set does not exist or was deleted',
              error_kpi_targets_list_null: 'Error! The list targets of this KPI set does not exist or was deleted'
            }
          },
          ...
          messages_from_server: {
            ...
            create_employee_kpi_failure: 'Can not add KPI target',

            edit_employee_kpi_set_success: 'Edit employee KPI set successfully',
            edit_employee_kpi_set_failure: 'Can not edit employee KPI set',
            delete_employee_kpi_set_success: 'Delete employee KPI set successfully',
            delete_employee_kpi_set_failure: 'Can not delete employee KPI set',

            approve_success: 'Confirm request approval successfully',
            approve_failure: 'Can not confirm request approval',

            delete_employee_kpi_success: 'KPI target has been deleted',
            delete_employee_kpi_failure: 'Can not delete KPI target',

            edit_employee_kpi_success: 'KPI target has been edited',
            edit_employee_kpi_failure: 'Can not edit KPI target'
          }
        }
      },
      evaluation: {
        ...
        employee_evaluation: {
          ...
          weekly_point_field: 'Weekly point (Automatic - Employee - Approver)',
        ...
        set_task_importance_level_success: 'Set task importance level and evalutate KPI successfully',
        set_task_importance_level_fail: 'Can not set task importance level and evalutate KPI',
        set_point_kpi_success: 'Evalutate all KPIs successfully',
        set_point_kpi_fail: 'Can not evalutate all KPIs'
      },
      organizational_unit: {
        // Module chính
        create_organizational_unit_kpi_set: {
          ...
          confirm_approve: 'Are you sure you want to approve this KPI?',
          ...
          confirm_edit_status_failure: 'Can not edit KPI status',

          confirm_kpi: 'Are you sure you want to delete this KPI target?',
          confirm_approving: 'KPI has been activated, you can not delete!',
          confirm_delete_target_success: 'KPI target has been successful deleted',
          confirm_delete_target_failure: 'Can not delete KPI target',
        ...
        create_organizational_unit_kpi_set_modal: {
          ...
          month: 'Month',
          default_target: 'Default target',
          create_organizational_unit_kpi_set_success: 'KPI has been successfully initialized',
        ...
        update_evaluate_kpi_unit_fail: 'Can not update KPI unit evaluation',
    ...
    manage_warehouse: {
      ...
      good_management: {
        ...
        choose_base_unit: 'Please select the unit to create the packing rule',
        packing_rule: 'Packing rule',
        non_choose_base_unit: 'Not select',
        choose_base_unit_all: 'Select all',
        error_packing_rule: 'The selected unit cannot form a packing rule. Please choose again!',
        ...
        validate_number_expiration_date: 'Expiration date cannot be left blank',
        validate_number_expiration_date_input: 'Expiry date must be greater than 0'
      },
      ...
      bill_management: {
        ...
        quantity_error_input_1: 'The quantity entered must not be greater than the quantity remaining in the lot',
        ...
        error_phone_receiver: 'Receiver phone number cannot be ',
        ...
        choose_all_lot: 'Please enter the total number of products in the consignment to create a receipt',
        create_product_bill_successfully: 'Add successfully',
    ...
    production: {
      request_management: {
        ...
        index: 'Index',
        select_all: 'Select all',
        1: { content: 'no process', color: 'orange' },
        2: { content: 'done processing ', color: 'green' },
        3: { content: 'cancelled', color: 'red' },
        purchasing_request: {
          1: { content: 'waiting for approval', color: 'orange' },
          2: { content: 'request sent to order', color: 'green' },
          3: { content: 'Approved', color: 'violet' },
          4: { content: 'Purchase form is created', color: 'blue' },
          5: { content: 'waiting for approval', color: 'orange' },
          6: { content: 'request sent to stock', color: 'blue' },
          7: { content: 'Approved', color: 'green' },
          8: { content: 'Completed', color: 'blue' },
          9: { content: 'cancelled', color: 'red' },
          10: { content: 'cancelled', color: 'red' }
        },
        receipt_request_from_order: {
          1: { content: 'waiting for approval', color: 'orange' },
          2: { content: 'Approved', color: 'green' },
          3: { content: 'request sent to stock', color: 'green' },
          4: { content: 'Completed', color: 'blue' },
          5: { content: 'cancelled', color: 'red' }
        },
        ...
        create_successfully: 'Add request successfully',
        create_failed: 'Add request failed',
        description: 'Description',
        good_code: 'Good code',
        good_name: 'Good name',
        good_base_unit: 'Good base unit',
        ...
        number_status: 'Number of request by status',
        purchase_request: 'Purchase request',
        receipt_request: 'Receipt request',
        issue_request: 'Issue request',
        approver: 'Approver',
        approver_in_factory: 'Approver in factory',
        validate_approver_in_factory: 'Approver in factory is required',
        approver_in_order: 'Approver in order',
        validate_approver_in_order: 'Approver in order is required',
        approver_in_stock: 'Approver in stock',
        validate_approver_in_stock: 'Approver in stock is required',
        desired_warehouse: 'Desired warehouse',
        request_sent_from: 'Request sent from',
        ...
        validate_unit: 'Unit is required',
        manufacturing_works: 'Manufacturing works',
        choose_manufacturing_works: '---choose manufacturing works ---',
    ...
    project: {
      ...
      select_all_type: 'Select all project type',
      search_by_employees: 'Enter name or email',
      search: 'Search',
      add_err_end_date: 'End date should be after start date',
      add_err_empty_start_date: 'Start date should not be empty',
      ...
      get_project_phase_success: 'Get phases success',
      get_project_phase_fail: 'Get phases fail',
      get_phase_success: 'Get phase success',
      get_phase_fail: 'Get phase fail',
      create_phase_success: 'Create phase success',
      create_phase_fail: 'Create phase fail',
      create_milestone_success: 'Create milestone success',
      create_milestone_fail: 'Create milestone fail',
      create_phase_project_success: 'Create phases from file success',
      create_phase_project_fail: 'Fail to create phases from file',
      edit_phase_success: 'Edit phase success',
      edit_phase_fail: 'Fail to edit phase',
      delete_phase_success: 'Delete phase success',
      delete_phase_fail: 'Delete phase fail',
      get_project_milestone_success: 'Get milestones success',
      get_project_milestone_fail: 'Get milestones fail',
      edit_milestone_success: 'Edit milestone success',
      edit_milestone_fail: 'Edit milestone fail',
      delete_milestone_success: 'Delete milestone success',
      delete_milestone_fail: 'Fail to delete milestone',
      total: 'Total',
      ...
      eval: {
        undefined:
          'Nếu costPerformanceIndex không tính được (mẫu số actualCost = 0 HOẶC costPerformanceIndex = Infinity): Điểm = Chưa tính được',
    ...
    manage_risk_plan: {
      ...
      delete: 'Delete plan',
      delete_success: 'Delete plan successfully',
      delete_failure: 'Delete plan fail',
      add: 'Create new plan',
      add_success: 'Add risk response plan successfully',
      add_failure: 'Add risk response plan fail',
      edit: 'Edit plan',
      edit_success: 'Edit plan successfully',
