export default {
  ...
  messages: {
    ...
    manage_authorization_policy: {
      ...
      detail_info_policy: 'Detail information of policy',
      general_information: 'General information',
      requester_information: 'Requester attributes information',
      resource_information: 'Resource attributes information',
      policy_information: 'Policy information',
      authorization_requirements: 'Authorization requirements',
      authorized_information: 'Authorization by policy',
      authorized_requester: 'Authorized requesters',
      authorized_resource: 'Authorized resources',
      authorized_role: 'Authorized roles',
      authorized_requester_name: 'User name',
      authorized_requester_type: 'Type',
      authorized_resource_name: 'Resource name',
      authorized_resource_type: 'Resource type',
      authorized_resource_additional_info: 'Additional Info',
      authorized_role_name: 'Role name',
      attributes_information: 'Attributes infomation',
      attribute_owner_table: 'Attribute of',
      requester_table: 'Requester',
      role_table: 'Role',
      resource_table: 'Resource',
      ...
      attribute_name: 'Attribute name',
      attribute_value: 'Attribute value',
      edit_requester_attribute: 'Edit requester attribute',
      edit_role_attribute: 'Edit role attribute',
      edit_resource_attribute: 'Edit resource attribute',
      add_requester_attribute: 'Add requester attribute',
      add_role_attribute: 'Add role attribute',
      ...
      requester: {
        ...
        attribute_description_example: 'VD: Manager of project A',
        add_attribute_title: 'Add requester attribute',
        requesters_add_attribute: 'Attributes of requesters',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected'
      },
      role: {
      ...
      environment: {
        add_attribute: 'Add attribute',
        add_environment_attribute: 'Add environment attribute',
        attributes: 'Resource attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        ...
        attribute_value_example: 'VD: PageProjectA',
        attribute_description_example: 'VD: Page for project A',
        add_attribute_title: 'Add environment attribute',
        environments_add_attribute: 'Attributes of environments',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected'
      },
      task: {
    ...
    manage_delegation_policy: {
      ...
      detail_info_policy: 'Detail information of policy',
      general_information: 'General information',
      delegator_information: 'Delegator attributes information',
      delegatee_information: 'Delegatee attributes information',
      policy_information: 'Policy information',
      delegation_requirements: 'Delegation requirements',
      delegated_information: 'Delegation using policy',
      delegated_name: 'Name',
      ...
      delegate_object_table: 'Delegate object',
      ...
      edit_delegate_object_attribute: 'Edit delegate object attribute',
      edit_delegatee_attribute: 'Edit delegatee attribute',
      add_delegator_attribute: 'Add delegator attribute',
      add_delegate_object_attribute: 'Add delegate object attribute',
      ...
      delegate_object: {
        attributes: 'Delegate object attributes',
        attribute_name: 'Attribute name',
        attribute_value: 'Attribute value',
        attribute_description: 'Attribute description',
        attribute_name_example: 'VD: Group',
        attribute_value_example: 'VD: Leader',
        attribute_description_example: 'VD: Delegate object position in group',
        add_attribute_title: 'Add delegate object attribute',
        delegate_objects_add_attribute: 'Attributes of delegate objects',
        attribute_select: 'Select attribute',
        attribute_not_selected: 'Attribute not selected',
        add_attribute: 'Add attribute',
        add_delegate_object_attribute: 'Add delegate object attribute'
    ...
    manage_delegation: {
      ...
      delegateTypeResource: 'Resource delegation',
      ...
      resource_delegation_title: 'Resource delegation',
      choose_delegate_resource: 'Choose resource to delegate ',
      resource_delegation_title_add: 'Add a resource delegation',
      resource_delegation_title_edit: 'Edit a resource delegation',
      no_blank_delegate_resource: 'Delegate resource must not be empty',
      delegatee_resource: 'Delegatee Resource',
      delegator_resource: 'Delegator Resource',
      choose_delegatee_resource: 'Choose delegatee resource',
      choose_delegator_resource: 'Choose delegator resource',
      delegate_resource: 'Delegate resource',
      api: {
        url: 'URL',
        action: 'Action'
      },
