export default {
  ...
  messages: {
    ...
    menu: {
      ...
      manage_requester: 'Quản lý người yêu cầu',
      manage_resource: 'Quản lý tài nguyên',
      manage_attribute: 'Quản lý thuộc tính',
      manage_policy: 'Quản lý chính sách',
      ...
      delegation_receive: 'Danh sách nhận',
      ...
      list_bidding_contract: 'Hợp đồng thầu',
      ...
      manage_purchasing_request: 'Quản lý phiếu đề nghị mua hàng',
      manufacturing_dashboard: 'Dashboard Quản lý sản xuất',
      analysis_manufacturing_performance: 'Phân tích hiệu suất sản xuất',
      detail_analysis_manufacturing_performance: 'Phân tích chi tiết',
    ...
    manufacturing_managerment: {
      manufacturing_process: {
        ...
        process_name: 'Tên dây chuyền sản xuất',
        process_start_date: 'Ngày bắt đầu',
        process_end_date: 'Ngày kết thúc',
        assign_employee: 'Phân công quản lý',
        assign_supervisor: 'Người giám sát',
    ...
    intro: {
      ...
      service_signup: {
        ...
        content: ['Miễn phí dùng thử 15 ngày', 'Tối đa truy cập 10 user', 'Trải nghiệm các tính năng miễn phí'],
        form: {
          customer: 'Khách hàng',
          email: 'Email',
          phone: 'Số điện thoại',
    ...
    auth: {
      validator: {
        ...
        confirm_password2_invalid: 'Mật khẩu cấp 2 không trùng khớp. Vui lòng kiểm tra lại',
    ...
    super_admin: {
      ...
      role: {
        ...
        role_manager_exist: 'Tên cho phân quyền của trưởng đơn vị này đã được sử dụng',
        role_deputy_manager_exist: 'Tên cho phân quyền của phó đơn vị này đã được sử dụng',
      ...
      policy: {
        ...
        attribute_selected_duplicate: 'Các thuộc tính đã chọn bị trùng với nhau',
        policy_delegation_exist: 'Tồn tại ủy quyền áp dụng chính sách!'
      },
      link: {
        // Thông điệp trả về từ server
    ...
    manage_role: {
      ...
      attribute_name_example: 'VD: Nhóm',
      attribute_value_example: 'VD: Trưởng nhóm',
    ...
    manage_service: {
      add: 'Thêm',
      add_title: 'Thêm tài khoản dịch vụ mới',
      add_common: 'Nhập tay',
      import: 'Thêm dữ liệu từ Chỉnh sửa thông tin tài khoản dịch vụ',
      import_title: 'Thêm dữ liệu dịch vụ từ file',
      info: 'Thông tin về tài khoản dịch vụ',
      edit: 'Chỉnh sửa thông tin tài khoản dịch vụ',
      disable: 'Ngưng hoạt động',
      enable: 'Hoạt động',
      delete: 'Xóa tài khoản',
      add_success: 'Tạo tài khoản thành công',
      ...
      status: 'Trạng thái tài khoản',
      add_attribute: 'Thêm thuộc tính',
      add_service_attribute: 'Thêm thuộc tính dịch vụ',
      attributes: 'Các thuộc tính của dịch vụ',
      attribute_name: 'Tên thuộc tính',
      attribute_value: 'Giá trị',
      attribute_description: 'Mô tả',
      attribute_name_example: 'VD: Project A',
      attribute_value_example: 'VD: PM',
      attribute_description_example: 'VD: Project Manager dự án A',
      add_attribute_title: 'Thêm thuộc tính cho dịch vụ',
      services_add_attribute: 'Các dịch vụ thêm thuộc tính',
      attribute_select: 'Chọn thuộc tính',
      attribute_not_selected: 'Chưa chọn thuộc tính'
    },
    ...
    manage_requester: {
      ...
      requester_type: 'Loại người yêu cầu',
      select_all_method: 'Chọn tất cả các phương thức',
      non_select_method: 'Chọn phương thức',
      type: 'Loại người yêu cầu',
      attribute: 'Thuộc tính',
      additional_info: 'Thông tin thêm',
      add_title: 'Thêm mới người truy cập',
      description: 'Mô tả',
      edit: 'Chỉnh sửa thông tin',
      delete: 'Xóa',
      add_success: 'Thêm mới thành công',
      ...
      category: 'Danh mục',
      add_attribute: 'Thêm thuộc tính',
      add_requester_attribute: 'Thêm thuộc tính người yêu cầu',
      attributes: 'Các thuộc tính của người yêu cầu',
      attribute_name: 'Tên thuộc tính',
      attribute_value: 'Giá trị',
      attribute_description: 'Mô tả',
      attribute_name_example: 'VD: Project A',
      attribute_value_example: 'VD: PageProjectA',
      attribute_description_example: 'VD: Trang truy cập dự án A',
      add_attribute_title: 'Thêm thuộc tính cho người yêu cầu',
      attribute_select: 'Chọn thuộc tính',
      attribute_not_selected: 'Chưa chọn thuộc tính'
    },
    ...
    manage_resource: {
      ...
      category: 'Danh mục',
      add_attribute: 'Thêm thuộc tính',
      add_resource_attribute: 'Thêm thuộc tính tài nguyên',
      ...
      attribute_value_example: 'VD: PageProjectA',
      attribute_description_example: 'VD: Trang truy cập dự án A',
      add_attribute_title: 'Thêm thuộc tính cho tài nguyên',
      attribute_select: 'Chọn thuộc tính',
      attribute_not_selected: 'Chưa chọn thuộc tính'
    },
    ...
    manage_attribute: {
      ...
      type_select: 'Chọn loại thuộc tính',
      type: {
        Authorization: 'Thuộc tính phân quyền',
        Delegation: 'Thuộc tính ủy quyền',
        Mixed: 'Thuộc tính chung'
      },
      add_type: 'Loại thuộc tính',
      type_not_selected: 'Chưa chọn loại thuộc tính'
    },
    manage_policy: {
      ...
      delete_fail: 'Xóa chính sách thất bại!',
      add: 'Thêm chính sách',
      add_title: 'Thêm mới chính sách phân quyền',
      ...
      satisfied_information: 'Phân quyền bởi chính sách',
      satisfied_subject: 'Người dùng được phân quyền',
      satisfied_resource: 'Tài nguyên được phân quyền',
      satisfied_subject_name: 'Tên người dùng',
      satisfied_subject_email: 'Địa chỉ email',
      satisfied_subject_role: 'Vai trò',
      satisfied_resource_name: 'Tên tài nguyên',
      satisfied_resource_type: 'Loại tài nguyên',
      satisfied_resource_description: 'Mô tả',
      attribute_owner_table: 'Thuộc tính của',
      role_table: 'Vai trò',
      user_table: 'Người dùng',
      resource_table: 'Tài nguyên',
      attribute_name: 'Tên thuộc tính',
      attribute_value: 'Giá trị',
      rule_table: 'Rule kiểm tra',
      edit_user_attribute: 'Chỉnh sửa thuộc tính người dùng',
      edit_role_attribute: 'Chỉnh sửa thuộc tính vai trò',
      edit_resource_attribute: 'Chỉnh sửa thuộc tính tài nguyên',
      add_user_attribute: 'Thêm thuộc tính người dùng',
      add_role_attribute: 'Thêm thuộc tính vai trò',
      add_resource_attribute: 'Thêm thuộc tính tài nguyên',
      ...
      user: {
        add_attribute: 'Thêm thuộc tính',
        add_user_attribute: 'Thêm thuộc tính user',
        attributes: 'Các thuộc tính của user',
        attribute_name: 'Tên thuộc tính',
        attribute_value: 'Giá trị',
        attribute_description: 'Mô tả',
        attribute_name_example: 'VD: Project A',
        attribute_value_example: 'VD: PM',
        attribute_description_example: 'VD: Project Manager dự án A',
        add_attribute_title: 'Thêm thuộc tính cho user',
        users_add_attribute: 'Các user thêm thuộc tính',
        attribute_select: 'Chọn thuộc tính',
        attribute_not_selected: 'Chưa chọn thuộc tính'
      },
      role: {
        attributes: 'Các thuộc tính của role',
        attribute_name: 'Tên thuộc tính',
        attribute_value: 'Giá trị',
        attribute_description: 'Mô tả',
        attribute_name_example: 'VD: Nhóm',
        attribute_value_example: 'VD: Trưởng nhóm',
        attribute_description_example: 'VD: Vị trí trong nhóm',
        add_attribute_title: 'Thêm thuộc tính cho role',
        roles_add_attribute: 'Các role thêm thuộc tính',
        attribute_select: 'Chọn thuộc tính',
        attribute_not_selected: 'Chưa chọn thuộc tính',
        add_attribute: 'Thêm thuộc tính',
        add_role_attribute: 'Thêm thuộc tính vai trò'
      ...
      resource: {
        add_attribute: 'Thêm thuộc tính',
        add_resource_attribute: 'Thêm thuộc tính resource',
        attributes: 'Các thuộc tính của resource',
        attribute_name: 'Tên thuộc tính',
        attribute_value: 'Giá trị',
        attribute_description: 'Mô tả',
        attribute_name_example: 'VD: Project A',
        attribute_value_example: 'VD: PageProjectA',
        attribute_description_example: 'VD: Trang truy cập dự án A',
        add_attribute_title: 'Thêm thuộc tính cho resource',
    ...
    manage_delegation_policy: {
      ...
      delete_fail: 'Xóa chính sách thất bại!',
      add: 'Thêm chính sách',
      add_title: 'Thêm mới chính sách ủy quyền',
      add_multi_policy: 'Thêm nhiều chính sách',
      add_one_policy: 'Thêm một chính sách',
      add_success: 'Thêm chính sách thành công!',
      add_fail: 'Thêm chính sách thất bại!',
      ...
      delegator: {
        add_attribute: 'Thêm thuộc tính',
        add_delegator_attribute: 'Thêm thuộc tính người ủy quyền',
        attributes: 'Các thuộc tính của người ủy quyền',
        attribute_name: 'Tên thuộc tính',
        attribute_value: 'Giá trị',
        attribute_description: 'Mô tả',
        attribute_name_example: 'VD: Project A',
        attribute_value_example: 'VD: PM',
        attribute_description_example: 'VD: Project Manager dự án A',
        add_attribute_title: 'Thêm thuộc tính cho người ủy quyền',
        delegators_add_attribute: 'Các người ủy quyền thêm thuộc tính',
        attribute_select: 'Chọn thuộc tính',
        attribute_not_selected: 'Chưa chọn thuộc tính'
      },
      delegatee: {
        attributes: 'Các thuộc tính của người nhận ủy quyền',
        attribute_name: 'Tên thuộc tính',
        attribute_value: 'Giá trị',
        attribute_description: 'Mô tả',
        attribute_name_example: 'VD: Nhóm',
        attribute_value_example: 'VD: Trưởng nhóm',
        attribute_description_example: 'VD: Vị trí trong nhóm',
        add_attribute_title: 'Thêm thuộc tính cho người nhận ủy quyền',
        delegatees_add_attribute: 'Các người nhận ủy quyền thêm thuộc tính',
        attribute_select: 'Chọn thuộc tính',
        attribute_not_selected: 'Chưa chọn thuộc tính',
        add_attribute: 'Thêm thuộc tính',
        add_delegatee_attribute: 'Thêm thuộc tính người nhận ủy quyền'
    ...
    manage_delegation: {
      ...
      delete: 'Xóa ủy quyền',
      delete_success: 'Xóa ủy quyền vai trò thành công!',
      delete_fail: 'Xóa ủy quyền vai trò thất bại!',
      add: 'Thêm ủy quyền',
      ...
      add_success: 'Thêm ủy quyền vai trò thành công!',
      add_fail: 'Thêm ủy quyền vai trò thất bại!',
      delegation_description: 'Mô tả ủy quyền',
      edit_role_delegation_title: 'Cập nhật ủy quyền vai trò',
      edit_delegation_success: 'Cập nhật ủy quyền vai trò thành công!',
      edit_delegation_fail: 'Cập nhật ủy quyền vai trò thất bại!',
      detail_info_delegation: 'Thông tin chi tiết ủy quyền vai trò',
      detail_info_delegation_task: 'Thông tin chi tiết ủy quyền công việc',
      no_blank_delegate_role: 'Vai trò ủy quyền không được bỏ trống',
      no_blank_delegate_task_role: 'Vai trò công việc ủy quyền không được bỏ trống',
      no_blank_delegatee: 'Người nhận ủy quyền không được bỏ trống',
      delegation_name_exist: 'Tên ủy quyền đã tồn tại',
      delegation_role_exist: 'Ủy quyền vai trò này đã tồn tại',
      not_select_link: 'Chưa chọn trang cho phép truy cập',
      user_role_exist: 'Người nhận ủy quyền đã có vai trò này',
      pending: 'Chờ kích hoạt',
      declined: 'Có yêu cầu từ chối',
      confirmed: 'Đã xác nhận',
      wait_confirm: 'Chờ xác nhận',
      revoked: 'Đã thu hồi',
      activated: 'Đang hoạt động',
      revoke_request: 'Thu hồi ủy quyền',
      revoke_success: 'Thu hồi ủy quyền vai trò thành công!',
      revoke_fail: 'Thu hồi ủy quyền vai trò thất bại!',
      general_information: 'Thông tin chung',
      log_activity: 'Hoạt động ủy quyền',
      log_activity_task: 'Hoạt động công việc',
      log_timesheet_task: 'Bấm giờ công việc',
      log_history_task: 'Lịch sử công việc',
      ...
      reject_success: 'Gửi yêu cầu từ chối ủy quyền vai trò thành công!',
      reject_fail: 'Gửi yêu cầu từ chối ủy quyền vai trò thất bại!',
      confirm_success: 'Xác nhận ủy quyền vai trò thành công!',
      confirm_fail: 'Xác nhận ủy quyền vai trò thất bại!',
      delegate_policy: 'Chính sách ủy quyền',
      choose_delegate_policy: 'Chọn chính sách ủy quyền',
      no_blank_delegate_policy: 'Chính sách ủy quyền không được bỏ trống',
      ...
      delegateTaskName: 'Công việc ủy quyền',
      ...
      revoke_task_delegation_faile: 'Thu hồi ủy quyền công việc thất bại!',
      delegation_task_exist: 'Đã tồn tại ủy quyền công việc trùng vai trò cho người nhận ủy quyền!',
      delegation_task_role_exist: 'Đã tồn tại ủy quyền công việc trùng vai trò đã chọn!',
      delegatee_already_in_task_responsible: 'Người nhận đã đảm nhận vai trò Người thực hiện trong công việc!',
      delegatee_already_in_task_accountable: 'Người nhận đã đảm nhận vai trò Người phê duyệt trong công việc!',
      delegatee_already_in_task_consulted: 'Người nhận đã đảm nhận vai trò Người tư vấn trong công việc!',
      delegatee_already_in_task_informed: 'Người nhận đã đảm nhận vai trò Người quan sát trong công việc!',
      delegator_is_delegatee: 'Người nhận ủy quyền công việc không thể ủy cho người khác',
      informed_get_by_delegation:
        'Vai trò Người quan sát của bạn có được khi ủy quyền cho người khác!\nVì vậy, bạn không thể ủy vai trò này',
      reject_task_delegation_success: 'Gửi yêu cầu từ chối ủy quyền công việc thành công!',
      reject_task_delegation_faile: 'Gửi yêu cầu từ chối ủy quyền công việc thất bại!',
      confirm_task_delegation_success: 'Xác nhận ủy quyền công việc thành công!',
      confirm_task_delegation_faile: 'Xác nhận ủy quyền công việc thất bại!',
      edit_task_delegation_success: 'Chỉnh sửa ủy quyền công việc thành công!',
      edit_task_delegation_faile: 'Chỉnh sửa ủy quyền công việc thất bại!'
    },
    ...
    human_resource: {
      ...
      profile: {
        ...
        employee_management: {
          ...
          importing_employee: 'Đang xử lí dữ liệu',
    ...
    asset: {
      ...
      maintainance: {
        ...
        edit_maintainance_success: 'Chỉnh sửa thông tin phiếu bảo trì-sửa chữa thành công',
        edit_maintainance_faile: 'Chỉnh sửa thông tin phiếu bảo trì-sửa chữa thất bại'
      },
      ...
      depreciation: {
        ...
        create_depreciation_failure: 'Thêm thông tin khấu hao tài sản thất bại',
        delete_depreciation_success: 'Xoá thông tin khấu hao tài sản thành công',
        delete_depreciation_failure: 'Xoá thông tin khấu hao tài sản thất bại',
      ...
      manage_use_request: {
        ...
        create_use_request_failure: 'Thêm phiếu đề nghị cấp phát thiết bị thất bại',
        delete_use_request_success: 'Xoá phiếu đề nghị cấp phát thiết bị thành công',
        delete_use_request_failure: 'Xoá phiếu đề nghị cấp phát thiết bị thất bại',
      ...
      purchase_request: {
        ...
        create_purchase_request_failure: 'Thêm phiếu đề nghị mua sắm thiết bị thất bại',
        delete_purchase_request_success: 'Xoá phiếu đề nghị mua sắm thiết bị thành công',
        delete_purchase_request_failure: 'Xoá phiếu đề nghị mua sắm thiết bị thất bại',
        edit_purchase_request_success: 'Chỉnh sửa thông tin phiếu thành công',
        edit_purchase_request_failure: 'Chỉnh sửa thông tin phiếu thất bại',
    ...
    task: {
      task_management: {
        ...
        confirm_assigned_failure: 'Bạn chưa xác nhận sắp xếp nhân viên tham gia phối hợp',
        unit_not_confirm_assigned_task: 'Đơn vị chưa xác nhận sắp xếp nhân viên tham gia phối hợp',
        ...
        col_actual_end_date: 'Thời điểm kết thúc thực tế',
        ...
        calc_passed_action_rating: 'Số hoạt động đạt (rating >= 5)',
        ...
        collaborated_with_organizational_units: 'Đơn vị phối hợp thực hiện',
    ...
    kpi: {
        ...
        employee_kpi_set: {
          create_employee_kpi_set: {
            ...
            edit_target: {
              ...
              evaluated: 'KPI đã được đánh giá, Bạn không thể chỉnh sửa!'
            },
            delete_kpi: {
          ...
          messages_from_server: {
            ...
            balance_employee_kpi_set_success: 'Cân bằng mục tiêu KPI thành công',
            balance_employee_kpi_set_failure: 'Cân bằng mục tiêu KPI thất bại',
      ...
      evaluation: {
        ...
        employee_evaluation: {
          ...
          weekly_point_field: 'Điểm từng tuần (Tự động - Tự đánh giá - Người phê duyệt đánh giá)',
        ...
        set_task_importance_level_success: 'Thêm độ quan trọng cho công việc và tính KPI thành công',
        set_task_importance_level_fail: 'Thêm độ quan trọng cho công việc và tính KPI lỗi',
        set_point_kpi_success: 'Tính điểm tất cả kpi thành công',
        set_point_kpi_fail: 'Tính điểm tất cả kpi lỗi'
      },
      organizational_unit: {
        // Module chính
        create_organizational_unit_kpi_set: {
          ...
          organizational_unit_kpi_allocation: 'Phân bổ Kpi công ty',
    ...
    manage_warehouse: {
      ...
      bill_management: {
        ...
        create_product_bill_successfully: 'Thêm phiếu thành công',
    ...
    manage_risk_plan: {
      ...
      description: 'Mô tả',
      delete: 'Xoá biện pháp',
      delete_success: 'Xoá biện pháp thành công',
      delete_failure: 'Xoá biện pháp thất bại',
      add: 'Thêm biện pháp',
      add_success: 'Thêm biện pháp thành công',
      add_failure: 'Thêm biện pháp thất bại',
      edit: 'Chỉnh sửa biện pháp',
      edit_success: 'Chỉnh sửa biện pháp thành công',
    ...
    manufacturing: {
      ...
      purchasing_request: {
        ...
        add_purchasing_request: 'Thêm phiếu đề nghị mua hàng',
    ...
    production: {
      request_management: {
        ...
        purchasing_request: {
          ...
          5: { content: 'Hàng hóa đã được mua về, đang chờ phê duyệt gửi đề nghị nhập kho', color: 'orange' },
          6: { content: 'Đã gửi đề nghị nhập kho', color: 'blue' },
          7: { content: 'Đã phê duyệt đề nghị nhập kho', color: 'green' },
          8: { content: 'Đã hoàn thành nhập kho', color: 'blue' },
          9: { content: 'Đã hủy đề nghị mua hàng', color: 'red' },
          10: { content: 'Đã hủy đề nghị nhập kho', color: 'red' }
        },
        ...
        receipt_request_from_order: {
          1: { content: 'Chờ phê duyệt', color: 'orange' },
          2: { content: 'Đã phê duyệt, đề nghị đã được gửi đến kho', color: 'green' },
          3: { content: 'Đã gửi phê duyệt đề nghị nhập kho', color: 'green' },
        ...
        issue_request_to_manufacturing: {
          1: { content: 'Chờ phê duyệt', color: 'orange' },
          2: { content: 'Đã phê duyệt, đề nghị đã được gửi đến kho', color: 'green' },
          3: { content: 'Đã gửi phê duyệt đề nghị xuất kho', color: 'green' },
        ...
        transport_request: 'Đề nghị vận chuyển',
        approver: 'Người phê duyệt',
        ...
        unit_receiving_request: 'Đơn vị tiếp nhận đề nghị',
        stock: 'Kho',
        choose_stock: '---Chọn kho---',
        validate_stock: 'Bạn cần chọn kho',
    ...
    project: {
      ...
      startTime: 'Thời gian bắt đầu dự án',
      endTime: 'Thời gian dự kiến kết thúc dự án',
      parent: 'Dự án cha',
      projectType: 'Hình thức quản lý',
      ...
      cpm: 'Phương pháp CPM',
      search_by_name: 'Tìm kiếm theo tên',
      select_type: 'Chọn hình thức quản lý',
      ...
      get_project_phase_success: 'Lấy thông tin giai đoạn thành công',
      get_project_phase_fail: 'Lấy thông tin giai đoạn thất bại',
      get_phase_success: 'Lấy thông tin giai đoạn thành công',
      get_phase_fail: 'Lấy thông tin giai đoạn thất bại',
      create_phase_success: 'Tạo giai đoạn mới thành công',
      create_phase_fail: 'Tạo giai đoạn mới thất bại',
      create_milestone_success: 'Tạo cột mốc hoàn thành',
      create_milestone_fail: 'Lỗi khi tạo cột mốc mới',
      create_phase_project_success: 'Tạo giai đoạn từ file thành công',
      create_phase_project_fail: 'Không thể tạo giai đoạn mới từ file',
      edit_phase_success: 'Chỉnh sửa thông tin giai đoạn thành công',
      edit_phase_fail: 'Chỉnh sửa thông tin giai đoạn thất bại',
      delete_phase_success: 'Xoá giai đoạn thành công',
      delete_phase_fail: 'Lỗi khi xoá giai đoạn',
      get_project_milestone_success: 'Lấy thông tin cột mốc thành công',
      get_project_milestone_fail: 'Lấy thông tin cột mốc thất bại',
      edit_milestone_success: 'Chỉnh sửa thông tin cột mốc thành công',
      edit_milestone_fail: 'Lỗi khi chỉnh sửa thông tin cột mốc',
      delete_milestone_success: 'Xoá cột mốc thành công',
      delete_milestone_fail: 'Không thể xoá cột mốc',
      total: 'Tổng',
