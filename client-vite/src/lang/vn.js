export default {
  ...
  messages: {
    ...
    menu: {
      ...
      manufacturing_dashboard: 'Dashboard thống kê sản xuất',
      analysis_manufacturing_performance: 'Dashboard KPI sản xuất',
    ...
    manage_authorization_policy: {
      ...
      authorized_role: 'Vai trò được phân quyền',
      authorized_requester_name: 'Tên người yêu cầu',
      authorized_requester_type: 'Loại',
      authorized_resource_name: 'Tên tài nguyên',
      authorized_resource_type: 'Loại tài nguyên',
      authorized_resource_additional_info: 'Thông tin thêm',
      authorized_role_name: 'Tên vai trò',
      attribute_owner_table: 'Thuộc tính của',
      role_table: 'Vai trò',
      requester_table: 'Người yêu cầu',
      resource_table: 'Tài nguyên',
      attribute_name: 'Tên thuộc tính',
      attribute_value: 'Giá trị',
      rule_table: 'Rule kiểm tra',
      edit_requester_attribute: 'Chỉnh sửa thuộc tính người yêu cầu',
      edit_role_attribute: 'Chỉnh sửa thuộc tính vai trò',
      edit_resource_attribute: 'Chỉnh sửa thuộc tính tài nguyên',
      add_requester_attribute: 'Thêm thuộc tính người yêu cầu',
      add_role_attribute: 'Thêm thuộc tính vai trò',
      ...
      requester: {
        ...
        attribute_description_example: 'VD: Project Manager dự án A',
        add_attribute_title: 'Thêm thuộc tính cho người yêu cầu',
        requesters_add_attribute: 'Những người yêu cầu thêm thuộc tính',
        attribute_select: 'Chọn thuộc tính',
        attribute_not_selected: 'Chưa chọn thuộc tính'
      },
      role: {
      ...
      resource: {
        ...
        attribute_description_example: 'VD: Trang truy cập dự án A',
        add_attribute_title: 'Thêm thuộc tính cho tài nguyên',
        resources_add_attribute: 'Các tài nguyên thêm thuộc tính',
        attribute_select: 'Chọn thuộc tính',
        attribute_not_selected: 'Chưa chọn thuộc tính'
      },
      environment: {
    ...
    manufacturing: {
      ...
      plan: {
        ...
        task_template: {
          responsible: 'Mẫu công việc thực hiện lệnh',
          quality_control: 'Mẫu công việc kiểm định chất lượng',
        },
      ...
      command: {
        ...
        employee_schedule: 'Lịch nhân viên',
        machine_schedule: 'Lịch máy móc',
        employee: 'Nhân viên',
        machine: 'Máy móc',
        month: 'Tháng',
        week: 'Tuần',
        ...
        qc_name: 'Tên người kiểm định',
        qc_email: 'Email',
        qc_operation: 'Công đoạn kiểm định',
        choose_qc_operation: 'Chọn phân đoạn kiểm định',
        oqc: 'Kiểm định thành phẩm',
      ...
      performance: {
        ...
        // create kpi form
        create_kpi_title: 'Thêm mới KPI',
        create_successfully: 'Thêm KPI thành công',
        create_failed: 'Thêm KPI thất bại',
        kpi_name: 'Tên KPI',
        kpi_category: 'Danh mục KPI',
        choose_category: 'Chọn danh mục',
        formula: 'Công thức',
        formula_description: 'Công thức tính giá trị KPI',
        attribute_description: "Các thuộc tính được thu thập tự động",
        target: 'Mục tiêu',
        unit: 'Đơn vị',
        threshold: 'Ngưỡng cảnh báo',
        threshold_description: "Khi giá trị KPI vượt quá ngưỡng cảnh báo, hệ thống sẽ tự động gửi thông báo",
        threshold_value: 'Mức cảnh báo',
        lowValue: 'Giá trị dưới',
        highValue: 'Giá trị trên',
        high: "Cao",
        medium: "Trung Bình",
        low: "Thấp",
        ...
        show_target: 'Hiển thị mục tiêu',
        show_trend: 'Hiển thị xu hướng',
        visualize: 'Hiển thị',
        ...
        // failureReasons
        failure_reason_analysis: 'Phân tích nguyên nhân',
        ...
        manpower: 'Nhân viên',
        method: 'Phương pháp',
        measurement:  'Kiểm tra',
        enviroment: 'Môi trường',
        add_failure: 'Thêm lỗi hiệu suất KPI',
        choose_cause_type: 'Chọn nguyên nhân',
        add_failure_successfully: 'Thêm lỗi sản xuất thành công',
        add_failure_failure: 'Thêm lỗi sản xuất thất bại',
      },
      quality: {
        index: 'STT',
        search: 'Tìm kiếm',
        ...
        dashboard_tab: "Dashboard thống kê",
        ...
        dashboard: {
          num_inspection: "Số phiếu kiểm định đã tạo",
          num_criteria: "Số tiêu chí đã tạo",
          passed_num: "Số lượng đạt yêu cầu",
          error_num: "Số lượng lỗi",
          error_rate: "Tỉ lệ lỗi theo nhóm",
          error_num_by_reporter: "Số lỗi phát hiện theo nhân viên kiểm định"
        }
      },
      routing: {
        // home
        ...
        asset_code: 'Mã tài sản',
        cost: 'Chi phí',
        estimated_hprs: 'Tổng sản lượng ước tính',
        avail_worker: 'Nhân viên khả dụng',
        ...
        cost_per_hour: 'Chi phí vận hành theo giờ',
