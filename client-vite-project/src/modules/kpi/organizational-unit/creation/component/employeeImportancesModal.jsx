...
function EmployeeImportancesModal(props) {
  ...
  useEffect(() => {
    ...
    if (
      employeeImportancesState &&
      user?.employeesOfUnitsUserIsManager &&
      user?.employeesOfUnitsUserIsManager?.[0]?.idUnit === organizationalUnitId &&
      updateEmployee
    ) {
      ...
      >
        ...
        >
          ...
          <table className='table table-hover table-bordered'>
            ...
            <tbody>
              {employeeImportancesState &&
                employeeImportancesState.length !== 0 &&
