      ...
      >
        ...
        <div className='nav-tabs-custom'>
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a href='#customer-general' data-toggle='tab'>
                Thông tin chung
              </a>
            </li>
            <li>
              <a href='#customer-fileAttachment-create' data-toggle='tab'>
                Tài liệu liên quan
              </a>
            </li>
          </ul>
          <div className='tab-content'>
            ...
            {newCustomer && newCustomer.owner && (
              <GeneralTabCreateForm id={'customer-general'} callBackFromParentCreateForm={myCallBack} newCustomer={newCustomer} />
            )}

            {/* Tab file liên quan đến khách hàng */}
            {<FileTabCreateForm id={'customer-fileAttachment-create'} callBackFromParentCreateForm={myCallBack} />}
          </div>
        </div>
      </DialogModal>
    </React.Fragment>
