...
function CrmDashBoard(props) {
  ...
  const data = {
    x: 'x',
    xFormat: '%m/%Y',
    columns: [x, completionRateData, solutionRateData]
  }
  const axis = {
    x: {
      type: 'timeseries',
          ...
          <div className='info-box'>
            ...
            <div className='info-box-content'>
              ...
              <span className='info-box-number'>
                {customerCareInfoByEmployee ? customerCareInfoByEmployee.listManagedCustomer.length : 0}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='col-md-3 col-sm-6 col-xs-12'>
          <div className='info-box'>
            ...
            <div className='info-box-content'>
              ...
              <span className='info-box-number'>
                {customerCareInfoByEmployee ? customerCareInfoByEmployee.numberOfCompletionCareAction : 0}
              </span>
            </div>
          </div>
        </div>
        <div className='col-md-3 col-sm-6 col-xs-12'>
          <div className='info-box'>
            ...
            <div className='info-box-content'>
              ...
              <span className='info-box-number'>
                {customerCareInfoByEmployee ? customerCareInfoByEmployee.numberOfOverdueCareAction : 0}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className='box box-primary'>
            <div className='box-header with-border'>
              <div className='box-title'>
                <label>
                  {' '}
                  <span>Biểu đồ đánh giá hoạt động CSKH</span>
                </label>
              </div>
            </div>
            <div className='box-body qlcv'>
