...
function GroupPromotionInfoForm(props) {
  ...
  return (
    <DialogModal
      modalID='modal-group-promotion-info-1'
      isLoading={crm.groups.isLoading}
    ...
    >
      ...
      {group && groupPromotionEdit && (
        <PromotionEditForm groupId={group._id} groupPromotionEdit={groupPromotionEdit} getRefreshData={() => getRefreshData()} />
      )}
            ...
            group.promotions.map((o, index) => (
              <tr key={o.code}>
                ...
                <td style={{ textAlign: 'center' }}>
                  <a className='text-yellow' title='Chỉnh sửa khuyến mãi nhóm khách hàng' onClick={() => handleEditPromotion(o)}>
