  ...
  return (
    <React.Fragment>
      <ButtonModal
        ...
        button_name='Chỉnh sửa chỉ tiêu công việc'
        title='Chỉnh sửa chỉ tiêu công việc'
      />
      <DialogModal
        modalID='modal-crm-customer-care-KPI-edit'
        isLoading={false}
      ...
      >
        <form id='form-crm-crm-customer-care-KPI-edit'>
          <fieldset className='scheduler-border'>
            <legend className='scheduler-border'>{'Chỉ tiêu cho công việc "Tìm kiếm khách hàng mới"'}</legend>
            <div className={`form-group`}>
              <strong style={{ color: 'green' }}> Chỉ tiêu số lượng khách hàng mới </strong>
              <div style={{ marginLeft: '3%', width: '80%' }}>
                <label>
                  {'Số lượng khách hàng mới'}
                  <span className='attention' style={{ color: 'red' }}>
                    {' '}
                    *{' '}
                  </span>
                </label>
                <input
                  ...
                  value={crmUnitKPIState ? crmUnitKPIState.numberOfNewCustomers.value : 0}
                  onChange={handleChangeNumberOfNewCustomersValue}
                />
                <label>
                  {'Trọng số'}
                  <span className='attention' style={{ color: 'red' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.numberOfNewCustomers.weight : 0}
                  onChange={handleChangeNumberOfNewCustomersWeight}
                />
              </div>
            ...
            <div className={`form-group`}>
              ...
              <div style={{ marginLeft: '3%', width: '80%' }}>
                <label>
                  {'Tỉ lệ mua hàng ở khách hàng mới (%)'}
                  <span className='attention' style={{ color: 'red' }}>
                    {' '}
                    *{' '}
                  </span>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.newCustomerBuyingRate.value : 0}
                  onChange={handleChangeNewCustomerBuyingRateValue}
                />
                <label>
                  {'Trọng số'}
                  <span className='attention' style={{ color: 'red' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.newCustomerBuyingRate.weight : 0}
                  onChange={handleChangeNewCustomerBuyingRateWeight}
                />
              </div>
              {/* <ErrorLabel content={groupCodeError} /> */}
            </div>
          ...
          <fieldset className='scheduler-border'>
            <legend className='scheduler-border'>{'Chỉ tiêu cho công việc "Chăm sóc khách hàng"'}</legend>
            <div className={`form-group`}>
              <strong style={{ color: 'green' }}> Chỉ tiêu số lượng hoạt động chăm sóc khách hàng </strong>
              <div style={{ marginLeft: '3%', width: '80%' }}>
                <label>
                  {'Số lượng hoạt động chăm sóc khách hàng'}
                  <span className='attention' style={{ color: 'red' }}>
                    {' '}
                    *{' '}
                  </span>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.totalActions.value : 0}
                  onChange={handleChangeTotalActionsValue}
                />
                <label>
                  {'Trọng số'}
                  <span className='attention' style={{ color: 'red' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.totalActions.weight : 0}
                  onChange={handleChangeTotalActionsWeight}
                />
              </div>
              {/* <ErrorLabel content={groupCodeError} /> */}
            </div>
            <div className={`form-group`}>
              ...
              <div style={{ marginLeft: '3%', width: '80%' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.completionRate.value : 0}
                  onChange={handleChangeCompletionRateValue}
                />
                <label>
                  {'Trọng số'}
                  <span className='attention' style={{ color: 'red' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.completionRate.weight : 0}
                  onChange={handleChangeCompletionRateWeight}
                />
              </div>
              {/* <ErrorLabel content={groupCodeError} /> */}
            </div>
            <div className={`form-group`}>
              ...
              <div style={{ marginLeft: '3%', width: '80%' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.solutionRate.value : 0}
                  onChange={handleChangeSolutionRateValue}
                />
                <label>
                  {'Trọng số'}
                  <span className='attention' style={{ color: 'red' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.solutionRate.weight : 0}
                  onChange={handleChangeSolutionRateWeight}
                />
              </div>
              {/* <ErrorLabel content={groupCodeError} /> */}
            </div>
            <div className={`form-group`}>
              ...
              <div style={{ marginLeft: '3%', width: '80%' }}>
                <label>
                  {'Tỉ lệ khách hàng quay lại mua hàng '}
                  <span className='attention' style={{ color: 'red' }}>
                    {' '}
                    *{' '}
                  </span>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.customerRetentionRate.value : 0}
                  onChange={handleChangeCustomerRetentionRateValue}
                />
                <label>
                  {'Trọng số'}
                  <span className='attention' style={{ color: 'red' }}>
                ...
                <input
                  ...
                  className='form-control'
                  style={{ borderRadius: '5px' }}
                  value={crmUnitKPIState ? crmUnitKPIState.customerRetentionRate.weight : 0}
                  onChange={handleChangeCustomerRetentionRateWeight}
                />
              </div>
              {/* <ErrorLabel content={groupCodeError} /> */}
            </div>
