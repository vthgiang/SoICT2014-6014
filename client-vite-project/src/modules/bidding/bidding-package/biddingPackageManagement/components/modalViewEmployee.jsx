...
const ModalViewEmployee = (props) => {
  ...
  return (
    <React.Fragment>
      <DialogModal
        size='100'
        modalID={`modal-view-employee-${id}`}
      ...
      >
        <div className='box'>
          <div className='box-body qlcv'>
            <div className='form-inline'>
              ...
              <div className='form-group'>
                <button
                  ...
                  onClick={() => handleSubmitSearch(state.nameSearch)}
                >
              ...
              <thead>
                <tr>
                  ...
                  <th style={{ width: '120px', textAlign: 'center' }}>
                    ...
                    <DataTableSetting
                      tableId={tableId}
                      columnArr={['Tên nhân viên', 'Trình độ chuyên môn', 'Số lượng công việc cần làm']}
                      // setLimit={setLimit}
                    />
                  </th>
                </tr>
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td style={{ textAlign: 'center' }}>
                            <a style={{ width: '5px' }} onClick={() => handleView(x)} title='detail'>
            ...
            {/* From xem thông tin nhân viên */ <EmployeeDetailForm _id={currentRowView ? currentRowView.empId : ''} />}
          </div>
        </div>
      </DialogModal>
    </React.Fragment>
