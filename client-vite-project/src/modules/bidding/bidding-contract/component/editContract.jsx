      ...
      <form id={`form-edit-bidding-contract-${id}`}>
        <div className='nav-tabs-custom' style={{ boxShadow: 'none', MozBoxShadow: 'none', WebkitBoxShadow: 'none', marginBottom: 0 }}>
          ...
          <ul className='nav nav-tabs'>
            ...
            <li className='active'>
              <a title='Thông tin chung' data-toggle='tab' href={`#edit-general-${id}`}>
                Thông tin chung
              </a>
            </li>
            {/* Nút tab các bên tgia */}
            <li>
              <a title='Các bên tham gia' data-toggle='tab' href={`#edit-party-${id}`}>
                Các bên tham gia
              </a>
            </li>
            {/* Nút tab quyết định giao triển khai hợp đồng */}
            <li>
              <a title='Quyết định giao triển khai hợp đồng' data-toggle='tab' href={`#edit-decision-${id}`}>
          ...
          <div className='tab-content'>
            {generalInfo()}
            {partyForm()}
            <DecisionForImplement type={'edit'} id={`edit-decision-${id}`} biddingContract={state} handleChange={handleChange} />
          </div>
        </div>
      </form>
    </DialogModal>
