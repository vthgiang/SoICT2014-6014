    ...
    sections: [
      {
        children: [
          ...
          createBulletHeader(
            `Căn cứ biên bản hoàn thiện hợp đồng đã được chủ đầu tư và nhà thầu trúng thầu ký ngày ___ tháng ___ năm ____`
          ),
          ...
          createBulletNumber(
            `Phụ lục hợp đồng gồm điều khoản tham chiếu, dự toán kinh phí, danh sách nhân sự của nhà thầu, trách nhiệm báo cáo của nhà thầu;`
          ),
          ...
          createBulletHeader(
            `Nộp báo cáo cho chủ đầu tư trong thời hạn và theo các hình thức được nêu trong Phụ lục B “Dự toán kinh phí, danh sách nhân sự của nhà thầu” để thực hiện dịch vụ;`
          ),
          createBulletHeader(
            `Đảm bảo huy động và bố trí nhân sự, dự toán kinh phí được liệt kê tại Phụ Lục C “Trách nhiệm báo cáo của nhà thầu”;`
          ),
          ...
          createBulletHeader(
            `Chủ đầu tư cam kết thanh toán cho nhà thầu theo giá hợp đồng và phương thức nêu tại Điều 5 của hợp đồng này cũng như thực hiện đầy đủ nghĩa vụ và trách nhiệm khác được quy định tại ĐKC và ĐKCT của hợp đồng.`
          ),
          createBulletHeader(
            `Chủ đầu tư chỉ định ông/bà ${contract.representativeNameA} là cán bộ phụ trách của chủ đầu tư để điều phối các hoạt động thuộc phạm vi hợp đồng này.`
          ),
          createBulletHeader(
            `Đảm bảo huy động và bố trí nhân sự, dự toán kinh phí được liệt kê tại Phụ Lục C “Trách nhiệm báo cáo của nhà thầu”;`
          ),
          ...
          createText(
            `  Chủ đầu tư thanh toán cho nhà thầu các chi phí khác với mức trần là [Ghi giá trị và đồng tiền thanh toán] cho các khoản chi thực tế hoặc khoán gọn dưới đây`
          ),
          createText(
...
const createSignatureBottom = (repA = '[Ghi tên, chức danh, ký tên và đóng dấu]', repB = '[Ghi tên, chức danh, ký tên và đóng dấu]') => {
  return new TableRow({
    children: [
      new TableCell({
        children: [
