      ...
      <div className='get-employee'>
        <div className='nav-tabs-custom'>
          <ul className='nav nav-tabs'>
            <li className='active'>
              <a title='Tìm kiếm nhân sự gói thầu theo vị trí công việc' data-toggle='tab' href='#find_by_position'>
                Tìm kiếm theo vị trí công việc
              </a>
            </li>
            <li>
              <a title='Tìm kiếm theo gói thầu' data-toggle='tab' href='#find_by_bidding_package'>
                Tìm kiếm theo gói thầu
              </a>
            </li>
          </ul>
