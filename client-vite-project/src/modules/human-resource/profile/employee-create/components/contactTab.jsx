      ...
      <div className='box-body'>
        <div className='row'>
          ...
          <div className={`form-group col-md-4`}>
            ...
            <input
              ...
              placeholder={translate('human_resource.profile.mobile_phone_1')}
              autoComplete='off'
            />
          </div>
          ...
          <div className='form-group col-md-4'>
            ...
            <input
              ...
              placeholder={translate('human_resource.profile.mobile_phone_2')}
              autoComplete='off'
            />
          </div>
        </div>
        <div className='row'>
          ...
          <div className={`form-group col-md-4 `}>
            ...
            <input
              ...
              placeholder={translate('human_resource.profile.personal_email_1')}
              autoComplete='off'
            />
          </div>
          {/* Email cá nhân 2 */}
          <div className={`form-group col-md-4`}>
            ...
            <input
              ...
              className='form-control'
              name='personalEmail2'
              value={personalEmail2 ? personalEmail2 : ''}
              onChange={handleEmail2Change}
              placeholder={translate('human_resource.profile.personal_email_2')}
              autoComplete='off'
            />
          </div>
          {/* Điện thoại cố định */}
          <div className='form-group col-md-4'>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder={translate('human_resource.profile.home_phone')}
              autoComplete='off'
            />
          </div>
        </div>
          ...
          <div className='row'>
            ...
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder={translate('human_resource.profile.full_name')}
                autoComplete='off'
              />
            </div>
            {/* Quan hệ */}
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                value={relationWithEmergencyContactPerson ? relationWithEmergencyContactPerson : ''}
                onChange={handleChange}
                placeholder={translate('human_resource.profile.nexus')}
                autoComplete='off'
              />
            </div>
            {/* Địa chỉ */}
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                value={emergencyContactPersonAddress ? emergencyContactPersonAddress : ''}
                onChange={handleChange}
          ...
          <div className='row'>
            ...
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                value={emergencyContactPersonPhoneNumber ? emergencyContactPersonPhoneNumber : ''}
                onChange={handleChange}
                placeholder={translate('human_resource.profile.mobile_phone')}
                autoComplete='off'
              />
            </div>
            {/* Điện thoại cố định */}
            <div className='form-group col-md-4'>
              ...
              <input
                ...
                value={emergencyContactPersonHomePhone ? emergencyContactPersonHomePhone : ''}
                onChange={handleChange}
                placeholder={translate('human_resource.profile.home_phone')}
                autoComplete='off'
              />
            ...
            <div className={`form-group col-md-4`}>
              ...
              <input
                ...
                value={emergencyContactPersonEmail ? emergencyContactPersonEmail : ''}
                onChange={handleEmergencyContactPersonEmailChange}
                placeholder={translate('human_resource.profile.email')}
                autoComplete='off'
              />
            </div>
          </div>
        ...
        <div className='row'>
          <div className='col-md-6'>
            ...
            <fieldset className='scheduler-border'>
              <legend className='scheduler-border'>
                <h4 className='box-title'>{translate('human_resource.profile.permanent_address')}</h4>
              </legend>
              {/* Địa chỉ */}
              <div className='form-group'>
                ...
                <input
                  ...
                  value={permanentResidence ? permanentResidence : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.address')}
                  autoComplete='off'
                />
              ...
              <div className='form-group'>
                ...
                <input
                  ...
                  value={permanentResidenceWard ? permanentResidenceWard : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.wards')}
                  autoComplete='off'
                />
              </div>
              {/* Huyện/Quận */}
              <div className='form-group'>
                ...
                <input
                  ...
                  value={permanentResidenceDistrict ? permanentResidenceDistrict : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.district')}
                  autoComplete='off'
                />
              </div>
              {/* Tỉnh/Thành phố */}
              <div className='form-group'>
                ...
                <input
                  ...
                  value={permanentResidenceCity ? permanentResidenceCity : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.province')}
                  autoComplete='off'
                />
              </div>
              {/* Quốc gia */}
              <div className='form-group'>
                ...
                <input
                  ...
                  value={permanentResidenceCountry ? permanentResidenceCountry : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.nation')}
                  autoComplete='off'
                />
              </div>
            </fieldset>
          ...
          <div className='col-md-6'>
            ...
            <fieldset className='scheduler-border'>
              <legend className='scheduler-border'>
                <h4 className='box-title'> {translate('human_resource.profile.current_residence')}</h4>
              </legend>
              {/* Địa chỉ hiện tại */}
              <div className={`form-group`}>
                <label>{translate('human_resource.profile.address')}</label>
                <input
                  ...
                  value={temporaryResidence ? temporaryResidence : ''}
                  onChange={handleNowAddressChange}
                  placeholder={translate('human_resource.profile.address')}
                  autoComplete='off'
                />
              </div>
              ...
              <div className='form-group'>
                ...
                <input
                  ...
                  value={temporaryResidenceWard ? temporaryResidenceWard : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.wards')}
                  autoComplete='off'
                />
              ...
              <div className='form-group'>
                ...
                <input
                  ...
                  value={temporaryResidenceDistrict ? temporaryResidenceDistrict : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.district')}
                  autoComplete='off'
                />
              ...
              <div className='form-group'>
                ...
                <input
                  ...
                  value={temporaryResidenceCity ? temporaryResidenceCity : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.province')}
                  autoComplete='off'
                />
              ...
              <div className='form-group'>
                ...
                <input
                  ...
                  value={temporaryResidenceCountry ? temporaryResidenceCountry : ''}
                  onChange={handleChange}
                  placeholder={translate('human_resource.profile.nation')}
                  autoComplete='off'
                />
