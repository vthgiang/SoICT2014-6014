...
function DetailUser(props) {
  ...
  useEffect(() => {
    if (props.user._id) {
      UserServices.getUserById(props.user._id).then((res) => {
    ...
    <div className='nav-tabs-custom'>
      <div className='col-xs-12'>
        <ul className='nav nav-tabs'>
          <li className='active'>
            <a href='#task' data-toggle='tab' onClick={() => handleNavTabs()}>
              Công việc nhân viên
            </a>
          </li>
          <li>
            <a href='#asset' data-toggle='tab' onClick={() => handleNavTabs(true)}>
              Tài sản nhân viên
            </a>
          </li>
          <li>
            <a href='#commendation-dícipline' data-toggle='tab' onClick={() => handleNavTabs(true)}>
              Khen thường và kỷ luật
            </a>
          </li>
          <li>
            <a href='#kpi' data-toggle='tab' onClick={() => handleNavTabs(true)}>
              KPI nhân viên
            </a>
          </li>
          <li>
            <a href='#annualLeave' data-toggle='tab' onClick={() => handleNavTabs(true)}>
              Nghỉ phép-Tăng ca
            </a>
          </li>
        </ul>
