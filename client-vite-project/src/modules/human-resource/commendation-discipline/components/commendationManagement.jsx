...
const CommendationManagement = (props) => {
  ...
  let pageTotal =
    discipline.totalListCommendation % limit === 0
    ...
    <div id='khenthuong' className={`tab-pane ${pageActive === 'commendation' ? 'active' : null}`}>
      <div className='box-body qlcv'>
        ...
        <div className='form-inline' style={{ marginBottom: 10 }}>
          ...
          <div className='form-group'>
            <label className='form-control-static'>
              {translate('human_resource.commendation_discipline.commendation.table.reward_forms_short')}
            </label>
            <input
              type='text'
              className='form-control'
