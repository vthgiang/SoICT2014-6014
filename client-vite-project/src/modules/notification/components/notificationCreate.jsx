...
import { DialogModal, SelectBox, QuillEditor, convertImageBase64ToFile, UploadFile } from '../../../common-components'
...
class NotificationCreate extends Component {
  ...
  validateTitle = (value, willUpdateState = true) => {
    const { message } = ValidationHelper.validateCode(this.props.translate, value)
  ...
  validateSender = (value, willUpdateState = true) => {
    const { message } = ValidationHelper.validateName(this.props.translate, value)
    ...
    return (
      <>
        <a
          ...
          data-toggle='modal'
          href='#modal-create-notification'
          data-backdrop='static'
        >
          {translate('notification.add')}
        </a>
        <DialogModal
          ...
          <form id='form-create-notification'>
            <div className='row'>
              ...
              <div className='form-group col-sm-4'>
                <label>
                  {translate('notification.type.title')}
                  <span className='text-red'>*</span>
                </label>
                <SelectBox // id cố định nên chỉ render SelectBox khi items đã có dữ liệu
                  ...
                  items={[
                    {
                      value: 'info',
                      text: translate('notification.type.info')
                    },
                    {
                      value: 'general',
                      text: translate('notification.type.general')
                    },
                    {
                      value: 'important',
                      text: translate('notification.type.important')
                    },
                    {
                      value: 'emergency',
                      text: translate('notification.type.emergency')
                    }
                  ]}
            ...
            <div className='form-group'>
              ...
              <QuillEditor id='notificationCreate' getTextData={this.handleContent} table={false} />
            </div>
            ...
            <div className='form-group'>
              ...
              <UploadFile multiple onChange={this.handleChangeFile} />
            </div>
          </form>
        </DialogModal>
      </>
