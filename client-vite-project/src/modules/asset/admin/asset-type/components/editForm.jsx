  ...
  return (
    <div id='edit-asset-type'>
      ...
      <div className='form-group'>
        <label>
          {translate('asset.asset_type.asset_type_code')}
      ...
      <div className='form-group'>
        <label>
          ...
          <a style={{ cursor: 'pointer' }} title='Thêm thuộc tính mặc định'>
      ...
      <div className='form-group'>
        <button className='btn btn-success pull-right' style={{ marginLeft: '5px' }} onClick={save}>
          {translate('asset.general_information.save')}
        </button>
        <button
        ...
        >
          {translate('asset.general_information.cancel')}
        </button>
      </div>
    </div>
  )
