...
;(function () {
  ...
  function Ta(k, p, D) {
    if (k && p && D) {
      ...
      if ('undefined' !== typeof Blob && new Blob()) {
        for (
          var F = k.replace(/^data:[a-z\/]*;base64,/, ''), F = atob(F), z = new ArrayBuffer(F.length), z = new Uint8Array(z), v = 0;
          v < F.length;
          v++
        )
          z[v] = F.charCodeAt(v)
  ...
  Ha = {
    ...
    data: [
      { indexLabelFontFamily: v, indexLabelFontSize: E, indexLabelFontColor: Q, indexLabelFontWeight: 'normal', indexLabelLineThickness: 1 }
    ],
    axisX: [
      {
        titleFontFamily: v,
  ...
  V.prototype.addEventListener = function (k, p, r) {
    k &&
      p &&
      ((this._eventListeners[k] = this._eventListeners[k] || []), this._eventListeners[k].push({ context: r || this, eventHandler: p }))
  }
  ...
  Na.Chart = (function () {
    ...
    p.prototype.setLayout = function () {
              ...
              if (!this.axisY.length)
                for (var b = 0; b < this.options.axisY.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push((this.axisY[b] = new z(this, 'axisY', this.options.axisY[b], b, 'axisY', 'bottom')))
              this.data[d].axisY =
                this.axisY[0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY.length ? this.data[d].axisYIndex : 0]
              this.axisY[
              ...
              if (!this.axisY2.length)
                for (b = 0; b < this.options.axisY2.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push((this.axisY2[b] = new z(this, 'axisY2', this.options.axisY2[b], b, 'axisY', 'top')))
              this.data[d].axisY =
                this.axisY2[0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY2.length ? this.data[d].axisYIndex : 0]
              this.axisY2[
              ...
              if (!this.axisX.length)
                for (b = 0; b < this.options.axisX.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push((this.axisX[b] = new z(this, 'axisX', this.options.axisX[b], b, 'axisX', 'left')))
              this.data[d].axisX =
              ...
              if (!this.axisX2.length)
                for (b = 0; b < this.options.axisX2.length; b++)
                  'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                      this._axes.push((this.axisX2[b] = new z(this, 'axisX2', this.options.axisX2[b], b, 'axisX', 'right')))
              this.data[d].axisX =
                this.axisX2[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX2.length ? this.data[d].axisXIndex : 0]
              this.axisX2[
      ...
      this._processData()
      this.options.title &&
        ((this.title = new Aa(this, this.options.title)), this.title.dockInsidePlotArea ? a.push(this.title) : this.title.setLayout())
      this.subtitles = []
      ...
      ;('normal' !== this.plotInfo.axisPlacement && 'xySwapped' !== this.plotInfo.axisPlacement) ||
        z.setLayout(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace())
    }
      ...
      if (g) {
        ...
        for (m = 0; m < this._axes.length; m++)
          if (this._axes[m].dataInfo._dataRanges) {
            ...
            c =
              ((this._axes[m].dataInfo.max + 1 - w) * Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10)) / 100
            ...
            if (this._axes[m].dataInfo.dataPointYNegativeSums) {
              ...
              for (l in n)
                n.hasOwnProperty(l) &&
                  !isNaN(l) &&
                  ((q = -1 * n[l]), u(q) || ((f = Math.floor((q - w) / c)), q < s[f].min && (s[f].min = q), q > s[f].max && (s[f].max = q)))
        ...
        if (this.panEnabled || this.zoomEnabled) {
          ...
          m &&
            ...
            m &&
              this.zoomEnabled &&
              'none' === this._zoomButton.style.display &&
              (Qa(this._zoomButton, this._resetButton), ua(this, this._zoomButton, 'pan'), ua(this, this._resetButton, 'reset')))
        }
      }
      this.isDrag = !1
          ...
          if (
            ...
            !(
              ...
              (!(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) &&
                ((q.logarithmic && B < Math.pow(q.dataInfo.minDiff, 3)) || (!q.logarithmic && B < 3 * Math.abs(q.dataInfo.minDiff)))) ||
              n < q.minimum ||
              f > q.maximum
            ))
          )
            ...
            'inside' !== t
              ? ((e = b.y1),
                ...
                0 < ma
                  ...
                  : ((n = h.point.y + m + c),
                    n > g - w - m - c && ((n = 'auto' === t ? Math.min(h.point.y, g) - w - m - c : g - w - m - c), (v = n < h.point.y))))
              ...
              'inside' !== t
                ? ((m = b.x1),
                  ...
                  0 > ma
                    ...
                    : ((q = h.point.x + e + c),
                      q > g - l - e - c && ((q = 'auto' === t ? Math.min(h.point.x, g) - l - e - c : g - l - e - c), (v = q < h.point.x))))
              ...
              if (
                ...
                if ('number' !== typeof s[t].y) 0 < t && !(h.connectNullData || u || p) && (b.stroke(), r && c.stroke()), (u = !0)
                  ...
                  p || u
                    ...
                    : (b.lineTo(C, x),
                      r && c.lineTo(C, x),
                      0 == t % 500 && (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))))
                  m = { x: C, y: x }
                  t < s.length - 1 &&
    ...
    p.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        f = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.width * (a.axisX.logarithmic ? Math.log(f) / Math.log(a.axisX.range) : Math.abs(f) / Math.abs(a.axisX.range))) /
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                  (l[c] = t[h].y + (l[c] ? l[c] : 0)),
                    0 < l[c] && ((q = a.axisY.convertValueToPixel(l[c])), (y = 'undefined' !== typeof g[c] ? g[c] : n), (g[c] = q))
    ...
    p.prototype.renderStackedBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        f = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.height * (a.axisX.logarithmic ? Math.log(f) / Math.log(a.axisX.range) : Math.abs(f) / Math.abs(a.axisX.range))) /
                a.plotType.plotUnits.length)) <<
            0
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                  ...
                  (w[c] = t[h].y + (w[c] ? w[c] : 0)), (s = m[c] ? m[c] : n), (m[c] = y = a.axisY.convertValueToPixel(w[c]))
    ...
    p.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        k = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.7 * m.width * (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range))) << 0
    ...
    p.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        k = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.7 * g.width * (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range))) << 0
    ...
    p.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        h = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((e.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0
    ...
    p.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var v = 0, t = 0; t < this.data.length; t++)
          !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || (this.data[t].type.match(/(stacked)/gi) && v) || v++
    ...
    p.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        n = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.6 *
              ((g.width * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range))) /
                a.plotType.totalDataSeries)) <<
            0
    ...
    p.prototype.renderPie = function (a) {
            ...
            if (((l = f[a]), (y = l.indexLabelTextBlock.measureText()), 0 !== y.height && 0 !== y.width))
              (y = y = 0),
                ...
                0 < y &&
                  (!m &&
                    l.indexLabelText &&
                    ((u = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1), 0 === g(a, y * u) && g(a, 2 * u)),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 !== z) {
          ...
          var A =
            'inside' !== h.indexLabelPlacement && a ? (0.75 * Math.min(n.width, n.height)) / 2 : (0.92 * Math.min(n.width, n.height)) / 2
            ...
            for (var s = J.length - 1; 0 <= s; s--)
              !J[s].isDirty &&
                ...
                !(l >= J.length - 1) &&
                  ...
                  (J[s].textBlock.y = J[s].textBlock.y + J[s].height - e > e - J[s].textBlock.y ? e + 1 : e - J[s].height - 1))
          }
        ...
        if (q.dataPoints && q.dataPoints.length)
          if ('pie' !== q.type && 'doughnut' !== q.type && 'funnel' !== q.type && 'pyramid' !== q.type) {
            var n = (q.legendMarkerType = q.legendMarkerType
                ? q.legendMarkerType
                : ('line' !== q.type && 'stepLine' !== q.type && 'spline' !== q.type && 'scatter' !== q.type && 'bubble' !== q.type) ||
                    !q.markerType
      ...
      if (0 < k.length) {
        ...
        for (s = 0; s < k.length; s++) {
          ...
          if (!(0 >= m || 'undefined' === typeof m || 0 >= v || 'undefined' === typeof v)) {
            ...
            p =
              n.textBlock.width +
              (r + l + ('line' === n.chartType || 'spline' === n.chartType || 'stepLine' === n.chartType ? 2 * 0.1 * this.lineHeight : 0))
          }
        }
        this.itemWidth = p
      ...
      if ('none' !== this.chart.plotInfo.axisPlacement)
        if (((q = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d })), this.axisX.logarithmic))
          ...
          (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (q =
              0 < n
                ? Math.min(Math.max((((this.dataPoints.length - 1) / n) * (q - this.dataPoints[0].x)) >> 0, 0), this.dataPoints.length)
                : 0)
      for (;;) {
        g = 0 < m ? q + e : q - e
        if (0 <= g && g < this.dataPoints.length) {
    ...
    z.prototype.createExtraLabelsForLog = function (a) {
      ...
      if (!(5 < a)) {
        ...
        if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
          for (
            var b = z.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0),
              ...
              if (!this._labels[b].breaksLabelType) {
                ...
                if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                  if (
                    ...
                    (p =
                      (h - (k + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) / Math.sin((Math.PI / 180) * Math.abs(-25))),
              ...
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (z =
                    ...
                    (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))),
                  (t =
            ...
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  ((A =
                    (a[f].logarithmic
                      ? Math.log(a[f]._labels[1].position / a[f].viewportMinimum) / a[f].conversionParameters.lnLogarithmBase
                  ...
                  (E = a[f].logarithmic
                    ? (1 < m
                        ? (Math.log(m) / a[f].conversionParameters.lnLogarithmBase) * Math.abs(a[f].conversionParameters.pixelPerUnit)
            ...
            for (f = 0; f < d.length; f++)
              d[f].calculateValueToPixelConversionParameters(),
                ...
                d[f]._labels &&
                  ...
                  ((A =
                    (d[f].logarithmic
                      ? Math.log(d[f]._labels[1].position / d[f].viewportMinimum) / d[f].conversionParameters.lnLogarithmBase
                  ...
                  (E = d[f].logarithmic
                    ? (1 < m
                        ? (Math.log(m) / d[f].conversionParameters.lnLogarithmBase) * Math.abs(d[f].conversionParameters.pixelPerUnit)
            ...
            for (f = 0; f < c.length; f++)
              (c[f].lineCoordinates = {}),
                ...
                c[f] &&
                  c[f].labelAutoFit &&
                  !u(D) &&
                  (0 < !a.length && (m = 0 < c[f].labelAngle ? Math.max(m, D) : 0 === c[f].labelAngle ? Math.max(m, D / 2) : m),
                  0 < !d.length && (k -= y / 2)),
          ...
          if (a && 0 < a.length)
            for (f = 0; f < a.length; f++) {
              ...
              h =
                b && 0 < b.length
                  ? Math.round(
                      b[0] ? b[0].lineCoordinates.y1 : g.y2 - S > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : g.y2 - S
                    )
    ...
    z.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ('undefined' === typeof this.options.interval) {
        ...
        if ('left' === this._position || 'right' === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              var b = [], p, l = this.viewportMaximum, k = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1;
              0 <= h;
              h--
            ) {
              q = this._labels[h]
          ...
          this.chart.addEventListener(
            ...
            function () {
              for (h = 0; h < a._labels.length; h++)
                if (
                  ((q = a._labels[h]),
                  !(q.position < a.viewportMinimum || q.position > a.viewportMaximum || (d && 0 !== g++ % 2 && a.labelAutoFit)) &&
          ...
          (q = this._labels[h]),
            q.position < this.viewportMinimum ||
              ...
              0 === this.labelAngle
                ...
                : ((q.textBlock.y =
                    'inside' === this.labelPlacement ? n.y : n.y - q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                  (q.textBlock.x =
                    'inside' === this.labelPlacement
                      ? n.x + this.tickLength + 5
                      : 0 < this.labelAngle
          ...
          (q = this._labels[h]),
            q.position < this.viewportMinimum ||
              ...
              0 === this.labelAngle
                ? ((q.textBlock.y = n.y),
                  (q.textBlock.x =
                    'inside' === this.labelPlacement ? n.x - q.textBlock.width - this.tickLength - 5 : n.x + this.tickLength + 5))
                : ((q.textBlock.y =
                    'inside' === this.labelPlacement
    ...
    z.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (var d = this, b, c = 0, e = 0, g = !1, m = !1, l = [], k = [], m = !1, c = 0; c < this.stripLines.length; c++) {
          ...
          h._thicknessType === a &&
            (('pixel' === a && (h.value < this.viewportMinimum || h.value > this.viewportMaximum || u(h.value) || isNaN(this.range))) ||
              l.push(h))
        }
        for (c = 0; c < this._stripLineLabels.length; c++)
          if (
            ...
            if ('outside' === b.stripLine.labelPlacement)
              if (
                (h && ((this.ctx.strokeStyle = h.color), 'pixel' === h._thicknessType && (this.ctx.lineWidth = h.thickness)),
        ...
        for (var g = 0; g < e.length && !(d < e[g].startValue); g++)
          a > e[g].endValue ||
            (a <= e[g].startValue && d >= e[g].endValue
              ...
              : a >= e[g].startValue && d >= e[g].endValue
                ? (b =
                    (b / e[g].endValue) * a * Math.pow(e[g].size, Math.log(e[g].endValue / a) / Math.log(e[g].endValue / e[g].startValue)))
                : a <= e[g].startValue && d <= e[g].endValue
                  ? (b =
                      (b / d) *
                      e[g].startValue *
                  ...
                  ? ((c = c - a[e].endValue + this.viewportMinimum),
                    (b =
                      0 < a[e].spacing.toString().indexOf('%')
                        ? b *
                          (1 -
                            ((parseFloat(a[e].spacing) / 100) * (a[e].endValue - this.viewportMinimum)) / (a[e].endValue - a[e].startValue))
                        : b -
                          (Math.min(a[e].spacing, 0.1 * b) * (a[e].endValue - this.viewportMinimum)) / (a[e].endValue - a[e].startValue)))
                  : this.viewportMinimum <= a[e].startValue &&
                    this.viewportMaximum < a[e].endValue &&
                    ((c = c - this.viewportMaximum + a[e].startValue),
                    (b =
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && 'none' !== this.chart.plotInfo.axisPlacement) {
          ...
          if ((h = this.chart.getDataPointAtXY(a, d, b)))
            ...
            if (
              ((h = ab(a, d, this.chart._eventManager.ghostCtx)), 0 < h && 'undefined' !== typeof this.chart._eventManager.objectMap[h])
            ) {
    ...
    ga.prototype.animate = function (a, d, b, c, e) {
      ...
      for (a = []; 0 < this.animations.length; )
        if (
          ...
          (c = 0),
          d.startTime <= b &&
            ((c = e(Math.min(b - d.startTime, d.duration), 0, 1, d.duration)), (c = Math.min(c, 1)), isNaN(c) || !isFinite(c)) &&
            (c = 1),
          1 > c && a.push(d),
            ...
            'circle' === c
              ? (b.moveTo(a, d),
                ...
                l &&
                  (k
                    ? b.stroke()
                    : ((p = b.globalAlpha), (b.globalAlpha = 0.15), (b.strokeStyle = 'black'), b.stroke(), (b.globalAlpha = p))))
              : 'square' === c
                ? (b.beginPath(),
