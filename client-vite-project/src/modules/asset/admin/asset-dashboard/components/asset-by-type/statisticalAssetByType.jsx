...
function StatisticalAssetByType(props) {
  ...
  useDeepCompareEffect(() => {
    let dataStatistical = [[translate('asset.dashboard.amount')], [translate('asset.dashboard.value')], [translate('asset.dashboard.lost')]]
  ...
  return <div id='statisticalAssetByType'></div>
}
