...
function DepreciationTab(props) {
  ...
  const validateYear = (value, index, willUpdateState = true) => {
    ...
    let startDepreciation = undefined,
      endDepreciation = undefined
      ...
      <div className='box-body'>
        ...
        <fieldset className='scheduler-border'>
          <legend className='scheduler-border'>
            <h4 className='box-title'>{translate('asset.general_information.depreciation_information')}</h4>
          </legend>

          {/* Nguyên giá */}
          <div className='form-group'>
            <label htmlFor='cost'>{translate('asset.general_information.original_price')} (VNĐ)</label>
            <br />
            <input
              type='number'
          ...
          <div className={`form-group`}>
            ...
            <input
              ...
              className='form-control'
              name='residualValue'
              value={residualValue ? residualValue : ''}
              onChange={handleResidualValueChange}
              placeholder='Giá trị thu hồi ước tính'
              autoComplete='off'
            />
          </div>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              placeholder='Thời gian trích khấu hao'
              autoComplete='off'
            />
          </div>
          ...
          <div className={`form-group ${!errorOnStartDepreciation ? '' : 'has-error'} `}>
            ...
            <DatePicker id={`startDepreciation${id}`} value={startDepreciation} onChange={handleStartDepreciationChange} />
          ...
          {depreciationType == 'units_of_production' && (
            <div className={`form-group ${!errorOnEstimatedTotalProduction ? '' : 'has-error'} `}>
              ...
              <input
                ...
                value={estimatedTotalProduction ? estimatedTotalProduction : ''}
                onChange={handleEstimatedTotalProductionChange}
                placeholder='Sản lượng theo công suất thiết kế'
                autoComplete='off'
              />
