      ...
      <div className='box-body qlcv'>
        ...
        <div className='form-inline'>
          {!props.assetId && props.typeRegisterForUse == 2 && (
            <div>
              <span style={{ color: 'red' }}>Cần thêm tài sản trước khi thêm sử dụng theo giờ</span>
            </div>
          )}
          <div className='form-group'>
            ...
            <div style={{ width: 'auto' }} className='form-control-static'>
              {assignedToUser
                ? userlist.filter((item) => item._id === assignedToUser).pop()
              ...
              {assignedToOrganizationalUnit
                ? departmentlist.filter((item) => item._id === assignedToOrganizationalUnit).pop()
          ...
          {(assignedToUser || assignedToOrganizationalUnit) && (
            <div className='form-group' style={{ marginLeft: '20px' }}>
              <button type='button' className='btn btn-success' onClick={handleRecallAsset}>
                Thu hồi
              </button>
            </div>
          )}
              ...
              {usageLogs &&
                ...
                usageLogs.map((x, index) => (
                  <tr key={index}>
                    <td>
                      {x.usedByUser
                        ? userlist.length && userlist.filter((item) => item._id === x.usedByUser).pop()
                    ...
                    <td>
                      {x.usedByOrganizationalUnit
                        ? departmentlist.length && departmentlist.filter((item) => item._id === x.usedByOrganizationalUnit).pop()
                    ...
                    <td>
                      <a
                        ...
                        style={{ width: '5px' }}
                        title='Chỉnh sửa thông tin sử dụng'
                      >
                        <i className='material-icons'>edit</i>
                      </a>
                      {((assignedToUser && index != usageLogs.length - 1) || !assignedToUser) && (
                        <a className='delete' title='Delete' data-toggle='tooltip' onClick={() => handleDeleteUsage(index)}>
