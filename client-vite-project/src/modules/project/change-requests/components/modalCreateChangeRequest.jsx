...
const ModalCreateChangeRequest = (props) => {
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID={`modal-create-change-request`}
        isLoading={false}
