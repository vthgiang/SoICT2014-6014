        ...
        <div className='form-inline' style={{ textAlign: 'center' }}>
          <div className='form-group'>
            ...
            <label id='label-for-calendar'>
              {translate('task.task_management.in_time')}({count && count.intime ? count.intime : 0})
            </label>
          </div>
          <div className='form-group'>
            <div id='delay'></div>
            <label id='label-for-calendar'>
              {translate('task.task_management.delayed_time')}({count && count.delay ? count.delay : 0})
            </label>
          </div>
          <div className='form-group'>
            <div id='not-achieved'></div>
            <label id='label-for-calendar'>
              {translate('task.task_management.not_achieved')}({count && count.notAchived ? count.notAchived : 0})
            </label>
          </div>
        </div>
      </div>
