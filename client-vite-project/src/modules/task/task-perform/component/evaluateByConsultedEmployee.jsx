        ...
        <form id='form-evaluate-task-by-consulted' className='body-evaluation' style={{ height: 'calc(100vh - 186px)', overflow: 'auto' }}>
            ...
            <div className='row'>
              ...
              <div className='col-md-6'>
                <div className={`form-group ${errorOnEndDate === undefined ? '' : 'has-error'}`}>
                  ...
                  <DatePicker id={`create_date_${id}_${perform}`} value={endDate} onChange={handleEndDateChange} disabled={disabled} />
          ...
          <fieldset className='scheduler-border'>
            ...
            {evaluations && evaluations.results.length !== 0 ? (
                    ...
                    return (
                      <div key={index}>
                        <span style={{ fontWeight: 'bold' }}>
                          {translate('task.task_management.detail_emp_point_of')} {res.employee.name}
                        </span>
                        :&nbsp;&nbsp;&nbsp;{res.employeePoint}
                      </div>
                    )
              ...
              <div>
                <p style={{ color: 'red', fontWeight: 'bold' }}>{translate('task.task_management.responsible_not_eval')} </p>
              </div>
            )}
          </fieldset>
          ...
          <fieldset className='scheduler-border'>
            ...
            <div style={{ lineHeight: 2.8 }}>
              {/* % tiến độ */}
              <div>
                <span style={{ fontWeight: 'bold' }}>{translate('task.task_management.detail_progress')}:&nbsp;&nbsp;&nbsp;</span>
                {evaluations?.progress !== null && evaluations?.progress !== undefined
              ...
              {evaluations ? (
                        ...
                        if (info.type === 'Date') {
                          ...
                          return (
                            <div key={index}>
                              <div>
                                <span style={{ fontWeight: 'bold' }}>{info.name}</span>:&nbsp;&nbsp;&nbsp;
                                {info.value !== null && info.value !== undefined ? info.value : translate('task.task_management.not_eval')}
                              </div>
                            </div>
                          )
                      })}
                ...
                <div>
                  <p style={{ color: 'red', fontWeight: 'bold' }}>{translate('task.task_management.not_eval_on_month')} </p>
                </div>
              )}
            </div>
          </fieldset>
