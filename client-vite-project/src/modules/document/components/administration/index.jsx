  ...
  return (
    <div className='nav-tabs-custom'>
      <ul className='nav nav-tabs'>
        <li className='active'>
          <a href='#administration-document-list-data' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
            {translate('document.data')}
          </a>
        </li>
        <li>
          <a href='#administration-document-categories' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
            {translate('document.category')}
          </a>
        </li>
        <li>
          <a href='#administration-document-domains' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
            {translate('document.domain')}
          </a>
        </li>
        <li>
          <a href='#administration-document-archives' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
            {translate('document.archive')}
          </a>
        </li>
        <li>
          <a href='#administration-statistics-report' data-toggle='tab' onClick={() => forceCheckOrVisible(true, false)}>
            {translate('document.statistics_report')}
          </a>
        </li>
      </ul>
      <div className='tab-content'>
        ...
        <div className='tab-pane active' id='administration-document-list-data'>
          <LazyLoadComponent key='AdministrationDocumentListData'>
        ...
        <div className='tab-pane' id='administration-document-categories'>
          <LazyLoadComponent key='AdministrationDocumentCategories'>
        ...
        <div className='tab-pane' id='administration-document-domains'>
          <LazyLoadComponent key='AdministrationDocumentDomains'>
        ...
        <div className='tab-pane' id='administration-statistics-report'>
          <LazyLoadComponent key='AdministrationStatisticsReport'>
        ...
        <div className='tab-pane' id='administration-document-archives'>
          <LazyLoadComponent key='AdministrationDocumentArchives'>
