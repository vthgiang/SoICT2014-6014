...
function AdministrationDocumentArchives(props) {
  ...
  return (
    <React.Fragment>
      <div className='form-inline'>
        <div className='dropdown pull-right' style={{ marginBottom: 15 }}>
          ...
          <ul className='dropdown-menu pull-right'>
            <li>
              <a
                href='#modal-create-document-archive'
                title='Add archive'
                onClick={(event) => {
            ...
            <li>
              <a
                href='#modal_import_file_archive'
                title='ImportForm'
                onClick={(event) => {
      ...
      {archiveParent.length > 0 && (
        <button className='btn btn-danger' style={{ marginLeft: '5px' }} onClick={deleteArchive}>
      ...
      <div className='row'>
        <div className='col-xs-12 col-sm-12 col-md-7 col-lg-7'>
          <div className='archive-tree' id='archive-tree'>
            <Tree id='tree-qlcv-document-archive' onChanged={onChanged} checkNode={checkNode} unCheckNode={unCheckNode} data={dataTree} />
          </div>
          <SlimScroll
            outerComponentId='archive-tree'
            innerComponentId='tree-qlcv-document-archive'
