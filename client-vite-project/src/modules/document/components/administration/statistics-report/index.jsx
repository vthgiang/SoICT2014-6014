...
function AdministrationStatisticsReport(props) {
  ...
  useCallback(() => {
    if (state.dataStatus === DATA_STATUS.QUERYING) {
      if (
        props.documents.administration.categories.list.length &&
        props.documents.administration.data.list.length &&
        props.documents.administration.domains.list.length &&
        props.documents.administration.archives.list.length
      ) {
        setState({
          ...state,
          dataStatus: DATA_STATUS.AVAILABLE
        ...
        <div className='col-xs-12'>
          <div className='box box-solid'>
            ...
            <div className='box-body qlcv' style={{ minHeight: '400px' }}>
              <TreeArchive archives={listArchives} documents={docs} chartArchive={documents.administration.dataChart.chartArchive} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='row'>
        <div className='col-xs-12'>
          <div className='box box-solid'>
            ...
            <div className='box-body qlcv' style={{ minHeight: '400px' }}>
              <TreeDomain domains={listDomains} documents={docs} chartDomain={documents.administration.dataChart.chartDomain} />
            </div>
          </div>
        </div>
      </div>
