        ...
        <form id={`form-create-payment-voucher`}>
          ...
          <fieldset className='scheduler-border'>
            ...
            <div className={'pull-right'} style={{ padding: 10 }}>
              {editPurchaseOrder ? (
                <React.Fragment>
                  <button className='btn btn-success' onClick={handleCancelEditPaymentForPurchaseOrder} style={{ marginLeft: '10px' }}>
                    Hủy chỉnh sửa
                  </button>
                  <button
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          <a href='#abc' className='edit' title='Sửa' onClick={() => handlePaymentForPurchaseOrderEdit(item, index)}>
