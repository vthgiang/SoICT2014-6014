          ...
          <fieldset className='scheduler-border'>
            ...
            {formality == 0 ? (
              <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                <div className={`form-group ${!discountedCashError ? '' : 'has-error'}`}>
                  ...
                  <input type='number' className='form-control' value={discountedCash} onChange={handleDiscountCashChange} />
            ...
            {formality == 1 ? (
              <div className='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                <div className={`form-group ${!discountedPercentageError ? '' : 'has-error'}`}>
                  ...
                  <input type='number' className='form-control' value={discountedPercentage} onChange={hanlleDiscountedPercentageChange} />
                ...
                <div className='form-group' style={{ display: 'flex', flexDirection: 'column' }}>
                  <label>
                    ...
                    <a style={{ cursor: 'pointer' }} title='Thêm các mặt hàng áp dụng'>
                      <i className='fa fa-plus-square' style={{ color: '#28A745', marginLeft: 5 }} onClick={handleAddDiscountOnGoods} />
                    </a>
                  </label>
                  {discountOnGoods && discountOnGoods.length ? <CollapsibleShowDiscountOnGoods discountOnGoods={discountOnGoods} /> : ''}
                </div>
              </div>
            ) : (
              ''
                ...
                <div className='form-group' style={{ display: 'flex', flexDirection: 'column' }}>
                  <label>
                    ...
                    <a style={{ cursor: 'pointer' }} title='Thêm các sản phẩm tặng kèm'>
                      <i className='fa fa-plus-square' style={{ color: '#28A745', marginLeft: 5 }} onClick={handleAddBonusGood} />
                    </a>
                  </label>
            ...
            <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
              <div className={'pull-right'} style={{ padding: 10 }}>
                {editDiscountDetail ? (
                  <React.Fragment>
                    <button className='btn btn-success' onClick={handleCancelEditDiscountDetail} style={{ marginLeft: '10px' }}>
                      Hủy chỉnh sửa
                    </button>
                    <button
                  ...
                  discounts.map((item, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>{item.minimumThresholdToBeApplied ? formatCurrency(item.minimumThresholdToBeApplied) : ''}</td>
                        <td>{item.maximumThresholdToBeApplied ? formatCurrency(item.maximumThresholdToBeApplied) : ''}</td>
                        ...
                        <td>
                          <a href='#abc' className='edit' title='Sửa' onClick={() => handleEditDiscountDetail(item, index)}>
                            <i className='material-icons'>edit</i>
                          </a>
                          <a href='#abc' className='delete' title='Xóa' onClick={() => handleDeleteDiscountDeatail(index)}>
