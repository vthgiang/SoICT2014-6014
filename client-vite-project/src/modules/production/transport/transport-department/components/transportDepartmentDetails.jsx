      ...
      >
        <form id='form-create-business-department'>
          <div className={`form-group`}>
            <label>{'Đơn vị: '}</label>
            <p>{organizationalUnit?.name}</p>
          </div>

          <div className={`form-group`}>
            {/* <div className="box box-solid"> */}
            <label>{'Vai trò phê duyệt yêu cầu, tạo kế hoạch vận chuyển'}</label>
            ...
            {/* <div className="box box-solid"> */}
            <label>{'Vai trò giám sát thực hiện kế hoạch vận chuyển'}</label>
            ...
            {/* <div className="box box-solid"> */}
            <label>{'Vai trò nhân viên tham gia vận chuyển'}</label>
