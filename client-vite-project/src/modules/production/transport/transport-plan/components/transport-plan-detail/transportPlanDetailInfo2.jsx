        ...
        <form id='modal-detail-info-transport-plan2'>
          <div className='box-body'>
                  ...
                  <div className='col-xs-12 col-sm-12 col-md-4 col-lg-4'>
                    ...
                    <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                      <div className='form-group'>
                        ...
                        <input type='text' className='form-control' disabled={true} value={formSchedule.name} />
                      </div>
                    </div>
                    <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                      <div className={`form-group`}>
                        <label>Người phụ trách</label>
                        <input type='text' className='form-control' disabled={true} value={formSchedule.supervisor?.name} />
                      </div>
                    </div>
                    ...
                    <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                      <div className='form-group'>
                        ...
                        <DatePicker id={`start_date_edit_22`} value={formatDate(formSchedule.startDate)} disabled={true} />
                      </div>
                    </div>
                    <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                      <div className={`form-group`}>
            ...
            <div className='box box-solid'>
              ...
              <div className='box-body qlcv'>
                <TransportVehicleAndCarrierSelect currentTransportPlan={currentTransportPlan} />
              </div>
            </div>
          </div>
        </form>
