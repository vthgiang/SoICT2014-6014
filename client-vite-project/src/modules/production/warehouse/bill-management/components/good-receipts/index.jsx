      ...
      <div className='box-body qlcv'>
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              items={[
                {
                  value: '1',
                  text: translate('manage_warehouse.bill_management.goodReceiptBillType.1')
                },
                {
                  value: '2',
                  text: translate('manage_warehouse.bill_management.goodReceiptBillType.2')
                },
                {
                  value: '3',
                  text: translate('manage_warehouse.bill_management.goodReceiptBillType.3')
                }
              ]}
        ...
        <div className='form-inline'>
          ...
          <div className='form-group'>
            ...
            <DatePicker id='book-stock-end-date-receipt' dateFormat='month-year' value={endDate} onChange={props.handleChangeEndDate} />
          </div>
        </div>
        <div className='form-inline'>
          <div className='form-group'>
