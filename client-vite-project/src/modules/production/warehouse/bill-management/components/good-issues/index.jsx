  ...
  return (
    <div id='bill-good-issues'>
      <div className='box-body qlcv'>
        ...
        {state.billInfor && <GoodIssueWorkFlowModal billId={state.billInfor._id} billInfor={state.billInfor} />}
        <div className='form-inline'>
          <div className='dropdown pull-right' style={{ marginTop: 5 }}>
            ...
            <ul className='dropdown-menu pull-right' style={{ marginTop: 0 }}>
              ...
              <li>
                <a style={{ cursor: 'pointer' }} title='Tạo từ yêu cầu' onClick={handleClickCreateFromRequest}>
                  Tạo từ yêu cầu xuất kho
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className='form-group'>
            ...
            <SelectMulti
              ...
              items={[
                {
                  value: '1',
                  text: translate('manage_warehouse.bill_management.goodRIssueBillType.1')
                },
                {
                  value: '2',
                  text: translate('manage_warehouse.bill_management.goodRIssueBillType.2')
                },
                {
                  value: '3',
                  text: translate('manage_warehouse.bill_management.goodRIssueBillType.3')
                },
                {
                  value: '4',
                  text: translate('manage_warehouse.bill_management.goodRIssueBillType.4')
                },
                {
                  value: '5',
                  text: translate('manage_warehouse.bill_management.goodRIssueBillType.5')
                }
              ]}
        ...
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <DatePicker id='book-stock-start-date-issue' dateFormat='month-year' value={startDate} onChange={props.handleChangeStartDate} />
          </div>
          <div className='form-group'>
            <label className='form-control-static'>{translate('manage_warehouse.bill_management.to_date')}</label>
            <DatePicker id='book-stock-end-date-issue' dateFormat='month-year' value={endDate} onChange={props.handleChangeEndDate} />
          </div>
        </div>
        <div className='form-inline'>
          <div className='form-group'>
