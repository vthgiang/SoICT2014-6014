        ...
        <div className={`form-group`}>
          <fieldset className='scheduler-border'>
            ...
            <table id={tableId} className='table table-striped table-bordered table-hover' style={{ marginTop: '15px' }}>
              <thead>
                <tr>
                  <th className='col-fixed not-sort' style={{ width: 45 }}></th>
              ...
              <tbody>
                {typeof listBillsIssue !== undefined &&
                  listBillsIssue.length !== 0 &&
                    ...
                    <tr key={index}>
                      <td>
                        <input
                          ...
                          checked={checkedId == x._id}
                          onChange={() => handleSelectBill(x)}
                        ></input>
                      </td>
                      <td>{x.code}</td>
                      ...
                      <td>
                        <p className='text-blue'>{showGoodInformation(x)}</p>
                      </td>
                    </tr>
                  ))}
              </tbody>
