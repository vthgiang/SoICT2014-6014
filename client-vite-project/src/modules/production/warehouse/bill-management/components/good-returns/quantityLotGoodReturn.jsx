...
function QuantityLotGoodReturn(props) {
  const EMPTY_LOT = {
    lot: null,
        ...
        <fieldset className='scheduler-border'>
          ...
          <div className='pull-right' style={{ marginBottom: '10px' }}>
            ...
            {state.editInfo ? (
              ...
              <button className='btn btn-success' style={{ marginLeft: '10px' }} disabled={!isLotsValidated()} onClick={handleAddLot}>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(QuantityLotGoodReturn))
