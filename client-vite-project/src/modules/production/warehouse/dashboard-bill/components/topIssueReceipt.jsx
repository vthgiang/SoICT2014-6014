...
function TopIssueReceipt(props) {
  let today = new Date(),
  ...
  const handleNumberTopChange = (value) => {
    setState({
      ...state,
      numberTop: value[0]
    })
  ...
  const barAndChart = () => {
    ...
    c3.generate({
      ...
      data: {
        x: 'x',
        columns: [dataChart.name, dataChart.quantity],
        type: 'bar',
        labels: true
      },
      axis: {
  ...
  const { defaultEndMonth, defaultStartMonth, type, numberTop } = state
        ...
        <div className='box-header with-border'>
          ...
          <div className='form-inline' style={{ display: 'flex', marginTop: '10px' }}>
            <div className='form-group' style={{ display: 'flex' }}>
              <label>{'Kho'}</label>
              <SelectMulti
                id={`select-multi-stock-top-bill-issue-receipt`}
                multiple='multiple'
            ...
            <div className='form-group' style={{ display: 'flex' }}>
              ...
              <SelectBox
                id='select-type-top-bill-issue-receipt'
                className='form-control select2'
                value={type}
                items={[
                  { value: '1', text: 'Nhập' },
            ...
            <div className='form-group' style={{ display: 'flex' }}>
              ...
              <SelectBox
                id='select-number-top-bill-issue-receipt'
                className='form-control select2'
                value={numberTop}
                items={[
                  { value: '1', text: '5' },
                ...
                onChange={handleNumberTopChange}
              />
            </div>
          </div>
          <div className='form-inline'>
            <div className='form-group'>
              ...
              <DatePicker
                id='start-month-top-issue-receipt'
            ...
            <div className='form-group'>
              ...
              <DatePicker
                id='end-month-top-issue-receipt'
                dateFormat='month-year'
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(TopIssueReceipt))
