      ...
      <React.Fragment>
        <div className='form-inline'>
          ...
          <div className={`form-group`}>
            ...
            <DatePicker id='end-day-manufacturing-dashboard-header' value={toDate} onChange={this.handleToDateChange} disabled={false} />
          </div>
          ...
          <div className='col-md-3 col-sm-3 col-xs-3'>
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.plan_total')}>
                ...
                <a href={`/manage-manufacturing-plan`} target='_blank'>
            ...
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.progress_1')}>
                ...
                <span className='info-box-number'>
                  {planNumber.truePlans}/{planNumber.totalPlans}
                </span>
                <a href={`/manage-manufacturing-plan`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa fa-arrow-circle-right'></i>
                </a>
          ...
          <div className='col-md-3 col-sm-3 col-xs-3'>
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.progress_2')}>
                ...
                <span className='info-box-number'>
                  {planNumber.slowPlans}/{planNumber.totalPlans}
                </span>
                <a href={`/manage-manufacturing-plan`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa fa-arrow-circle-right'></i>
                </a>
          ...
          <div className='col-md-3 col-sm-3 col-xs-3'>
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.progress_3')}>
                ...
                <span className='info-box-number'>
                  {planNumber.expiredPlans}/{planNumber.totalPlans}
                </span>
                <a href={`/manage-manufacturing-plan`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa fa-arrow-circle-right'></i>
                </a>
          ...
          <div className='col-md-4 col-sm-6 col-xs-6'>
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.command_total')}>
                ...
                <a href={`/manage-manufacturing-command`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa fa-arrow-circle-right'></i>
                </a>
              </div>
            </div>
          ...
          <div className='col-md-4 col-sm-6 col-xs-6'>
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.command_number_1')}>
                ...
                <span className='info-box-number'>
                  {commandNumber.trueCommands}/{commandNumber.totalCommands}
                </span>
                <a href={`/manage-manufacturing-command`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa fa-arrow-circle-right'></i>
                </a>
          ...
          <div className='col-md-4 col-sm-6 col-xs-6'>
            <div className='info-box'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.command_number_2')}>
                ...
                <span className='info-box-number'>
                  {commandNumber.slowCommands}/{commandNumber.totalCommands}
                </span>
                <a href={`/manage-manufacturing-command`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa  fa-arrow-circle-o-right'></i>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className='col-md-4 col-sm-4 col-xs-4'>
            <div className='info-box with-border'>
              ...
              <div className='info-box-content' title={translate('manufacturing.dashboard.sales_order_number_1')}>
                ...
                <span className='info-box-number'>{numberSalesOrdersWorks.salesOrder1}</span>
                <a href={`/manage-manufacturing-plan`} target='_blank'>
                  {translate('manufacturing.dashboard.see_more')} <i className='fa fa-arrow-circle-right'></i>
                </a>
              </div>
