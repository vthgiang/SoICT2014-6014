...
class TopTenProductBarChart extends Component {
  ...
  barAndChart = (translate, topTenProduct) => {
    ...
    let chart = c3.generate({
      ...
      data: {
        x: 'x',
        columns: [arrayContent, arrayQuantity],
        type: 'bar',
        labels: true
      },
      axis: {
          ...
          <div className='box-header with-border'>
            ...
            <div className='form-inline'>
              <div className='form-group'>
                ...
                <DatePicker id='top-ten-from-date' value={fromDate} onChange={this.handleFromDateChange} />
              </div>
              <div className='form-group'>
                <label className='form-control-static'>{translate('manufacturing.dashboard.to')}</label>
                <DatePicker id='top-ten-to-date' value={toDate} onChange={this.handleToDateChange} />
              </div>
              <div className='form-group'>
                <button className='btn btn-success' disabled={errorTime} onClick={this.handleSubmitSearch}>
