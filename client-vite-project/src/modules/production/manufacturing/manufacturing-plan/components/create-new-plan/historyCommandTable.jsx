...
class HistoryCommandTable extends Component {
  ...
  handleSubmitSearch = () => {
    const { currentRole, page, limit, fromDate, toDate, manufacturingMills, quantity_gt, quantity_lt } = this.state
    const data = {
            ...
            <div className='box-body qlcv'>
              <div className='form-inline'>
                <div className='form-group'>
                  ...
                  <input
                    ...
                    value={quantity_gt}
                    onChange={this.handleQuantityGTChange}
                    placeholder='50'
                    autoComplete='off'
                  />
                </div>
                <div className='form-group'>
                  ...
                  <input
                    ...
                    className='form-control'
                    value={quantity_lt}
                    onChange={this.handleQuantityLTChange}
                    placeholder='200'
                    autoComplete='off'
                  />
                </div>
              ...
              <div className='form-inline'>
                ...
                <div className='form-group'>
                  ...
                  <DatePicker id={`end-date-command-hostory-table`} value={toDate} onChange={this.handleEndDateChange} disabled={false} />
                </div>
              </div>
              <div className='form-inline'>
                <div className='form-group'>
                  ...
                  <SelectMulti
                    ...
                    multiple='multiple'
                    options={{
                      nonSelectedText: translate('manufacturing.command.choose_mills'),
                      ...
                      <tr key={index}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          <a
                            ...
                            onClick={() => {
                              this.handleShowDetailManufacturingCommand(command)
                            }}
                          >
