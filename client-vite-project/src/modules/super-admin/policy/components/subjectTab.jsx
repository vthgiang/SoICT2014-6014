    ...
    <div id={props.id} className='tab-pane'>
      ...
      <table className='table table-bordered policy-attribute-table not-sort'>
        ...
        <tbody>
            ...
            <td rowSpan={!userAttributes || userAttributes.length == 0 ? 1 : userAttributes.length}>
              {!userAttributes || userAttributes.length == 0 ? (
                <a
                  ...
                  onClick={() => window.$(`#modal-add-attribute-${props.id}-user`).modal('show')}
                  title={translate('manage_policy.add_user_attribute')}
                >
                ...
                <a
                  ...
                  style={{ width: '5px' }}
                  title={translate('manage_policy.edit_user_attribute')}
                >
          ...
          {!userAttributes || userAttributes.length <= 1
            ? null
            ...
            <td rowSpan={!roleAttributes || roleAttributes.length == 0 ? 1 : roleAttributes.length}>
              {!roleAttributes || roleAttributes.length == 0 ? (
                <a
                  ...
                  title={translate('manage_policy.add_role_attribute')}
                >
                  <i className='material-icons'>add_box</i>
                </a>
              ) : (
                <a
                  ...
                  className='edit text-yellow'
                  style={{ width: '5px' }}
                  title={translate('manage_policy.edit_role_attribute')}
                >
                  <i className='material-icons'>edit</i>
                </a>
              )}
