...
const TaskReportCreateForm = (props) => {
  ...
  const handleChangeTaskTemplate = (value) => {
    ...
    if (value === '') {
      // Reset các input nhận giá trị tự động khi mẫu công việc trống
      setState({
        ...state,
        newReport: {
          ...newReport,
      ...
      let taskTemplate = props.tasktemplates.items.find((taskTemplate) => taskTemplate._id === value)
  ...
  useEffect(() => {
    async function fetData() {
      ...
      if (newReport.organizationalUnit === '' && user.organizationalUnitsOfUser) {
        let defaultUnit = await user.organizationalUnitsOfUser.find(
          (item) =>
  ...
  const handleClickTransferRightList = () => {
    ...
    setState({
      ...
      newReport: {
        ...newReport,
        itemListBoxLeft: checkId ? itemListBoxLeft : itemListBoxLeft,
  ...
  const handleClickTransferLeftList = () => {
    ...
    setState({
      ...
      newReport: {
        ...newReport,
        itemListBoxRight: checkId ? itemListBoxRight : itemListBoxRight,
  ...
  const isFormValidated = () => {
    ...
    if (
      !ValidationHelper.validateName(translate, nameTaskReport).status ||
  ...
  return (
    <React.Fragment>
      <DialogModal
        modalID='modal-create-task-report'
        isLoading={reports.isLoading && user.isLoading && tasktemplates.isLoading}
      ...
      >
        ...
        <div className='row'>
          <div className='col-md-12 col-lg-12' style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <div className='form-inline d-flex justify-content-end'>
              {!isFormValidated() ? (
                <button disabled id='exportButton' className='btn btn-sm btn-success ' title='Xem biểu đồ' style={{ marginBottom: '6px' }}>
                  <span className='fa fa-fw fa-line-chart' style={{ color: 'rgb(66 65 64)', fontSize: '15px', marginRight: '5px' }}></span>
                </button>
              ) : (
                <button
                  id='exportButton'
          ...
          <div className='col-md-6'>
            ...
            <div className={`form-group`}>
              <label className='control-label'>
                {translate('task_template.permission_view')}
        ...
        <div className='row'>
          <div className={`col-md-6`}>
            ...
            <div className={`form-group ${!taskTemplateErrorCreateForm ? '' : 'has-error'}`}>
              <label className='control-label'>
                Mẫu công việc <span className='text-red'>*</span>
              </label>
            ...
            <div className={`form-group ${!nameErrorCreateForm ? '' : 'has-error'}`}>
              ...
              <input
                ...
                value={newReport.nameTaskReport}
                onChange={handleNameTaskReportChange}
                placeholder='Nhập tên báo cáo'
              />
          ...
          <div className='col-md-6'>
            ...
            <div className={`form-group ${!descriptionErrorCreateForm ? '' : 'has-error'}`}>
              <label htmlFor='Descriptionreport'>
              ...
              <textarea
                ...
                name='description'
                value={newReport.descriptionTaskReport}
                onChange={handleDesTaskReportChange}
              />
        ...
        <div className='row'>
          <div className={`col-md-6 ${!startDateErrorCreateForm ? '' : 'has-error'}`}>
            ...
            <div className={`form-group`}>
              <label className='control-label '>
                Thống kê từ ngày <span className='text-red'>*</span>
              </label>
              <DatePicker id='start-date-form-create' value={newReport.startDate} onChange={handleChangeStartDate} disabled={false} />
          ...
          <div className='col-md-6'>
            ...
            <div className='form-group'>
              ...
              <DatePicker id='end-date-form-create' value={newReport.endDate} onChange={handleChangeEndDate} disabled={false} />
            </div>
          </div>
        </div>
            ...
            <div className='row' id='showTable' style={{ marginTop: '15px' }}>
              <div className='col-md-12'>
                <table className='table table-hover table-striped table-bordered' id='report_manager'>
                  ...
                  <tbody>
                    {taskInformations ? (
                      taskInformations.map((item2, index) => (
                        <tr key={index}>
                          <td>{item2.code}</td>
                          <td>{item2.name}</td>
                              ...
                              <div className='checkbox' style={{ paddingLeft: '20%' }}>
                                <label>
                                  <input
                                    ...
                                    type='checkbox'
                                    value={item2.name}
                                    onChange={(e) => handleChangeShowInReport(index, e)}
                                  />
                                </label>
                              </div>
                            ) : (
                          ...
                          <td>
                            {item2.type === 'number' ? (
                              <input
                                ...
                                style={{ width: '100%' }}
                                type='text'
                                onChange={(e) => handleChangeNewName(index, e)}
                              />
                            ) : (
                              ''
                            )}
                          ...
                          <td>
                            {item2.type === 'number' ? (
                              <input
                                ...
                                className='form-control'
                                style={{ width: '100%' }}
                                onChange={(e) => handleChangeCoefficient(index, e)}
                              />
                            ) : (
                              ''
                            )}
                      ...
                      <tr>
                        <td colSpan={8}>
                          <center>{translate('report_manager.no_data')}</center>
                        </td>
                      </tr>
                    )}
                  </tbody>
                  ...
                  <div className='box-display'>
                    <div className='col-md-5 '>
                      <div className='border'>
                        <div className='box-title'>
                          <span>
                            <b>Chọn chiều dữ liệu trong biểu đồ</b>
                          </span>
                        </div>
                    ...
                    <div className='col-md-5 '>
                      <div className='border'>
                        <div className='box-title'>
                          <span>
                            <b>Dữ liệu được đưa vào biểu đồ</b>
                          </span>
                        </div>
                        <div className='box-body box-size'>
                          <div className='listItem-left'>
