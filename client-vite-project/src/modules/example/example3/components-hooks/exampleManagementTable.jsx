...
const ExampleManagementTable = (props) => {
  const getTableId = 'table-manage-example3-hooks'
  ...
  return (
    <React.Fragment>
      {<ExampleEditForm exampleEdit={exampleEdit} />}
      {<ExampleDetailInfo exampleId={exampleId} />}
        ...
        <div className='form-inline'>
          <div className='form-group'>
            ...
            <input
              ...
              name='exampleName'
              onChange={handleChangeExampleName}
          ...
          <thead>
            <tr>
              ...
              <th style={{ width: '120px', textAlign: 'center' }}>
                ...
                <DataTableSetting
                  tableId={tableId}
                  columnArr={[translate('manage_example.index'), translate('manage_example.exampleName')]}
                  setLimit={setLimit}
                />
              </th>
            </tr>
                ...
                <tr key={index}>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    <a
                      ...
                      onClick={() => handleShowDetailInfo(example._id)}
                    >
                    ...
                    <a
                      ...
                      onClick={() => handleEdit(example._id)}
                    >
